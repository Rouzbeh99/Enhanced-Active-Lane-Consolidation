...
.Ltmp7:
	...
	sub	x12, x12, x13
	splice	z3.s, p5, z3.s, z2.s
	cntp	x13, p2, p6.s
	.loc	0 9 9                           // test.c:9:9
	and	z4.s, z4.s, #0x1
	add	x12, x12, x13
	cmpne	p4.s, p0/z, z4.s, #0
	ld1w	{ z2.s }, p2/z, [x17, z3.s, sxtw #2]
	mov	z4.s, p4/z, #1                  // =0x1
	ld1w	{ z5.s }, p2/z, [x18, z3.s, sxtw #2]
	mov	z4.s, p1/m, w14
	sub	x11, x2, x11
	and	z4.s, z4.s, #0x1
	cmpne	p4.s, p0/z, z4.s, #0
	...
	and	z4.s, z4.s, #0x1
	st1w	{ z5.s }, p2, [x11, z3.s, sxtw]
	sel	p5.b, p5, p5.b, p4.b
	st1w	{ z3.s }, p2, [x11, z3.s, sxtw]
	cmpne	p4.s, p0/z, z4.s, #0
.Ltmp8:
	.loc	0 6 5                           // test.c:6:5
	neg	x11, x8, lsl #2
...
.Ldebug_info_start0:
	...
	.word	93                              // DW_AT_abstract_origin
	.byte	2                               // DW_AT_low_pc
	.word	.Ltmp16-.Ltmp12                 // DW_AT_high_pc
	...
	.byte	3                               // DW_AT_low_pc
	.word	.Ltmp20-.Ltmp17                 // DW_AT_high_pc
