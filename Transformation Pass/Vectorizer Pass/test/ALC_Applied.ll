...
entry:
  call void @llvm.dbg.value(metadata i32 2048, metadata !54, metadata !DIExpression()), !dbg !76
  %vla30 = alloca [2048 x i32], align 4, !dbg !77
  call void @llvm.dbg.value(metadata i64 2048, metadata !55, metadata !DIExpression()), !dbg !76
  call void @llvm.dbg.declare(metadata ptr %vla30, metadata !57, metadata !DIExpression()), !dbg !78
  %vla131 = alloca [2048 x i32], align 4, !dbg !79
  call void @llvm.dbg.value(metadata i64 2048, metadata !61, metadata !DIExpression()), !dbg !76
  call void @llvm.dbg.declare(metadata ptr %vla131, metadata !62, metadata !DIExpression()), !dbg !80
  %vla232 = alloca [2048 x i32], align 4, !dbg !81
  call void @llvm.dbg.value(metadata i64 2048, metadata !66, metadata !DIExpression()), !dbg !76
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(8192) %vla232, i8 0, i64 8192, i1 false), !dbg !84, !tbaa !87
...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  call void @llvm.dbg.value(metadata i32 2048, metadata !24, metadata !DIExpression()) #8, !dbg !100
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 2048, !dbg !118
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 2048, !dbg !129
...
for.body11:                                       ; preds = %for.body11, %foo.exit
  ...
  %exitcond40.not = icmp eq i64 %indvars.iv.next38, 2048, !dbg !139
...
!1 = !DIFile(filename: "test.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation Pass/Vectorizer Pass/test", checksumkind: CSK_MD5, checksum: "bc781f2842685dbfa8e2a90da871e3ed")
