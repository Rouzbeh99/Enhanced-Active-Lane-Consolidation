...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  tail call void asm sideeffect "dmb sy\0A\09orr x4,x4,x4\0A", "~{memory}"() #5, !dbg !34, !srcloc !35
  ret void, !dbg !36
...
entry:
  call void @llvm.dbg.value(metadata i32 524288, metadata !61, metadata !DIExpression()), !dbg !83
  %vla30 = alloca [524288 x i32], align 4, !dbg !84
  call void @llvm.dbg.value(metadata i64 524288, metadata !62, metadata !DIExpression()), !dbg !83
  call void @llvm.dbg.declare(metadata ptr %vla30, metadata !64, metadata !DIExpression()), !dbg !85
  %vla131 = alloca [524288 x i32], align 4, !dbg !86
  call void @llvm.dbg.value(metadata i64 524288, metadata !68, metadata !DIExpression()), !dbg !83
  call void @llvm.dbg.declare(metadata ptr %vla131, metadata !69, metadata !DIExpression()), !dbg !87
  %vla232 = alloca [524288 x i32], align 4, !dbg !88
  call void @llvm.dbg.value(metadata i64 524288, metadata !73, metadata !DIExpression()), !dbg !83
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(2097152) %vla232, i8 0, i64 2097152, i1 false), !dbg !91, !tbaa !43
...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  call void @llvm.dbg.value(metadata ptr %vla30, metadata !21, metadata !DIExpression()) #5, !dbg !103
  call void @llvm.dbg.value(metadata ptr %vla131, metadata !22, metadata !DIExpression()) #5, !dbg !103
  call void @llvm.dbg.value(metadata ptr %vla232, metadata !23, metadata !DIExpression()) #5, !dbg !103
  call void @llvm.dbg.value(metadata i32 524288, metadata !24, metadata !DIExpression()) #5, !dbg !103
  tail call void asm sideeffect "dmb sy\0A\09orr x3,x3,x3\0A", "~{memory}"() #5, !dbg !105, !noalias !106, !srcloc !29
  call void @llvm.dbg.value(metadata i32 0, metadata !25, metadata !DIExpression()) #5, !dbg !107
...
for.body.i:                                       ; preds = %for.inc.i, %for.cond.cleanup
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i, metadata !25, metadata !DIExpression()) #5, !dbg !107
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i, metadata !25, metadata !DIExpression()) #5, !dbg !107
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 524288, !dbg !121
  br i1 %exitcond.not.i, label %foo.exit, label %for.body.i, !dbg !108, !llvm.loop !122

foo.exit:                                         ; preds = %for.inc.i
  tail call void asm sideeffect "dmb sy\0A\09orr x4,x4,x4\0A", "~{memory}"() #5, !dbg !124, !noalias !106, !srcloc !35
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 524288, !dbg !132
...
for.body11:                                       ; preds = %for.body11, %foo.exit
  ...
  %exitcond40.not = icmp eq i64 %indvars.iv.next38, 524288, !dbg !142
...
!135 = !DILocation(line: 39, column: 13, scope: !136)
!136 = distinct !DILexicalBlock(scope: !137, file: !1, line: 38, column: 33)
!137 = distinct !DILexicalBlock(scope: !82, file: !1, line: 38, column: 5)
!138 = !DILocation(line: 41, column: 5, scope: !57)
!139 = !DILocation(line: 45, column: 1, scope: !57)
!140 = !DILocation(line: 39, column: 16, scope: !136)
!141 = !DILocation(line: 38, column: 28, scope: !137)
!142 = !DILocation(line: 38, column: 23, scope: !137)
