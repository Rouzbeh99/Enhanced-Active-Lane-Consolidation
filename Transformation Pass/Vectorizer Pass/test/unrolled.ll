...
define dso_local void @foo(ptr noalias noundef %a, ptr noalias noundef %b, ptr noalias noundef %c, i32 noundef %n) #0 {
entry:
...
entry:
  ...
  call void @foo(ptr noundef %arraydecay, ptr noundef %arraydecay1, ptr noundef %arraydecay2, i32 noundef %0)
  store i32 0, ptr %i, align 4
  br label %for.cond
