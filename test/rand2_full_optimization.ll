...
3:                                                ; preds = %3, %2
  ...
  %5 = tail call fastcc double @rand2a() #7, !dbg !150
  %6 = insertelement <2 x double> undef, double %4, i32 0, !dbg !151
  %7 = insertelement <2 x double> %6, double %5, i32 1, !dbg !151
  %8 = fmul <2 x double> %7, <double 2.000000e+00, double 2.000000e+00>, !dbg !151
  %9 = fadd <2 x double> %8, <double -1.000000e+00, double -1.000000e+00>, !dbg !152
  %10 = fmul <2 x double> %9, %9, !dbg !153
  %11 = extractelement <2 x double> %10, i32 0, !dbg !154
  %12 = extractelement <2 x double> %10, i32 1, !dbg !154
  %13 = fadd double %11, %12, !dbg !154
  call void @llvm.dbg.value(metadata double %13, metadata !142, metadata !DIExpression()) #7, !dbg !145
  %14 = fcmp oge double %13, 1.000000e+00, !dbg !155
  %15 = fcmp oeq double %13, 0.000000e+00, !dbg !156
  %16 = or i1 %14, %15, !dbg !156
  br i1 %16, label %3, label %17, !dbg !157, !llvm.loop !158

17:                                               ; preds = %3
  %18 = tail call double @log(double %13) #7, !dbg !160
  %19 = fmul double %18, -2.000000e+00, !dbg !161
  %20 = fdiv double %19, %13, !dbg !162
  %21 = tail call double @sqrt(double %20) #7, !dbg !163
  call void @llvm.dbg.value(metadata double %21, metadata !140, metadata !DIExpression()) #7, !dbg !145
  %22 = extractelement <2 x double> %9, i32 0, !dbg !164
  %23 = fmul double %22, %21, !dbg !164
  call void @llvm.dbg.value(metadata double %23, metadata !141, metadata !DIExpression()) #7, !dbg !145
  %24 = load double, double* %1, align 8, !dbg !165, !tbaa !166
  %25 = fmul double %24, %23, !dbg !168
  %26 = load double, double* %0, align 8, !dbg !169, !tbaa !166
  %27 = fadd double %25, %26, !dbg !170
  ret double %27, !dbg !171
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @setseed(i32* nocapture readonly %0) local_unnamed_addr #1 !dbg !172 {
  call void @llvm.dbg.value(metadata i32* %0, metadata !176, metadata !DIExpression()), !dbg !177
  %2 = load i32, i32* %0, align 4, !dbg !178, !tbaa !54
  %3 = icmp sgt i32 %2, -1, !dbg !180
  br i1 %3, label %4, label %7, !dbg !181

4:                                                ; preds = %1
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !182, !tbaa !184
  %6 = tail call i64 @fwrite(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0), i64 38, i64 1, %struct._IO_FILE* %5) #8, !dbg !186
  br label %8, !dbg !187

7:                                                ; preds = %1
  store i32 %2, i32* @seed3, align 4, !dbg !188, !tbaa !54
  br label %8, !dbg !190

8:                                                ; preds = %7, %4
  %9 = phi i32 [ 1, %4 ], [ 0, %7 ], !dbg !191
  ret i32 %9, !dbg !192
}

; Function Attrs: nounwind uwtable
define dso_local i32 @rseed() local_unnamed_addr #3 !dbg !193 {
  %1 = alloca %struct.timeval, align 8
  %2 = bitcast %struct.timeval* %1 to i8*, !dbg !198
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2) #7, !dbg !198
  call void @llvm.dbg.declare(metadata %struct.timeval* %1, metadata !197, metadata !DIExpression()), !dbg !199
  %3 = call i32 @gettimeofday(%struct.timeval* nonnull %1, i8* null) #7, !dbg !200
  %4 = getelementptr inbounds %struct.timeval, %struct.timeval* %1, i64 0, i32 0, !dbg !201
  %5 = load i64, i64* %4, align 8, !dbg !201, !tbaa !202
  %6 = getelementptr inbounds %struct.timeval, %struct.timeval* %1, i64 0, i32 1, !dbg !205
  %7 = load i64, i64* %6, align 8, !dbg !205, !tbaa !206
  %8 = xor i64 %7, %5, !dbg !207
  %9 = trunc i64 %8 to i32, !dbg !208
  %10 = sub nsw i32 0, %9, !dbg !209
  store i32 %10, i32* @seed3, align 4, !dbg !210, !tbaa !54
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2) #7, !dbg !211
  ret i32 %10, !dbg !212
}
...
!150 = !DILocation(line: 153, column: 12, scope: !149, inlinedAt: !146)
!151 = !DILocation(line: 152, column: 11, scope: !149, inlinedAt: !146)
!152 = !DILocation(line: 152, column: 25, scope: !149, inlinedAt: !146)
!153 = !DILocation(line: 154, column: 12, scope: !149, inlinedAt: !146)
!154 = !DILocation(line: 154, column: 16, scope: !149, inlinedAt: !146)
!155 = !DILocation(line: 155, column: 17, scope: !134, inlinedAt: !146)
!156 = !DILocation(line: 155, column: 23, scope: !134, inlinedAt: !146)
!157 = !DILocation(line: 155, column: 3, scope: !149, inlinedAt: !146)
!158 = distinct !{!158, !147, !159}
!159 = !DILocation(line: 155, column: 37, scope: !134, inlinedAt: !146)
!160 = !DILocation(line: 156, column: 18, scope: !134, inlinedAt: !146)
!161 = !DILocation(line: 156, column: 17, scope: !134, inlinedAt: !146)
!162 = !DILocation(line: 156, column: 26, scope: !134, inlinedAt: !146)
!163 = !DILocation(line: 156, column: 9, scope: !134, inlinedAt: !146)
!164 = !DILocation(line: 157, column: 13, scope: !134, inlinedAt: !146)
!165 = !DILocation(line: 159, column: 11, scope: !134, inlinedAt: !146)
!166 = !{!167, !167, i64 0}
!167 = !{!"double", !56, i64 0}
!168 = !DILocation(line: 159, column: 14, scope: !134, inlinedAt: !146)
!169 = !DILocation(line: 159, column: 23, scope: !134, inlinedAt: !146)
!170 = !DILocation(line: 159, column: 21, scope: !134, inlinedAt: !146)
!171 = !DILocation(line: 177, column: 2, scope: !125)
!172 = distinct !DISubprogram(name: "setseed", scope: !3, file: !3, line: 184, type: !173, scopeLine: 185, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !175)
!173 = !DISubroutineType(types: !174)
!174 = !{!11, !45}
!175 = !{!176}
!176 = !DILocalVariable(name: "seed4", arg: 1, scope: !172, file: !3, line: 184, type: !45)
!177 = !DILocation(line: 0, scope: !172)
!178 = !DILocation(line: 186, column: 6, scope: !179)
!179 = distinct !DILexicalBlock(scope: !172, file: !3, line: 186, column: 6)
!180 = !DILocation(line: 186, column: 13, scope: !179)
!181 = !DILocation(line: 186, column: 6, scope: !172)
!182 = !DILocation(line: 187, column: 12, scope: !183)
!183 = distinct !DILexicalBlock(scope: !179, file: !3, line: 186, column: 19)
!184 = !{!185, !185, i64 0}
!185 = !{!"any pointer", !56, i64 0}
!186 = !DILocation(line: 187, column: 3, scope: !183)
!187 = !DILocation(line: 188, column: 3, scope: !183)
!188 = !DILocation(line: 190, column: 9, scope: !189)
!189 = distinct !DILexicalBlock(scope: !179, file: !3, line: 189, column: 9)
!190 = !DILocation(line: 191, column: 3, scope: !189)
!191 = !DILocation(line: 0, scope: !179)
!192 = !DILocation(line: 193, column: 1, scope: !172)
!193 = distinct !DISubprogram(name: "rseed", scope: !3, file: !3, line: 200, type: !194, scopeLine: 201, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !196)
!194 = !DISubroutineType(types: !195)
!195 = !{!11}
!196 = !{!197}
!197 = !DILocalVariable(name: "tv", scope: !193, file: !3, line: 202, type: !13)
!198 = !DILocation(line: 202, column: 2, scope: !193)
!199 = !DILocation(line: 202, column: 17, scope: !193)
!200 = !DILocation(line: 203, column: 2, scope: !193)
!201 = !DILocation(line: 204, column: 21, scope: !193)
!202 = !{!203, !204, i64 0}
!203 = !{!"timeval", !204, i64 0, !204, i64 8}
!204 = !{!"long", !56, i64 0}
!205 = !DILocation(line: 204, column: 33, scope: !193)
!206 = !{!203, !204, i64 8}
!207 = !DILocation(line: 204, column: 28, scope: !193)
!208 = !DILocation(line: 204, column: 12, scope: !193)
!209 = !DILocation(line: 204, column: 10, scope: !193)
!210 = !DILocation(line: 204, column: 8, scope: !193)
!211 = !DILocation(line: 206, column: 1, scope: !193)
!212 = !DILocation(line: 205, column: 2, scope: !193)
