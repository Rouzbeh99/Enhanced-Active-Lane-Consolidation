...
define dso_local i32 @main(i32 noundef %argc, i8** nocapture noundef readnone %argv) local_unnamed_addr #1 !dbg !97 {
entry:
  call void @llvm.dbg.value(metadata i32 %argc, metadata !104, metadata !DIExpression()), !dbg !110
  call void @llvm.dbg.value(metadata i8** %argv, metadata !105, metadata !DIExpression()), !dbg !110
  call void @llvm.dbg.value(metadata i32 undef, metadata !106, metadata !DIExpression()), !dbg !110
  call void @llvm.dbg.value(metadata i32 undef, metadata !106, metadata !DIExpression()), !dbg !110
  call void @llvm.dbg.value(metadata i32 undef, metadata !106, metadata !DIExpression()), !dbg !110
  call void @llvm.dbg.value(metadata i32 undef, metadata !106, metadata !DIExpression()), !dbg !110
  call void @llvm.dbg.value(metadata i32 undef, metadata !106, metadata !DIExpression()), !dbg !110
  %call = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i64 noundef 8), !dbg !111
  ret i32 0, !dbg !112
}
...
!93 = distinct !{!93, !66, !94, !95}
!94 = !DILocation(line: 78, column: 5, scope: !67)
!95 = !{!"llvm.loop.mustprogress"}
!96 = !DILocation(line: 79, column: 1, scope: !21)
!97 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 85, type: !98, scopeLine: 86, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !103)
...
!103 = !{!104, !105, !106}
!104 = !DILocalVariable(name: "argc", arg: 1, scope: !97, file: !3, line: 85, type: !6)
!105 = !DILocalVariable(name: "argv", arg: 2, scope: !97, file: !3, line: 85, type: !100)
!106 = !DILocalVariable(name: "roundKeys", scope: !97, file: !3, line: 87, type: !107)
!107 = !DICompositeType(tag: DW_TAG_array_type, baseType: !6, size: 3456, elements: !108)
!108 = !{!109}
!109 = !DISubrange(count: 108)
!110 = !DILocation(line: 0, scope: !97)
!111 = !DILocation(line: 90, column: 5, scope: !97)
!112 = !DILocation(line: 91, column: 5, scope: !97)
