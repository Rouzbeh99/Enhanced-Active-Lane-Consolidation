...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[nogroupskip,nonumberlist,nopostdot,acronym]{glossaries}
...
\newacronym{alc}{ALC}{Active Lane Consolidation}
\newacronym{cfl}{CFL}{Control Flow Linearization}
\newacronym{cfg}{CFG}{Control Flow Graph}
\newacronym{llvm}{LLVM}{Low Level Virtual Machine}
\newacronym{sve}{SVE}{Scalable Vector Extension}
\newacronym{tsvc}{TSVC}{Test Suite for Vectorizing Compilers}
\newacronym{gcc}{GCC}{GNU Compiler Collection}
\newacronym{vf}{VF}{Vector Factor}
\newacronym{vl}{VL}{Vector Length}
\newacronym{isa}{ISA}{Instruction-Set Architecture}
\newacronym{boscc}{BOSCC}{Branch On Superword Condition Codes}
\newacronym{armIE}{ArmIE}{Arm’s Instruction Emulator}
\newacronym{cfdp}{CFDP}{Control Flow Divergent Path}
...
\title{Efficient Auto-Vectorization for Control-flow Dependent Loops through Data Permutation} % Title can't use formulae, symbols, superscripts, subscripts, greek letters, etc. all of which should be replaced with word substitutes
...
\printglossary[type=\acronymtype]
 ...
 % settings for the body including roman numeral numbering starting at 1
\setforbodyoftext
...
\subfile{Sections/related-works.tex}
