...
\begin{figure}%
    \centering
    \subfloat[\centering Number of Program Cycles]{{\includegraphics[width=6cm, height=5cm]{img/gather_scatter_cycles.png} }}%
    \qquad
    \subfloat[\centering Number of instructions executed]{{\includegraphics[width=6cm, height=5cm]{img/gather_scatter_instructions.png} }}%
...
\begin{figure}[h]
    \centering
    \subfloat[Branch misses]{\includegraphics[width=0.5\textwidth]{img/gather_scatter_br_miss.png}}\hfill
    \subfloat[Cache misses.]{\includegraphics[width=0.5\textwidth]{img/gather_scatter_cache_miss.png}}\\
    \subfloat[Cycles stalled due to memory]{\includegraphics[width=0.5\textwidth]{img/gather_scatter_mem_stall.png}}\hfill
    \subfloat[Cycles with no instructions executed]{\includegraphics[width=0.5\textwidth]{img/gather_scatter_no_instr.png}}
