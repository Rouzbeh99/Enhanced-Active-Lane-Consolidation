...
for.cond4.for.cond.cleanup6_crit_edge.us:         ; preds = %for.inc.us
  ...
  br i1 %exitcond71.not, label %for.cond.cleanup, label %for.cond4.preheader.us, !dbg !190, !llvm.loop !220
...
for.inc:                                          ; preds = %if.end39, %for.body
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !256, !llvm.loop !295
...
for.inc:                                          ; preds = %if.then16, %if.then10, %if.then4, %for.body
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !324, !llvm.loop !352
...
for.inc:                                          ; preds = %if.else, %if.then16, %if.then4, %for.body
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !381, !llvm.loop !412
...
for.inc:                                          ; preds = %if.else, %if.then4
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !441, !llvm.loop !463
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  br i1 %exitcond.not, label %for.body33, label %for.body, !dbg !556, !llvm.loop !571

for.cond.cleanup32:                               ; preds = %for.body33
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add), !dbg !573
  %9 = load ptr, ptr @a, align 8, !dbg !574, !tbaa !113
  tail call void @free(ptr noundef %9) #10, !dbg !575
  %10 = load ptr, ptr @b, align 8, !dbg !576, !tbaa !113
  tail call void @free(ptr noundef %10) #10, !dbg !577
  %11 = load ptr, ptr @c, align 8, !dbg !578, !tbaa !113
  tail call void @free(ptr noundef %11) #10, !dbg !579
  %12 = load ptr, ptr @cond, align 8, !dbg !580, !tbaa !113
  tail call void @free(ptr noundef %12) #10, !dbg !581
  %13 = load i64, ptr @CounterValues, align 8, !dbg !582, !tbaa !583
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i64 noundef %13), !dbg !585
  %14 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !586, !tbaa !583
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %14), !dbg !587
  %15 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !588, !tbaa !583
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %15), !dbg !589
  %16 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !590, !tbaa !583
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %16), !dbg !591
  %17 = load double, ptr @ExecutionTime, align 8, !dbg !592, !tbaa !155
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, double noundef %17), !dbg !593
  %18 = load i32, ptr @EventSet, align 4, !dbg !594, !tbaa !102
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %18, ptr noundef nonnull @EventCodes, i32 noundef 4) #10, !dbg !596
  call void @llvm.dbg.value(metadata i32 %call45, metadata !508, metadata !DIExpression()), !dbg !532
  %cmp46.not = icmp eq i32 %call45, 0, !dbg !597
  br i1 %cmp46.not, label %if.end50, label %if.then48, !dbg !598
...
for.body33:                                       ; preds = %for.body, %for.body33
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv83, metadata !518, metadata !DIExpression()), !dbg !599
  call void @llvm.dbg.value(metadata i32 %sum.080, metadata !517, metadata !DIExpression()), !dbg !532
  %arrayidx35 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv83, !dbg !600
  %19 = load i32, ptr %arrayidx35, align 4, !dbg !600, !tbaa !102
  %add = add nsw i32 %19, %sum.080, !dbg !603
  call void @llvm.dbg.value(metadata i32 %add, metadata !517, metadata !DIExpression()), !dbg !532
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1, !dbg !604
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next84, metadata !518, metadata !DIExpression()), !dbg !599
  %exitcond86.not = icmp eq i64 %indvars.iv.next84, 5000000, !dbg !605
  br i1 %exitcond86.not, label %for.cond.cleanup32, label %for.body33, !dbg !606, !llvm.loop !607
...
!573 = !DILocation(line: 265, column: 5, scope: !504)
!574 = !DILocation(line: 267, column: 10, scope: !504)
!575 = !DILocation(line: 267, column: 5, scope: !504)
!576 = !DILocation(line: 268, column: 10, scope: !504)
!577 = !DILocation(line: 268, column: 5, scope: !504)
!578 = !DILocation(line: 269, column: 10, scope: !504)
!579 = !DILocation(line: 269, column: 5, scope: !504)
!580 = !DILocation(line: 270, column: 10, scope: !504)
!581 = !DILocation(line: 270, column: 5, scope: !504)
!582 = !DILocation(line: 272, column: 53, scope: !504)
!583 = !{!584, !584, i64 0}
!584 = !{!"long long", !64, i64 0}
!585 = !DILocation(line: 272, column: 5, scope: !504)
!586 = !DILocation(line: 273, column: 36, scope: !504)
!587 = !DILocation(line: 273, column: 5, scope: !504)
!588 = !DILocation(line: 274, column: 50, scope: !504)
!589 = !DILocation(line: 274, column: 5, scope: !504)
!590 = !DILocation(line: 275, column: 49, scope: !504)
!591 = !DILocation(line: 275, column: 5, scope: !504)
!592 = !DILocation(line: 276, column: 40, scope: !504)
!593 = !DILocation(line: 276, column: 5, scope: !504)
!594 = !DILocation(line: 278, column: 38, scope: !595)
!595 = distinct !DILexicalBlock(scope: !504, file: !3, line: 278, column: 9)
!596 = !DILocation(line: 278, column: 19, scope: !595)
!597 = !DILocation(line: 278, column: 72, scope: !595)
!598 = !DILocation(line: 278, column: 9, scope: !504)
!599 = !DILocation(line: 0, scope: !519)
!600 = !DILocation(line: 262, column: 16, scope: !601)
!601 = distinct !DILexicalBlock(scope: !602, file: !3, line: 261, column: 33)
!602 = distinct !DILexicalBlock(scope: !519, file: !3, line: 261, column: 5)
!603 = !DILocation(line: 262, column: 13, scope: !601)
!604 = !DILocation(line: 261, column: 28, scope: !602)
!605 = !DILocation(line: 261, column: 23, scope: !602)
!606 = !DILocation(line: 261, column: 5, scope: !519)
!607 = distinct !{!607, !606, !608, !148, !149}
!608 = !DILocation(line: 263, column: 5, scope: !519)
!609 = !DILocation(line: 278, column: 84, scope: !610)
!610 = distinct !DILexicalBlock(scope: !595, file: !3, line: 278, column: 84)
