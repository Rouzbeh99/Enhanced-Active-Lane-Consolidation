...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  %call29 = tail call i32 @simple_if_else(ptr noundef %4, ptr noundef %5, ptr noundef %6, ptr noundef nonnull %11, i32 noundef 5000000) #13, !dbg !271
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  %rem = srem i32 %call24, 100, !dbg !283
  %cmp25 = icmp slt i32 %rem, 3, !dbg !284
...
for.cond.cleanup34:                               ; preds = %for.body35
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add), !dbg !291
  ...
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %16), !dbg !304
  %17 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !305, !tbaa !302
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %17), !dbg !306
  %18 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !307, !tbaa !302
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %18), !dbg !308
  %19 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !309, !tbaa !302
  %call46 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, i64 noundef %19), !dbg !310
  %20 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 4), align 8, !dbg !311, !tbaa !302
  %call47 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.10, i64 noundef %20), !dbg !312
  %21 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 5), align 8, !dbg !313, !tbaa !302
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.11, i64 noundef %21), !dbg !314
  %22 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 6), align 8, !dbg !315, !tbaa !302
  %call49 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.12, i64 noundef %22), !dbg !316
  %23 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 7), align 8, !dbg !317, !tbaa !302
  %call50 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.13, i64 noundef %23), !dbg !318
  %24 = load double, ptr @ExecutionTime, align 8, !dbg !319, !tbaa !172
  %call51 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.14, double noundef %24), !dbg !320
  %25 = load i32, ptr @EventSet, align 4, !dbg !321, !tbaa !119
  %call52 = tail call i32 @PAPI_remove_events(i32 noundef %25, ptr noundef nonnull @EventCodes, i32 noundef 8) #13, !dbg !323
...
for.body35:                                       ; preds = %for.body35, %for.cond.cleanup
  %indvars.iv83 = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next84, %for.body35 ]
  %sum.080 = phi i32 [ 0, %for.cond.cleanup ], [ %add, %for.body35 ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv83, metadata !229, metadata !DIExpression()), !dbg !272
  call void @llvm.dbg.value(metadata i32 %sum.080, metadata !228, metadata !DIExpression()), !dbg !243
  %arrayidx37 = getelementptr inbounds i32, ptr %7, i64 %indvars.iv83, !dbg !326
  %26 = load i32, ptr %arrayidx37, align 4, !dbg !326, !tbaa !119
  %add = add nsw i32 %26, %sum.080, !dbg !329
  call void @llvm.dbg.value(metadata i32 %add, metadata !228, metadata !DIExpression()), !dbg !243
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1, !dbg !330
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next84, metadata !229, metadata !DIExpression()), !dbg !272
  %exitcond86.not = icmp eq i64 %indvars.iv.next84, 5000000, !dbg !331
  br i1 %exitcond86.not, label %for.cond.cleanup34, label %for.body35, !dbg !273, !llvm.loop !332

if.then55:                                        ; preds = %for.cond.cleanup34
  %27 = load ptr, ptr @stderr, align 8, !dbg !334, !tbaa !130
  %call56 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %27, ptr noundef nonnull @.str, i32 noundef %call52, ptr noundef nonnull @.str.1, i32 noundef 385) #14, !dbg !334
  tail call void @exit(i32 noundef %call52) #15, !dbg !334
  unreachable, !dbg !334

if.end57:                                         ; preds = %for.cond.cleanup34
  %call58 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #13, !dbg !336
  call void @llvm.dbg.value(metadata i32 %call58, metadata !220, metadata !DIExpression()), !dbg !243
  %cmp59.not = icmp eq i32 %call58, 0, !dbg !338
  br i1 %cmp59.not, label %if.end63, label %if.then61, !dbg !339

if.then61:                                        ; preds = %if.end57
  %28 = load ptr, ptr @stderr, align 8, !dbg !340, !tbaa !130
  %call62 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %28, ptr noundef nonnull @.str, i32 noundef %call58, ptr noundef nonnull @.str.1, i32 noundef 388) #14, !dbg !340
  tail call void @exit(i32 noundef %call58) #15, !dbg !340
  unreachable, !dbg !340
...
declare i32 @simple_if_else(...) local_unnamed_addr #4
...
!3 = !DIFile(filename: "test.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation-Pass/Vectorizer-Pass/test", checksumkind: CSK_MD5, checksum: "65ee889ea227957ea6547f97c8431d30")
!4 = !{!5, !7, !8}
...
!228 = !DILocalVariable(name: "sum", scope: !216, file: !3, line: 360, type: !6)
!229 = !DILocalVariable(name: "i", scope: !230, file: !3, line: 362, type: !6)
!230 = distinct !DILexicalBlock(scope: !216, file: !3, line: 362, column: 5)
...
!268 = !DILocation(line: 357, column: 20, scope: !216)
!269 = !DILocation(line: 357, column: 23, scope: !216)
!270 = !DILocation(line: 357, column: 26, scope: !216)
!271 = !DILocation(line: 357, column: 5, scope: !216)
!272 = !DILocation(line: 0, scope: !230)
!273 = !DILocation(line: 362, column: 5, scope: !230)
!274 = !DILocation(line: 349, column: 9, scope: !275)
!275 = distinct !DILexicalBlock(scope: !276, file: !3, line: 348, column: 33)
!276 = distinct !DILexicalBlock(scope: !227, file: !3, line: 348, column: 5)
!277 = !DILocation(line: 349, column: 14, scope: !275)
!278 = !DILocation(line: 350, column: 9, scope: !275)
!279 = !DILocation(line: 350, column: 14, scope: !275)
!280 = !DILocation(line: 351, column: 9, scope: !275)
!281 = !DILocation(line: 351, column: 14, scope: !275)
!282 = !DILocation(line: 352, column: 20, scope: !275)
!283 = !DILocation(line: 352, column: 27, scope: !275)
!284 = !DILocation(line: 352, column: 34, scope: !275)
!285 = !DILocation(line: 352, column: 9, scope: !275)
!286 = !DILocation(line: 352, column: 17, scope: !275)
!287 = !DILocation(line: 348, column: 28, scope: !276)
!288 = !DILocation(line: 348, column: 23, scope: !276)
!289 = distinct !{!289, !267, !290, !165, !166}
!290 = !DILocation(line: 353, column: 5, scope: !227)
!291 = !DILocation(line: 367, column: 5, scope: !216)
!292 = !DILocation(line: 368, column: 5, scope: !216)
!293 = !DILocation(line: 370, column: 10, scope: !216)
!294 = !DILocation(line: 370, column: 5, scope: !216)
!295 = !DILocation(line: 371, column: 10, scope: !216)
!296 = !DILocation(line: 371, column: 5, scope: !216)
!297 = !DILocation(line: 372, column: 10, scope: !216)
!298 = !DILocation(line: 372, column: 5, scope: !216)
!299 = !DILocation(line: 373, column: 10, scope: !216)
!300 = !DILocation(line: 373, column: 5, scope: !216)
!301 = !DILocation(line: 375, column: 53, scope: !216)
!302 = !{!303, !303, i64 0}
!303 = !{!"long long", !81, i64 0}
!304 = !DILocation(line: 375, column: 5, scope: !216)
!305 = !DILocation(line: 376, column: 44, scope: !216)
!306 = !DILocation(line: 376, column: 5, scope: !216)
!307 = !DILocation(line: 377, column: 50, scope: !216)
!308 = !DILocation(line: 377, column: 5, scope: !216)
!309 = !DILocation(line: 378, column: 49, scope: !216)
!310 = !DILocation(line: 378, column: 5, scope: !216)
!311 = !DILocation(line: 379, column: 57, scope: !216)
!312 = !DILocation(line: 379, column: 5, scope: !216)
!313 = !DILocation(line: 380, column: 59, scope: !216)
!314 = !DILocation(line: 380, column: 5, scope: !216)
!315 = !DILocation(line: 381, column: 45, scope: !216)
!316 = !DILocation(line: 381, column: 5, scope: !216)
!317 = !DILocation(line: 382, column: 66, scope: !216)
!318 = !DILocation(line: 382, column: 5, scope: !216)
!319 = !DILocation(line: 383, column: 40, scope: !216)
!320 = !DILocation(line: 383, column: 5, scope: !216)
!321 = !DILocation(line: 385, column: 38, scope: !322)
!322 = distinct !DILexicalBlock(scope: !216, file: !3, line: 385, column: 9)
!323 = !DILocation(line: 385, column: 19, scope: !322)
!324 = !DILocation(line: 385, column: 72, scope: !322)
!325 = !DILocation(line: 385, column: 9, scope: !216)
!326 = !DILocation(line: 363, column: 16, scope: !327)
!327 = distinct !DILexicalBlock(scope: !328, file: !3, line: 362, column: 33)
!328 = distinct !DILexicalBlock(scope: !230, file: !3, line: 362, column: 5)
!329 = !DILocation(line: 363, column: 13, scope: !327)
!330 = !DILocation(line: 362, column: 28, scope: !328)
!331 = !DILocation(line: 362, column: 23, scope: !328)
!332 = distinct !{!332, !273, !333, !165, !166}
!333 = !DILocation(line: 364, column: 5, scope: !230)
!334 = !DILocation(line: 385, column: 84, scope: !335)
!335 = distinct !DILexicalBlock(scope: !322, file: !3, line: 385, column: 84)
!336 = !DILocation(line: 388, column: 19, scope: !337)
!337 = distinct !DILexicalBlock(scope: !216, file: !3, line: 388, column: 9)
!338 = !DILocation(line: 388, column: 53, scope: !337)
!339 = !DILocation(line: 388, column: 9, scope: !216)
!340 = !DILocation(line: 388, column: 65, scope: !341)
!341 = distinct !DILexicalBlock(scope: !337, file: !3, line: 388, column: 65)
!342 = !DILocation(line: 391, column: 5, scope: !216)
!343 = !DILocation(line: 394, column: 1, scope: !216)
!344 = !DILocation(line: 393, column: 5, scope: !216)
