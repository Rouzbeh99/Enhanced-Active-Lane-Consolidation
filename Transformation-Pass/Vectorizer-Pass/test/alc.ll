...
Preheader.for.remaining.iterations:               ; preds = %middel.block, %for.body.preheader
  %16 = phi i64 [ 0, %for.body.preheader ], [ %145, %middel.block ]
  br label %for.body
...
alc.header:                                       ; preds = %new.latch, %pre.alc
  ...
  %uniform.vector = phi <vscale x 4 x i32> [ %18, %pre.alc ], [ %109, %new.latch ]
  %uniform.vector.predicates = phi <vscale x 4 x i1> [ %24, %pre.alc ], [ %110, %new.latch ]
  %uniform.vec.actives = phi i32 [ %26, %pre.alc ], [ %111, %new.latch ]
...
lane.gather:                                      ; preds = %alc.header
  %36 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %uniform.vector.predicates, <vscale x 4 x i32> %uniform.vector)
  %37 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %32, <vscale x 4 x i32> %27)
  %38 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %uniform.vec.actives)
  %39 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %38, <vscale x 4 x i32> %36, <vscale x 4 x i32> %37)
  %40 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %35)
  %41 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %40, <vscale x 4 x i1> %40)
  %42 = trunc i64 %41 to i32
  %43 = icmp ult i32 %35, %2
  br i1 %43, label %join.block, label %uniform.block

linearized:                                       ; preds = %alc.header
  %44 = getelementptr inbounds i32, ptr %a, i32 %vector.loop.index, !dbg !127
  %45 = getelementptr inbounds i32, ptr %c, i32 %vector.loop.index, !dbg !129
  %46 = getelementptr inbounds i32, ptr %b, i32 %vector.loop.index, !dbg !130
  %47 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %vector.loop.index, i32 1)
  %48 = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %45, i32 16, <vscale x 4 x i1> %32, <vscale x 4 x i32> undef)
  %49 = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %46, i32 16, <vscale x 4 x i1> %32, <vscale x 4 x i32> undef)
  ...
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %55, ptr %44, i32 16, <vscale x 4 x i1> %32)
  ...
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %62, ptr %46, i32 16, <vscale x 4 x i1> %32)
  ...
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %71, ptr %45, i32 16, <vscale x 4 x i1> %32)
  br label %new.latch

uniform.block:                                    ; preds = %lane.gather
  %72 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !127
  %73 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !129
  %74 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !130
  %75 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %17, ptr %73, <vscale x 4 x i32> %39)
  %76 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %17, ptr %74, <vscale x 4 x i32> %39)
  %77 = mul <vscale x 4 x i32> %76, %39
  ...
  %79 = shl <vscale x 4 x i32> %39, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %80 = add <vscale x 4 x i32> %76, %79
  %81 = add <vscale x 4 x i32> %80, %77
  %82 = add <vscale x 4 x i32> %81, %78
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %82, <vscale x 4 x i1> %17, ptr %72, <vscale x 4 x i32> %39)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %89, <vscale x 4 x i1> %17, ptr %74, <vscale x 4 x i32> %39)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %98, <vscale x 4 x i1> %17, ptr %73, <vscale x 4 x i32> %39)
  %99 = add i32 %vector.loop.index, %2
  %100 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %99, i32 1)
  %101 = getelementptr inbounds i8, ptr %cond, i32 %99, !dbg !120
...
join.block:                                       ; preds = %uniform.block, %lane.gather
  ...
  %115 = phi <vscale x 4 x i32> [ %39, %lane.gather ], [ %100, %uniform.block ]
  %116 = phi <vscale x 4 x i1> [ %40, %lane.gather ], [ %105, %uniform.block ]
  %117 = phi i32 [ %42, %lane.gather ], [ %107, %uniform.block ]
  br label %new.latch

middel.block:                                     ; preds = %new.latch
  %condition1 = icmp eq i32 %19, 0
  %118 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !127
  %119 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !129
  %120 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !130
...
if.then75:                                        ; preds = %for.cond.cleanup
  %146 = load ptr, ptr @stderr, align 8, !dbg !151, !tbaa !113
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %146, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 53) #14, !dbg !151
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 233) #14, !dbg !231
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 236) #14, !dbg !238
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  %arrayidx19 = getelementptr inbounds i32, ptr %4, i64 %indvars.iv, !dbg !253
  %8 = trunc i64 %indvars.iv to i32, !dbg !256
  store i32 %8, ptr %arrayidx19, align 4, !dbg !256, !tbaa !102
  %arrayidx21 = getelementptr inbounds i32, ptr %5, i64 %indvars.iv, !dbg !257
  store i32 2, ptr %arrayidx21, align 4, !dbg !258, !tbaa !102
  %arrayidx23 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv, !dbg !259
  store i32 0, ptr %arrayidx23, align 4, !dbg !260, !tbaa !102
  %rem = urem i32 %8, 100, !dbg !261
  %cmp24 = icmp ult i32 %rem, 40, !dbg !262
  %arrayidx27 = getelementptr inbounds i8, ptr %7, i64 %indvars.iv, !dbg !263
  %frombool = zext i1 %cmp24 to i8, !dbg !264
  store i8 %frombool, ptr %arrayidx27, align 1, !dbg !264, !tbaa !123
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 5000000, !dbg !266
  br i1 %exitcond.not, label %for.body33.preheader, label %for.body, !dbg !252, !llvm.loop !267

for.body33.preheader:                             ; preds = %for.body
  br label %for.body33, !dbg !269

for.cond.cleanup32:                               ; preds = %for.body33
  %add.lcssa = phi i32 [ %add, %for.body33 ], !dbg !270
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add.lcssa), !dbg !273
  %9 = load ptr, ptr @a, align 8, !dbg !274, !tbaa !113
  tail call void @free(ptr noundef %9) #13, !dbg !275
  %10 = load ptr, ptr @b, align 8, !dbg !276, !tbaa !113
  tail call void @free(ptr noundef %10) #13, !dbg !277
  %11 = load ptr, ptr @c, align 8, !dbg !278, !tbaa !113
  tail call void @free(ptr noundef %11) #13, !dbg !279
  %12 = load ptr, ptr @cond, align 8, !dbg !280, !tbaa !113
  tail call void @free(ptr noundef %12) #13, !dbg !281
  %13 = load i64, ptr @CounterValues, align 8, !dbg !282, !tbaa !283
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i64 noundef %13), !dbg !285
  %14 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !286, !tbaa !283
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %14), !dbg !287
  %15 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !288, !tbaa !283
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %15), !dbg !289
  %16 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !290, !tbaa !283
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %16), !dbg !291
  %17 = load double, ptr @ExecutionTime, align 8, !dbg !292, !tbaa !156
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, double noundef %17), !dbg !293
  %18 = load i32, ptr @EventSet, align 4, !dbg !294, !tbaa !102
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %18, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !296
...
for.body33:                                       ; preds = %for.body33.preheader, %for.body33
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv83, metadata !214, metadata !DIExpression()), !dbg !299
  call void @llvm.dbg.value(metadata i32 %sum.080, metadata !213, metadata !DIExpression()), !dbg !228
  %arrayidx35 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv83, !dbg !300
  %19 = load i32, ptr %arrayidx35, align 4, !dbg !300, !tbaa !102
  %add = add nsw i32 %19, %sum.080, !dbg !270
  call void @llvm.dbg.value(metadata i32 %add, metadata !213, metadata !DIExpression()), !dbg !228
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1, !dbg !301
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next84, metadata !214, metadata !DIExpression()), !dbg !299
  %exitcond86.not = icmp eq i64 %indvars.iv.next84, 5000000, !dbg !302
  br i1 %exitcond86.not, label %for.cond.cleanup32, label %for.body33, !dbg !269, !llvm.loop !303

if.then48:                                        ; preds = %for.cond.cleanup32
  %20 = load ptr, ptr @stderr, align 8, !dbg !305, !tbaa !113
  %call49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str, i32 noundef %call45, ptr noundef nonnull @.str.1, i32 noundef 279) #14, !dbg !305
  tail call void @exit(i32 noundef %call45) #15, !dbg !305
  unreachable, !dbg !305

if.end50:                                         ; preds = %for.cond.cleanup32
  %call51 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #13, !dbg !307
...
if.then54:                                        ; preds = %if.end50
  %21 = load ptr, ptr @stderr, align 8, !dbg !311, !tbaa !113
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %21, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 282) #14, !dbg !311
  tail call void @exit(i32 noundef %call51) #15, !dbg !311
  unreachable, !dbg !311

if.end56:                                         ; preds = %if.end50
  tail call void @PAPI_shutdown() #13, !dbg !313
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #13, !dbg !314
  ret i32 0, !dbg !315
}
...
!3 = !DIFile(filename: "test.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation-Pass/Vectorizer-Pass/test", checksumkind: CSK_MD5, checksum: "eabb418b6f9a35b7433745f9b89ee289")
!4 = !{!5, !7, !8}
...
!167 = distinct !DISubprogram(name: "checked_malloc_int_array", scope: !3, file: !3, line: 205, type: !168, scopeLine: 205, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !170)
!168 = !DISubroutineType(types: !169)
!169 = !{!5, !6}
!170 = !{!171, !172}
!171 = !DILocalVariable(name: "n", arg: 1, scope: !167, file: !3, line: 205, type: !6)
!172 = !DILocalVariable(name: "ptr", scope: !167, file: !3, line: 206, type: !5)
!173 = !DILocation(line: 0, scope: !167)
!174 = !DILocation(line: 206, column: 45, scope: !167)
!175 = !DILocation(line: 206, column: 43, scope: !167)
!176 = !DILocation(line: 206, column: 24, scope: !167)
!177 = !DILocation(line: 207, column: 13, scope: !178)
!178 = distinct !DILexicalBlock(scope: !167, file: !3, line: 207, column: 9)
!179 = !DILocation(line: 207, column: 9, scope: !167)
!180 = !DILocation(line: 208, column: 9, scope: !181)
!181 = distinct !DILexicalBlock(scope: !178, file: !3, line: 207, column: 22)
!182 = !DILocation(line: 209, column: 9, scope: !181)
!183 = !DILocation(line: 211, column: 5, scope: !167)
!184 = distinct !DISubprogram(name: "checked_malloc_bool_array", scope: !3, file: !3, line: 214, type: !185, scopeLine: 214, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !187)
!185 = !DISubroutineType(types: !186)
!186 = !{!8, !6}
!187 = !{!188, !189}
!188 = !DILocalVariable(name: "n", arg: 1, scope: !184, file: !3, line: 214, type: !6)
!189 = !DILocalVariable(name: "ptr", scope: !184, file: !3, line: 215, type: !8)
!190 = !DILocation(line: 0, scope: !184)
!191 = !DILocation(line: 215, column: 48, scope: !184)
!192 = !DILocation(line: 215, column: 26, scope: !184)
!193 = !DILocation(line: 216, column: 13, scope: !194)
!194 = distinct !DILexicalBlock(scope: !184, file: !3, line: 216, column: 9)
!195 = !DILocation(line: 216, column: 9, scope: !184)
!196 = !DILocation(line: 217, column: 9, scope: !197)
!197 = distinct !DILexicalBlock(scope: !194, file: !3, line: 216, column: 22)
!198 = !DILocation(line: 218, column: 9, scope: !197)
!199 = !DILocation(line: 220, column: 5, scope: !184)
!200 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 223, type: !201, scopeLine: 223, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !203)
!201 = !DISubroutineType(types: !202)
!202 = !{!6}
!203 = !{!204, !205, !210, !211, !213, !214}
!204 = !DILocalVariable(name: "status", scope: !200, file: !3, line: 224, type: !6)
!205 = !DILocalVariable(name: "errstring", scope: !200, file: !3, line: 225, type: !206)
...
!210 = !DILocalVariable(name: "n", scope: !200, file: !3, line: 238, type: !6)
!211 = !DILocalVariable(name: "i", scope: !212, file: !3, line: 249, type: !6)
!212 = distinct !DILexicalBlock(scope: !200, file: !3, line: 249, column: 5)
!213 = !DILocalVariable(name: "sum", scope: !200, file: !3, line: 260, type: !6)
!214 = !DILocalVariable(name: "i", scope: !215, file: !3, line: 262, type: !6)
!215 = distinct !DILexicalBlock(scope: !200, file: !3, line: 262, column: 5)
!216 = !DILocation(line: 225, column: 5, scope: !200)
!217 = !DILocation(line: 225, column: 10, scope: !200)
!218 = !DILocation(line: 227, column: 9, scope: !219)
!219 = distinct !DILexicalBlock(scope: !200, file: !3, line: 227, column: 9)
!220 = !DILocation(line: 227, column: 45, scope: !219)
!221 = !DILocation(line: 227, column: 9, scope: !200)
!222 = !DILocation(line: 228, column: 17, scope: !223)
!223 = distinct !DILexicalBlock(scope: !219, file: !3, line: 227, column: 66)
!224 = !DILocation(line: 228, column: 9, scope: !223)
!225 = !DILocation(line: 229, column: 9, scope: !223)
!226 = !DILocation(line: 233, column: 19, scope: !227)
!227 = distinct !DILexicalBlock(scope: !200, file: !3, line: 233, column: 9)
!228 = !DILocation(line: 0, scope: !200)
!229 = !DILocation(line: 233, column: 52, scope: !227)
!230 = !DILocation(line: 233, column: 9, scope: !200)
!231 = !DILocation(line: 233, column: 64, scope: !232)
!232 = distinct !DILexicalBlock(scope: !227, file: !3, line: 233, column: 64)
!233 = !DILocation(line: 236, column: 35, scope: !234)
!234 = distinct !DILexicalBlock(scope: !200, file: !3, line: 236, column: 9)
!235 = !DILocation(line: 236, column: 19, scope: !234)
!236 = !DILocation(line: 236, column: 69, scope: !234)
!237 = !DILocation(line: 236, column: 9, scope: !200)
!238 = !DILocation(line: 236, column: 81, scope: !239)
!239 = distinct !DILexicalBlock(scope: !234, file: !3, line: 236, column: 81)
!240 = !DILocation(line: 240, column: 9, scope: !200)
!241 = !DILocation(line: 240, column: 7, scope: !200)
!242 = !DILocation(line: 241, column: 9, scope: !200)
!243 = !DILocation(line: 241, column: 7, scope: !200)
!244 = !DILocation(line: 242, column: 9, scope: !200)
!245 = !DILocation(line: 242, column: 7, scope: !200)
!246 = !DILocation(line: 243, column: 12, scope: !200)
!247 = !DILocation(line: 243, column: 10, scope: !200)
!248 = !DILocation(line: 245, column: 13, scope: !200)
!249 = !DILocation(line: 247, column: 11, scope: !200)
!250 = !DILocation(line: 247, column: 5, scope: !200)
!251 = !DILocation(line: 0, scope: !212)
!252 = !DILocation(line: 249, column: 5, scope: !212)
!253 = !DILocation(line: 250, column: 9, scope: !254)
!254 = distinct !DILexicalBlock(scope: !255, file: !3, line: 249, column: 33)
!255 = distinct !DILexicalBlock(scope: !212, file: !3, line: 249, column: 5)
!256 = !DILocation(line: 250, column: 14, scope: !254)
!257 = !DILocation(line: 251, column: 9, scope: !254)
!258 = !DILocation(line: 251, column: 14, scope: !254)
!259 = !DILocation(line: 252, column: 9, scope: !254)
!260 = !DILocation(line: 252, column: 14, scope: !254)
!261 = !DILocation(line: 253, column: 22, scope: !254)
!262 = !DILocation(line: 253, column: 28, scope: !254)
!263 = !DILocation(line: 253, column: 9, scope: !254)
!264 = !DILocation(line: 253, column: 17, scope: !254)
!265 = !DILocation(line: 249, column: 28, scope: !255)
!266 = !DILocation(line: 249, column: 23, scope: !255)
!267 = distinct !{!267, !252, !268, !149, !150}
!268 = !DILocation(line: 254, column: 5, scope: !212)
!269 = !DILocation(line: 262, column: 5, scope: !215)
!270 = !DILocation(line: 263, column: 13, scope: !271)
!271 = distinct !DILexicalBlock(scope: !272, file: !3, line: 262, column: 33)
!272 = distinct !DILexicalBlock(scope: !215, file: !3, line: 262, column: 5)
!273 = !DILocation(line: 266, column: 5, scope: !200)
!274 = !DILocation(line: 268, column: 10, scope: !200)
!275 = !DILocation(line: 268, column: 5, scope: !200)
!276 = !DILocation(line: 269, column: 10, scope: !200)
!277 = !DILocation(line: 269, column: 5, scope: !200)
!278 = !DILocation(line: 270, column: 10, scope: !200)
!279 = !DILocation(line: 270, column: 5, scope: !200)
!280 = !DILocation(line: 271, column: 10, scope: !200)
!281 = !DILocation(line: 271, column: 5, scope: !200)
!282 = !DILocation(line: 273, column: 53, scope: !200)
!283 = !{!284, !284, i64 0}
!284 = !{!"long long", !64, i64 0}
!285 = !DILocation(line: 273, column: 5, scope: !200)
!286 = !DILocation(line: 274, column: 36, scope: !200)
!287 = !DILocation(line: 274, column: 5, scope: !200)
!288 = !DILocation(line: 275, column: 50, scope: !200)
!289 = !DILocation(line: 275, column: 5, scope: !200)
!290 = !DILocation(line: 276, column: 49, scope: !200)
!291 = !DILocation(line: 276, column: 5, scope: !200)
!292 = !DILocation(line: 277, column: 40, scope: !200)
!293 = !DILocation(line: 277, column: 5, scope: !200)
!294 = !DILocation(line: 279, column: 38, scope: !295)
!295 = distinct !DILexicalBlock(scope: !200, file: !3, line: 279, column: 9)
!296 = !DILocation(line: 279, column: 19, scope: !295)
!297 = !DILocation(line: 279, column: 72, scope: !295)
!298 = !DILocation(line: 279, column: 9, scope: !200)
!299 = !DILocation(line: 0, scope: !215)
!300 = !DILocation(line: 263, column: 16, scope: !271)
!301 = !DILocation(line: 262, column: 28, scope: !272)
!302 = !DILocation(line: 262, column: 23, scope: !272)
!303 = distinct !{!303, !269, !304, !149, !150}
!304 = !DILocation(line: 264, column: 5, scope: !215)
!305 = !DILocation(line: 279, column: 84, scope: !306)
!306 = distinct !DILexicalBlock(scope: !295, file: !3, line: 279, column: 84)
!307 = !DILocation(line: 282, column: 19, scope: !308)
!308 = distinct !DILexicalBlock(scope: !200, file: !3, line: 282, column: 9)
!309 = !DILocation(line: 282, column: 53, scope: !308)
!310 = !DILocation(line: 282, column: 9, scope: !200)
!311 = !DILocation(line: 282, column: 65, scope: !312)
!312 = distinct !DILexicalBlock(scope: !308, file: !3, line: 282, column: 65)
!313 = !DILocation(line: 285, column: 5, scope: !200)
!314 = !DILocation(line: 288, column: 1, scope: !200)
!315 = !DILocation(line: 287, column: 5, scope: !200)
!316 = !DISubprogram(name: "PAPI_library_init", scope: !160, file: !160, line: 1172, type: !161, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!317 = !DISubprogram(name: "PAPI_create_eventset", scope: !160, file: !160, line: 1147, type: !318, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!318 = !DISubroutineType(types: !319)
!319 = !{!6, !5}
!320 = !DISubprogram(name: "PAPI_add_events", scope: !160, file: !160, line: 1143, type: !321, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
...
!334 = !DISubprogram(name: "PAPI_remove_events", scope: !160, file: !160, line: 1192, type: !321, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!335 = !DISubprogram(name: "PAPI_destroy_eventset", scope: !160, file: !160, line: 1149, type: !318, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!336 = !DISubprogram(name: "PAPI_shutdown", scope: !160, file: !160, line: 1202, type: !337, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
