...
Preheader.for.remaining.iterations:               ; preds = %middel.block, %for.cond4.preheader.us
  %14 = phi i64 [ 0, %for.cond4.preheader.us ], [ %143, %middel.block ]
...
alc.header:                                       ; preds = %new.latch, %pre.alc
  ...
  %uniform.vector = phi <vscale x 4 x i32> [ %16, %pre.alc ], [ %107, %new.latch ]
  %uniform.vector.predicates = phi <vscale x 4 x i1> [ %22, %pre.alc ], [ %108, %new.latch ]
  %uniform.vec.actives = phi i32 [ %24, %pre.alc ], [ %109, %new.latch ]
...
lane.gather:                                      ; preds = %alc.header
  ...
  %35 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %30, <vscale x 4 x i32> %25)
  %36 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %uniform.vec.actives)
  %37 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %36, <vscale x 4 x i32> %34, <vscale x 4 x i32> %35)
  %38 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %33)
  %39 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %38, <vscale x 4 x i1> %38)
  %40 = trunc i64 %39 to i32
  %41 = icmp ult i32 %33, %2
  br i1 %41, label %join.block, label %uniform.block

linearized:                                       ; preds = %alc.header
  %42 = getelementptr inbounds i32, ptr %a, i32 %vector.loop.index, !dbg !123
  %43 = getelementptr inbounds i32, ptr %c, i32 %vector.loop.index, !dbg !125
  %44 = getelementptr inbounds i32, ptr %b, i32 %vector.loop.index, !dbg !126
  %45 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %vector.loop.index, i32 1)
  %46 = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %43, i32 16, <vscale x 4 x i1> %30, <vscale x 4 x i32> undef)
  %47 = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %44, i32 16, <vscale x 4 x i1> %30, <vscale x 4 x i32> undef)
  ...
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %53, ptr %42, i32 16, <vscale x 4 x i1> %30)
  ...
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %60, ptr %44, i32 16, <vscale x 4 x i1> %30)
  ...
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %69, ptr %43, i32 16, <vscale x 4 x i1> %30)
  br label %new.latch

uniform.block:                                    ; preds = %lane.gather
  %70 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !123
  %71 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !125
  %72 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !126
  %73 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %15, ptr %71, <vscale x 4 x i32> %37)
  %74 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %15, ptr %72, <vscale x 4 x i32> %37)
  %75 = mul <vscale x 4 x i32> %74, %37
  ...
  %77 = shl <vscale x 4 x i32> %37, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %78 = add <vscale x 4 x i32> %74, %77
  %79 = add <vscale x 4 x i32> %78, %75
  %80 = add <vscale x 4 x i32> %79, %76
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %80, <vscale x 4 x i1> %15, ptr %70, <vscale x 4 x i32> %37)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %87, <vscale x 4 x i1> %15, ptr %72, <vscale x 4 x i32> %37)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %96, <vscale x 4 x i1> %15, ptr %71, <vscale x 4 x i32> %37)
  %97 = add i32 %vector.loop.index, %2
  %98 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %97, i32 1)
  %99 = getelementptr inbounds i8, ptr %cond, i32 %97, !dbg !115
...
join.block:                                       ; preds = %uniform.block, %lane.gather
  ...
  %113 = phi <vscale x 4 x i32> [ %37, %lane.gather ], [ %98, %uniform.block ]
  %114 = phi <vscale x 4 x i1> [ %38, %lane.gather ], [ %103, %uniform.block ]
  %115 = phi i32 [ %40, %lane.gather ], [ %105, %uniform.block ]
  br label %new.latch

middel.block:                                     ; preds = %new.latch
  %condition1 = icmp eq i32 %17, 0
  %116 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !123
  %117 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !125
  %118 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !126
...
if.then:                                          ; preds = %entry
  %144 = load ptr, ptr @stderr, align 8, !dbg !152, !tbaa !154
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %144, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 36) #14, !dbg !152
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %for.cond.preheader
  %145 = load i32, ptr @EventSet, align 4, !dbg !156, !tbaa !106
  %call80 = tail call i32 @PAPI_stop(i32 noundef %145, ptr noundef nonnull @CounterValues) #13, !dbg !158
...
if.then82:                                        ; preds = %for.cond.cleanup
  %146 = load ptr, ptr @stderr, align 8, !dbg !161, !tbaa !154
  %call83 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %146, ptr noundef nonnull @.str, i32 noundef %call80, ptr noundef nonnull @.str.1, i32 noundef 52) #14, !dbg !161
