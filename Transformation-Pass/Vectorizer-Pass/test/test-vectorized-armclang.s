...
// %bb.0:                               // %entry
	...
	cnth	x8
	rdvl	x9, #1
	add	x13, sp, #64, lsl #12           // =262144
	udiv	x11, x14, x8
	lsr	x9, x9, #4
	and	x16, x9, #0xffffffff
	add	x15, sp, #128, lsl #12          // =524288
	lsl	x17, x16, #4
	mov	x12, xzr
	add	x16, x13, x17
	add	x17, x15, x17
...
// %bb.8:                               // %for.body.i.preheader
	add	x10, sp, #128, lsl #12          // =524288
	add	x12, sp, #64, lsl #12           // =262144
	mov	x13, sp
	b	.LBB1_10
.LBB1_9:                                // %for.inc.i
...
.L.str:
	...
	.ident	"clang version 15.0.1 (git@github.com:llvm/llvm-project.git 29d395a1b7a8176abb1d6278f7df98301fbe7744)"
