...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 48) #14, !dbg !128
...
if.then75:                                        ; preds = %for.cond.cleanup
  ...
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %166, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 64) #14, !dbg !168
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 318) #14, !dbg !247
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 321) #14, !dbg !254
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  %rem = srem i32 %call24, 50, !dbg !285
...
for.cond.cleanup33:                               ; preds = %for.body34
  ...
  %17 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !309, !tbaa !306
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %17), !dbg !310
  %18 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !311, !tbaa !306
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %18), !dbg !312
  %19 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !313, !tbaa !306
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, i64 noundef %19), !dbg !314
  %20 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 4), align 8, !dbg !315, !tbaa !306
  %call46 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.10, i64 noundef %20), !dbg !316
  %21 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 5), align 8, !dbg !317, !tbaa !306
  %call47 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.11, i64 noundef %21), !dbg !318
  %22 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 6), align 8, !dbg !319, !tbaa !306
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.12, i64 noundef %22), !dbg !320
  %23 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 7), align 8, !dbg !321, !tbaa !306
  %call49 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.13, i64 noundef %23), !dbg !322
  %24 = load double, ptr @ExecutionTime, align 8, !dbg !323, !tbaa !173
  %call50 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.14, double noundef %24), !dbg !324
  %25 = load i32, ptr @EventSet, align 4, !dbg !325, !tbaa !119
  %call51 = tail call i32 @PAPI_remove_events(i32 noundef %25, ptr noundef nonnull @EventCodes, i32 noundef 8) #13, !dbg !327
  call void @llvm.dbg.value(metadata i32 %call51, metadata !221, metadata !DIExpression()), !dbg !244
  %cmp52.not = icmp eq i32 %call51, 0, !dbg !328
  br i1 %cmp52.not, label %if.end56, label %if.then54, !dbg !329
...
for.body34:                                       ; preds = %for.body34, %for.cond.cleanup
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv82, metadata !230, metadata !DIExpression()), !dbg !276
  call void @llvm.dbg.value(metadata i32 %sum.079, metadata !229, metadata !DIExpression()), !dbg !244
  %arrayidx36 = getelementptr inbounds i32, ptr %7, i64 %indvars.iv82, !dbg !330
  %26 = load i32, ptr %arrayidx36, align 4, !dbg !330, !tbaa !119
  %add = add nsw i32 %26, %sum.079, !dbg !292
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next83, metadata !230, metadata !DIExpression()), !dbg !276
  %exitcond85.not = icmp eq i64 %indvars.iv.next83, 5000000, !dbg !332
  br i1 %exitcond85.not, label %for.cond.cleanup33, label %for.body34, !dbg !277, !llvm.loop !333

if.then54:                                        ; preds = %for.cond.cleanup33
  %27 = load ptr, ptr @stderr, align 8, !dbg !335, !tbaa !130
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %27, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 375) #14, !dbg !335
  tail call void @exit(i32 noundef %call51) #15, !dbg !335
  unreachable, !dbg !335

if.end56:                                         ; preds = %for.cond.cleanup33
  %call57 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #13, !dbg !337
...
if.then60:                                        ; preds = %if.end56
  ...
  %call61 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %28, ptr noundef nonnull @.str, i32 noundef %call57, ptr noundef nonnull @.str.1, i32 noundef 378) #14, !dbg !341
  tail call void @exit(i32 noundef %call57) #15, !dbg !341
  unreachable, !dbg !341

if.end62:                                         ; preds = %if.end56
  tail call void @PAPI_shutdown() #13, !dbg !343
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #13, !dbg !344
  ret i32 0, !dbg !345
}
...
!165 = !DILocation(line: 60, column: 5, scope: !114)
!166 = !{!"llvm.loop.mustprogress"}
!167 = !{!"llvm.loop.unroll.disable"}
!168 = !DILocation(line: 64, column: 67, scope: !169)
!169 = distinct !DILexicalBlock(scope: !133, file: !3, line: 64, column: 67)
!170 = !DILocation(line: 66, column: 21, scope: !100)
!171 = !DILocation(line: 66, column: 42, scope: !100)
!172 = !DILocation(line: 66, column: 19, scope: !100)
!173 = !{!174, !174, i64 0}
!174 = !{!"double", !81, i64 0}
!175 = !DILocation(line: 67, column: 1, scope: !100)
...
!184 = distinct !DISubprogram(name: "checked_malloc_int_array", scope: !3, file: !3, line: 290, type: !185, scopeLine: 290, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !187)
!185 = !DISubroutineType(types: !186)
!186 = !{!5, !6}
!187 = !{!188, !189}
!188 = !DILocalVariable(name: "n", arg: 1, scope: !184, file: !3, line: 290, type: !6)
!189 = !DILocalVariable(name: "ptr", scope: !184, file: !3, line: 291, type: !5)
!190 = !DILocation(line: 0, scope: !184)
!191 = !DILocation(line: 291, column: 45, scope: !184)
!192 = !DILocation(line: 291, column: 43, scope: !184)
!193 = !DILocation(line: 291, column: 24, scope: !184)
!194 = !DILocation(line: 292, column: 13, scope: !195)
!195 = distinct !DILexicalBlock(scope: !184, file: !3, line: 292, column: 9)
!196 = !DILocation(line: 292, column: 9, scope: !184)
!197 = !DILocation(line: 293, column: 9, scope: !198)
!198 = distinct !DILexicalBlock(scope: !195, file: !3, line: 292, column: 22)
!199 = !DILocation(line: 294, column: 9, scope: !198)
!200 = !DILocation(line: 296, column: 5, scope: !184)
!201 = distinct !DISubprogram(name: "checked_malloc_bool_array", scope: !3, file: !3, line: 299, type: !202, scopeLine: 299, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !204)
!202 = !DISubroutineType(types: !203)
!203 = !{!8, !6}
!204 = !{!205, !206}
!205 = !DILocalVariable(name: "n", arg: 1, scope: !201, file: !3, line: 299, type: !6)
!206 = !DILocalVariable(name: "ptr", scope: !201, file: !3, line: 300, type: !8)
!207 = !DILocation(line: 0, scope: !201)
!208 = !DILocation(line: 300, column: 48, scope: !201)
!209 = !DILocation(line: 300, column: 26, scope: !201)
!210 = !DILocation(line: 301, column: 13, scope: !211)
!211 = distinct !DILexicalBlock(scope: !201, file: !3, line: 301, column: 9)
!212 = !DILocation(line: 301, column: 9, scope: !201)
!213 = !DILocation(line: 302, column: 9, scope: !214)
!214 = distinct !DILexicalBlock(scope: !211, file: !3, line: 301, column: 22)
!215 = !DILocation(line: 303, column: 9, scope: !214)
!216 = !DILocation(line: 305, column: 5, scope: !201)
!217 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 308, type: !218, scopeLine: 308, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !220)
!218 = !DISubroutineType(types: !219)
!219 = !{!6}
!220 = !{!221, !222, !227, !229, !230}
!221 = !DILocalVariable(name: "status", scope: !217, file: !3, line: 309, type: !6)
!222 = !DILocalVariable(name: "errstring", scope: !217, file: !3, line: 310, type: !223)
...
!227 = !DILocalVariable(name: "i", scope: !228, file: !3, line: 334, type: !6)
!228 = distinct !DILexicalBlock(scope: !217, file: !3, line: 334, column: 5)
!229 = !DILocalVariable(name: "sum", scope: !217, file: !3, line: 350, type: !6)
!230 = !DILocalVariable(name: "i", scope: !231, file: !3, line: 352, type: !6)
!231 = distinct !DILexicalBlock(scope: !217, file: !3, line: 352, column: 5)
!232 = !DILocation(line: 310, column: 5, scope: !217)
!233 = !DILocation(line: 310, column: 10, scope: !217)
!234 = !DILocation(line: 312, column: 9, scope: !235)
!235 = distinct !DILexicalBlock(scope: !217, file: !3, line: 312, column: 9)
!236 = !DILocation(line: 312, column: 45, scope: !235)
!237 = !DILocation(line: 312, column: 9, scope: !217)
!238 = !DILocation(line: 313, column: 17, scope: !239)
!239 = distinct !DILexicalBlock(scope: !235, file: !3, line: 312, column: 66)
!240 = !DILocation(line: 313, column: 9, scope: !239)
!241 = !DILocation(line: 314, column: 9, scope: !239)
!242 = !DILocation(line: 318, column: 19, scope: !243)
!243 = distinct !DILexicalBlock(scope: !217, file: !3, line: 318, column: 9)
!244 = !DILocation(line: 0, scope: !217)
!245 = !DILocation(line: 318, column: 52, scope: !243)
!246 = !DILocation(line: 318, column: 9, scope: !217)
!247 = !DILocation(line: 318, column: 64, scope: !248)
!248 = distinct !DILexicalBlock(scope: !243, file: !3, line: 318, column: 64)
!249 = !DILocation(line: 321, column: 35, scope: !250)
!250 = distinct !DILexicalBlock(scope: !217, file: !3, line: 321, column: 9)
!251 = !DILocation(line: 321, column: 19, scope: !250)
!252 = !DILocation(line: 321, column: 69, scope: !250)
!253 = !DILocation(line: 321, column: 9, scope: !217)
!254 = !DILocation(line: 321, column: 81, scope: !255)
!255 = distinct !DILexicalBlock(scope: !250, file: !3, line: 321, column: 81)
!256 = !DILocation(line: 324, column: 9, scope: !217)
!257 = !DILocation(line: 324, column: 7, scope: !217)
!258 = !DILocation(line: 325, column: 9, scope: !217)
!259 = !DILocation(line: 325, column: 7, scope: !217)
!260 = !DILocation(line: 326, column: 9, scope: !217)
!261 = !DILocation(line: 326, column: 7, scope: !217)
!262 = !DILocation(line: 327, column: 12, scope: !217)
!263 = !DILocation(line: 327, column: 10, scope: !217)
!264 = !DILocation(line: 329, column: 13, scope: !217)
!265 = !DILocation(line: 331, column: 11, scope: !217)
!266 = !DILocation(line: 331, column: 5, scope: !217)
!267 = !DILocation(line: 0, scope: !228)
!268 = !DILocation(line: 334, column: 5, scope: !228)
!269 = !DILocation(line: 342, column: 9, scope: !270)
!270 = distinct !DILexicalBlock(scope: !271, file: !3, line: 334, column: 33)
!271 = distinct !DILexicalBlock(scope: !228, file: !3, line: 334, column: 5)
!272 = !DILocation(line: 346, column: 15, scope: !217)
!273 = !DILocation(line: 346, column: 18, scope: !217)
!274 = !DILocation(line: 346, column: 21, scope: !217)
!275 = !DILocation(line: 346, column: 5, scope: !217)
!276 = !DILocation(line: 0, scope: !231)
!277 = !DILocation(line: 352, column: 5, scope: !231)
!278 = !DILocation(line: 335, column: 9, scope: !270)
!279 = !DILocation(line: 335, column: 14, scope: !270)
!280 = !DILocation(line: 336, column: 9, scope: !270)
!281 = !DILocation(line: 336, column: 14, scope: !270)
!282 = !DILocation(line: 337, column: 9, scope: !270)
!283 = !DILocation(line: 337, column: 14, scope: !270)
!284 = !DILocation(line: 342, column: 20, scope: !270)
!285 = !DILocation(line: 342, column: 27, scope: !270)
!286 = !DILocation(line: 342, column: 33, scope: !270)
!287 = !DILocation(line: 342, column: 17, scope: !270)
!288 = !DILocation(line: 334, column: 28, scope: !271)
!289 = !DILocation(line: 334, column: 23, scope: !271)
!290 = distinct !{!290, !268, !291, !166, !167}
!291 = !DILocation(line: 343, column: 5, scope: !228)
!292 = !DILocation(line: 353, column: 13, scope: !293)
!293 = distinct !DILexicalBlock(scope: !294, file: !3, line: 352, column: 33)
!294 = distinct !DILexicalBlock(scope: !231, file: !3, line: 352, column: 5)
!295 = !DILocation(line: 357, column: 5, scope: !217)
!296 = !DILocation(line: 358, column: 5, scope: !217)
!297 = !DILocation(line: 360, column: 10, scope: !217)
!298 = !DILocation(line: 360, column: 5, scope: !217)
!299 = !DILocation(line: 361, column: 10, scope: !217)
!300 = !DILocation(line: 361, column: 5, scope: !217)
!301 = !DILocation(line: 362, column: 10, scope: !217)
!302 = !DILocation(line: 362, column: 5, scope: !217)
!303 = !DILocation(line: 363, column: 10, scope: !217)
!304 = !DILocation(line: 363, column: 5, scope: !217)
!305 = !DILocation(line: 365, column: 53, scope: !217)
!306 = !{!307, !307, i64 0}
!307 = !{!"long long", !81, i64 0}
!308 = !DILocation(line: 365, column: 5, scope: !217)
!309 = !DILocation(line: 366, column: 44, scope: !217)
!310 = !DILocation(line: 366, column: 5, scope: !217)
!311 = !DILocation(line: 367, column: 50, scope: !217)
!312 = !DILocation(line: 367, column: 5, scope: !217)
!313 = !DILocation(line: 368, column: 49, scope: !217)
!314 = !DILocation(line: 368, column: 5, scope: !217)
!315 = !DILocation(line: 369, column: 57, scope: !217)
!316 = !DILocation(line: 369, column: 5, scope: !217)
!317 = !DILocation(line: 370, column: 59, scope: !217)
!318 = !DILocation(line: 370, column: 5, scope: !217)
!319 = !DILocation(line: 371, column: 45, scope: !217)
!320 = !DILocation(line: 371, column: 5, scope: !217)
!321 = !DILocation(line: 372, column: 66, scope: !217)
!322 = !DILocation(line: 372, column: 5, scope: !217)
!323 = !DILocation(line: 373, column: 40, scope: !217)
!324 = !DILocation(line: 373, column: 5, scope: !217)
!325 = !DILocation(line: 375, column: 38, scope: !326)
!326 = distinct !DILexicalBlock(scope: !217, file: !3, line: 375, column: 9)
!327 = !DILocation(line: 375, column: 19, scope: !326)
!328 = !DILocation(line: 375, column: 72, scope: !326)
!329 = !DILocation(line: 375, column: 9, scope: !217)
!330 = !DILocation(line: 353, column: 16, scope: !293)
!331 = !DILocation(line: 352, column: 28, scope: !294)
!332 = !DILocation(line: 352, column: 23, scope: !294)
!333 = distinct !{!333, !277, !334, !166, !167}
!334 = !DILocation(line: 354, column: 5, scope: !231)
!335 = !DILocation(line: 375, column: 84, scope: !336)
!336 = distinct !DILexicalBlock(scope: !326, file: !3, line: 375, column: 84)
!337 = !DILocation(line: 378, column: 19, scope: !338)
!338 = distinct !DILexicalBlock(scope: !217, file: !3, line: 378, column: 9)
!339 = !DILocation(line: 378, column: 53, scope: !338)
!340 = !DILocation(line: 378, column: 9, scope: !217)
!341 = !DILocation(line: 378, column: 65, scope: !342)
!342 = distinct !DILexicalBlock(scope: !338, file: !3, line: 378, column: 65)
!343 = !DILocation(line: 381, column: 5, scope: !217)
!344 = !DILocation(line: 384, column: 1, scope: !217)
!345 = !DILocation(line: 383, column: 5, scope: !217)
