...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 77) #14, !dbg !128
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %for.cond.preheader
  ...
  %call127 = tail call i32 @PAPI_stop(i32 noundef %6, ptr noundef nonnull @CounterValues) #13, !dbg !134
...
if.then4:                                         ; preds = %for.body
  ...
  %mul21214 = add i32 %9, 2, !dbg !148
  %10 = trunc i64 %indvars.iv to i32, !dbg !148
  %add22 = mul i32 %mul21214, %10, !dbg !148
  %.neg = mul i32 %8, -2
  %add = add i32 %add22, %9, !dbg !149
  %add25 = add i32 %add, %.neg, !dbg !150
  store i32 %add25, ptr %arrayidx6, align 4, !dbg !150, !tbaa !119
  %mul43215.neg = sub i32 -3, %8, !dbg !151
  %add44.neg224 = mul i32 %mul43215.neg, %10, !dbg !151
  %11 = add i32 %8, %9
  ...
  %12 = add nsw i32 %sub47, %add25, !dbg !154
  %add54 = shl nsw i32 %12, 1, !dbg !154
  %13 = sub nsw i32 %8, %sub47, !dbg !155
  %sub61 = shl nsw i32 %13, 1, !dbg !155
  %mul62 = mul nsw i32 %10, %10, !dbg !156
  %add63 = add nsw i32 %sub61, %mul62, !dbg !157
  %mul64.neg = mul i32 %add63, -3, !dbg !158
  %sub65 = add i32 %add54, %8, !dbg !159
...
if.else:                                          ; preds = %for.body
  ...
  %14 = load i32, ptr %arrayidx70, align 4, !dbg !162, !tbaa !119
  %add71 = add nsw i32 %14, 2, !dbg !164
  %arrayidx73 = getelementptr inbounds i32, ptr %c, i64 %indvars.iv, !dbg !165
  %15 = load i32, ptr %arrayidx73, align 4, !dbg !165, !tbaa !119
  %mul74.neg = mul i32 %15, -3, !dbg !166
  %sub75 = add i32 %add71, %mul74.neg, !dbg !167
  %arrayidx77 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv, !dbg !168
  %16 = load i32, ptr %arrayidx77, align 4, !dbg !169, !tbaa !119
  %mul78 = mul nsw i32 %sub75, %16, !dbg !169
  %mul83 = mul nsw i32 %mul78, %14, !dbg !170
  %sub84 = add i32 %15, -1, !dbg !171
...
Preheader.for.remaining.iterations:               ; preds = %middel.block, %for.body.preheader
  %17 = phi i64 [ 0, %for.body.preheader ], [ %233, %middel.block ]
  br label %for.body
...
pre.alc:                                          ; preds = %for.body.preheader
  ...
  %23 = getelementptr inbounds i8, ptr %cond, i32 0, !dbg !137
  %24 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 0, i32 1)
  %25 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg = shufflevector <vscale x 4 x i32> %25, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %26 = load <vscale x 4 x i8>, ptr %23, align 4
...
alc.header:                                       ; preds = %new.latch, %pre.alc
  ...
  %uniform.vector = phi <vscale x 4 x i32> [ %19, %pre.alc ], [ %117, %new.latch ]
  %uniform.vector.predicates = phi <vscale x 4 x i1> [ %27, %pre.alc ], [ %118, %new.latch ]
  %28 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %vector.loop.index, i32 1)
  %29 = getelementptr inbounds i8, ptr %cond, i32 %vector.loop.index, !dbg !137
...
lane.gather:                                      ; preds = %alc.header
  %34 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %uniform.vector.predicates, <vscale x 4 x i1> %uniform.vector.predicates)
  %35 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %33, <vscale x 4 x i1> %33)
  %36 = trunc i64 %34 to i32
  %37 = trunc i64 %35 to i32
  %38 = add i32 %36, %37
  %39 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %uniform.vector.predicates, <vscale x 4 x i32> %uniform.vector)
  %40 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %33, <vscale x 4 x i32> %28)
  %41 = xor <vscale x 4 x i1> %uniform.vector.predicates, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %42 = xor <vscale x 4 x i1> %33, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %43 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %41, <vscale x 4 x i32> %uniform.vector)
  %44 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %42, <vscale x 4 x i32> %28)
  %45 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %36)
  %46 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %45, <vscale x 4 x i32> %39, <vscale x 4 x i32> %40)
  %47 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %38)
  %48 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %47, <vscale x 4 x i32> %46, <vscale x 4 x i32> %44)
  %49 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %33, <vscale x 4 x i1> %33)
  %50 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %49)
  %51 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %50, <vscale x 4 x i32> %40, <vscale x 4 x i32> %44)
  %52 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %41, <vscale x 4 x i1> %41)
  %53 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %52)
  %54 = call <vscale x 4 x i32> @llvm.aarch64.sve.sel.nxv4i32(<vscale x 4 x i1> %53, <vscale x 4 x i32> %43, <vscale x 4 x i32> %51)
  %55 = xor <vscale x 4 x i1> %53, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %56 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %42, <vscale x 4 x i1> %42)
  %57 = sext i32 %2 to i64
  %58 = sub i64 %57, %56
  %59 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %58)
  %60 = and <vscale x 4 x i1> %55, %59
  %61 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %47, <vscale x 4 x i1> %47)
  %62 = trunc i64 %61 to i32
  %63 = icmp ugt i32 %38, %2
  br i1 %63, label %uniform.then, label %uniform.else

uniform.then:                                     ; preds = %lane.gather
  %64 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !162
  %65 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !165
  %66 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !168
  %67 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg2 = shufflevector <vscale x 4 x i32> %67, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %68 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %18, ptr %64, <vscale x 4 x i32> %48)
  %69 = add <vscale x 4 x i32> %68, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %70 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %18, ptr %65, <vscale x 4 x i32> %48)
  ...
  %72 = add <vscale x 4 x i32> %69, %71
  %73 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %18, ptr %66, <vscale x 4 x i32> %48)
  %74 = mul <vscale x 4 x i32> %72, %73
  %75 = mul <vscale x 4 x i32> %74, %68
  %76 = add <vscale x 4 x i32> %70, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %77 = add <vscale x 4 x i32> %76, %75
  %78 = mul <vscale x 4 x i32> %74, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  ...
  %80 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %74
  %81 = add <vscale x 4 x i32> %80, %78
  %82 = add <vscale x 4 x i32> %81, %79
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %82, <vscale x 4 x i1> %18, ptr %64, <vscale x 4 x i32> %48)
  %83 = mul <vscale x 4 x i32> %82, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %84 = add <vscale x 4 x i32> %74, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %85 = add <vscale x 4 x i32> %84, %83
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %85, <vscale x 4 x i1> %18, ptr %66, <vscale x 4 x i32> %48)
  %86 = mul <vscale x 4 x i32> %85, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 5, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %87 = shl <vscale x 4 x i32> %82, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %88 = add <vscale x 4 x i32> %87, %77
  %89 = add <vscale x 4 x i32> %88, %86
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %89, <vscale x 4 x i1> %18, ptr %65, <vscale x 4 x i32> %48)
  br label %new.latch

uniform.else:                                     ; preds = %lane.gather
  %90 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !144
  %91 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !146
  %92 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !147
  ...
  %94 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %18, ptr %91, <vscale x 4 x i32> %54)
  %95 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %18, ptr %92, <vscale x 4 x i32> %54)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %100, <vscale x 4 x i1> %18, ptr %90, <vscale x 4 x i32> %54)
  ...
  %102 = mul <vscale x 4 x i32> %101, %54
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %107, <vscale x 4 x i1> %18, ptr %92, <vscale x 4 x i32> %54)
  ...
  %112 = mul <vscale x 4 x i32> %54, %54
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %116, <vscale x 4 x i1> %18, ptr %91, <vscale x 4 x i32> %54)
  br label %new.latch

new.latch:                                        ; preds = %uniform.else, %uniform.then
  %117 = phi <vscale x 4 x i32> [ %54, %uniform.then ], [ %48, %uniform.else ]
  %118 = phi <vscale x 4 x i1> [ %60, %uniform.then ], [ %47, %uniform.else ]
...
linearized.then:                                  ; preds = %joinBlock
  %121 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !162
  %122 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !165
  %123 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !168
  ...
  %125 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %47, ptr %121, <vscale x 4 x i32> %48)
  ...
  %127 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %47, ptr %122, <vscale x 4 x i32> %48)
  ...
  %130 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %47, ptr %123, <vscale x 4 x i32> %48)
  %131 = mul <vscale x 4 x i32> %129, %130
  %132 = mul <vscale x 4 x i32> %131, %125
  %133 = add <vscale x 4 x i32> %127, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %134 = add <vscale x 4 x i32> %133, %132
  %135 = mul <vscale x 4 x i32> %131, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %139, <vscale x 4 x i1> %47, ptr %121, <vscale x 4 x i32> %48)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %142, <vscale x 4 x i1> %47, ptr %123, <vscale x 4 x i32> %48)
  ...
  %145 = add <vscale x 4 x i32> %144, %134
  %146 = add <vscale x 4 x i32> %145, %143
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %146, <vscale x 4 x i1> %47, ptr %122, <vscale x 4 x i32> %48)
  %147 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !144
  %148 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !146
  %149 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !147
  %150 = xor <vscale x 4 x i1> %47, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %151 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg5 = shufflevector <vscale x 4 x i32> %151, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %152 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %150, ptr %148, <vscale x 4 x i32> %48)
  %153 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %150, ptr %149, <vscale x 4 x i32> %48)
  ...
  %155 = mul <vscale x 4 x i32> %154, %48
  %156 = mul <vscale x 4 x i32> %152, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %157 = add <vscale x 4 x i32> %155, %153
  %158 = add <vscale x 4 x i32> %157, %156
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %158, <vscale x 4 x i1> %150, ptr %147, <vscale x 4 x i32> %48)
  %159 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %152
  %160 = mul <vscale x 4 x i32> %159, %48
  %161 = add <vscale x 4 x i32> %152, %153
  %162 = sub <vscale x 4 x i32> %158, %161
  ...
  %164 = add <vscale x 4 x i32> %160, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %165 = add <vscale x 4 x i32> %164, %163
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %165, <vscale x 4 x i1> %150, ptr %149, <vscale x 4 x i32> %48)
  %166 = add <vscale x 4 x i32> %165, %158
  %167 = shl <vscale x 4 x i32> %166, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %168 = sub <vscale x 4 x i32> %152, %165
  %169 = shl <vscale x 4 x i32> %168, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %170 = mul <vscale x 4 x i32> %48, %48
  %171 = add <vscale x 4 x i32> %169, %170
  ...
  %173 = add <vscale x 4 x i32> %167, %152
  %174 = add <vscale x 4 x i32> %173, %172
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %174, <vscale x 4 x i1> %150, ptr %148, <vscale x 4 x i32> %48)
  br label %middel.block

linearized.else:                                  ; preds = %joinBlock
  %175 = xor <vscale x 4 x i1> %60, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %176 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !144
  %177 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !146
  %178 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !147
  %179 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg6 = shufflevector <vscale x 4 x i32> %179, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %180 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %175, ptr %177, <vscale x 4 x i32> %54)
  %181 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %175, ptr %178, <vscale x 4 x i32> %54)
  %182 = add <vscale x 4 x i32> %181, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %183 = mul <vscale x 4 x i32> %182, %54
  %184 = mul <vscale x 4 x i32> %180, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %185 = add <vscale x 4 x i32> %183, %181
  %186 = add <vscale x 4 x i32> %185, %184
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %186, <vscale x 4 x i1> %175, ptr %176, <vscale x 4 x i32> %54)
  %187 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %180
  %188 = mul <vscale x 4 x i32> %187, %54
  %189 = add <vscale x 4 x i32> %180, %181
  %190 = sub <vscale x 4 x i32> %186, %189
  %191 = shl <vscale x 4 x i32> %190, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %192 = add <vscale x 4 x i32> %188, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %193 = add <vscale x 4 x i32> %192, %191
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %193, <vscale x 4 x i1> %175, ptr %178, <vscale x 4 x i32> %54)
  %194 = add <vscale x 4 x i32> %193, %186
  %195 = shl <vscale x 4 x i32> %194, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %196 = sub <vscale x 4 x i32> %180, %193
  ...
  %198 = mul <vscale x 4 x i32> %54, %54
  %199 = add <vscale x 4 x i32> %197, %198
  %200 = mul <vscale x 4 x i32> %199, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %201 = add <vscale x 4 x i32> %195, %180
  %202 = add <vscale x 4 x i32> %201, %200
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %202, <vscale x 4 x i1> %175, ptr %177, <vscale x 4 x i32> %54)
  %203 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !162
  %204 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !165
  %205 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !168
  %206 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg7 = shufflevector <vscale x 4 x i32> %206, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %207 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %60, ptr %203, <vscale x 4 x i32> %54)
  %208 = add <vscale x 4 x i32> %207, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %209 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %60, ptr %204, <vscale x 4 x i32> %54)
  %210 = mul <vscale x 4 x i32> %209, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %211 = add <vscale x 4 x i32> %208, %210
  %212 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %60, ptr %205, <vscale x 4 x i32> %54)
  %213 = mul <vscale x 4 x i32> %211, %212
  %214 = mul <vscale x 4 x i32> %213, %207
  %215 = add <vscale x 4 x i32> %209, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %216 = add <vscale x 4 x i32> %215, %214
  %217 = mul <vscale x 4 x i32> %213, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %218 = mul <vscale x 4 x i32> %216, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %219 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %213
  %220 = add <vscale x 4 x i32> %219, %217
  %221 = add <vscale x 4 x i32> %220, %218
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %221, <vscale x 4 x i1> %60, ptr %203, <vscale x 4 x i32> %54)
  %222 = mul <vscale x 4 x i32> %221, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %223 = add <vscale x 4 x i32> %213, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %224 = add <vscale x 4 x i32> %223, %222
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %224, <vscale x 4 x i1> %60, ptr %205, <vscale x 4 x i32> %54)
  %225 = mul <vscale x 4 x i32> %224, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 5, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %226 = shl <vscale x 4 x i32> %221, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %227 = add <vscale x 4 x i32> %226, %216
  %228 = add <vscale x 4 x i32> %227, %225
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %228, <vscale x 4 x i1> %60, ptr %204, <vscale x 4 x i32> %54)
  br label %middel.block

joinBlock:                                        ; preds = %new.latch
  %229 = icmp eq <vscale x 4 x i32> %117, %48
  %230 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %229, <vscale x 4 x i1> %229)
  %231 = trunc i64 %230 to i32
  %232 = icmp eq i32 %231, %2
  br i1 %232, label %linearized.then, label %linearized.else

middel.block:                                     ; preds = %linearized.else, %linearized.then
  %233 = zext i32 %119 to i64
...
for.inc:                                          ; preds = %if.else, %if.then4
  ...
  br i1 %exitcond.not, label %for.cond.cleanup.loopexit, label %for.body, !dbg !127, !llvm.loop !185

if.then129:                                       ; preds = %for.cond.cleanup
  %234 = load ptr, ptr @stderr, align 8, !dbg !189, !tbaa !130
  %call130 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %234, ptr noundef nonnull @.str, i32 noundef %call127, ptr noundef nonnull @.str.1, i32 noundef 103) #14, !dbg !189
  tail call void @exit(i32 noundef %call127) #15, !dbg !189
  unreachable, !dbg !189
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul) #16, !dbg !214
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #15, !dbg !220
  unreachable, !dbg !220
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %conv) #16, !dbg !230
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #15, !dbg !236
  unreachable, !dbg !236
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %errstring) #13, !dbg !253
  call void @llvm.dbg.declare(metadata ptr %errstring, metadata !243, metadata !DIExpression()), !dbg !254
  %call = tail call i32 @PAPI_library_init(i32 noundef 117440512) #13, !dbg !255
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3, ptr noundef nonnull %errstring) #14, !dbg !261
  call void @exit(i32 noundef 1) #15, !dbg !262
  unreachable, !dbg !262

if.end:                                           ; preds = %entry
  %call2 = tail call i32 @PAPI_create_eventset(ptr noundef nonnull @EventSet) #13, !dbg !263
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 318) #14, !dbg !268
  tail call void @exit(i32 noundef %call2) #15, !dbg !268
  unreachable, !dbg !268

if.end6:                                          ; preds = %if.end
  %2 = load i32, ptr @EventSet, align 4, !dbg !270, !tbaa !119
  %call7 = tail call i32 @PAPI_add_events(i32 noundef %2, ptr noundef nonnull @EventCodes, i32 noundef 8) #13, !dbg !272
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 321) #14, !dbg !275
  tail call void @exit(i32 noundef %call7) #15, !dbg !275
  unreachable, !dbg !275
...
if.end11:                                         ; preds = %if.end6
  ...
  %call16 = tail call i64 @time(ptr noundef null) #13, !dbg !286
  %conv = trunc i64 %call16 to i32, !dbg !286
  tail call void @srand(i32 noundef %conv) #13, !dbg !287
  call void @llvm.dbg.value(metadata i32 1, metadata !248, metadata !DIExpression()), !dbg !288
  br label %for.body, !dbg !289

for.cond.cleanup:                                 ; preds = %for.body
  %.lcssa = phi ptr [ %11, %for.body ], !dbg !290
  %4 = load ptr, ptr @a, align 8, !dbg !293, !tbaa !130
  %5 = load ptr, ptr @b, align 8, !dbg !294, !tbaa !130
  %6 = load ptr, ptr @c, align 8, !dbg !295, !tbaa !130
  tail call void @simple_if_else(ptr noundef %4, ptr noundef %5, ptr noundef %6, ptr noundef nonnull %.lcssa, i32 noundef 5000000), !dbg !296
  call void @llvm.dbg.value(metadata i32 0, metadata !250, metadata !DIExpression()), !dbg !265
  call void @llvm.dbg.value(metadata i32 0, metadata !251, metadata !DIExpression()), !dbg !297
  %7 = load ptr, ptr @c, align 8, !tbaa !130
  call void @llvm.dbg.value(metadata i32 0, metadata !251, metadata !DIExpression()), !dbg !297
  call void @llvm.dbg.value(metadata i32 0, metadata !250, metadata !DIExpression()), !dbg !265
  br label %for.body34, !dbg !298
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  %8 = load ptr, ptr @a, align 8, !dbg !299, !tbaa !130
  %arrayidx19 = getelementptr inbounds i32, ptr %8, i64 %indvars.iv, !dbg !299
  store i32 1, ptr %arrayidx19, align 4, !dbg !300, !tbaa !119
  %9 = load ptr, ptr @b, align 8, !dbg !301, !tbaa !130
  %arrayidx21 = getelementptr inbounds i32, ptr %9, i64 %indvars.iv, !dbg !301
  store i32 -1, ptr %arrayidx21, align 4, !dbg !302, !tbaa !119
  %10 = load ptr, ptr @c, align 8, !dbg !303, !tbaa !130
  %arrayidx23 = getelementptr inbounds i32, ptr %10, i64 %indvars.iv, !dbg !303
  store i32 0, ptr %arrayidx23, align 4, !dbg !304, !tbaa !119
  %call24 = tail call i32 @rand() #13, !dbg !305
  %rem = srem i32 %call24, 3, !dbg !306
  %cmp25 = icmp eq i32 %rem, 0, !dbg !307
  %11 = load ptr, ptr @cond, align 8, !dbg !290, !tbaa !130
...
for.cond.cleanup33:                               ; preds = %for.body34
  %add.lcssa = phi i32 [ %add, %for.body34 ], !dbg !313
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add.lcssa), !dbg !316
  %putchar = tail call i32 @putchar(i32 10), !dbg !317
  %12 = load ptr, ptr @a, align 8, !dbg !318, !tbaa !130
  tail call void @free(ptr noundef %12) #13, !dbg !319
  %13 = load ptr, ptr @b, align 8, !dbg !320, !tbaa !130
  tail call void @free(ptr noundef %13) #13, !dbg !321
  %14 = load ptr, ptr @c, align 8, !dbg !322, !tbaa !130
  tail call void @free(ptr noundef %14) #13, !dbg !323
  %15 = load ptr, ptr @cond, align 8, !dbg !324, !tbaa !130
  tail call void @free(ptr noundef %15) #13, !dbg !325
  %16 = load i64, ptr @CounterValues, align 8, !dbg !326, !tbaa !327
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %16), !dbg !329
  %17 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !330, !tbaa !327
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %17), !dbg !331
  %18 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !332, !tbaa !327
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %18), !dbg !333
  %19 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !334, !tbaa !327
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, i64 noundef %19), !dbg !335
  %20 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 4), align 8, !dbg !336, !tbaa !327
  %call46 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.10, i64 noundef %20), !dbg !337
  %21 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 5), align 8, !dbg !338, !tbaa !327
  %call47 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.11, i64 noundef %21), !dbg !339
  %22 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 6), align 8, !dbg !340, !tbaa !327
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.12, i64 noundef %22), !dbg !341
  %23 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 7), align 8, !dbg !342, !tbaa !327
  %call49 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.13, i64 noundef %23), !dbg !343
  %24 = load double, ptr @ExecutionTime, align 8, !dbg !344, !tbaa !194
  %call50 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.14, double noundef %24), !dbg !345
  %25 = load i32, ptr @EventSet, align 4, !dbg !346, !tbaa !119
  %call51 = tail call i32 @PAPI_remove_events(i32 noundef %25, ptr noundef nonnull @EventCodes, i32 noundef 8) #13, !dbg !348
  call void @llvm.dbg.value(metadata i32 %call51, metadata !242, metadata !DIExpression()), !dbg !265
  %cmp52.not = icmp eq i32 %call51, 0, !dbg !349
  br i1 %cmp52.not, label %if.end56, label %if.then54, !dbg !350
...
for.body34:                                       ; preds = %for.body34, %for.cond.cleanup
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv82, metadata !251, metadata !DIExpression()), !dbg !297
  call void @llvm.dbg.value(metadata i32 %sum.079, metadata !250, metadata !DIExpression()), !dbg !265
  %arrayidx36 = getelementptr inbounds i32, ptr %7, i64 %indvars.iv82, !dbg !351
  %26 = load i32, ptr %arrayidx36, align 4, !dbg !351, !tbaa !119
  %add = add nsw i32 %26, %sum.079, !dbg !313
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next83, metadata !251, metadata !DIExpression()), !dbg !297
  %exitcond85.not = icmp eq i64 %indvars.iv.next83, 5000000, !dbg !353
  br i1 %exitcond85.not, label %for.cond.cleanup33, label %for.body34, !dbg !298, !llvm.loop !354

if.then54:                                        ; preds = %for.cond.cleanup33
  %27 = load ptr, ptr @stderr, align 8, !dbg !356, !tbaa !130
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %27, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 375) #14, !dbg !356
  tail call void @exit(i32 noundef %call51) #15, !dbg !356
  unreachable, !dbg !356

if.end56:                                         ; preds = %for.cond.cleanup33
  %call57 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #13, !dbg !358
...
if.then60:                                        ; preds = %if.end56
  ...
  %call61 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %28, ptr noundef nonnull @.str, i32 noundef %call57, ptr noundef nonnull @.str.1, i32 noundef 378) #14, !dbg !362
  tail call void @exit(i32 noundef %call57) #15, !dbg !362
  unreachable, !dbg !362

if.end62:                                         ; preds = %if.end56
  tail call void @PAPI_shutdown() #13, !dbg !364
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #13, !dbg !365
  ret i32 0, !dbg !366
}
...
!290 = !DILocation(line: 342, column: 9, scope: !291)
!291 = distinct !DILexicalBlock(scope: !292, file: !3, line: 334, column: 33)
!292 = distinct !DILexicalBlock(scope: !249, file: !3, line: 334, column: 5)
!293 = !DILocation(line: 347, column: 20, scope: !238)
!294 = !DILocation(line: 347, column: 23, scope: !238)
!295 = !DILocation(line: 347, column: 26, scope: !238)
!296 = !DILocation(line: 347, column: 5, scope: !238)
!297 = !DILocation(line: 0, scope: !252)
!298 = !DILocation(line: 352, column: 5, scope: !252)
!299 = !DILocation(line: 335, column: 9, scope: !291)
!300 = !DILocation(line: 335, column: 14, scope: !291)
!301 = !DILocation(line: 336, column: 9, scope: !291)
!302 = !DILocation(line: 336, column: 14, scope: !291)
!303 = !DILocation(line: 337, column: 9, scope: !291)
!304 = !DILocation(line: 337, column: 14, scope: !291)
!305 = !DILocation(line: 342, column: 20, scope: !291)
!306 = !DILocation(line: 342, column: 27, scope: !291)
!307 = !DILocation(line: 342, column: 32, scope: !291)
!308 = !DILocation(line: 342, column: 17, scope: !291)
!309 = !DILocation(line: 334, column: 28, scope: !292)
!310 = !DILocation(line: 334, column: 23, scope: !292)
!311 = distinct !{!311, !289, !312, !187, !188}
!312 = !DILocation(line: 343, column: 5, scope: !249)
!313 = !DILocation(line: 353, column: 13, scope: !314)
!314 = distinct !DILexicalBlock(scope: !315, file: !3, line: 352, column: 33)
!315 = distinct !DILexicalBlock(scope: !252, file: !3, line: 352, column: 5)
!316 = !DILocation(line: 357, column: 5, scope: !238)
!317 = !DILocation(line: 358, column: 5, scope: !238)
!318 = !DILocation(line: 360, column: 10, scope: !238)
!319 = !DILocation(line: 360, column: 5, scope: !238)
!320 = !DILocation(line: 361, column: 10, scope: !238)
!321 = !DILocation(line: 361, column: 5, scope: !238)
!322 = !DILocation(line: 362, column: 10, scope: !238)
!323 = !DILocation(line: 362, column: 5, scope: !238)
!324 = !DILocation(line: 363, column: 10, scope: !238)
!325 = !DILocation(line: 363, column: 5, scope: !238)
!326 = !DILocation(line: 365, column: 53, scope: !238)
!327 = !{!328, !328, i64 0}
!328 = !{!"long long", !81, i64 0}
!329 = !DILocation(line: 365, column: 5, scope: !238)
!330 = !DILocation(line: 366, column: 44, scope: !238)
!331 = !DILocation(line: 366, column: 5, scope: !238)
!332 = !DILocation(line: 367, column: 50, scope: !238)
!333 = !DILocation(line: 367, column: 5, scope: !238)
!334 = !DILocation(line: 368, column: 49, scope: !238)
!335 = !DILocation(line: 368, column: 5, scope: !238)
!336 = !DILocation(line: 369, column: 57, scope: !238)
!337 = !DILocation(line: 369, column: 5, scope: !238)
!338 = !DILocation(line: 370, column: 59, scope: !238)
!339 = !DILocation(line: 370, column: 5, scope: !238)
!340 = !DILocation(line: 371, column: 45, scope: !238)
!341 = !DILocation(line: 371, column: 5, scope: !238)
!342 = !DILocation(line: 372, column: 66, scope: !238)
!343 = !DILocation(line: 372, column: 5, scope: !238)
!344 = !DILocation(line: 373, column: 40, scope: !238)
!345 = !DILocation(line: 373, column: 5, scope: !238)
!346 = !DILocation(line: 375, column: 38, scope: !347)
!347 = distinct !DILexicalBlock(scope: !238, file: !3, line: 375, column: 9)
!348 = !DILocation(line: 375, column: 19, scope: !347)
!349 = !DILocation(line: 375, column: 72, scope: !347)
!350 = !DILocation(line: 375, column: 9, scope: !238)
!351 = !DILocation(line: 353, column: 16, scope: !314)
!352 = !DILocation(line: 352, column: 28, scope: !315)
!353 = !DILocation(line: 352, column: 23, scope: !315)
!354 = distinct !{!354, !298, !355, !187, !188}
!355 = !DILocation(line: 354, column: 5, scope: !252)
!356 = !DILocation(line: 375, column: 84, scope: !357)
!357 = distinct !DILexicalBlock(scope: !347, file: !3, line: 375, column: 84)
