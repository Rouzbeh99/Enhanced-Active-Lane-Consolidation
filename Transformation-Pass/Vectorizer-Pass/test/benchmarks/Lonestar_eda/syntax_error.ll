; ModuleID = 'syntax_error.cpp'
source_filename = "syntax_error.cpp"
...
%class.syntax_error = type { %"class.std::exception", i32, i32, %"class.std::__cxx11::basic_string" }
%"class.std::exception" = type { ptr }
%"class.std::ctype" = type <{ %"class.std::locale::facet.base", [4 x i8], ptr, i8, [7 x i8], ptr, ptr, ptr, i8, [256 x i8], [256 x i8], i8, [6 x i8] }>
%"class.std::locale::facet.base" = type <{ ptr, i32 }>
%"class.std::basic_istream" = type { ptr, i64, %"class.std::basic_ios" }

@_ZTV12syntax_error = dso_local unnamed_addr constant { [5 x ptr] } { [5 x ptr] [ptr null, ptr @_ZTI12syntax_error, ptr @_ZN12syntax_errorD2Ev, ptr @_ZN12syntax_errorD0Ev, ptr @_ZNK12syntax_error4whatEv] }, align 8
@.str = private unnamed_addr constant [22 x i8] c"Syntax error in line-\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c" char-\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c": \00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global ptr
@_ZTS12syntax_error = dso_local constant [15 x i8] c"12syntax_error\00", align 1
@_ZTISt9exception = external constant ptr
@_ZTI12syntax_error = dso_local constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2), ptr @_ZTS12syntax_error, ptr @_ZTISt9exception }, align 8
@_ZTTNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEE = external unnamed_addr constant [10 x ptr], align 8
@_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE = external unnamed_addr constant { [16 x ptr] }, align 8
@_ZTVSt15basic_streambufIcSt11char_traitsIcEE = external unnamed_addr constant { [16 x ptr] }, align 8

@_ZN12syntax_errorC1EjjNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE = dso_local unnamed_addr alias void (ptr, i32, i32, ptr), ptr @_ZN12syntax_errorC2EjjNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
@_ZN12syntax_errorD1Ev = dso_local unnamed_addr alias void (ptr), ptr @_ZN12syntax_errorD2Ev

; Function Attrs: uwtable
define dso_local void @_ZN12syntax_errorC2EjjNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(48) %this, i32 noundef %l, i32 noundef %c, ptr nocapture noundef readonly %msg) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
entry:
  %ret = alloca %"class.std::__cxx11::basic_stringstream", align 8
  %ref.tmp = alloca %"class.std::__cxx11::basic_string", align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV12syntax_error, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !5
  %full_msg = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3
  %0 = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3, i32 2
  store ptr %0, ptr %full_msg, align 8, !tbaa !8
  %_M_string_length.i.i.i = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3, i32 1
  store i64 0, ptr %_M_string_length.i.i.i, align 8, !tbaa !12
  store i8 0, ptr %0, align 8, !tbaa !15
  %l2 = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 1
  store i32 %l, ptr %l2, align 8, !tbaa !16
  %c3 = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 2
...
invoke.cont:                                      ; preds = %entry
  ...
  %call1.i30 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %add.ptr, ptr noundef nonnull @.str, i64 noundef 21)
...
define dso_local noundef ptr @_ZNK12syntax_error4whatEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(48) %this) unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
entry:
  %full_msg = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3
...
; Function Attrs: nounwind uwtable
define dso_local void @_ZN12syntax_errorD2Ev(ptr noundef nonnull align 8 dereferenceable(48) %this) unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV12syntax_error, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !5
  %full_msg = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %full_msg, align 8, !tbaa !20
  %1 = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3, i32 2
...
; Function Attrs: nounwind uwtable
define dso_local void @_ZN12syntax_errorD0Ev(ptr noundef nonnull align 8 dereferenceable(48) %this) unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV12syntax_error, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !5
  %full_msg.i = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %full_msg.i, align 8, !tbaa !20
  %1 = getelementptr inbounds %class.syntax_error, ptr %this, i64 0, i32 3, i32 2
  %cmp.i.i.i.i = icmp eq ptr %0, %1
  br i1 %cmp.i.i.i.i, label %_ZN12syntax_errorD2Ev.exit, label %if.then.i.i.i

if.then.i.i.i:                                    ; preds = %entry
  tail call void @_ZdlPv(ptr noundef %0) #10
  br label %_ZN12syntax_errorD2Ev.exit

_ZN12syntax_errorD2Ev.exit:                       ; preds = %entry, %if.then.i.i.i
  tail call void @_ZNSt9exceptionD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) #10
...
!15 = !{!11, !11, i64 0}
!16 = !{!17, !18, i64 8}
!17 = !{!"_ZTS12syntax_error", !18, i64 8, !18, i64 12, !13, i64 16}
!18 = !{!"int", !11, i64 0}
!19 = !{!17, !18, i64 12}
!20 = !{!13, !10, i64 0}
!21 = !{!22, !10, i64 240}
