; ModuleID = 'CutPool.cpp'
source_filename = "CutPool.cpp"
...
%"class.algorithm::CutPool" = type { i64, i32, i32, i64, i64, ptr, %"class.std::vector" }
%"class.std::vector" = type { %"struct.std::_Vector_base" }
%"struct.std::_Vector_base" = type { %"struct.std::_Vector_base<char *, std::allocator<char *>>::_Vector_impl" }
%"struct.std::_Vector_base<char *, std::allocator<char *>>::_Vector_impl" = type { %"struct.std::_Vector_base<char *, std::allocator<char *>>::_Vector_impl_data" }
%"struct.std::_Vector_base<char *, std::allocator<char *>>::_Vector_impl_data" = type { ptr, ptr, ptr }
%"struct.algorithm::cut_" = type { i32, i16, ptr, [0 x i32] }

$_ZN9algorithm7CutPool5allocEv = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@.str = private unnamed_addr constant [29 x i8] c"this->entriesFree == nullptr\00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c"CutPool.cpp\00", align 1
@__PRETTY_FUNCTION__._ZN9algorithm7CutPool9getMemoryEv = private unnamed_addr constant [48 x i8] c"algorithm::Cut *algorithm::CutPool::getMemory()\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_CutPool.cpp, ptr null }]

@_ZN9algorithm7CutPoolC1Elib = dso_local unnamed_addr alias void (ptr, i64, i32, i1), ptr @_ZN9algorithm7CutPoolC2Elib
@_ZN9algorithm7CutPoolD1Ev = dso_local unnamed_addr alias void (ptr), ptr @_ZN9algorithm7CutPoolD2Ev
...
define dso_local void @_ZN9algorithm7CutPoolC2Elib(ptr nocapture noundef nonnull writeonly align 8 dereferenceable(64) %this, i64 noundef %initialSize, i32 noundef %k, i1 noundef zeroext %compTruth) unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
entry:
  %blocks = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 6
  ...
  %k2 = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 1
...
cond.false.i:                                     ; preds = %if.then
  ...
  %phi.cast = sext i32 %shl.i to i64
...
_ZN12Functional327wordNumEi.exit:                 ; preds = %if.then, %cond.false.i
  %cond.i = phi i64 [ %phi.bo, %cond.false.i ], [ 4, %if.then ]
  %add5 = add nsw i64 %cond.i, %add
  br label %if.end

if.end:                                           ; preds = %_ZN12Functional327wordNumEi.exit, %entry
  %initialEntrySize.0 = phi i64 [ %add5, %_ZN12Functional327wordNumEi.exit ], [ %add, %entry ]
  %rem = and i64 %initialEntrySize.0, 7
  %tobool6.not = icmp eq i64 %rem, 0
  %sub = sub nuw nsw i64 8, %rem
  %spec.select = select i1 %tobool6.not, i64 0, i64 %sub
  %add7 = add nsw i64 %spec.select, %initialEntrySize.0
  %conv8 = trunc i64 %add7 to i32
  %entrySize = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 2
  store i32 %conv8, ptr %entrySize, align 4, !tbaa !14
  %entriesUsed = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 3
...
define dso_local void @_ZN9algorithm7CutPoolD2Ev(ptr nocapture noundef nonnull readonly align 8 dereferenceable(64) %this) unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
entry:
  %blocks = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 6
...
define dso_local noundef ptr @_ZN9algorithm7CutPool9getMemoryEv(ptr noundef nonnull align 8 dereferenceable(64) %this) local_unnamed_addr #6 align 2 {
entry:
  %entriesUsed = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 3
  %0 = load i64, ptr %entriesUsed, align 8, !tbaa !18
  %entriesAlloc = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 4
  %1 = load i64, ptr %entriesAlloc, align 8, !tbaa !19
  %cmp = icmp eq i64 %0, %1
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %entriesFree = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 5
  %2 = load ptr, ptr %entriesFree, align 8, !tbaa !20
  %cmp2 = icmp eq ptr %2, null
  br i1 %cmp2, label %cond.end, label %cond.false

cond.false:                                       ; preds = %if.then
  tail call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 92, ptr noundef nonnull @__PRETTY_FUNCTION__._ZN9algorithm7CutPool9getMemoryEv) #21
  unreachable

cond.end:                                         ; preds = %if.then
  tail call void @_ZN9algorithm7CutPool5allocEv(ptr noundef nonnull align 8 dereferenceable(64) %this)
...
if.end:                                           ; preds = %cond.end, %entry
  ...
  %entriesFree4 = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 5
  ...
  %nextCut = getelementptr inbounds %"struct.algorithm::cut_", ptr %4, i64 0, i32 2
...
define linkonce_odr dso_local void @_ZN9algorithm7CutPool5allocEv(ptr noundef nonnull align 8 dereferenceable(64) %this) local_unnamed_addr #8 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  %entrySize = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 2
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit.unr-lcssa, %for.body.epil, %for.cond.preheader
  ...
  %7 = load ptr, ptr %_M_end_of_storage.i, align 8, !tbaa !27
...
_ZNSt6vectorIPcSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i: ; preds = %if.then.i39.i.i, %_ZNSt6vectorIPcSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit38.i.i
  ...
  store ptr %incdec.ptr.i.i, ptr %_M_finish.i, align 8, !tbaa !26
  %add.ptr19.i.i = getelementptr inbounds ptr, ptr %cond.i.i.i, i64 %spec.select.i.i.i
  store ptr %add.ptr19.i.i, ptr %_M_end_of_storage.i, align 8, !tbaa !27
  br label %_ZNSt6vectorIPcSaIS0_EE9push_backERKS0_.exit
...
define dso_local void @_ZN9algorithm7CutPool14giveBackMemoryEPNS_4cut_E(ptr nocapture noundef nonnull align 8 dereferenceable(64) %this, ptr noundef %cut) local_unnamed_addr #10 align 2 {
entry:
  %entriesUsed = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 3
  %0 = load i64, ptr %entriesUsed, align 8, !tbaa !18
  %dec = add nsw i64 %0, -1
...
define dso_local noundef i32 @_ZN9algorithm7CutPool12getNumBlocksEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(64) %this) local_unnamed_addr #11 align 2 {
entry:
  %blocks = getelementptr inbounds %"class.algorithm::CutPool", ptr %this, i64 0, i32 6
  %_M_finish.i = getelementptr inbounds %"struct.std::_Vector_base<char *, std::allocator<char *>>::_Vector_impl_data", ptr %blocks, i64 0, i32 1
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn uwtable
define dso_local noundef i32 @_ZN9algorithm7CutPool12getBlockSizeEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(64) %this) local_unnamed_addr #11 align 2 {
entry:
...
define internal void @_GLOBAL__sub_I_CutPool.cpp() #18 section ".text.startup" {
entry:
...
!5 = !{!6, !7, i64 0}
!6 = !{!"_ZTSN9algorithm7CutPoolE", !7, i64 0, !10, i64 8, !10, i64 12, !7, i64 16, !7, i64 24, !11, i64 32, !12, i64 40}
!7 = !{!"long", !8, i64 0}
...
!20 = !{!6, !11, i64 32}
!21 = !{!22, !11, i64 8}
!22 = !{!"_ZTSN9algorithm4cut_E", !10, i64 0, !23, i64 4, !11, i64 8, !8, i64 16}
!23 = !{!"short", !8, i64 0}
!24 = distinct !{!24, !25}
