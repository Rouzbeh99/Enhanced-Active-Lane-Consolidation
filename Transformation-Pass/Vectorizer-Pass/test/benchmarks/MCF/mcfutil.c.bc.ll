; ModuleID = '/home/rouzbeh/Graduate/LLVM/spec2017cpu-cmake/build/apps/505.mcf_r/llvm-ir/505.mcf_r_bc/src/mcfutil.c.bc'
...
for.body:                                         ; preds = %entry, %for.body
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %firstout, i8 0, i64 16, i1 false), !dbg !135
...
for.body30:                                       ; preds = %for.body30.lr.ph, %for.inc62
...
if.else54:                                        ; preds = %land.lhs.true, %if.then44
...
for.inc62:                                        ; preds = %for.body30, %if.then50, %if.else54, %land.lhs.true
...
for.inc:                                          ; preds = %sw.bb, %sw.bb5, %for.body
...
cleanup:                                          ; preds = %for.inc, %entry, %DUAL_INFEAS
...
if.end13:                                         ; preds = %if.then11, %if.end9
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %nodes, i8 0, i64 56, i1 false), !dbg !511
  ret i64 0, !dbg !512
}
