...
if.end:                                           ; preds = %if.then, %entry
  ...
  store i32 %14, ptr %pixel_size, align 4, !tbaa !27
  %arrayidx31 = getelementptr inbounds [18 x i8], ptr %targaheader, i64 0, i64 17
  %15 = load i8, ptr %arrayidx31, align 1, !tbaa !26
  %16 = and i8 %15, 32
  %cmp33 = icmp eq i8 %16, 0
...
lor.lhs.false45:                                  ; preds = %if.end
  %17 = and i8 %spec.store.select, 7
  %cmp49 = icmp ne i8 %17, 0
  %cmp52 = icmp ugt i8 %15, 63
...
if.then54:                                        ; preds = %lor.lhs.false45, %if.end
  ...
  %msg_code56 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %18, i64 0, i32 5
...
if.end64:                                         ; preds = %if.end59, %if.then62
  ...
  %20 = getelementptr inbounds %struct._tga_source_struct, ptr %sinfo, i64 0, i32 5
  store ptr %read_non_rle_pixel.sink, ptr %20, align 8
...
sw.bb:                                            ; preds = %if.end64
  %21 = load i32, ptr %pixel_size, align 4, !tbaa !27
  %cmp66 = icmp eq i32 %21, 1
...
if.else71:                                        ; preds = %sw.bb
  ...
  %msg_code73 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %22, i64 0, i32 5
...
if.end76:                                         ; preds = %if.else71, %if.then70
  ...
  %msg_code78 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %24, i64 0, i32 5
  ...
  %msg_parm82 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %25, i64 0, i32 6
  ...
  %27 = load ptr, ptr %emit_message, align 8, !tbaa !32
  tail call void %27(ptr noundef nonnull %cinfo, i32 noundef 1) #5
  br label %sw.epilog135

sw.bb85:                                          ; preds = %if.end64
  %28 = load i32, ptr %pixel_size, align 4, !tbaa !27
...
sw.default:                                       ; preds = %sw.bb85
  ...
  %msg_code94 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %29, i64 0, i32 5
  store i32 1033, ptr %msg_code94, align 8, !tbaa !23
  %30 = load ptr, ptr %29, align 8, !tbaa !25
  tail call void %30(ptr noundef nonnull %cinfo) #5
  br label %sw.epilog

sw.epilog:                                        ; preds = %sw.default, %sw.bb91, %sw.bb89, %sw.bb87
  %31 = load ptr, ptr %cinfo, align 8, !tbaa !22
  %msg_code98 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %31, i64 0, i32 5
  store i32 1035, ptr %msg_code98, align 8, !tbaa !23
  %msg_parm100 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %31, i64 0, i32 6
  store i32 %add22, ptr %msg_parm100, align 4, !tbaa !26
  %32 = load ptr, ptr %cinfo, align 8, !tbaa !22
  %msg_parm103 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %32, i64 0, i32 6
  ...
  %emit_message106 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %33, i64 0, i32 1
  %34 = load ptr, ptr %emit_message106, align 8, !tbaa !32
  tail call void %34(ptr noundef nonnull %cinfo, i32 noundef 1) #5
  br label %sw.epilog135

sw.bb107:                                         ; preds = %if.end64
  store i32 1, ptr %in_color_space, align 4, !tbaa !30
  %35 = load i32, ptr %pixel_size, align 4, !tbaa !27
  %cmp110 = icmp eq i32 %35, 1
...
if.else114:                                       ; preds = %sw.bb107
  ...
  %msg_code116 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %36, i64 0, i32 5
  store i32 1033, ptr %msg_code116, align 8, !tbaa !23
  %37 = load ptr, ptr %36, align 8, !tbaa !25
  tail call void %37(ptr noundef nonnull %cinfo) #5
  br label %if.end119

if.end119:                                        ; preds = %if.else114, %if.then112
  %38 = load ptr, ptr %cinfo, align 8, !tbaa !22
  %msg_code121 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %38, i64 0, i32 5
  store i32 1036, ptr %msg_code121, align 8, !tbaa !23
  %msg_parm123 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %38, i64 0, i32 6
  store i32 %add22, ptr %msg_parm123, align 4, !tbaa !26
  %39 = load ptr, ptr %cinfo, align 8, !tbaa !22
  %msg_parm126 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %39, i64 0, i32 6
  ...
  %emit_message129 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %40, i64 0, i32 1
  %41 = load ptr, ptr %emit_message129, align 8, !tbaa !32
  tail call void %41(ptr noundef nonnull %cinfo, i32 noundef 1) #5
  br label %sw.epilog135

sw.default130:                                    ; preds = %if.end64
  %42 = load ptr, ptr %cinfo, align 8, !tbaa !22
  %msg_code132 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %42, i64 0, i32 5
...
if.then136:                                       ; preds = %sw.epilog135
  %mem = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 1
  %44 = load ptr, ptr %mem, align 8, !tbaa !5
  %request_virt_sarray = getelementptr inbounds %struct.jpeg_memory_mgr, ptr %44, i64 0, i32 4
  %45 = load ptr, ptr %request_virt_sarray, align 8, !tbaa !33
  %mul = mul nuw nsw i32 %components.0, %add22
  %call137 = tail call ptr %45(ptr noundef nonnull %cinfo, i32 noundef 1, i32 noundef 0, i32 noundef %mul, i32 noundef %add28, i32 noundef 1) #5
  ...
  %46 = load ptr, ptr %progress, align 8, !tbaa !35
  %cmp138.not = icmp eq ptr %46, null
  br i1 %cmp138.not, label %if.end143, label %if.then140

if.then140:                                       ; preds = %if.then136
  %total_extra_passes = getelementptr inbounds %struct.cdjpeg_progress_mgr, ptr %46, i64 0, i32 2
  %47 = load i32, ptr %total_extra_passes, align 4, !tbaa !36
...
if.else147:                                       ; preds = %sw.epilog135
  ...
  %48 = load ptr, ptr %mem149, align 8, !tbaa !5
  %alloc_sarray = getelementptr inbounds %struct.jpeg_memory_mgr, ptr %48, i64 0, i32 2
  %49 = load ptr, ptr %alloc_sarray, align 8, !tbaa !40
  %mul150 = mul nuw nsw i32 %components.0, %add22
  %call151 = tail call ptr %49(ptr noundef nonnull %cinfo, i32 noundef 1, i32 noundef %mul150, i32 noundef 1) #5
  ...
  %50 = load ptr, ptr %get_pixel_rows155, align 8, !tbaa !31
  br label %if.end158

if.end158:                                        ; preds = %if.else147, %if.end143
  %.sink = phi ptr [ %50, %if.else147 ], [ @preload_image, %if.end143 ]
  ...
  %tobool159.not300 = icmp eq i8 %4, 0
  br i1 %tobool159.not300, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %read_byte.exit
  %idlen.0301 = phi i32 [ %conv8, %while.body.lr.ph ], [ %dec, %read_byte.exit ]
  %dec = add nsw i32 %idlen.0301, -1
  %51 = load ptr, ptr %input_file, align 8, !tbaa !21
  %call.i = tail call i32 @getc(ptr noundef %51) #5
  %cmp.i = icmp eq i32 %call.i, -1
  br i1 %cmp.i, label %if.then.i, label %read_byte.exit

if.then.i:                                        ; preds = %while.body
  %52 = load ptr, ptr %cinfo.i, align 8, !tbaa !16
  %53 = load ptr, ptr %52, align 8, !tbaa !22
  %msg_code.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %53, i64 0, i32 5
  store i32 42, ptr %msg_code.i, align 8, !tbaa !23
  %54 = load ptr, ptr %53, align 8, !tbaa !25
  tail call void %54(ptr noundef nonnull %52) #5
...
lor.lhs.false166:                                 ; preds = %if.then163
  ...
  %55 = load i8, ptr %arrayidx167, align 1, !tbaa !26
  %conv168 = zext i8 %55 to i32
  %arrayidx169 = getelementptr inbounds [18 x i8], ptr %targaheader, i64 0, i64 4
  %56 = load i8, ptr %arrayidx169, align 4, !tbaa !26
  %conv170 = zext i8 %56 to i32
...
if.then175:                                       ; preds = %lor.lhs.false166, %if.then163
  %57 = load ptr, ptr %cinfo, align 8, !tbaa !22
  %msg_code177 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %57, i64 0, i32 5
  store i32 1032, ptr %msg_code177, align 8, !tbaa !23
  %58 = load ptr, ptr %57, align 8, !tbaa !25
  tail call void %58(ptr noundef nonnull %cinfo) #5
  br label %if.end180
...
if.end180:                                        ; preds = %if.then175, %lor.lhs.false166
  ...
  %59 = load ptr, ptr %mem181, align 8, !tbaa !5
  %alloc_sarray182 = getelementptr inbounds %struct.jpeg_memory_mgr, ptr %59, i64 0, i32 2
  %60 = load ptr, ptr %alloc_sarray182, align 8, !tbaa !40
  %call183 = tail call ptr %60(ptr noundef %cinfo, i32 noundef 1, i32 noundef %add, i32 noundef 3) #5
  ...
  %61 = load i8, ptr %arrayidx184, align 1, !tbaa !26
  %cmp.not.i = icmp eq i8 %61, 24
...
if.then.i299:                                     ; preds = %if.end180
  ...
  %62 = load ptr, ptr %cinfo.i297, align 8, !tbaa !16
  %63 = load ptr, ptr %62, align 8, !tbaa !22
  %msg_code.i298 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %63, i64 0, i32 5
...
for.body.i:                                       ; preds = %read_byte.exit43.i, %for.body.lr.ph.i
  ...
  %65 = load ptr, ptr %input_file, align 8, !tbaa !21
  %call.i.i = tail call i32 @getc(ptr noundef %65) #5
  %cmp.i.i = icmp eq i32 %call.i.i, -1
  br i1 %cmp.i.i, label %if.then.i.i, label %read_byte.exit.i

if.then.i.i:                                      ; preds = %for.body.i
  %66 = load ptr, ptr %cinfo.i.i, align 8, !tbaa !16
  %67 = load ptr, ptr %66, align 8, !tbaa !22
  %msg_code.i.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %67, i64 0, i32 5
  store i32 42, ptr %msg_code.i.i, align 8, !tbaa !23
  %68 = load ptr, ptr %67, align 8, !tbaa !25
  tail call void %68(ptr noundef nonnull %66) #5
  br label %read_byte.exit.i

read_byte.exit.i:                                 ; preds = %if.then.i.i, %for.body.i
  %conv.i = trunc i32 %call.i.i to i8
  %69 = load ptr, ptr %colormap, align 8, !tbaa !45
  %arrayidx.i = getelementptr inbounds ptr, ptr %69, i64 2
  %70 = load ptr, ptr %arrayidx.i, align 8, !tbaa !46
  %arrayidx5.i = getelementptr inbounds i8, ptr %70, i64 %indvars.iv.i
  store i8 %conv.i, ptr %arrayidx5.i, align 1, !tbaa !26
  %71 = load ptr, ptr %input_file, align 8, !tbaa !21
  %call.i31.i = tail call i32 @getc(ptr noundef %71) #5
...
if.then.i35.i:                                    ; preds = %read_byte.exit.i
  %72 = load ptr, ptr %cinfo.i.i, align 8, !tbaa !16
  %73 = load ptr, ptr %72, align 8, !tbaa !22
  %msg_code.i34.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %73, i64 0, i32 5
  store i32 42, ptr %msg_code.i34.i, align 8, !tbaa !23
  %74 = load ptr, ptr %73, align 8, !tbaa !25
  tail call void %74(ptr noundef nonnull %72) #5
  br label %read_byte.exit36.i

read_byte.exit36.i:                               ; preds = %if.then.i35.i, %read_byte.exit.i
  %conv7.i = trunc i32 %call.i31.i to i8
  %75 = load ptr, ptr %colormap, align 8, !tbaa !45
  %arrayidx9.i = getelementptr inbounds ptr, ptr %75, i64 1
  %76 = load ptr, ptr %arrayidx9.i, align 8, !tbaa !46
  %arrayidx11.i = getelementptr inbounds i8, ptr %76, i64 %indvars.iv.i
  store i8 %conv7.i, ptr %arrayidx11.i, align 1, !tbaa !26
  %77 = load ptr, ptr %input_file, align 8, !tbaa !21
  %call.i38.i = tail call i32 @getc(ptr noundef %77) #5
...
if.then.i42.i:                                    ; preds = %read_byte.exit36.i
  %78 = load ptr, ptr %cinfo.i.i, align 8, !tbaa !16
  %79 = load ptr, ptr %78, align 8, !tbaa !22
  %msg_code.i41.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %79, i64 0, i32 5
  store i32 42, ptr %msg_code.i41.i, align 8, !tbaa !23
  %80 = load ptr, ptr %79, align 8, !tbaa !25
  tail call void %80(ptr noundef nonnull %78) #5
  br label %read_byte.exit43.i

read_byte.exit43.i:                               ; preds = %if.then.i42.i, %read_byte.exit36.i
  %conv13.i = trunc i32 %call.i38.i to i8
  %81 = load ptr, ptr %colormap, align 8, !tbaa !45
  %82 = load ptr, ptr %81, align 8, !tbaa !46
  %arrayidx17.i = getelementptr inbounds i8, ptr %82, i64 %indvars.iv.i
...
if.then188:                                       ; preds = %if.else186
  %83 = load ptr, ptr %cinfo, align 8, !tbaa !22
  %msg_code190 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %83, i64 0, i32 5
...
define internal void @finish_input_tga(ptr nocapture noundef %cinfo, ptr nocapture noundef %sinfo) #2 {
entry:
  ret void
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %8 = load i8, ptr %arrayidx4, align 1, !tbaa !26
  %incdec.ptr = getelementptr inbounds i8, ptr %ptr.026, i64 1
  store i8 %8, ptr %ptr.026, align 1, !tbaa !26
  %9 = load ptr, ptr %arrayidx5, align 8, !tbaa !46
  %arrayidx7 = getelementptr inbounds i8, ptr %9, i64 %7
  %10 = load i8, ptr %arrayidx7, align 1, !tbaa !26
  %incdec.ptr8 = getelementptr inbounds i8, ptr %ptr.026, i64 2
  store i8 %10, ptr %incdec.ptr, align 1, !tbaa !26
  %11 = load ptr, ptr %arrayidx9, align 8, !tbaa !46
  %arrayidx11 = getelementptr inbounds i8, ptr %11, i64 %7
  %12 = load i8, ptr %arrayidx11, align 1, !tbaa !26
  %incdec.ptr12 = getelementptr inbounds i8, ptr %ptr.026, i64 3
  store i8 %12, ptr %incdec.ptr8, align 1, !tbaa !26
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %arrayidx5 = getelementptr inbounds [32 x i8], ptr @c5to8bits, i64 0, i64 %6
  %7 = load i8, ptr %arrayidx5, align 1, !tbaa !26
  %arrayidx6 = getelementptr inbounds i8, ptr %ptr.030, i64 2
  store i8 %7, ptr %arrayidx6, align 1, !tbaa !26
  %8 = lshr i32 %add, 5
  %and7 = and i32 %8, 31
  %9 = zext i32 %and7 to i64
  %arrayidx9 = getelementptr inbounds [32 x i8], ptr @c5to8bits, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx9, align 1, !tbaa !26
  %arrayidx10 = getelementptr inbounds i8, ptr %ptr.030, i64 1
  store i8 %10, ptr %arrayidx10, align 1, !tbaa !26
  %11 = lshr i32 %conv4, 2
  %and12 = and i32 %11, 31
  %12 = zext i32 %and12 to i64
  %arrayidx14 = getelementptr inbounds [32 x i8], ptr @c5to8bits, i64 0, i64 %12
  %13 = load i8, ptr %arrayidx14, align 1, !tbaa !26
  store i8 %13, ptr %ptr.030, align 1, !tbaa !26
...
if.then11:                                        ; preds = %for.body, %for.end
  %.lcssa47 = phi i32 [ %.lcssa, %for.end ], [ %14, %for.body ]
...
if.end13:                                         ; preds = %if.then11, %for.end
  %.lcssa48 = phi i32 [ %.lcssa47, %if.then11 ], [ %.lcssa, %for.end ]
