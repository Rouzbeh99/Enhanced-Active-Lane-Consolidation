...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %uglygep, i8 0, i64 32, i1 false), !tbaa !22
...
for.cond14.preheader:                             ; preds = %entry, %for.cond14.preheader
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(256) %coef_bit_ptr.043, i8 -1, i64 256, i1 false), !tbaa !25
...
if.then21:                                        ; preds = %if.end18
  %sub = add nsw i32 %4, -1
  %cmp23.not = icmp eq i32 %.pre, %sub
  %spec.select313 = select i1 %cmp23.not, i32 %bad.1, i32 1
  br label %if.end27

if.end27:                                         ; preds = %if.end18, %if.then21
  %bad.2 = phi i32 [ %spec.select313, %if.then21 ], [ %bad.1, %if.end18 ]
  %Al28 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 71
  %cmp29 = icmp slt i32 %.pre, 14
  %tobool33.not319 = icmp eq i32 %bad.2, 0
  %tobool33.not = select i1 %cmp29, i1 %tobool33.not319, i1 false
  br i1 %tobool33.not, label %if.end50, label %if.then34

if.then34:                                        ; preds = %if.end27
  %5 = load ptr, ptr %cinfo, align 8, !tbaa !33
  ...
  %6 = load i32, ptr %Se37, align 8, !tbaa !29
  %7 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %msg_parm39 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %7, i64 0, i32 6
  %arrayidx40 = getelementptr inbounds [8 x i32], ptr %msg_parm39, i64 0, i64 1
  store i32 %6, ptr %arrayidx40, align 4, !tbaa !36
  %8 = load i32, ptr %Ah, align 4, !tbaa !31
  %9 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %msg_parm43 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %9, i64 0, i32 6
  %arrayidx44 = getelementptr inbounds [8 x i32], ptr %msg_parm43, i64 0, i64 2
  store i32 %8, ptr %arrayidx44, align 4, !tbaa !36
  %10 = load i32, ptr %Al28, align 8, !tbaa !32
  %11 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %msg_parm47 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %11, i64 0, i32 6
  %arrayidx48 = getelementptr inbounds [8 x i32], ptr %msg_parm47, i64 0, i64 3
  store i32 %10, ptr %arrayidx48, align 4, !tbaa !36
  %12 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %13 = load ptr, ptr %12, align 8, !tbaa !37
  tail call void %13(ptr noundef nonnull %cinfo) #6
  br label %if.end50

if.end50:                                         ; preds = %if.then34, %if.end27
  %comps_in_scan51 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 62
  %14 = load i32, ptr %comps_in_scan51, align 8, !tbaa !30
  %cmp52323 = icmp sgt i32 %14, 0
  br i1 %cmp52323, label %for.body.lr.ph, label %for.end105
...
for.body.lr.ph.split.us:                          ; preds = %for.body.lr.ph
  %15 = load i32, ptr %Ss, align 4, !tbaa !28
  %16 = load i32, ptr %Se75, align 8, !tbaa !29
  %17 = icmp sgt i32 %15, %16
  br i1 %17, label %for.end105.thread, label %for.body.us

for.body.us:                                      ; preds = %for.body.lr.ph.split.us, %for.end.us.for.body.us_crit_edge
  %18 = phi i32 [ %36, %for.end.us.for.body.us_crit_edge ], [ %14, %for.body.lr.ph.split.us ]
  %19 = phi i32 [ %37, %for.end.us.for.body.us_crit_edge ], [ %16, %for.body.lr.ph.split.us ]
  %20 = phi i32 [ %.pre346, %for.end.us.for.body.us_crit_edge ], [ %15, %for.body.lr.ph.split.us ]
  %indvars.iv337 = phi i64 [ %indvars.iv.next338, %for.end.us.for.body.us_crit_edge ], [ 0, %for.body.lr.ph.split.us ]
  %arrayidx54.us = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63, i64 %indvars.iv337
  ...
  %cmp76.not320.us = icmp sgt i32 %20, %19
  br i1 %cmp76.not320.us, label %for.end.us, label %for.body78.us.preheader
...
for.body78.us:                                    ; preds = %for.body78.us.preheader, %if.end99.us
  %indvars.iv334 = phi i64 [ %24, %for.body78.us.preheader ], [ %indvars.iv.next335, %if.end99.us ]
  %arrayidx80.us = getelementptr inbounds i32, ptr %arrayidx56.us, i64 %indvars.iv334
  %25 = load i32, ptr %arrayidx80.us, align 4, !tbaa !25
  %26 = tail call i32 @llvm.smax.i32(i32 %25, i32 0)
  %27 = load i32, ptr %Ah, align 4, !tbaa !31
  %cmp86.not.us = icmp eq i32 %27, %26
...
if.then88.us:                                     ; preds = %for.body78.us
  ...
  %msg_parm95.us = getelementptr inbounds %struct.jpeg_error_mgr, ptr %29, i64 0, i32 6
  %arrayidx96.us = getelementptr inbounds [8 x i32], ptr %msg_parm95.us, i64 0, i64 1
  %30 = trunc i64 %indvars.iv334 to i32
...
if.end99.us:                                      ; preds = %if.then88.us, %for.body78.us
  ...
  %cmp76.not.us.not = icmp slt i64 %indvars.iv334, %35
  br i1 %cmp76.not.us.not, label %for.body78.us, label %for.end.us.loopexit, !llvm.loop !41

for.end.us.loopexit:                              ; preds = %if.end99.us
  %.pre347 = load i32, ptr %comps_in_scan51, align 8, !tbaa !30
  br label %for.end.us

for.end.us:                                       ; preds = %for.end.us.loopexit, %for.body.us
  %36 = phi i32 [ %.pre347, %for.end.us.loopexit ], [ %18, %for.body.us ]
  %37 = phi i32 [ %34, %for.end.us.loopexit ], [ %19, %for.body.us ]
  %indvars.iv.next338 = add nuw nsw i64 %indvars.iv337, 1
  %38 = sext i32 %36 to i64
  %cmp52.us = icmp slt i64 %indvars.iv.next338, %38
  br i1 %cmp52.us, label %for.end.us.for.body.us_crit_edge, label %for.end105, !llvm.loop !42

for.end.us.for.body.us_crit_edge:                 ; preds = %for.end.us
  %.pre346 = load i32, ptr %Ss, align 4, !tbaa !28
  br label %for.body.us

for.body:                                         ; preds = %for.body.lr.ph, %for.end
  %indvars.iv331 = phi i64 [ %indvars.iv.next332, %for.end ], [ 0, %for.body.lr.ph ]
  %arrayidx54 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63, i64 %indvars.iv331
...
if.then62:                                        ; preds = %for.body
  ...
  %msg_parm69 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %44, i64 0, i32 6
...
if.end72:                                         ; preds = %if.then62, %for.body
  ...
  %cmp76.not320 = icmp sgt i32 %47, %48
  br i1 %cmp76.not320, label %for.end, label %for.body78.preheader
...
for.body78:                                       ; preds = %for.body78.preheader, %if.end99
  ...
  %52 = load i32, ptr %Ah, align 4, !tbaa !31
  %cmp86.not = icmp eq i32 %52, %51
  br i1 %cmp86.not, label %if.end99, label %if.then88

if.then88:                                        ; preds = %for.body78
  %53 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %msg_code90 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %53, i64 0, i32 5
  store i32 111, ptr %msg_code90, align 8, !tbaa !34
  %msg_parm92 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %53, i64 0, i32 6
  store i32 %40, ptr %msg_parm92, align 4, !tbaa !36
  %54 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %msg_parm95 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %54, i64 0, i32 6
  %arrayidx96 = getelementptr inbounds [8 x i32], ptr %msg_parm95, i64 0, i64 1
  %55 = trunc i64 %indvars.iv to i32
  store i32 %55, ptr %arrayidx96, align 4, !tbaa !36
  %56 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %emit_message98 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %56, i64 0, i32 1
  %57 = load ptr, ptr %emit_message98, align 8, !tbaa !40
  tail call void %57(ptr noundef nonnull %cinfo, i32 noundef -1) #6
  br label %if.end99

if.end99:                                         ; preds = %if.then88, %for.body78
  %58 = load i32, ptr %Al28, align 8, !tbaa !32
  store i32 %58, ptr %arrayidx80, align 4, !tbaa !25
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %59 = load i32, ptr %Se75, align 8, !tbaa !29
  %60 = sext i32 %59 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv, %60
  br i1 %cmp76.not.not, label %for.body78, label %for.end, !llvm.loop !41

for.end:                                          ; preds = %if.end99, %if.end72
  %indvars.iv.next332 = add nuw nsw i64 %indvars.iv331, 1
  %61 = load i32, ptr %comps_in_scan51, align 8, !tbaa !30
  %62 = sext i32 %61 to i64
  %cmp52 = icmp slt i64 %indvars.iv.next332, %62
  br i1 %cmp52, label %for.body, label %for.end105, !llvm.loop !44

for.end105:                                       ; preds = %for.end, %for.end.us, %if.end50
  %63 = phi i32 [ %14, %if.end50 ], [ %36, %for.end.us ], [ %61, %for.end ]
  %64 = load i32, ptr %Ah, align 4, !tbaa !31
  %cmp107 = icmp eq i32 %64, 0
  br i1 %cmp107, label %if.then109, label %if.else116

for.end105.thread:                                ; preds = %for.body.lr.ph.split.us
  %65 = load i32, ptr %Ah, align 4, !tbaa !31
  %cmp107349 = icmp eq i32 %65, 0
  br i1 %cmp107349, label %if.end125, label %if.then118
...
if.then118:                                       ; preds = %for.end105.thread, %if.else116
  %66 = phi i32 [ %63, %if.else116 ], [ %14, %for.end105.thread ]
  %67 = phi i32 [ %64, %if.else116 ], [ %65, %for.end105.thread ]
  br label %if.end125
...
if.end125:                                        ; preds = %if.then109, %if.else116, %for.end105.thread, %if.then118
  ...
  %68 = phi i32 [ %67, %if.then118 ], [ 0, %for.end105.thread ], [ %64, %if.else116 ], [ 0, %if.then109 ]
  %69 = phi i32 [ %66, %if.then118 ], [ %14, %for.end105.thread ], [ %63, %if.else116 ], [ %63, %if.then109 ]
  ...
  %cmp128325 = icmp sgt i32 %69, 0
  br i1 %cmp128325, label %for.body130.lr.ph, label %for.end199
...
for.body130.us:                                   ; preds = %for.body130.lr.ph, %if.end194.us.for.body130.us_crit_edge
  %70 = phi i32 [ %.pre348, %if.end194.us.for.body130.us_crit_edge ], [ %68, %for.body130.lr.ph ]
  %indvars.iv343 = phi i64 [ %indvars.iv.next344, %if.end194.us.for.body130.us_crit_edge ], [ 0, %for.body130.lr.ph ]
  %cmp137.us = icmp eq i32 %70, 0
  br i1 %cmp137.us, label %if.then139.us, label %if.end194.us

if.then139.us:                                    ; preds = %for.body130.us
  %arrayidx133.us = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63, i64 %indvars.iv343
  %71 = load ptr, ptr %arrayidx133.us, align 8, !tbaa !22
  %dc_tbl_no.us = getelementptr inbounds %struct.jpeg_component_info, ptr %71, i64 0, i32 5
  %72 = load i32, ptr %dc_tbl_no.us, align 4, !tbaa !46
  %73 = icmp ugt i32 %72, 3
  br i1 %73, label %if.then150.us, label %lor.lhs.false145.us

lor.lhs.false145.us:                              ; preds = %if.then139.us
  %idxprom146317.us = zext i32 %72 to i64
  %arrayidx147.us = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 40, i64 %idxprom146317.us
  %74 = load ptr, ptr %arrayidx147.us, align 8, !tbaa !22
  %cmp148.us = icmp eq ptr %74, null
  br i1 %cmp148.us, label %if.then150.us, label %if.end158.us

if.then150.us:                                    ; preds = %lor.lhs.false145.us, %if.then139.us
  %75 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %msg_code152.us = getelementptr inbounds %struct.jpeg_error_mgr, ptr %75, i64 0, i32 5
  store i32 49, ptr %msg_code152.us, align 8, !tbaa !34
  %msg_parm154.us = getelementptr inbounds %struct.jpeg_error_mgr, ptr %75, i64 0, i32 6
  store i32 %72, ptr %msg_parm154.us, align 4, !tbaa !36
  %76 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %77 = load ptr, ptr %76, align 8, !tbaa !37
  tail call void %77(ptr noundef nonnull %cinfo) #6
  br label %if.end158.us

if.end158.us:                                     ; preds = %if.then150.us, %lor.lhs.false145.us
  %idxprom160.us = sext i32 %72 to i64
  %arrayidx161.us = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 40, i64 %idxprom160.us
  %78 = load ptr, ptr %arrayidx161.us, align 8, !tbaa !22
  %arrayidx163.us = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 4, i64 %idxprom160.us
  tail call void @jpeg_make_d_derived_tbl(ptr noundef nonnull %cinfo, ptr noundef %78, ptr noundef nonnull %arrayidx163.us) #6
  br label %if.end194.us

if.end194.us:                                     ; preds = %if.end158.us, %for.body130.us
  %arrayidx196.us = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 2, i32 1, i64 %indvars.iv343
  store i32 0, ptr %arrayidx196.us, align 4, !tbaa !25
  %indvars.iv.next344 = add nuw nsw i64 %indvars.iv343, 1
  %79 = load i32, ptr %comps_in_scan51, align 8, !tbaa !30
  %80 = sext i32 %79 to i64
  %cmp128.us = icmp slt i64 %indvars.iv.next344, %80
  br i1 %cmp128.us, label %if.end194.us.for.body130.us_crit_edge, label %for.end199, !llvm.loop !47

if.end194.us.for.body130.us_crit_edge:            ; preds = %if.end194.us
  %.pre348 = load i32, ptr %Ah, align 4, !tbaa !31
  br label %for.body130.us

for.body130:                                      ; preds = %for.body130.lr.ph, %if.end184
  %indvars.iv340 = phi i64 [ %indvars.iv.next341, %if.end184 ], [ 0, %for.body130.lr.ph ]
  %arrayidx133 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63, i64 %indvars.iv340
  %81 = load ptr, ptr %arrayidx133, align 8, !tbaa !22
  %ac_tbl_no = getelementptr inbounds %struct.jpeg_component_info, ptr %81, i64 0, i32 6
  %82 = load i32, ptr %ac_tbl_no, align 8, !tbaa !48
  %83 = icmp ugt i32 %82, 3
  br i1 %83, label %if.then176, label %lor.lhs.false171

lor.lhs.false171:                                 ; preds = %for.body130
  %idxprom172318 = zext i32 %82 to i64
  %arrayidx173 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 41, i64 %idxprom172318
  %84 = load ptr, ptr %arrayidx173, align 8, !tbaa !22
  %cmp174 = icmp eq ptr %84, null
  br i1 %cmp174, label %if.then176, label %if.end184

if.then176:                                       ; preds = %lor.lhs.false171, %for.body130
  %85 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %msg_code178 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %85, i64 0, i32 5
  store i32 49, ptr %msg_code178, align 8, !tbaa !34
  %msg_parm180 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %85, i64 0, i32 6
  store i32 %82, ptr %msg_parm180, align 4, !tbaa !36
  %86 = load ptr, ptr %cinfo, align 8, !tbaa !33
  %87 = load ptr, ptr %86, align 8, !tbaa !37
  tail call void %87(ptr noundef nonnull %cinfo) #6
  br label %if.end184
...
if.end184:                                        ; preds = %if.then176, %lor.lhs.false171
  ...
  %88 = load ptr, ptr %arrayidx187, align 8, !tbaa !22
  %arrayidx190 = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 4, i64 %idxprom186
  tail call void @jpeg_make_d_derived_tbl(ptr noundef nonnull %cinfo, ptr noundef %88, ptr noundef nonnull %arrayidx190) #6
  %89 = load ptr, ptr %arrayidx190, align 8, !tbaa !22
  store ptr %89, ptr %ac_derived_tbl, align 8, !tbaa !49
  %arrayidx196 = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 2, i32 1, i64 %indvars.iv340
  store i32 0, ptr %arrayidx196, align 4, !tbaa !25
  %indvars.iv.next341 = add nuw nsw i64 %indvars.iv340, 1
  %90 = load i32, ptr %comps_in_scan51, align 8, !tbaa !30
  %91 = sext i32 %90 to i64
  %cmp128 = icmp slt i64 %indvars.iv.next341, %91
...
for.end199:                                       ; preds = %if.end184, %if.end194.us, %if.end125
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %bitstate, i8 0, i64 20, i1 false)
  %92 = load i32, ptr %restart_interval, align 8, !tbaa !50
  %restarts_to_go = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 3
  store i32 %92, ptr %restarts_to_go, align 4, !tbaa !51
  ret void
}
...
if.end7:                                          ; preds = %process_restart.exit, %if.then, %entry
  ...
  %cmp17185 = icmp sgt i32 %18, 0
  br i1 %cmp17185, label %for.body.lr.ph, label %for.end
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end78
  ...
  %bits_left.0187 = phi i32 [ %17, %for.body.lr.ph ], [ %bits_left.6, %if.end78 ]
  %get_buffer.0186 = phi i64 [ %16, %for.body.lr.ph ], [ %get_buffer.6, %if.end78 ]
  ...
  %cmp24 = icmp slt i32 %bits_left.0187, 8
  br i1 %cmp24, label %if.then25, label %if.end35

if.then25:                                        ; preds = %for.body
  %call26 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.0186, i32 noundef %bits_left.0187, i32 noundef 0) #6
...
if.end35:                                         ; preds = %if.end29, %for.body
  %get_buffer.1 = phi i64 [ %24, %if.end29 ], [ %get_buffer.0186, %for.body ]
  %bits_left.1 = phi i32 [ %25, %if.end29 ], [ %bits_left.0187, %for.body ]
...
if.end65:                                         ; preds = %if.end62, %if.then55
  ...
  %idxprom72182 = zext i32 %s.2.ph to i64
  %arrayidx73 = getelementptr inbounds [16 x i32], ptr @extend_test, i64 0, i64 %idxprom72182
...
cond.true:                                        ; preds = %if.end65
  %arrayidx77 = getelementptr inbounds [16 x i32], ptr @extend_offset, i64 0, i64 %idxprom72182
...
for.end.loopexit:                                 ; preds = %if.end78
  ...
  %.pre191 = load ptr, ptr %src, align 8, !tbaa !62
  %.pre192 = load i64, ptr %bytes_in_buffer11, align 8, !tbaa !67
  %.pre193 = load i32, ptr %unread_marker12, align 8, !tbaa !69
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %if.end7
  %37 = phi i32 [ %15, %if.end7 ], [ %.pre193, %for.end.loopexit ]
  %38 = phi i64 [ %14, %if.end7 ], [ %.pre192, %for.end.loopexit ]
  %39 = phi ptr [ %12, %if.end7 ], [ %.pre191, %for.end.loopexit ]
...
if.else:                                          ; preds = %if.end8
  ...
  %cmp21.not235 = icmp sgt i32 %22, %1
  br i1 %cmp21.not235, label %for.end, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %bits_left.0238 = phi i32 [ %19, %for.body.lr.ph ], [ %bits_left.8, %for.inc ]
  %get_buffer.0237 = phi i64 [ %18, %for.body.lr.ph ], [ %get_buffer.8, %for.inc ]
  %k.0236 = phi i32 [ %22, %for.body.lr.ph ], [ %inc, %for.inc ]
  %cmp22 = icmp slt i32 %bits_left.0238, 8
  br i1 %cmp22, label %if.then23, label %if.end33

if.then23:                                        ; preds = %for.body
  %call24 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.0237, i32 noundef %bits_left.0238, i32 noundef 0) #6
...
if.end33:                                         ; preds = %if.end27, %for.body
  %get_buffer.1 = phi i64 [ %23, %if.end27 ], [ %get_buffer.0237, %for.body ]
  %bits_left.1 = phi i32 [ %24, %if.end27 ], [ %bits_left.0238, %for.body ]
  %sub = add nsw i32 %bits_left.1, -8
  %sh_prom = zext i32 %sub to i64
  %shr = ashr i64 %get_buffer.1, %sh_prom
  %and = and i64 %shr, 255
...
if.else85:                                        ; preds = %cleanup.cont
  %cmp86 = icmp eq i32 %shr52230, 15
  br i1 %cmp86, label %if.then88, label %if.else90

if.then88:                                        ; preds = %if.else85
  %add89 = add nsw i32 %k.0236, 15
  br label %for.inc

if.else90:                                        ; preds = %if.else85
  %shl91 = shl nuw i32 1, %shr52230
  %tobool92.not = icmp ult i32 %s.2.ph, 16
  br i1 %tobool92.not, label %if.end112, label %if.then93

if.then93:                                        ; preds = %if.else90
  %cmp94 = icmp slt i32 %bits_left.4.ph, %shr52230
  br i1 %cmp94, label %if.then96, label %if.end103

if.then96:                                        ; preds = %if.then93
  %call97 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.4.ph, i32 noundef %bits_left.4.ph, i32 noundef %shr52230) #6
...
if.end103:                                        ; preds = %if.end100, %if.then93
  ...
  %sub104 = sub nsw i32 %bits_left.6, %shr52230
...
if.end9:                                          ; preds = %process_restart.exit, %if.then, %entry
  ...
  %cmp22.not413 = icmp sgt i32 %22, %1
  %or.cond = select i1 %cmp20, i1 true, i1 %cmp22.not413
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %num_newnz.0418 = phi i32 [ 0, %for.body.lr.ph ], [ %num_newnz.1, %for.inc ]
  %k.0416 = phi i32 [ %22, %for.body.lr.ph ], [ %inc168, %for.inc ]
  %bits_left.0415 = phi i32 [ %18, %for.body.lr.ph ], [ %bits_left.11, %for.inc ]
  %get_buffer.0414 = phi i64 [ %17, %for.body.lr.ph ], [ %get_buffer.11, %for.inc ]
  %cmp23 = icmp slt i32 %bits_left.0415, 8
  br i1 %cmp23, label %if.then24, label %if.end34

if.then24:                                        ; preds = %for.body
  %call25 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.0414, i32 noundef %bits_left.0415, i32 noundef 0) #6
...
if.end34:                                         ; preds = %if.end28, %for.body
  %get_buffer.1 = phi i64 [ %24, %if.end28 ], [ %get_buffer.0414, %for.body ]
  %bits_left.1 = phi i32 [ %25, %if.end28 ], [ %bits_left.0415, %for.body ]
  %sub = add nsw i32 %bits_left.1, -8
  %sh_prom = zext i32 %sub to i64
  %shr = ashr i64 %get_buffer.1, %sh_prom
  %and = and i64 %shr, 255
...
if.else80:                                        ; preds = %cleanup.cont
  %cmp81.not = icmp eq i32 %shr52391, 15
  br i1 %cmp81.not, label %if.end106, label %if.then83

if.then83:                                        ; preds = %if.else80
  %shl84 = shl nuw i32 1, %shr52391
  %tobool85.not = icmp ult i32 %s.2.ph, 16
  br i1 %tobool85.not, label %for.cond173.preheader, label %if.then86

if.then86:                                        ; preds = %if.then83
  %cmp87 = icmp slt i32 %bits_left.4.ph, %shr52391
  br i1 %cmp87, label %if.then89, label %if.end96

if.then89:                                        ; preds = %if.then86
  %call90 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.4.ph, i32 noundef %bits_left.4.ph, i32 noundef %shr52391) #6
...
if.end96:                                         ; preds = %if.end93, %if.then86
  ...
  %sub97 = sub nsw i32 %bits_left.6, %shr52391
...
if.end106:                                        ; preds = %if.end70, %if.else80
  ...
  %38 = sext i32 %k.0416 to i64
  %smax = call i32 @llvm.smax.i32(i32 %k.0416, i32 %1)
  %39 = add i32 %smax, 1
  br label %do.body

do.body:                                          ; preds = %if.end154, %if.end106
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end154 ], [ %38, %if.end106 ]
  %r.0 = phi i32 [ %r.1, %if.end154 ], [ %shr52391, %if.end106 ]
...
if.then134:                                       ; preds = %if.then129
  %cmp136494 = icmp slt i16 %46, 0
  %..v = select i1 %cmp136494, i32 %shl4, i32 %shl
  %. = trunc i32 %..v to i16
  %conv141 = add i16 %46, %.
...
if.then158:                                       ; preds = %do.end
  ...
  %inc164 = add nsw i32 %num_newnz.0418, 1
  %idxprom165 = sext i32 %num_newnz.0418 to i64
...
for.inc:                                          ; preds = %do.end, %if.then158
  %num_newnz.1 = phi i32 [ %inc164, %if.then158 ], [ %num_newnz.0418, %do.end ]
...
if.end169:                                        ; preds = %if.end96, %if.end9
  ...
  %k.3 = phi i32 [ %k.0416, %if.end96 ], [ %22, %if.end9 ]
  %num_newnz.2 = phi i32 [ %num_newnz.0418, %if.end96 ], [ 0, %if.end9 ]
...
for.cond173.preheader:                            ; preds = %if.then83, %if.end169
  %num_newnz.2471 = phi i32 [ %num_newnz.2, %if.end169 ], [ %num_newnz.0418, %if.then83 ]
  %k.3470 = phi i32 [ %k.3, %if.end169 ], [ %k.0416, %if.then83 ]
  %bits_left.12469 = phi i32 [ %bits_left.12, %if.end169 ], [ %bits_left.4.ph, %if.then83 ]
  %get_buffer.12468 = phi i64 [ %get_buffer.12, %if.end169 ], [ %get_buffer.4.ph, %if.then83 ]
  %EOBRUN.0467 = phi i32 [ %EOBRUN.0, %if.end169 ], [ %shl84, %if.then83 ]
  %cmp174.not423 = icmp sgt i32 %k.3470, %1
  br i1 %cmp174.not423, label %for.end225, label %for.body176.lr.ph
...
for.body176.lr.ph:                                ; preds = %for.cond173.preheader
  ...
  %49 = sext i32 %k.3470 to i64
  %50 = add i32 %1, 1
  br label %for.body176

for.body176:                                      ; preds = %for.body176.lr.ph, %for.inc223
  %indvars.iv448 = phi i64 [ %49, %for.body176.lr.ph ], [ %indvars.iv.next449, %for.inc223 ]
  %bits_left.13425 = phi i32 [ %bits_left.12469, %for.body176.lr.ph ], [ %bits_left.15, %for.inc223 ]
  %get_buffer.13424 = phi i64 [ %get_buffer.12468, %for.body176.lr.ph ], [ %get_buffer.15, %for.inc223 ]
  %arrayidx179 = getelementptr inbounds [0 x i32], ptr @jpeg_natural_order, i64 0, i64 %indvars.iv448
...
if.then185:                                       ; preds = %for.body176
  %cmp186 = icmp slt i32 %bits_left.13425, 1
  br i1 %cmp186, label %if.then188, label %if.end195

if.then188:                                       ; preds = %if.then185
  %call189 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.13424, i32 noundef %bits_left.13425, i32 noundef 1) #6
...
if.end195:                                        ; preds = %if.end192, %if.then185
  %get_buffer.14 = phi i64 [ %53, %if.end192 ], [ %get_buffer.13424, %if.then185 ]
  %bits_left.14 = phi i32 [ %54, %if.end192 ], [ %bits_left.13425, %if.then185 ]
...
if.then207:                                       ; preds = %if.then202
  %cmp209495 = icmp slt i16 %57, 0
  %.493.v = select i1 %cmp209495, i32 %shl4, i32 %shl
  %.493 = trunc i32 %.493.v to i16
  %conv218 = add i16 %57, %.493
  store i16 %conv218, ptr %add.ptr181, align 2, !tbaa !76
  br label %for.inc223

for.inc223:                                       ; preds = %if.then207, %for.body176, %if.then202, %if.end195
  %get_buffer.15 = phi i64 [ %get_buffer.14, %if.then202 ], [ %get_buffer.14, %if.end195 ], [ %get_buffer.13424, %for.body176 ], [ %get_buffer.14, %if.then207 ]
  %bits_left.15 = phi i32 [ %sub196, %if.then202 ], [ %sub196, %if.end195 ], [ %bits_left.13425, %for.body176 ], [ %sub196, %if.then207 ]
...
for.end225:                                       ; preds = %for.inc223, %for.cond173.preheader
  %get_buffer.13.lcssa = phi i64 [ %get_buffer.12468, %for.cond173.preheader ], [ %get_buffer.15, %for.inc223 ]
  %bits_left.13.lcssa = phi i32 [ %bits_left.12469, %for.cond173.preheader ], [ %bits_left.15, %for.inc223 ]
  %dec226 = add i32 %EOBRUN.0467, -1
  br label %if.end227
...
undoit:                                           ; preds = %if.then24, %label3, %if.then63, %if.then115, %if.then188, %if.then89
  %num_newnz.3 = phi i32 [ %num_newnz.0418, %if.then89 ], [ %num_newnz.2471, %if.then188 ], [ %num_newnz.0418, %if.then115 ], [ %num_newnz.0418, %if.then63 ], [ %num_newnz.0418, %label3 ], [ %num_newnz.0418, %if.then24 ]
  %cmp244429 = icmp sgt i32 %num_newnz.3, 0
  br i1 %cmp244429, label %while.body.preheader, label %cleanup251
...
while.body.prol:                                  ; preds = %while.body.preheader, %while.body.prol
  %indvars.iv451.prol = phi i64 [ %indvars.iv.next452.prol, %while.body.prol ], [ %63, %while.body.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %while.body.prol ], [ 0, %while.body.preheader ]
  %indvars.iv.next452.prol = add nsw i64 %indvars.iv451.prol, -1
  %65 = and i64 %indvars.iv.next452.prol, 4294967295
  %arrayidx248.prol = getelementptr inbounds [64 x i32], ptr %newnz_pos, i64 0, i64 %65
  %66 = load i32, ptr %arrayidx248.prol, align 4, !tbaa !25
  %idxprom249.prol = sext i32 %66 to i64
...
while.body.prol.loopexit:                         ; preds = %while.body.prol, %while.body.preheader
  %indvars.iv451.unr = phi i64 [ %63, %while.body.preheader ], [ %indvars.iv.next452.prol, %while.body.prol ]
  %67 = icmp ult i64 %64, 3
  br i1 %67, label %cleanup251, label %while.body

while.body:                                       ; preds = %while.body.prol.loopexit, %while.body
  %indvars.iv451 = phi i64 [ %indvars.iv.next452.3, %while.body ], [ %indvars.iv451.unr, %while.body.prol.loopexit ]
  %indvars.iv.next452 = add i64 %indvars.iv451, 4294967295
  %68 = and i64 %indvars.iv.next452, 4294967295
  %arrayidx248 = getelementptr inbounds [64 x i32], ptr %newnz_pos, i64 0, i64 %68
  %69 = load i32, ptr %arrayidx248, align 4, !tbaa !25
  ...
  %indvars.iv.next452.1 = add i64 %indvars.iv451, 4294967294
  %70 = and i64 %indvars.iv.next452.1, 4294967295
  %arrayidx248.1 = getelementptr inbounds [64 x i32], ptr %newnz_pos, i64 0, i64 %70
  %71 = load i32, ptr %arrayidx248.1, align 4, !tbaa !25
  %idxprom249.1 = sext i32 %71 to i64
  %arrayidx250.1 = getelementptr inbounds [64 x i16], ptr %20, i64 0, i64 %idxprom249.1
  store i16 0, ptr %arrayidx250.1, align 2, !tbaa !76
  %indvars.iv.next452.2 = add nsw i64 %indvars.iv451, -3
  %72 = and i64 %indvars.iv.next452.2, 4294967295
  %arrayidx248.2 = getelementptr inbounds [64 x i32], ptr %newnz_pos, i64 0, i64 %72
  %73 = load i32, ptr %arrayidx248.2, align 4, !tbaa !25
  %idxprom249.2 = sext i32 %73 to i64
  %arrayidx250.2 = getelementptr inbounds [64 x i16], ptr %20, i64 0, i64 %idxprom249.2
  store i16 0, ptr %arrayidx250.2, align 2, !tbaa !76
  %indvars.iv.next452.3 = add nsw i64 %indvars.iv451, -4
  %74 = and i64 %indvars.iv.next452.3, 4294967295
  %arrayidx248.3 = getelementptr inbounds [64 x i32], ptr %newnz_pos, i64 0, i64 %74
  %75 = load i32, ptr %arrayidx248.3, align 4, !tbaa !25
  %idxprom249.3 = sext i32 %75 to i64
  %arrayidx250.3 = getelementptr inbounds [64 x i16], ptr %20, i64 0, i64 %idxprom249.3
  store i16 0, ptr %arrayidx250.3, align 2, !tbaa !76
  %cmp244.3 = icmp ugt i64 %indvars.iv.next452.2, 1
