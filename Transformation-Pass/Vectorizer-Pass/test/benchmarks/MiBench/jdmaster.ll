...
if.end53.sink.split:                              ; preds = %if.else, %if.end
  %.sink240.ph = phi i64 [ 8, %if.end ], [ 4, %if.else ]
...
if.end53:                                         ; preds = %if.end53.sink.split, %if.else27
  %.sink241 = phi i32 [ %6, %if.else27 ], [ %7, %if.end53.sink.split ]
  %.sink240 = phi i64 [ 2, %if.else27 ], [ %.sink240.ph, %if.end53.sink.split ]
  %.sink = phi i32 [ 4, %if.else27 ], [ %.sink.ph, %if.end53.sink.split ]
  %conv17 = zext i32 %.sink241 to i64
  %call18 = tail call i64 @jdiv_round_up(i64 noundef %conv17, i64 noundef %.sink240) #4
  ...
  %call23 = tail call i64 @jdiv_round_up(i64 noundef %conv22, i64 noundef %.sink240) #4
  ...
  %cmp54204 = icmp sgt i32 %10, 0
  br i1 %cmp54204, label %for.body.lr.ph.split.us, label %for.end105
...
if.end53.thread:                                  ; preds = %if.else27
  ...
  %comp_info214 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 43
  %12 = load ptr, ptr %comp_info214, align 8, !tbaa !26
  %num_components215 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 8
  %13 = load i32, ptr %num_components215, align 8, !tbaa !27
  %cmp54204216 = icmp sgt i32 %13, 0
  br i1 %cmp54204216, label %for.body.preheader, label %for.end105

for.body.preheader:                               ; preds = %if.end53.thread
  %14 = add i32 %13, -1
  %xtraiter = and i32 %13, 7
  %15 = icmp ult i32 %14, 7
  br i1 %15, label %for.cond73.preheader.loopexit.unr-lcssa, label %for.body.preheader.new
...
for.body.lr.ph.split.us:                          ; preds = %if.end53
  ...
  %16 = load i32, ptr %max_h_samp_factor, align 4, !tbaa !28
  %mul62.us = mul nsw i32 %16, %.sink
  br label %for.body.us

for.body.us:                                      ; preds = %while.end.us, %for.body.lr.ph.split.us
  %compptr.0206.us = phi ptr [ %9, %for.body.lr.ph.split.us ], [ %incdec.ptr.us, %while.end.us ]
  %ci.0205.us = phi i32 [ 0, %for.body.lr.ph.split.us ], [ %inc.us, %while.end.us ]
  %h_samp_factor.us = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206.us, i64 0, i32 2
  %v_samp_factor.us = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206.us, i64 0, i32 3
  %17 = load i32, ptr %h_samp_factor.us, align 8, !tbaa !29
  br label %land.lhs.true.us

land.lhs.true.us:                                 ; preds = %for.body.us, %while.body.us
  %ssize.0201.us = phi i32 [ %.sink, %for.body.us ], [ %mul59.us, %while.body.us ]
  %mul59.us = shl i32 %ssize.0201.us, 1
  %mul60.us = mul i32 %mul59.us, %17
...
land.rhs.us:                                      ; preds = %land.lhs.true.us
  %18 = load i32, ptr %v_samp_factor.us, align 4, !tbaa !31
  %mul66.us = mul i32 %mul59.us, %18
  %19 = load i32, ptr %max_v_samp_factor, align 8, !tbaa !32
  %mul68.us = mul nsw i32 %19, %.sink
...
while.body.us:                                    ; preds = %land.rhs.us
  %cmp57.us = icmp slt i32 %ssize.0201.us, 4
  br i1 %cmp57.us, label %land.lhs.true.us, label %while.end.us, !llvm.loop !33

while.end.us:                                     ; preds = %land.rhs.us, %land.lhs.true.us, %while.body.us
  %ssize.0.lcssa.us = phi i32 [ %mul59.us, %while.body.us ], [ %ssize.0201.us, %land.lhs.true.us ], [ %ssize.0201.us, %land.rhs.us ]
  %DCT_scaled_size.us = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206.us, i64 0, i32 9
  store i32 %ssize.0.lcssa.us, ptr %DCT_scaled_size.us, align 4, !tbaa !35
  %inc.us = add nuw nsw i32 %ci.0205.us, 1
  %incdec.ptr.us = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206.us, i64 1
  %exitcond212.not = icmp eq i32 %inc.us, %10
  br i1 %exitcond212.not, label %for.cond73.preheader, label %for.body.us, !llvm.loop !36

for.cond73.preheader.loopexit.unr-lcssa:          ; preds = %for.body, %for.body.preheader
  %compptr.0206.unr = phi ptr [ %12, %for.body.preheader ], [ %incdec.ptr.7, %for.body ]
...
for.body.epil:                                    ; preds = %for.cond73.preheader.loopexit.unr-lcssa, %for.body.epil
  %compptr.0206.epil = phi ptr [ %incdec.ptr.epil, %for.body.epil ], [ %compptr.0206.unr, %for.cond73.preheader.loopexit.unr-lcssa ]
  %epil.iter = phi i32 [ %epil.iter.next, %for.body.epil ], [ 0, %for.cond73.preheader.loopexit.unr-lcssa ]
  %DCT_scaled_size.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206.epil, i64 0, i32 9
  store i32 8, ptr %DCT_scaled_size.epil, align 4, !tbaa !35
  %incdec.ptr.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206.epil, i64 1
...
for.cond73.preheader:                             ; preds = %while.end.us, %for.cond73.preheader.loopexit.unr-lcssa, %for.body.epil
  %cmp54204222 = phi i1 [ %cmp54204216, %for.body.epil ], [ %cmp54204216, %for.cond73.preheader.loopexit.unr-lcssa ], [ true, %while.end.us ]
  %20 = phi i32 [ %13, %for.body.epil ], [ %13, %for.cond73.preheader.loopexit.unr-lcssa ], [ %10, %while.end.us ]
  %num_components220 = phi ptr [ %num_components215, %for.body.epil ], [ %num_components215, %for.cond73.preheader.loopexit.unr-lcssa ], [ %num_components, %while.end.us ]
  %21 = phi ptr [ %12, %for.body.epil ], [ %12, %for.cond73.preheader.loopexit.unr-lcssa ], [ %9, %while.end.us ]
  %comp_info218 = phi ptr [ %comp_info214, %for.body.epil ], [ %comp_info214, %for.cond73.preheader.loopexit.unr-lcssa ], [ %comp_info, %while.end.us ]
  br i1 %cmp54204222, label %for.body77.lr.ph, label %for.end105
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  %compptr.0206 = phi ptr [ %12, %for.body.preheader.new ], [ %incdec.ptr.7, %for.body ]
  %niter = phi i32 [ 0, %for.body.preheader.new ], [ %niter.next.7, %for.body ]
  %DCT_scaled_size = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 0, i32 9
  store i32 8, ptr %DCT_scaled_size, align 4, !tbaa !35
  %DCT_scaled_size.1 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 1, i32 9
  store i32 8, ptr %DCT_scaled_size.1, align 4, !tbaa !35
  %DCT_scaled_size.2 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 2, i32 9
  store i32 8, ptr %DCT_scaled_size.2, align 4, !tbaa !35
  %DCT_scaled_size.3 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 3, i32 9
  store i32 8, ptr %DCT_scaled_size.3, align 4, !tbaa !35
  %DCT_scaled_size.4 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 4, i32 9
  store i32 8, ptr %DCT_scaled_size.4, align 4, !tbaa !35
  %DCT_scaled_size.5 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 5, i32 9
  store i32 8, ptr %DCT_scaled_size.5, align 4, !tbaa !35
  %DCT_scaled_size.6 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 6, i32 9
  store i32 8, ptr %DCT_scaled_size.6, align 4, !tbaa !35
  %DCT_scaled_size.7 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 7, i32 9
  store i32 8, ptr %DCT_scaled_size.7, align 4, !tbaa !35
  %incdec.ptr.7 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0206, i64 8
...
for.body77:                                       ; preds = %for.body77.lr.ph, %for.body77
  %compptr.1210 = phi ptr [ %21, %for.body77.lr.ph ], [ %incdec.ptr104, %for.body77 ]
  %ci.1209 = phi i32 [ 0, %for.body77.lr.ph ], [ %inc103, %for.body77 ]
  %22 = load i32, ptr %image_width78, align 8, !tbaa !21
  %conv79 = zext i32 %22 to i64
  %h_samp_factor80 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1210, i64 0, i32 2
  %23 = load i32, ptr %h_samp_factor80, align 8, !tbaa !29
  %DCT_scaled_size81 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1210, i64 0, i32 9
  %24 = load i32, ptr %DCT_scaled_size81, align 4, !tbaa !35
  %mul82 = mul nsw i32 %24, %23
  %conv83 = sext i32 %mul82 to i64
  %mul84 = mul nsw i64 %conv83, %conv79
  %25 = load i32, ptr %max_h_samp_factor85, align 4, !tbaa !28
  %mul86 = shl nsw i32 %25, 3
  ...
  %downsampled_width = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1210, i64 0, i32 10
  store i32 %conv89, ptr %downsampled_width, align 8, !tbaa !39
  %26 = load i32, ptr %image_height90, align 4, !tbaa !23
  %conv91 = zext i32 %26 to i64
  %v_samp_factor92 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1210, i64 0, i32 3
  %27 = load i32, ptr %v_samp_factor92, align 4, !tbaa !31
  %28 = load i32, ptr %DCT_scaled_size81, align 4, !tbaa !35
  %mul94 = mul nsw i32 %28, %27
  %conv95 = sext i32 %mul94 to i64
  %mul96 = mul nsw i64 %conv95, %conv91
  %29 = load i32, ptr %max_v_samp_factor97, align 8, !tbaa !32
  %mul98 = shl nsw i32 %29, 3
  ...
  %downsampled_height = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1210, i64 0, i32 11
  store i32 %conv101, ptr %downsampled_height, align 4, !tbaa !40
  %inc103 = add nuw nsw i32 %ci.1209, 1
  %incdec.ptr104 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1210, i64 1
  %.pr = load i32, ptr %num_components220, align 8, !tbaa !27
...
for.end105:                                       ; preds = %for.body77, %if.end53, %if.end53.thread, %for.cond73.preheader
  %comp_info218236 = phi ptr [ %comp_info218, %for.cond73.preheader ], [ %comp_info, %if.end53 ], [ %comp_info214, %if.end53.thread ], [ %comp_info218, %for.body77 ]
  %.lcssa = phi i32 [ %20, %for.cond73.preheader ], [ %10, %if.end53 ], [ %13, %if.end53.thread ], [ %.pr, %for.body77 ]
  %out_color_space = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 10
  %30 = load i32, ptr %out_color_space, align 8, !tbaa !42
  %switch.tableidx = add i32 %30, -1
  %31 = icmp ult i32 %switch.tableidx, 5
  br i1 %31, label %switch.lookup, label %sw.epilog

switch.lookup:                                    ; preds = %for.end105
  %32 = sext i32 %switch.tableidx to i64
  %switch.gep = getelementptr inbounds [5 x i32], ptr @switch.table.jpeg_calc_output_dimensions, i64 0, i64 %32
...
lor.lhs.false.i:                                  ; preds = %sw.epilog
  ...
  %35 = load i32, ptr %CCIR601_sampling.i, align 8, !tbaa !47
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  %36 = load i32, ptr %jpeg_color_space.i, align 4, !tbaa !48
  %cmp.not.i = icmp eq i32 %36, 3
  %cmp3.not.i = icmp eq i32 %.lcssa, 3
  %or.cond = select i1 %cmp.not.i, i1 %cmp3.not.i, i1 false
  %cmp5.not.i = icmp eq i32 %30, 2
  %or.cond198 = select i1 %or.cond, i1 %cmp5.not.i, i1 false
  %cmp7.not.i = icmp eq i32 %.lcssa.sink, 3
  %or.cond242 = select i1 %or.cond198, i1 %cmp7.not.i, i1 false
  br i1 %or.cond242, label %if.end9.i, label %if.end119

if.end9.i:                                        ; preds = %if.end.i
  %37 = load ptr, ptr %comp_info218236, align 8, !tbaa !26
  %h_samp_factor.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 0, i32 2
  %38 = load i32, ptr %h_samp_factor.i, align 8, !tbaa !29
  %cmp10.not.i = icmp eq i32 %38, 2
  br i1 %cmp10.not.i, label %lor.lhs.false11.i, label %if.end119

lor.lhs.false11.i:                                ; preds = %if.end9.i
  %h_samp_factor14.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 1, i32 2
  %39 = load i32, ptr %h_samp_factor14.i, align 8, !tbaa !29
  %cmp15.not.i = icmp eq i32 %39, 1
  br i1 %cmp15.not.i, label %lor.lhs.false16.i, label %if.end119

lor.lhs.false16.i:                                ; preds = %lor.lhs.false11.i
  %h_samp_factor19.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 2, i32 2
  %40 = load i32, ptr %h_samp_factor19.i, align 8, !tbaa !29
  %cmp20.not.i = icmp eq i32 %40, 1
  br i1 %cmp20.not.i, label %lor.lhs.false21.i, label %if.end119

lor.lhs.false21.i:                                ; preds = %lor.lhs.false16.i
  %v_samp_factor.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 0, i32 3
  %41 = load i32, ptr %v_samp_factor.i, align 4, !tbaa !31
  %cmp24.i = icmp sgt i32 %41, 2
  br i1 %cmp24.i, label %if.end119, label %lor.lhs.false25.i

lor.lhs.false25.i:                                ; preds = %lor.lhs.false21.i
  %v_samp_factor28.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 1, i32 3
  %42 = load i32, ptr %v_samp_factor28.i, align 4, !tbaa !31
  %cmp29.not.i = icmp eq i32 %42, 1
  br i1 %cmp29.not.i, label %lor.lhs.false30.i, label %if.end119

lor.lhs.false30.i:                                ; preds = %lor.lhs.false25.i
  %v_samp_factor33.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 2, i32 3
  %43 = load i32, ptr %v_samp_factor33.i, align 4, !tbaa !31
  %cmp34.not.i = icmp eq i32 %43, 1
  br i1 %cmp34.not.i, label %if.end36.i, label %if.end119

if.end36.i:                                       ; preds = %lor.lhs.false30.i
  %DCT_scaled_size.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 0, i32 9
  %44 = load i32, ptr %DCT_scaled_size.i, align 4, !tbaa !35
  %min_DCT_scaled_size.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 59
  %45 = load i32, ptr %min_DCT_scaled_size.i, align 4, !tbaa !25
  %cmp39.not.i = icmp eq i32 %44, %45
  br i1 %cmp39.not.i, label %lor.lhs.false40.i, label %if.end119

lor.lhs.false40.i:                                ; preds = %if.end36.i
  %DCT_scaled_size43.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 1, i32 9
  %46 = load i32, ptr %DCT_scaled_size43.i, align 4, !tbaa !35
  %cmp45.not.i = icmp eq i32 %46, %44
  br i1 %cmp45.not.i, label %use_merged_upsample.exit, label %if.end119

use_merged_upsample.exit:                         ; preds = %lor.lhs.false40.i
  %DCT_scaled_size49.i = getelementptr inbounds %struct.jpeg_component_info, ptr %37, i64 2, i32 9
  %47 = load i32, ptr %DCT_scaled_size49.i, align 4, !tbaa !35
  %cmp51.not.i.not = icmp eq i32 %47, %44
...
if.then115:                                       ; preds = %use_merged_upsample.exit
  ...
  %48 = load i32, ptr %max_v_samp_factor116, align 8, !tbaa !32
  br label %if.end119
...
if.end119:                                        ; preds = %use_merged_upsample.exit, %lor.lhs.false.i, %sw.epilog, %if.end.i, %lor.lhs.false30.i, %lor.lhs.false25.i, %lor.lhs.false21.i, %lor.lhs.false16.i, %lor.lhs.false11.i, %if.end9.i, %lor.lhs.false40.i, %if.end36.i, %if.then115
  %.sink243 = phi i32 [ %48, %if.then115 ], [ 1, %if.end36.i ], [ 1, %lor.lhs.false40.i ], [ 1, %if.end9.i ], [ 1, %lor.lhs.false11.i ], [ 1, %lor.lhs.false16.i ], [ 1, %lor.lhs.false21.i ], [ 1, %lor.lhs.false25.i ], [ 1, %lor.lhs.false30.i ], [ 1, %if.end.i ], [ 1, %sw.epilog ], [ 1, %lor.lhs.false.i ], [ 1, %use_merged_upsample.exit ]
  %rec_outbuf_height118 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 30
  store i32 %.sink243, ptr %rec_outbuf_height118, align 8, !tbaa !49
  ret void
}
...
entry:
  ...
  store i32 0, ptr %is_dummy_pass, align 8, !tbaa !59
  tail call void @jpeg_calc_output_dimensions(ptr noundef %cinfo) #4
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %call.i.i, i8 0, i64 256, i1 false) #4
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(384) %uglygep.i.i, i8 -1, i64 384, i1 false) #4, !tbaa !17
  %add.ptr12.i.i = getelementptr inbounds i8, ptr %call.i.i, i64 896
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(384) %add.ptr12.i.i, i8 0, i64 384, i1 false) #4
  %add.ptr13.i.i = getelementptr inbounds i8, ptr %call.i.i, i64 1280
  %19 = load ptr, ptr %sample_range_limit.i.i, align 8, !tbaa !65
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(128) %add.ptr13.i.i, ptr noundef nonnull align 1 dereferenceable(128) %19, i64 128, i1 false) #4
  ...
  %22 = icmp ult i64 %mul.i, 4294967296
  br i1 %22, label %if.end.i, label %if.then.i
...
if.end.i:                                         ; preds = %if.then.i, %entry
  ...
  %25 = load i32, ptr %do_fancy_upsampling.i.i, align 4, !tbaa !46
...
lor.lhs.false.i.i:                                ; preds = %if.end.i
  ...
  %26 = load i32, ptr %CCIR601_sampling.i.i, align 8, !tbaa !47
...
if.end.i.i:                                       ; preds = %lor.lhs.false.i.i
  ...
  %27 = load i32, ptr %jpeg_color_space.i.i, align 4, !tbaa !48
  %cmp.not.i.i = icmp eq i32 %27, 3
...
lor.lhs.false2.i.i:                               ; preds = %if.end.i.i
  ...
  %28 = load i32, ptr %num_components.i.i, align 8, !tbaa !27
  %cmp3.not.i.i = icmp eq i32 %28, 3
...
lor.lhs.false4.i.i:                               ; preds = %lor.lhs.false2.i.i
  ...
  %29 = load i32, ptr %out_color_space.i.i, align 8, !tbaa !42
  %cmp5.not.i.i = icmp eq i32 %29, 2
  br i1 %cmp5.not.i.i, label %lor.lhs.false6.i.i, label %use_merged_upsample.exit.i

lor.lhs.false6.i.i:                               ; preds = %lor.lhs.false4.i.i
  %30 = load i32, ptr %out_color_components.i, align 8, !tbaa !43
  %cmp7.not.i.i = icmp eq i32 %30, 3
...
if.end9.i.i:                                      ; preds = %lor.lhs.false6.i.i
  ...
  %31 = load ptr, ptr %comp_info.i.i, align 8, !tbaa !26
  %h_samp_factor.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 0, i32 2
  %32 = load i32, ptr %h_samp_factor.i.i, align 8, !tbaa !29
  %cmp10.not.i.i = icmp eq i32 %32, 2
  br i1 %cmp10.not.i.i, label %lor.lhs.false11.i.i, label %use_merged_upsample.exit.i

lor.lhs.false11.i.i:                              ; preds = %if.end9.i.i
  %h_samp_factor14.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 1, i32 2
  %33 = load i32, ptr %h_samp_factor14.i.i, align 8, !tbaa !29
  %cmp15.not.i.i = icmp eq i32 %33, 1
...
lor.lhs.false16.i.i:                              ; preds = %lor.lhs.false11.i.i
  %h_samp_factor19.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 2, i32 2
  %34 = load i32, ptr %h_samp_factor19.i.i, align 8, !tbaa !29
  %cmp20.not.i.i = icmp eq i32 %34, 1
...
lor.lhs.false21.i.i:                              ; preds = %lor.lhs.false16.i.i
  %v_samp_factor.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 0, i32 3
  %35 = load i32, ptr %v_samp_factor.i.i, align 4, !tbaa !31
  %cmp24.i.i = icmp sgt i32 %35, 2
  br i1 %cmp24.i.i, label %use_merged_upsample.exit.i, label %lor.lhs.false25.i.i

lor.lhs.false25.i.i:                              ; preds = %lor.lhs.false21.i.i
  %v_samp_factor28.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 1, i32 3
  %36 = load i32, ptr %v_samp_factor28.i.i, align 4, !tbaa !31
  %cmp29.not.i.i = icmp eq i32 %36, 1
...
lor.lhs.false30.i.i:                              ; preds = %lor.lhs.false25.i.i
  %v_samp_factor33.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 2, i32 3
  %37 = load i32, ptr %v_samp_factor33.i.i, align 4, !tbaa !31
  %cmp34.not.i.i = icmp eq i32 %37, 1
  br i1 %cmp34.not.i.i, label %if.end36.i.i, label %use_merged_upsample.exit.i

if.end36.i.i:                                     ; preds = %lor.lhs.false30.i.i
  %DCT_scaled_size.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 0, i32 9
  %38 = load i32, ptr %DCT_scaled_size.i.i, align 4, !tbaa !35
  %min_DCT_scaled_size.i.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 59
  %39 = load i32, ptr %min_DCT_scaled_size.i.i, align 4, !tbaa !25
  %cmp39.not.i.i = icmp eq i32 %38, %39
  br i1 %cmp39.not.i.i, label %lor.lhs.false40.i.i, label %use_merged_upsample.exit.i

lor.lhs.false40.i.i:                              ; preds = %if.end36.i.i
  %DCT_scaled_size43.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 1, i32 9
  %40 = load i32, ptr %DCT_scaled_size43.i.i, align 4, !tbaa !35
  %cmp45.not.i.i = icmp eq i32 %40, %38
...
lor.lhs.false46.i.i:                              ; preds = %lor.lhs.false40.i.i
  %DCT_scaled_size49.i.i = getelementptr inbounds %struct.jpeg_component_info, ptr %31, i64 2, i32 9
  %41 = load i32, ptr %DCT_scaled_size49.i.i, align 4, !tbaa !35
  %cmp51.not.i.i = icmp eq i32 %41, %38
...
use_merged_upsample.exit.i:                       ; preds = %lor.lhs.false46.i.i, %lor.lhs.false40.i.i, %if.end36.i.i, %lor.lhs.false30.i.i, %lor.lhs.false25.i.i, %lor.lhs.false21.i.i, %lor.lhs.false16.i.i, %lor.lhs.false11.i.i, %if.end9.i.i, %lor.lhs.false6.i.i, %lor.lhs.false4.i.i, %lor.lhs.false2.i.i, %if.end.i.i, %lor.lhs.false.i.i, %if.end.i
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %quantizer_1pass.i, i8 0, i64 16, i1 false) #4
  %42 = load i32, ptr %quantize_colors.i, align 4, !tbaa !44
...
lor.lhs.false.i:                                  ; preds = %use_merged_upsample.exit.i
  ...
  %43 = load i32, ptr %buffered_image.i, align 8, !tbaa !70
  %tobool7.not.i = icmp eq i32 %43, 0
...
if.then12.i:                                      ; preds = %if.end9.i, %lor.lhs.false.i
  ...
  %44 = load i32, ptr %raw_data_out.i, align 4, !tbaa !71
...
if.then14.i:                                      ; preds = %if.then12.i
  ...
  %msg_code16.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %45, i64 0, i32 5
...
if.end19.i:                                       ; preds = %if.then14.i, %if.then12.i
  %47 = load i32, ptr %out_color_components.i, align 8, !tbaa !43
  %cmp21.not.i = icmp eq i32 %47, 3
...
if.else.i:                                        ; preds = %if.end19.i
  ...
  %48 = load ptr, ptr %colormap27.i, align 8, !tbaa !52
  %cmp28.not.i = icmp eq ptr %48, null
...
if.else32.i:                                      ; preds = %if.else.i
  ...
  %49 = load i32, ptr %two_pass_quantize.i, align 4, !tbaa !72
  %tobool33.not.i = icmp eq i32 %49, 0
...
if.end40.i:                                       ; preds = %if.else36.i, %if.then34.i, %if.then30.i, %if.then23.i
  ...
  %50 = load i32, ptr %enable_1pass_quant41.i, align 4, !tbaa !68
  %tobool42.not.i = icmp eq i32 %50, 0
...
if.then43.i:                                      ; preds = %if.end40.i
  ...
  %51 = load ptr, ptr %cquantize.i, align 8, !tbaa !56
  store ptr %51, ptr %quantizer_1pass.i, align 8, !tbaa !73
  br label %if.end45.i
...
if.end45.i:                                       ; preds = %if.then43.i, %if.end40.i
  ...
  %52 = load i32, ptr %enable_2pass_quant46.i, align 4, !tbaa !69
  %tobool47.not.i = icmp eq i32 %52, 0
...
lor.lhs.false48.i:                                ; preds = %if.end45.i
  ...
  %53 = load i32, ptr %enable_external_quant49.i, align 8, !tbaa !51
...
if.then51.i:                                      ; preds = %lor.lhs.false48.i, %if.end45.i
  ...
  %54 = load ptr, ptr %cquantize52.i, align 8, !tbaa !56
  store ptr %54, ptr %quantizer_2pass.i, align 8, !tbaa !53
  br label %if.end55.i
...
if.end55.i:                                       ; preds = %if.then51.i, %lor.lhs.false48.i, %if.end9.thread191.i
  ...
  %55 = load i32, ptr %raw_data_out56.i, align 4, !tbaa !71
  %tobool57.not.i = icmp eq i32 %55, 0
  br i1 %tobool57.not.i, label %if.then58.i, label %if.end65.i

if.then58.i:                                      ; preds = %if.end55.i
  %56 = load i32, ptr %using_merged_upsample.i, align 4, !tbaa !67
  %tobool60.not.i = icmp eq i32 %56, 0
...
if.end63.i:                                       ; preds = %if.else62.i, %if.then61.i
  ...
  %57 = load i32, ptr %enable_2pass_quant64.i, align 4, !tbaa !69
  tail call void @jinit_d_post_controller(ptr noundef nonnull %cinfo, i32 noundef %57) #4
  br label %if.end65.i
...
if.end65.i:                                       ; preds = %if.end63.i, %if.end55.i
  ...
  %58 = load i32, ptr %arith_code.i, align 4, !tbaa !74
  %tobool66.not.i = icmp eq i32 %58, 0
...
if.then67.i:                                      ; preds = %if.end65.i
  ...
  %msg_code69.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %59, i64 0, i32 5
  store i32 1, ptr %msg_code69.i, align 8, !tbaa !14
  %60 = load ptr, ptr %59, align 8, !tbaa !18
  tail call void %60(ptr noundef nonnull %cinfo) #4
  br label %if.end77.i
...
if.else72.i:                                      ; preds = %if.end65.i
  ...
  %61 = load i32, ptr %progressive_mode.i, align 8, !tbaa !75
  %tobool73.not.i = icmp eq i32 %61, 0
...
if.end77.i:                                       ; preds = %if.else75.i, %if.then74.i, %if.then67.i
  ...
  %62 = load ptr, ptr %inputctl.i, align 8, !tbaa !76
  %has_multiple_scans.i = getelementptr inbounds %struct.jpeg_input_controller, ptr %62, i64 0, i32 4
  %63 = load i32, ptr %has_multiple_scans.i, align 8, !tbaa !77
  %tobool78.not.i = icmp eq i32 %63, 0
...
lor.rhs.i:                                        ; preds = %if.end77.i
  ...
  %64 = load i32, ptr %buffered_image79.i, align 8, !tbaa !70
  %tobool80.i = icmp ne i32 %64, 0
  %phi.cast.i = zext i1 %tobool80.i to i32
  br label %lor.end.i

lor.end.i:                                        ; preds = %lor.rhs.i, %if.end77.i
  %65 = phi i32 [ 1, %if.end77.i ], [ %phi.cast.i, %lor.rhs.i ]
  tail call void @jinit_d_coef_controller(ptr noundef nonnull %cinfo, i32 noundef %65) #4
  %66 = load i32, ptr %raw_data_out56.i, align 4, !tbaa !71
  %tobool82.not.i = icmp eq i32 %66, 0
...
if.end84.i:                                       ; preds = %if.then83.i, %lor.end.i
  %67 = load ptr, ptr %mem, align 8, !tbaa !60
  %realize_virt_arrays.i = getelementptr inbounds %struct.jpeg_memory_mgr, ptr %67, i64 0, i32 6
  %68 = load ptr, ptr %realize_virt_arrays.i, align 8, !tbaa !79
  tail call void %68(ptr noundef nonnull %cinfo) #4
  %69 = load ptr, ptr %inputctl.i, align 8, !tbaa !76
  %start_input_pass.i = getelementptr inbounds %struct.jpeg_input_controller, ptr %69, i64 0, i32 2
  %70 = load ptr, ptr %start_input_pass.i, align 8, !tbaa !80
  tail call void %70(ptr noundef nonnull %cinfo) #4
  %progress.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 2
  %71 = load ptr, ptr %progress.i, align 8, !tbaa !81
  %cmp86.not.i = icmp eq ptr %71, null
...
land.lhs.true.i:                                  ; preds = %if.end84.i
  ...
  %72 = load i32, ptr %buffered_image88.i, align 8, !tbaa !70
  %tobool89.not.i = icmp eq i32 %72, 0
  br i1 %tobool89.not.i, label %land.lhs.true90.i, label %master_selection.exit

land.lhs.true90.i:                                ; preds = %land.lhs.true.i
  %73 = load ptr, ptr %inputctl.i, align 8, !tbaa !76
  %has_multiple_scans92.i = getelementptr inbounds %struct.jpeg_input_controller, ptr %73, i64 0, i32 4
  %74 = load i32, ptr %has_multiple_scans92.i, align 8, !tbaa !77
  %tobool93.not.i = icmp eq i32 %74, 0
...
if.then94.i:                                      ; preds = %land.lhs.true90.i
  ...
  %75 = load i32, ptr %progressive_mode95.i, align 8, !tbaa !75
  %tobool96.not.i = icmp eq i32 %75, 0
  %num_components100.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 8
  %76 = load i32, ptr %num_components100.i, align 8, !tbaa !27
  br i1 %tobool96.not.i, label %if.end101.i, label %if.then97.i

if.then97.i:                                      ; preds = %if.then94.i
  %mul98.i = mul nsw i32 %76, 3
  %add.i = add nsw i32 %mul98.i, 2
  br label %if.end101.i

if.end101.i:                                      ; preds = %if.then97.i, %if.then94.i
  %nscans.0.i = phi i32 [ %add.i, %if.then97.i ], [ %76, %if.then94.i ]
  %pass_counter.i = getelementptr inbounds %struct.jpeg_progress_mgr, ptr %71, i64 0, i32 1
  ...
  %77 = load i32, ptr %total_iMCU_rows.i, align 8, !tbaa !84
  %conv103.i = zext i32 %77 to i64
  %conv104.i = sext i32 %nscans.0.i to i64
  %mul105.i = mul nsw i64 %conv103.i, %conv104.i
  %pass_limit.i = getelementptr inbounds %struct.jpeg_progress_mgr, ptr %71, i64 0, i32 2
  store i64 %mul105.i, ptr %pass_limit.i, align 8, !tbaa !85
  %completed_passes.i = getelementptr inbounds %struct.jpeg_progress_mgr, ptr %71, i64 0, i32 3
  ...
  %78 = load i32, ptr %enable_2pass_quant108.i, align 4, !tbaa !69
  %tobool109.not.i = icmp eq i32 %78, 0
  %cond.i = select i1 %tobool109.not.i, i32 2, i32 3
  %total_passes.i = getelementptr inbounds %struct.jpeg_progress_mgr, ptr %71, i64 0, i32 4
  store i32 %cond.i, ptr %total_passes.i, align 4, !tbaa !87
  %79 = load i32, ptr %pass_number.i, align 8, !tbaa !66
  %inc.i = add nsw i32 %79, 1
  store i32 %inc.i, ptr %pass_number.i, align 8, !tbaa !66
  br label %master_selection.exit

master_selection.exit:                            ; preds = %if.end84.i, %land.lhs.true.i, %land.lhs.true90.i, %if.end101.i
  ret void
}
