...
if.end:                                           ; preds = %entry
  %call1 = tail call ptr @fopen(ptr noundef %name, ptr noundef %mode)
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %bf, align 8, !tbaa !5
  %call = tail call i32 @fgetc(ptr noundef %1)
...
if.end:                                           ; preds = %entry.if.end_crit_edge, %if.then
  %2 = phi i8 [ %conv2, %if.then ], [ %.pre, %entry.if.end_crit_edge ]
  %3 = phi i8 [ 7, %if.then ], [ %phi.bo, %entry.if.end_crit_edge ]
  store i8 %3, ptr %rcnt, align 1, !tbaa !10
  %conv6 = sext i8 %2 to i32
  %conv817 = zext i8 %3 to i32
