...
while.body:                                       ; preds = %while.cond.preheader, %fill_input_buffer.exit.while.body_crit_edge
  %2 = phi ptr [ %.pre, %fill_input_buffer.exit.while.body_crit_edge ], [ %0, %while.cond.preheader ]
  %3 = phi i64 [ %14, %fill_input_buffer.exit.while.body_crit_edge ], [ %1, %while.cond.preheader ]
  %num_bytes.addr.018 = phi i64 [ %sub, %fill_input_buffer.exit.while.body_crit_edge ], [ %num_bytes, %while.cond.preheader ]
  %sub = sub nsw i64 %num_bytes.addr.018, %3
  %buffer.i = getelementptr inbounds %struct.my_source_mgr, ptr %2, i64 0, i32 2
  %4 = load ptr, ptr %buffer.i, align 8, !tbaa !17
  %infile.i = getelementptr inbounds %struct.my_source_mgr, ptr %2, i64 0, i32 1
  %5 = load ptr, ptr %infile.i, align 8, !tbaa !25
  %call.i = tail call i64 @fread(ptr noundef %4, i64 noundef 1, i64 noundef 4096, ptr noundef %5) #6
  %cmp.i = icmp eq i64 %call.i, 0
  br i1 %cmp.i, label %if.then.i, label %fill_input_buffer.exit

if.then.i:                                        ; preds = %while.body
  %start_of_file.i = getelementptr inbounds %struct.my_source_mgr, ptr %2, i64 0, i32 3
...
fill_input_buffer.exit:                           ; preds = %while.body, %if.end.i
  ...
  %start_of_file13.i = getelementptr inbounds %struct.my_source_mgr, ptr %2, i64 0, i32 3
  store i32 0, ptr %start_of_file13.i, align 8, !tbaa !26
  %14 = load i64, ptr %bytes_in_buffer, align 8, !tbaa !34
  %cmp2 = icmp sgt i64 %sub, %14
  br i1 %cmp2, label %fill_input_buffer.exit.while.body_crit_edge, label %while.end, !llvm.loop !35
...
define internal void @term_source(ptr nocapture noundef %cinfo) #3 {
entry:
  ret void
}
