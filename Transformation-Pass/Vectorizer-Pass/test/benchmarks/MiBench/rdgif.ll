...
do.body:                                          ; preds = %land.lhs.true
  ...
  %arrayidx56 = getelementptr inbounds i32, ptr %msg_parm, i64 1
  store i32 %conv55, ptr %arrayidx56, align 4, !tbaa !29
  %conv58 = sext i8 %12 to i32
  %arrayidx59 = getelementptr inbounds i32, ptr %msg_parm, i64 2
...
for.cond:                                         ; preds = %for.cond.backedge, %if.end112
  ...
  %call.i = tail call i32 @getc(ptr noundef %24) #4
...
if.then124:                                       ; preds = %for.cond
  ...
  %call.i.i = tail call i32 @getc(ptr noundef %26) #4
...
while.cond.i.i:                                   ; preds = %GetDataBlock.exit.i.i, %ReadByte.exit.i
  ...
  %call.i.i.i.i = tail call i32 @getc(ptr noundef %35) #4
...
if.then.i.i.i:                                    ; preds = %ReadByte.exit.i.i.i
  %conv18.i.i.i = zext i32 %call.i.i.i.i to i64
  %36 = load ptr, ptr %input_file, align 8, !tbaa !23
  %call1.i.i.i = call i64 @fread(ptr noundef nonnull %buf.i.i, i64 noundef 1, i64 noundef %conv18.i.i.i, ptr noundef %36) #4
  %cmp3.i.i.i = icmp eq i64 %call1.i.i.i, %conv18.i.i.i
...
if.end9.sink.split.i.i.i:                         ; preds = %if.then.i.i.i, %while.cond.i.i
  %.sink22.i.i.i = load ptr, ptr %cinfo.i.i, align 8, !tbaa !16
  %37 = load ptr, ptr %.sink22.i.i.i, align 8, !tbaa !24
  ...
  tail call void %38(ptr noundef nonnull %.sink22.i.i.i) #4
...
if.end148:                                        ; preds = %if.then143, %if.end136
  ...
  %conv169361 = zext i8 %51 to i32
  %and170 = and i32 %conv169361, 128
  %tobool171.not = icmp eq i32 %and170, 0
  br i1 %tobool171.not, label %if.end178, label %if.then172

if.then172:                                       ; preds = %if.end148
  %and175 = and i32 %conv169361, 7
  %shl176 = shl nuw nsw i32 2, %and175
  %53 = load ptr, ptr %colormap, align 8, !tbaa !22
  tail call fastcc void @ReadColorMap(ptr noundef nonnull %sinfo, i32 noundef %shl176, ptr noundef %53)
  br label %if.end178

if.end178:                                        ; preds = %if.then172, %if.end148
  %colormaplen.0 = phi i32 [ %shl176, %if.then172 ], [ %shl92, %if.end148 ]
  %54 = load ptr, ptr %input_file, align 8, !tbaa !23
  %call.i349 = tail call i32 @getc(ptr noundef %54) #4
...
ReadByte.exit354.thread:                          ; preds = %if.end178
  %55 = load ptr, ptr %cinfo.i.i, align 8, !tbaa !16
  %56 = load ptr, ptr %55, align 8, !tbaa !24
  %msg_code.i352 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %56, i64 0, i32 5
  store i32 42, ptr %msg_code.i352, align 8, !tbaa !25
  %57 = load ptr, ptr %56, align 8, !tbaa !27
  tail call void %57(ptr noundef nonnull %55) #4
...
ReadByte.exit354:                                 ; preds = %if.end178
  ...
  %58 = add i32 %call.i349, -12
  %59 = icmp ult i32 %58, -10
  br i1 %59, label %if.then187, label %for.end
...
if.end219:                                        ; preds = %for.end, %if.then207, %if.then212
  ...
  %arrayidx231 = getelementptr inbounds i32, ptr %msg_parm228, i64 1
  store i32 %or164, ptr %arrayidx231, align 4, !tbaa !29
  %arrayidx232 = getelementptr inbounds i32, ptr %msg_parm228, i64 2
...
define internal void @finish_input_gif(ptr nocapture noundef %cinfo, ptr nocapture noundef %sinfo) #2 {
entry:
  ret void
}
...
ReadByte.exit:                                    ; preds = %for.body, %if.then.i
  ...
  %call.i21 = tail call i32 @getc(ptr noundef %5) #4
...
ReadByte.exit26:                                  ; preds = %ReadByte.exit, %if.then.i25
  ...
  %call.i28 = tail call i32 @getc(ptr noundef %10) #4
...
for.body.i.prol:                                  ; preds = %for.body.lr.ph.i
  ...
  %arrayidx15.i.prol = getelementptr inbounds i8, ptr %28, i64 %29
  %30 = load i8, ptr %arrayidx15.i.prol, align 1, !tbaa !28
  %incdec.ptr16.i.prol = getelementptr inbounds i8, ptr %25, i64 1
  store i8 %30, ptr %25, align 1, !tbaa !28
  %31 = load ptr, ptr %arrayidx17.i, align 8, !tbaa !60
  %arrayidx19.i.prol = getelementptr inbounds i8, ptr %31, i64 %29
  %32 = load i8, ptr %arrayidx19.i.prol, align 1, !tbaa !28
  %incdec.ptr20.i.prol = getelementptr inbounds i8, ptr %25, i64 2
  store i8 %32, ptr %incdec.ptr16.i.prol, align 1, !tbaa !28
  %33 = load ptr, ptr %arrayidx21.i, align 8, !tbaa !60
  %arrayidx23.i.prol = getelementptr inbounds i8, ptr %33, i64 %29
  %34 = load i8, ptr %arrayidx23.i.prol, align 1, !tbaa !28
  %incdec.ptr24.i.prol = getelementptr inbounds i8, ptr %25, i64 3
  store i8 %34, ptr %incdec.ptr20.i.prol, align 1, !tbaa !28
...
for.body.i.prol.loopexit:                         ; preds = %for.body.i.prol, %for.body.lr.ph.i
  ...
  %35 = icmp eq i32 %23, 1
  br i1 %35, label %get_interlaced_row.exit, label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  ...
  %36 = load i8, ptr %sptr.049.i, align 1, !tbaa !28
  %37 = load ptr, ptr %19, align 8, !tbaa !60
  %38 = zext i8 %36 to i64
  %arrayidx15.i = getelementptr inbounds i8, ptr %37, i64 %38
  %39 = load i8, ptr %arrayidx15.i, align 1, !tbaa !28
  %incdec.ptr16.i = getelementptr inbounds i8, ptr %ptr.047.i, i64 1
  store i8 %39, ptr %ptr.047.i, align 1, !tbaa !28
  %40 = load ptr, ptr %arrayidx17.i, align 8, !tbaa !60
  %arrayidx19.i = getelementptr inbounds i8, ptr %40, i64 %38
  %41 = load i8, ptr %arrayidx19.i, align 1, !tbaa !28
  %incdec.ptr20.i = getelementptr inbounds i8, ptr %ptr.047.i, i64 2
  store i8 %41, ptr %incdec.ptr16.i, align 1, !tbaa !28
  %42 = load ptr, ptr %arrayidx21.i, align 8, !tbaa !60
  %arrayidx23.i = getelementptr inbounds i8, ptr %42, i64 %38
  %43 = load i8, ptr %arrayidx23.i, align 1, !tbaa !28
  %incdec.ptr24.i = getelementptr inbounds i8, ptr %ptr.047.i, i64 3
  store i8 %43, ptr %incdec.ptr20.i, align 1, !tbaa !28
  %incdec.ptr.i.1 = getelementptr inbounds i8, ptr %sptr.049.i, i64 2
  %44 = load i8, ptr %incdec.ptr.i, align 1, !tbaa !28
  %45 = load ptr, ptr %19, align 8, !tbaa !60
  %46 = zext i8 %44 to i64
  %arrayidx15.i.1 = getelementptr inbounds i8, ptr %45, i64 %46
  %47 = load i8, ptr %arrayidx15.i.1, align 1, !tbaa !28
  %incdec.ptr16.i.1 = getelementptr inbounds i8, ptr %ptr.047.i, i64 4
  store i8 %47, ptr %incdec.ptr24.i, align 1, !tbaa !28
  %48 = load ptr, ptr %arrayidx17.i, align 8, !tbaa !60
  %arrayidx19.i.1 = getelementptr inbounds i8, ptr %48, i64 %46
  %49 = load i8, ptr %arrayidx19.i.1, align 1, !tbaa !28
  %incdec.ptr20.i.1 = getelementptr inbounds i8, ptr %ptr.047.i, i64 5
  store i8 %49, ptr %incdec.ptr16.i.1, align 1, !tbaa !28
  %50 = load ptr, ptr %arrayidx21.i, align 8, !tbaa !60
  %arrayidx23.i.1 = getelementptr inbounds i8, ptr %50, i64 %46
  %51 = load i8, ptr %arrayidx23.i.1, align 1, !tbaa !28
  %incdec.ptr24.i.1 = getelementptr inbounds i8, ptr %ptr.047.i, i64 6
  store i8 %51, ptr %incdec.ptr20.i.1, align 1, !tbaa !28
...
get_interlaced_row.exit:                          ; preds = %for.body.i.prol.loopexit, %for.body.i, %sw.epilog.i
  %52 = load i32, ptr %cur_row_number, align 8, !tbaa !69
  %inc.i = add i32 %52, 1
...
; Function Attrs: nounwind uwtable
define internal i32 @get_pixel_rows(ptr nocapture noundef readonly %cinfo, ptr noundef %sinfo) #0 {
entry:
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @LZWReadByte(ptr noundef %sinfo) unnamed_addr #0 {
entry:
...
if.then26:                                        ; preds = %if.then24
  ...
  %.sink22.in.i.i = getelementptr inbounds %struct.gif_source_struct, ptr %sinfo, i64 0, i32 1
  br label %while.cond.i

while.cond.i:                                     ; preds = %GetDataBlock.exit.i, %if.then26
  %14 = load ptr, ptr %input_file.i.i.i, align 8, !tbaa !23
  %call.i.i.i = tail call i32 @getc(ptr noundef %14) #4
...
if.then.i.i:                                      ; preds = %ReadByte.exit.i.i
  %conv18.i.i = zext i32 %call.i.i.i to i64
  %15 = load ptr, ptr %input_file.i.i.i, align 8, !tbaa !23
  %call1.i.i = call i64 @fread(ptr noundef nonnull %buf.i, i64 noundef 1, i64 noundef %conv18.i.i, ptr noundef %15) #4
  %cmp3.i.i = icmp eq i64 %call1.i.i, %conv18.i.i
...
if.end9.sink.split.i.i:                           ; preds = %if.then.i.i, %while.cond.i
  %.sink22.i.i = load ptr, ptr %.sink22.in.i.i, align 8, !tbaa !16
  %16 = load ptr, ptr %.sink22.i.i, align 8, !tbaa !24
  ...
  %17 = load ptr, ptr %16, align 8, !tbaa !27
  tail call void %17(ptr noundef nonnull %.sink22.i.i) #4
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %arrayidx15.prol = getelementptr inbounds i8, ptr %13, i64 %14
  %15 = load i8, ptr %arrayidx15.prol, align 1, !tbaa !28
  %incdec.ptr16.prol = getelementptr inbounds i8, ptr %10, i64 1
  store i8 %15, ptr %10, align 1, !tbaa !28
  %16 = load ptr, ptr %arrayidx17, align 8, !tbaa !60
  %arrayidx19.prol = getelementptr inbounds i8, ptr %16, i64 %14
  %17 = load i8, ptr %arrayidx19.prol, align 1, !tbaa !28
  %incdec.ptr20.prol = getelementptr inbounds i8, ptr %10, i64 2
  store i8 %17, ptr %incdec.ptr16.prol, align 1, !tbaa !28
  %18 = load ptr, ptr %arrayidx21, align 8, !tbaa !60
  %arrayidx23.prol = getelementptr inbounds i8, ptr %18, i64 %14
  %19 = load i8, ptr %arrayidx23.prol, align 1, !tbaa !28
  %incdec.ptr24.prol = getelementptr inbounds i8, ptr %10, i64 3
  store i8 %19, ptr %incdec.ptr20.prol, align 1, !tbaa !28
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %21 = load i8, ptr %sptr.049, align 1, !tbaa !28
  %22 = load ptr, ptr %0, align 8, !tbaa !60
  %23 = zext i8 %21 to i64
  %arrayidx15 = getelementptr inbounds i8, ptr %22, i64 %23
  %24 = load i8, ptr %arrayidx15, align 1, !tbaa !28
  %incdec.ptr16 = getelementptr inbounds i8, ptr %ptr.047, i64 1
  store i8 %24, ptr %ptr.047, align 1, !tbaa !28
  %25 = load ptr, ptr %arrayidx17, align 8, !tbaa !60
  %arrayidx19 = getelementptr inbounds i8, ptr %25, i64 %23
  %26 = load i8, ptr %arrayidx19, align 1, !tbaa !28
  %incdec.ptr20 = getelementptr inbounds i8, ptr %ptr.047, i64 2
  store i8 %26, ptr %incdec.ptr16, align 1, !tbaa !28
  %27 = load ptr, ptr %arrayidx21, align 8, !tbaa !60
  %arrayidx23 = getelementptr inbounds i8, ptr %27, i64 %23
  %28 = load i8, ptr %arrayidx23, align 1, !tbaa !28
  %incdec.ptr24 = getelementptr inbounds i8, ptr %ptr.047, i64 3
  store i8 %28, ptr %incdec.ptr20, align 1, !tbaa !28
  %incdec.ptr.1 = getelementptr inbounds i8, ptr %sptr.049, i64 2
  %29 = load i8, ptr %incdec.ptr, align 1, !tbaa !28
  %30 = load ptr, ptr %0, align 8, !tbaa !60
  %31 = zext i8 %29 to i64
  %arrayidx15.1 = getelementptr inbounds i8, ptr %30, i64 %31
  %32 = load i8, ptr %arrayidx15.1, align 1, !tbaa !28
  %incdec.ptr16.1 = getelementptr inbounds i8, ptr %ptr.047, i64 4
  store i8 %32, ptr %incdec.ptr24, align 1, !tbaa !28
  %33 = load ptr, ptr %arrayidx17, align 8, !tbaa !60
  %arrayidx19.1 = getelementptr inbounds i8, ptr %33, i64 %31
  %34 = load i8, ptr %arrayidx19.1, align 1, !tbaa !28
  %incdec.ptr20.1 = getelementptr inbounds i8, ptr %ptr.047, i64 5
  store i8 %34, ptr %incdec.ptr16.1, align 1, !tbaa !28
  %35 = load ptr, ptr %arrayidx21, align 8, !tbaa !60
  %arrayidx23.1 = getelementptr inbounds i8, ptr %35, i64 %31
  %36 = load i8, ptr %arrayidx23.1, align 1, !tbaa !28
  %incdec.ptr24.1 = getelementptr inbounds i8, ptr %ptr.047, i64 6
  store i8 %36, ptr %incdec.ptr20.1, align 1, !tbaa !28
...
for.end:                                          ; preds = %for.body.prol.loopexit, %for.body, %sw.epilog
  %37 = load i32, ptr %cur_row_number, align 8, !tbaa !69
  %inc = add i32 %37, 1
...
while.body.lr.ph:                                 ; preds = %entry
  ...
  %.sink22.in.i = getelementptr inbounds %struct.gif_source_struct, ptr %sinfo, i64 0, i32 1
  br label %while.body
...
if.then:                                          ; preds = %while.body
  %4 = load ptr, ptr %.sink22.in.i, align 8, !tbaa !16
...
if.end:                                           ; preds = %while.body
  ...
  %call.i.i = tail call i32 @getc(ptr noundef %11) #4
  %cmp.i.i = icmp eq i32 %call.i.i, -1
...
if.then.i:                                        ; preds = %ReadByte.exit.i
  %conv18.i = zext i32 %call.i.i to i64
  %12 = load ptr, ptr %input_file.i.i, align 8, !tbaa !23
  %call1.i = tail call i64 @fread(ptr noundef nonnull %arrayidx14, i64 noundef 1, i64 noundef %conv18.i, ptr noundef %12) #4
  %cmp3.i = icmp eq i64 %call1.i, %conv18.i
  br i1 %cmp3.i, label %if.end26, label %if.end9.sink.split.i

if.end9.sink.split.i:                             ; preds = %if.then.i, %if.end
  %.sink22.i = load ptr, ptr %.sink22.in.i, align 8, !tbaa !16
  %13 = load ptr, ptr %.sink22.i, align 8, !tbaa !24
  %msg_code.i.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %13, i64 0, i32 5
  store i32 42, ptr %msg_code.i.i, align 8, !tbaa !25
  %14 = load ptr, ptr %13, align 8, !tbaa !27
  tail call void %14(ptr noundef nonnull %.sink22.i) #4
...
if.then16:                                        ; preds = %GetDataBlock.exit
  store i32 1, ptr %out_of_blocks, align 8, !tbaa !78
  %15 = load ptr, ptr %.sink22.in.i, align 8, !tbaa !16
...
while.end:                                        ; preds = %if.end26, %entry
  ...
  %24 = load i8, ptr %arrayidx45, align 1, !tbaa !28
  ...
  %28 = load i8, ptr %arrayidx52, align 1, !tbaa !28
  %29 = zext i8 %28 to i32
  %or56 = or i32 %shl49, %29
