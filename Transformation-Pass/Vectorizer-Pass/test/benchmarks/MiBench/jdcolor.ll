...
define internal void @start_pass_dcolor(ptr nocapture noundef %cinfo) #1 {
entry:
  ret void
}
...
for.body.us:                                      ; preds = %while.body.us, %for.body.us
  ...
  %arrayidx19.us = getelementptr inbounds i32, ptr %3, i64 %17
  %18 = load i32, ptr %arrayidx19.us, align 4, !tbaa !38
  ...
  %19 = load i8, ptr %arrayidx21.us, align 1, !tbaa !47
  store i8 %19, ptr %outptr.065.us, align 1, !tbaa !47
  %20 = zext i8 %15 to i64
  %arrayidx24.us = getelementptr inbounds i64, ptr %6, i64 %20
  %21 = load i64, ptr %arrayidx24.us, align 8, !tbaa !39
  %arrayidx26.us = getelementptr inbounds i64, ptr %5, i64 %17
  %22 = load i64, ptr %arrayidx26.us, align 8, !tbaa !39
  %add27.us = add nsw i64 %22, %21
  %23 = lshr i64 %add27.us, 16
  %conv28.us = trunc i64 %23 to i32
  ...
  %24 = load i8, ptr %arrayidx31.us, align 1, !tbaa !47
  %arrayidx32.us = getelementptr inbounds i8, ptr %outptr.065.us, i64 1
  store i8 %24, ptr %arrayidx32.us, align 1, !tbaa !47
  %arrayidx34.us = getelementptr inbounds i32, ptr %4, i64 %20
  %25 = load i32, ptr %arrayidx34.us, align 4, !tbaa !38
  %add35.us = add nsw i32 %25, %conv.us
  %idxprom36.us = sext i32 %add35.us to i64
  %arrayidx37.us = getelementptr inbounds i8, ptr %2, i64 %idxprom36.us
  %26 = load i8, ptr %arrayidx37.us, align 1, !tbaa !47
  %arrayidx38.us = getelementptr inbounds i8, ptr %outptr.065.us, i64 2
  store i8 %26, ptr %arrayidx38.us, align 1, !tbaa !47
...
for.cond.preheader.us:                            ; preds = %for.cond.preheader.us.preheader, %for.cond.for.end13_crit_edge.split.us42
  %dec37.us.in = phi i32 [ %dec37.us, %for.cond.for.end13_crit_edge.split.us42 ], [ %num_rows, %for.cond.preheader.us.preheader ]
  %input_row.addr.036.us = phi i32 [ %inc14.us, %for.cond.for.end13_crit_edge.split.us42 ], [ %input_row, %for.cond.preheader.us.preheader ]
  %output_buf.addr.033.us = phi ptr [ %incdec.ptr15.us, %for.cond.for.end13_crit_edge.split.us42 ], [ %output_buf, %for.cond.preheader.us.preheader ]
  %dec37.us = add nsw i32 %dec37.us.in, -1
  %idxprom3.us = zext i32 %input_row.addr.036.us to i64
  br label %for.body.us38

for.body.us38:                                    ; preds = %for.cond.preheader.us, %for.cond6.for.inc12_crit_edge.us
...
for.body8.us.prol:                                ; preds = %for.body.us38, %for.body8.us.prol
  %count.028.us.prol = phi i32 [ %dec11.us.prol, %for.body8.us.prol ], [ %1, %for.body.us38 ]
  %outptr.027.us.prol = phi ptr [ %add.ptr10.us.prol, %for.body8.us.prol ], [ %add.ptr.us, %for.body.us38 ]
  %inptr.026.us.prol = phi ptr [ %incdec.ptr.us.prol, %for.body8.us.prol ], [ %5, %for.body.us38 ]
  %prol.iter = phi i32 [ %prol.iter.next, %for.body8.us.prol ], [ 0, %for.body.us38 ]
...
for.body8.us.prol.loopexit:                       ; preds = %for.body8.us.prol, %for.body.us38
  %count.028.us.unr = phi i32 [ %1, %for.body.us38 ], [ %dec11.us.prol, %for.body8.us.prol ]
  %outptr.027.us.unr = phi ptr [ %add.ptr.us, %for.body.us38 ], [ %add.ptr10.us.prol, %for.body8.us.prol ]
  %inptr.026.us.unr = phi ptr [ %5, %for.body.us38 ], [ %incdec.ptr.us.prol, %for.body8.us.prol ]
...
for.cond6.for.inc12_crit_edge.us:                 ; preds = %for.body8.us, %for.body8.us.prol.loopexit
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond.for.end13_crit_edge.split.us42, label %for.body.us38, !llvm.loop !52

for.cond.for.end13_crit_edge.split.us42:          ; preds = %for.cond6.for.inc12_crit_edge.us
  %inc14.us = add i32 %input_row.addr.036.us, 1
  %incdec.ptr15.us = getelementptr inbounds ptr, ptr %output_buf.addr.033.us, i64 1
  %cmp.us = icmp sgt i32 %dec37.us.in, 1
  br i1 %cmp.us, label %for.cond.preheader.us, label %while.end, !llvm.loop !53

while.end:                                        ; preds = %for.cond.for.end13_crit_edge.split.us42, %for.cond.preheader.lr.ph, %entry
  ret void
}
...
for.body.us:                                      ; preds = %while.body.us, %for.body.us
  ...
  %arrayidx22.us = getelementptr inbounds i32, ptr %3, i64 %19
  %20 = load i32, ptr %arrayidx22.us, align 4, !tbaa !38
  %21 = xor i8 %16, -1
  %add.neg.us = zext i8 %21 to i32
  ...
  %22 = load i8, ptr %arrayidx24.us, align 1, !tbaa !47
  store i8 %22, ptr %outptr.078.us, align 1, !tbaa !47
  %23 = zext i8 %17 to i64
  %arrayidx27.us = getelementptr inbounds i64, ptr %6, i64 %23
  %24 = load i64, ptr %arrayidx27.us, align 8, !tbaa !39
  %arrayidx29.us = getelementptr inbounds i64, ptr %5, i64 %19
  %25 = load i64, ptr %arrayidx29.us, align 8, !tbaa !39
  %add30.us = add nsw i64 %25, %24
  %26 = lshr i64 %add30.us, 16
  %conv31.us = trunc i64 %26 to i32
  ...
  %27 = load i8, ptr %arrayidx35.us, align 1, !tbaa !47
  %arrayidx36.us = getelementptr inbounds i8, ptr %outptr.078.us, i64 1
  store i8 %27, ptr %arrayidx36.us, align 1, !tbaa !47
  %arrayidx38.us = getelementptr inbounds i32, ptr %4, i64 %23
  %28 = load i32, ptr %arrayidx38.us, align 4, !tbaa !38
  %sub40.us = sub i32 %add.neg.us, %28
  %idxprom41.us = sext i32 %sub40.us to i64
  %arrayidx42.us = getelementptr inbounds i8, ptr %2, i64 %idxprom41.us
  %29 = load i8, ptr %arrayidx42.us, align 1, !tbaa !47
  %arrayidx43.us = getelementptr inbounds i8, ptr %outptr.078.us, i64 2
  store i8 %29, ptr %arrayidx43.us, align 1, !tbaa !47
  %arrayidx45.us = getelementptr inbounds i8, ptr %14, i64 %indvars.iv
  %30 = load i8, ptr %arrayidx45.us, align 1, !tbaa !47
  %arrayidx46.us = getelementptr inbounds i8, ptr %outptr.078.us, i64 3
  store i8 %30, ptr %arrayidx46.us, align 1, !tbaa !47
