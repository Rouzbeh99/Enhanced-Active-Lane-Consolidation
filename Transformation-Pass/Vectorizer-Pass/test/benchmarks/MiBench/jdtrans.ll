...
if.end18:                                         ; preds = %if.end12
  ...
  %24 = and i32 %call, -3
  %25 = icmp eq i32 %24, 1
  %or.cond = select i1 %cmp20.not, i1 %25, i1 false
  br i1 %or.cond, label %if.then23, label %for.cond.backedge
...
if.then23:                                        ; preds = %if.end18
  ...
  %26 = load i64, ptr %pass_counter, align 8, !tbaa !29
  ...
  %27 = load i64, ptr %pass_limit, align 8, !tbaa !32
  %cmp26.not = icmp slt i64 %inc, %27
  br i1 %cmp26.not, label %for.cond.backedge, label %if.then27

if.then27:                                        ; preds = %if.then23
  %28 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !31
...
for.end:                                          ; preds = %if.end12
  ...
  %29 = load ptr, ptr %coef, align 8, !tbaa !38
  %coef_arrays = getelementptr inbounds %struct.jpeg_d_coef_controller, ptr %29, i64 0, i32 4
  %30 = load ptr, ptr %coef_arrays, align 8, !tbaa !39
  br label %return

return:                                           ; preds = %if.end12, %for.end
  %retval.2 = phi ptr [ %30, %for.end ], [ null, %if.end12 ]
  ret ptr %retval.2
}
