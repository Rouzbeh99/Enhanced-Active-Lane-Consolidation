...
if.end20:                                         ; preds = %if.end13
  ...
  %9 = and i32 %call, -3
  %10 = icmp eq i32 %9, 1
  %or.cond = select i1 %cmp22.not, i1 %10, i1 false
  br i1 %or.cond, label %if.then25, label %for.cond.backedge
...
if.then25:                                        ; preds = %if.end20
  ...
  %11 = load i64, ptr %pass_counter, align 8, !tbaa !22
  ...
  %12 = load i64, ptr %pass_limit, align 8, !tbaa !23
  %cmp28.not = icmp slt i64 %inc, %12
  br i1 %cmp28.not, label %for.cond.backedge, label %if.then29

if.then29:                                        ; preds = %if.then25
  %13 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !24
...
if.end34:                                         ; preds = %if.end13, %if.then7
  ...
  %14 = load i32, ptr %input_scan_number, align 4, !tbaa !25
  %output_scan_number = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 36
  store i32 %14, ptr %output_scan_number, align 4, !tbaa !26
  br label %if.end43
...
if.end43:                                         ; preds = %if.then38, %if.end34
  ...
  %phi.cmp = icmp eq i32 %.pr, 204
  br i1 %phi.cmp, label %if.end.i, label %if.then.i
...
if.end:                                           ; preds = %entry, %entry, %if.then
  %4 = tail call i32 @llvm.smax.i32(i32 %scan_number, i32 1)
  %inputctl = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 77
  %5 = load ptr, ptr %inputctl, align 8, !tbaa !14
  %eoi_reached = getelementptr inbounds %struct.jpeg_input_controller, ptr %5, i64 0, i32 5
  %6 = load i32, ptr %eoi_reached, align 4, !tbaa !52
...
if.end13:                                         ; preds = %land.lhs.true9, %if.end
  %scan_number.addr.0 = phi i32 [ %4, %if.end ], [ %8, %land.lhs.true9 ]
  %output_scan_number = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 36
  store i32 %scan_number.addr.0, ptr %output_scan_number, align 4, !tbaa !26
  %9 = load i32, ptr %global_state, align 4, !tbaa !5
  %cmp.not.i = icmp eq i32 %9, 204
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.end13
  %master.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 73
  %10 = load ptr, ptr %master.i, align 8, !tbaa !32
...
if.end.i:                                         ; preds = %if.then.i, %if.end13
  %master2.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 73
  %12 = load ptr, ptr %master2.i, align 8, !tbaa !32
  %is_dummy_pass58.i = getelementptr inbounds %struct.jpeg_decomp_master, ptr %12, i64 0, i32 2
  %13 = load i32, ptr %is_dummy_pass58.i, align 8, !tbaa !36
  %tobool.not59.i = icmp eq i32 %13, 0
  br i1 %tobool.not59.i, label %while.end27.i, label %while.cond3.preheader.lr.ph.i
...
while.cond3.i:                                    ; preds = %while.cond3.i.backedge, %while.cond3.preheader.lr.ph.i
  %14 = phi i32 [ %.pre.pre.i, %while.cond3.preheader.lr.ph.i ], [ %.be, %while.cond3.i.backedge ]
  %15 = load i32, ptr %output_height.i, align 4, !tbaa !37
  %cmp5.i = icmp ult i32 %14, %15
  br i1 %cmp5.i, label %while.body6.i, label %while.end.i

while.body6.i:                                    ; preds = %while.cond3.i
  %16 = load ptr, ptr %progress.i, align 8, !tbaa !17
  %cmp7.not.i = icmp eq ptr %16, null
  br i1 %cmp7.not.i, label %if.end15.i, label %if.then8.i

if.then8.i:                                       ; preds = %while.body6.i
  %conv.i = zext i32 %14 to i64
  %pass_counter.i = getelementptr inbounds %struct.jpeg_progress_mgr, ptr %16, i64 0, i32 1
  store i64 %conv.i, ptr %pass_counter.i, align 8, !tbaa !22
  %conv12.i = zext i32 %15 to i64
  %pass_limit.i = getelementptr inbounds %struct.jpeg_progress_mgr, ptr %16, i64 0, i32 2
  store i64 %conv12.i, ptr %pass_limit.i, align 8, !tbaa !23
...
if.end15.i:                                       ; preds = %if.then8.i, %while.body6.i
  %18 = phi i32 [ %.pre60.i, %if.then8.i ], [ %14, %while.body6.i ]
  %19 = load ptr, ptr %main.i, align 8, !tbaa !38
  %process_data.i = getelementptr inbounds %struct.jpeg_d_main_controller, ptr %19, i64 0, i32 1
  %20 = load ptr, ptr %process_data.i, align 8, !tbaa !39
  tail call void %20(ptr noundef nonnull %cinfo, ptr noundef null, ptr noundef nonnull %output_scanline4.i, i32 noundef 0) #4
  %21 = load i32, ptr %output_scanline4.i, align 8, !tbaa !35
  %cmp19.not.i = icmp eq i32 %21, %18
  br i1 %cmp19.not.i, label %output_pass_setup.exit, label %while.cond3.i.backedge

while.cond3.i.backedge:                           ; preds = %if.end15.i, %while.end.i
  %.be = phi i32 [ %21, %if.end15.i ], [ 0, %while.end.i ]
  br label %while.cond3.i, !llvm.loop !41

while.end.i:                                      ; preds = %while.cond3.i
  %22 = load ptr, ptr %master2.i, align 8, !tbaa !32
  %finish_output_pass.i = getelementptr inbounds %struct.jpeg_decomp_master, ptr %22, i64 0, i32 1
  %23 = load ptr, ptr %finish_output_pass.i, align 8, !tbaa !43
  tail call void %23(ptr noundef nonnull %cinfo) #4
  %24 = load ptr, ptr %master2.i, align 8, !tbaa !32
  %25 = load ptr, ptr %24, align 8, !tbaa !33
  tail call void %25(ptr noundef nonnull %cinfo) #4
  store i32 0, ptr %output_scanline4.i, align 8, !tbaa !35
  %26 = load ptr, ptr %master2.i, align 8, !tbaa !32
  %is_dummy_pass.i = getelementptr inbounds %struct.jpeg_decomp_master, ptr %26, i64 0, i32 2
  %27 = load i32, ptr %is_dummy_pass.i, align 8, !tbaa !36
  %tobool.not.i = icmp eq i32 %27, 0
  br i1 %tobool.not.i, label %while.end27.i, label %while.cond3.i.backedge

while.end27.i:                                    ; preds = %while.end.i, %if.end.i
  %raw_data_out.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 15
  %28 = load i32, ptr %raw_data_out.i, align 4, !tbaa !44
