...
while.body:                                       ; preds = %while.body.lr.ph, %if.end20
  %3 = phi i32 [ %.pre, %while.body.lr.ph ], [ 0, %if.end20 ]
  %cmp2 = icmp ult i32 %3, 8
  br i1 %cmp2, label %if.then, label %if.end

if.then:                                          ; preds = %while.body
  %4 = load ptr, ptr %prep, align 8, !tbaa !40
  %pre_process_data = getelementptr inbounds %struct.jpeg_c_prep_controller, ptr %4, i64 0, i32 1
  %5 = load ptr, ptr %pre_process_data, align 8, !tbaa !41
  tail call void %5(ptr noundef nonnull %cinfo, ptr noundef %input_buf, ptr noundef %in_row_ctr, i32 noundef %in_rows_avail, ptr noundef nonnull %buffer, ptr noundef nonnull %rowgroup_ctr, i32 noundef 8) #1
  %.pr = load i32, ptr %rowgroup_ctr, align 4, !tbaa !35
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %6 = phi i32 [ %.pr, %if.then ], [ %3, %while.body ]
  %cmp5.not = icmp eq i32 %6, 8
  br i1 %cmp5.not, label %if.end7, label %cleanup

if.end7:                                          ; preds = %if.end
  %7 = load ptr, ptr %coef, align 8, !tbaa !43
  %compress_data = getelementptr inbounds %struct.jpeg_c_coef_controller, ptr %7, i64 0, i32 1
  %8 = load ptr, ptr %compress_data, align 8, !tbaa !44
  %call = tail call i32 %8(ptr noundef nonnull %cinfo, ptr noundef nonnull %buffer) #1
  %tobool.not = icmp eq i32 %call, 0
  %9 = load i32, ptr %suspended16, align 8, !tbaa !36
...
if.then12:                                        ; preds = %if.then10
  %10 = load i32, ptr %in_row_ctr, align 4, !tbaa !46
  %dec = add i32 %10, -1
...
if.then18:                                        ; preds = %if.end15
  %11 = load i32, ptr %in_row_ctr, align 4, !tbaa !46
  %inc = add i32 %11, 1
...
if.end20:                                         ; preds = %if.then18, %if.end15
  store i32 0, ptr %rowgroup_ctr, align 4, !tbaa !35
  %12 = load i32, ptr %cur_iMCU_row, align 8, !tbaa !34
  %inc23 = add i32 %12, 1
  store i32 %inc23, ptr %cur_iMCU_row, align 8, !tbaa !34
  %13 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !39
  %cmp = icmp ult i32 %inc23, %13
  br i1 %cmp, label %while.body, label %cleanup, !llvm.loop !47

cleanup:                                          ; preds = %if.end, %if.end20, %entry, %if.then10, %if.then12
  ret void
}
