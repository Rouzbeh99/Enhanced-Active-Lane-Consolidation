...
if.end18:                                         ; preds = %if.then7, %if.end
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %comp_info, i8 0, i64 104, i1 false)
...
if.end16.sink.split:                              ; preds = %if.end, %if.then8
  %.sink82 = phi ptr [ %7, %if.then8 ], [ %finish_pass, %if.end ]
  %8 = load ptr, ptr %.sink82, align 8, !tbaa !23
...
if.end16:                                         ; preds = %if.end16.sink.split, %entry
  ...
  %is_last_pass79 = getelementptr inbounds %struct.jpeg_comp_master, ptr %9, i64 0, i32 4
  %10 = load i32, ptr %is_last_pass79, align 4, !tbaa !31
  %tobool.not80 = icmp eq i32 %10, 0
