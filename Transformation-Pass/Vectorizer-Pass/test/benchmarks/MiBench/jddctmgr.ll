...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc90
  %indvars.iv173 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next174, %for.inc90 ]
...
sw.epilog16:                                      ; preds = %switch.lookup, %for.body, %sw.default, %sw.default9, %sw.bb3, %sw.bb2
  ...
  %arrayidx17 = getelementptr inbounds %struct.jpeg_inverse_dct, ptr %0, i64 0, i32 1, i64 %indvars.iv173
...
lor.lhs.false:                                    ; preds = %sw.epilog16
  %arrayidx19 = getelementptr inbounds %struct.my_idct_controller, ptr %0, i64 0, i32 1, i64 %indvars.iv173
...
for.body40:                                       ; preds = %for.body40, %sw.bb35
  %indvars.iv165 = phi i64 [ 0, %sw.bb35 ], [ %indvars.iv.next166.1, %for.body40 ]
  %arrayidx43 = getelementptr inbounds [64 x i16], ptr %14, i64 0, i64 %indvars.iv165
  %49 = load i16, ptr %arrayidx43, align 2, !tbaa !37
  %conv44 = zext i16 %49 to i64
  %arrayidx46 = getelementptr inbounds [64 x i16], ptr @start_pass.aanscales, i64 0, i64 %indvars.iv165
  ...
  %arrayidx50 = getelementptr inbounds i32, ptr %48, i64 %indvars.iv165
  store i32 %conv48, ptr %arrayidx50, align 4, !tbaa !24
  %indvars.iv.next166 = or i64 %indvars.iv165, 1
  %arrayidx43.1 = getelementptr inbounds [64 x i16], ptr %14, i64 0, i64 %indvars.iv.next166
  %51 = load i16, ptr %arrayidx43.1, align 2, !tbaa !37
  %conv44.1 = zext i16 %51 to i64
  %arrayidx46.1 = getelementptr inbounds [64 x i16], ptr @start_pass.aanscales, i64 0, i64 %indvars.iv.next166
  ...
  %arrayidx50.1 = getelementptr inbounds i32, ptr %48, i64 %indvars.iv.next166
  store i32 %conv48.1, ptr %arrayidx50.1, align 4, !tbaa !24
  %indvars.iv.next166.1 = add nuw nsw i64 %indvars.iv165, 2
  %exitcond168.not.1 = icmp eq i64 %indvars.iv.next166.1, 64
  br i1 %exitcond168.not.1, label %for.inc90, label %for.body40, !llvm.loop !38
...
for.inc90:                                        ; preds = %for.body40, %vector.body, %sw.bb27, %sw.default84, %if.end, %sw.epilog16, %lor.lhs.false
  ...
  %cmp = icmp slt i64 %indvars.iv.next174, %395
