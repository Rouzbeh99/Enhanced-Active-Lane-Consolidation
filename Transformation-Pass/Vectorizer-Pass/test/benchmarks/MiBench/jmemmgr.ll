...
if.end11:                                         ; preds = %if.then5, %entry
  ...
  %uglygep = getelementptr i8, ptr %call3, i64 96
  %total_space_allocated = getelementptr inbounds %struct.my_memory_mgr, ptr %call3, i64 0, i32 5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %uglygep, i8 0, i64 48, i1 false)
...
if.then34:                                        ; preds = %if.then31
  %3 = load i8, ptr %ch, align 1, !tbaa !16
  %4 = and i8 %3, -33
  %5 = icmp eq i8 %4, 77
  %6 = load i64, ptr %max_to_use, align 8, !tbaa !11
  br i1 %5, label %if.then40, label %if.end41

if.then40:                                        ; preds = %if.then34
  %mul = mul nsw i64 %6, 1000
  store i64 %mul, ptr %max_to_use, align 8, !tbaa !11
  br label %if.end41

if.end41:                                         ; preds = %if.then34, %if.then40
  %7 = phi i64 [ %mul, %if.then40 ], [ %6, %if.then34 ]
  %mul42 = mul nsw i64 %7, 1000
...
if.then3:                                         ; preds = %if.end
  %sub = add i64 %sizeofobject, 8
  %add = and i64 %sub, -8
  br label %if.end4

if.end4:                                          ; preds = %if.then3, %if.end
  %sizeofobject.addr.0 = phi i64 [ %add, %if.then3 ], [ %sizeofobject, %if.end ]
  %4 = icmp ugt i32 %pool_id, 1
  br i1 %4, label %if.then7, label %if.end10
...
if.then7:                                         ; preds = %if.end4
  ...
  tail call void %7(ptr noundef nonnull %cinfo) #7
  br label %if.end10
...
while.body:                                       ; preds = %if.end10, %while.cond
  ...
  %8 = load i64, ptr %bytes_left, align 8, !tbaa !16
  %cmp13.not = icmp ult i64 %8, %sizeofobject.addr.0
...
if.then17:                                        ; preds = %while.cond, %if.end10
  ...
  %9 = tail call i64 @llvm.umin.i64(i64 %slop.0, i64 %sub26)
  %add18114 = add i64 %9, %sizeofobject.addr.0
...
if.end34:                                         ; preds = %if.then17, %if.end37
  %slop.2118 = phi i64 [ %div106, %if.end37 ], [ %9, %if.then17 ]
...
if.then36:                                        ; preds = %if.end34
  ...
  %msg_code.i107 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %10, i64 0, i32 5
  store i32 53, ptr %msg_code.i107, align 8, !tbaa !14
  %msg_parm.i108 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %10, i64 0, i32 6
...
for.end:                                          ; preds = %if.end37, %if.then17
  ...
  %13 = load i64, ptr %total_space_allocated, align 8, !tbaa !32
  %add39 = add i64 %13, %add31.lcssa
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call.lcssa, i8 0, i64 16, i1 false)
...
if.end51:                                         ; preds = %while.body, %for.end
  ...
  %14 = load i64, ptr %bytes_used52, align 8, !tbaa !16
  %add.ptr53 = getelementptr inbounds i8, ptr %add.ptr, i64 %14
  %add55 = add i64 %14, %sizeofobject.addr.0
  ...
  %15 = load i64, ptr %bytes_left56, align 8, !tbaa !16
  %sub57 = sub i64 %15, %sizeofobject.addr.0
...
if.then13:                                        ; preds = %if.end10
  ...
  %msg_code.i45 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %8, i64 0, i32 5
  store i32 53, ptr %msg_code.i45, align 8, !tbaa !14
  %msg_parm.i46 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %8, i64 0, i32 6
...
if.end14:                                         ; preds = %if.then13, %if.end10
  ...
  %12 = load ptr, ptr %arrayidx17, align 8, !tbaa !35
  store ptr %12, ptr %call, align 8, !tbaa !16
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %3 = tail call i32 @llvm.umin.i32(i32 %div49, i32 %numrows)
  %last_rowsperchunk = getelementptr inbounds %struct.my_memory_mgr, ptr %0, i64 0, i32 6
  store i32 %3, ptr %last_rowsperchunk, align 8, !tbaa !36
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond.loopexit
  ...
  %rowsperchunk.155 = phi i32 [ %3, %while.body.lr.ph ], [ %5, %while.cond.loopexit ]
  %sub = sub i32 %numrows, %currow.056
  %5 = tail call i32 @llvm.umin.i32(i32 %rowsperchunk.155, i32 %sub)
  %conv17 = zext i32 %5 to i64
  %mul19 = mul nuw i64 %conv17, %conv
  %6 = load ptr, ptr %mem1, align 8, !tbaa !5
  %cmp.i = icmp ugt i64 %mul19, 999999976
  br i1 %cmp.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %while.body
  %7 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_code.i.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %7, i64 0, i32 5
  store i32 53, ptr %msg_code.i.i, align 8, !tbaa !14
  %msg_parm.i.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %7, i64 0, i32 6
...
if.end.i:                                         ; preds = %if.then.i, %while.body
  %rem.i = and i64 %mul19, 7
  %cmp2.not.i = icmp eq i64 %rem.i, 0
  br i1 %cmp2.not.i, label %if.end4.i, label %if.then3.i

if.then3.i:                                       ; preds = %if.end.i
  %sub.i = add i64 %mul19, 8
  %add.i = and i64 %sub.i, -8
  br label %if.end4.i

if.end4.i:                                        ; preds = %if.then3.i, %if.end.i
  %sizeofobject.addr.0.i = phi i64 [ %add.i, %if.then3.i ], [ %mul19, %if.end.i ]
  br i1 %4, label %if.then7.i, label %if.end10.i
...
if.end10.i:                                       ; preds = %if.then7.i, %if.end4.i
  %add11.i = add i64 %sizeofobject.addr.0.i, 24
...
if.then13.i:                                      ; preds = %if.end10.i
  ...
  %msg_code.i45.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %13, i64 0, i32 5
  store i32 53, ptr %msg_code.i45.i, align 8, !tbaa !14
  %msg_parm.i46.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %13, i64 0, i32 6
...
alloc_large.exit:                                 ; preds = %if.end10.i, %if.then13.i
  %total_space_allocated.i = getelementptr inbounds %struct.my_memory_mgr, ptr %6, i64 0, i32 5
  %16 = load i64, ptr %total_space_allocated.i, align 8, !tbaa !32
  %add16.i = add i64 %16, %add11.i
  store i64 %add16.i, ptr %total_space_allocated.i, align 8, !tbaa !32
  %arrayidx17.i = getelementptr inbounds %struct.my_memory_mgr, ptr %6, i64 0, i32 2, i64 %idxprom.i
  %17 = load ptr, ptr %arrayidx17.i, align 8, !tbaa !35
  store ptr %17, ptr %call.i, align 8, !tbaa !16
...
for.body.prol:                                    ; preds = %for.body.preheader, %for.body.prol
  ...
  %i.052.prol = phi i32 [ %dec.prol, %for.body.prol ], [ %5, %for.body.preheader ]
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader
  ...
  %i.052.unr = phi i32 [ %5, %for.body.preheader ], [ %dec.prol, %for.body.prol ]
  %currow.151.unr = phi i32 [ %currow.056, %for.body.preheader ], [ %inc.prol, %for.body.prol ]
  %19 = icmp ult i32 %18, 3
  br i1 %19, label %while.cond.loopexit, label %for.body
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %spec.select = select i1 %cmp5, i32 %conv8, i32 %numrows
  %last_rowsperchunk = getelementptr inbounds %struct.my_memory_mgr, ptr %0, i64 0, i32 6
  store i32 %spec.select, ptr %last_rowsperchunk, align 8, !tbaa !36
  %mul11 = shl nuw nsw i64 %conv4, 3
  %call = tail call ptr @alloc_small(ptr noundef nonnull %cinfo, i32 noundef %pool_id, i64 noundef %mul11)
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond.loopexit
  ...
  %rowsperchunk.154 = phi i32 [ %spec.select, %while.body.lr.ph ], [ %4, %while.cond.loopexit ]
  %sub = sub i32 %numrows, %currow.055
  %4 = tail call i32 @llvm.umin.i32(i32 %rowsperchunk.154, i32 %sub)
  %conv17 = zext i32 %4 to i64
  %mul20 = mul i64 %mul, %conv17
  %5 = load ptr, ptr %mem1, align 8, !tbaa !5
  %cmp.i = icmp ugt i64 %mul20, 999999976
  br i1 %cmp.i, label %if.then.i, label %if.end4.i

if.then.i:                                        ; preds = %while.body
  %6 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_code.i.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %6, i64 0, i32 5
  store i32 53, ptr %msg_code.i.i, align 8, !tbaa !14
  %msg_parm.i.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %6, i64 0, i32 6
  store i32 3, ptr %msg_parm.i.i, align 4, !tbaa !16
  %7 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %8 = load ptr, ptr %7, align 8, !tbaa !17
  tail call void %8(ptr noundef nonnull %cinfo) #7
  br label %if.end4.i

if.end4.i:                                        ; preds = %while.body, %if.then.i
  br i1 %3, label %if.then7.i, label %if.end10.i
...
if.then13.i:                                      ; preds = %if.end10.i
  ...
  %msg_code.i45.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %12, i64 0, i32 5
  store i32 53, ptr %msg_code.i45.i, align 8, !tbaa !14
  %msg_parm.i46.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %12, i64 0, i32 6
  store i32 4, ptr %msg_parm.i46.i, align 4, !tbaa !16
  %13 = load ptr, ptr %cinfo, align 8, !tbaa !13
...
alloc_large.exit:                                 ; preds = %if.end10.i, %if.then13.i
  %total_space_allocated.i = getelementptr inbounds %struct.my_memory_mgr, ptr %5, i64 0, i32 5
  %15 = load i64, ptr %total_space_allocated.i, align 8, !tbaa !32
  %add16.i = add i64 %15, %add11.i
  store i64 %add16.i, ptr %total_space_allocated.i, align 8, !tbaa !32
  %arrayidx17.i = getelementptr inbounds %struct.my_memory_mgr, ptr %5, i64 0, i32 2, i64 %idxprom.i
  %16 = load ptr, ptr %arrayidx17.i, align 8, !tbaa !35
  store ptr %16, ptr %call.i, align 8, !tbaa !16
  %bytes_used.i = getelementptr inbounds %struct.anon.0, ptr %call.i, i64 0, i32 1
  store i64 %mul20, ptr %bytes_used.i, align 8, !tbaa !16
  %bytes_left.i = getelementptr inbounds %struct.anon.0, ptr %call.i, i64 0, i32 2
  store i64 0, ptr %bytes_left.i, align 8, !tbaa !16
  store ptr %call.i, ptr %arrayidx17.i, align 8, !tbaa !35
  %cmp22.not49 = icmp eq i32 %4, 0
...
for.body.prol:                                    ; preds = %for.body.preheader, %for.body.prol
  ...
  %i.051.prol = phi i32 [ %dec.prol, %for.body.prol ], [ %4, %for.body.preheader ]
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader
  ...
  %i.051.unr = phi i32 [ %4, %for.body.preheader ], [ %dec.prol, %for.body.prol ]
  %currow.150.unr = phi i32 [ %currow.055, %for.body.preheader ], [ %inc.prol, %for.body.prol ]
  %18 = icmp ult i32 %17, 3
  br i1 %18, label %while.cond.loopexit, label %for.body
...
if.else:                                          ; preds = %if.end39
  ...
  %10 = tail call i64 @llvm.smax.i64(i64 %div, i64 1)
  br label %if.end47

if.end47:                                         ; preds = %if.end39, %if.else
  %max_minheights.0 = phi i64 [ %10, %if.else ], [ 1000000000, %if.end39 ]
...
for.body92.lr.ph:                                 ; preds = %for.cond89.preheader
  %12 = trunc i64 %max_minheights.0 to i32
...
for.body52:                                       ; preds = %for.body52.lr.ph, %for.inc85
  ...
  %13 = load ptr, ptr %sptr.1235, align 8, !tbaa !44
  %cmp54 = icmp eq ptr %13, null
...
if.then56:                                        ; preds = %for.body52
  ...
  %14 = load i32, ptr %rows_in_array57, align 8, !tbaa !47
  ...
  %15 = load i32, ptr %maxaccess59, align 8, !tbaa !49
...
if.then65:                                        ; preds = %if.then56
  ...
  store i32 %14, ptr %rows_in_mem, align 4, !tbaa !65
  br label %if.end79

if.else67:                                        ; preds = %if.then56
  %conv71 = mul i32 %15, %11
  ...
  %16 = load i32, ptr %samplesperrow75, align 4, !tbaa !48
...
if.end79:                                         ; preds = %if.else67, %if.then65
  %17 = phi i32 [ %.pre, %if.else67 ], [ %14, %if.then65 ]
  %samplesperrow80 = getelementptr inbounds %struct.jvirt_sarray_control, ptr %sptr.1235, i64 0, i32 2
  %18 = load i32, ptr %samplesperrow80, align 4, !tbaa !48
  %call82 = tail call ptr @alloc_sarray(ptr noundef %cinfo, i32 noundef 1, i32 noundef %18, i32 noundef %17)
  store ptr %call82, ptr %sptr.1235, align 8, !tbaa !44
  %19 = load i32, ptr %last_rowsperchunk, align 8, !tbaa !36
  %rowsperchunk = getelementptr inbounds %struct.jvirt_sarray_control, ptr %sptr.1235, i64 0, i32 5
  store i32 %19, ptr %rowsperchunk, align 8, !tbaa !66
...
for.body92:                                       ; preds = %for.body92.lr.ph, %for.inc134
  ...
  %20 = load ptr, ptr %bptr.1238, align 8, !tbaa !54
  %cmp94 = icmp eq ptr %20, null
...
if.then96:                                        ; preds = %for.body92
  ...
  %21 = load i32, ptr %rows_in_array97, align 8, !tbaa !56
  %conv98 = zext i32 %21 to i64
  %sub99 = add nsw i64 %conv98, -1
  %maxaccess100 = getelementptr inbounds %struct.jvirt_barray_control, ptr %bptr.1238, i64 0, i32 3
  %22 = load i32, ptr %maxaccess100, align 8, !tbaa !58
  %conv101 = zext i32 %22 to i64
...
if.then106:                                       ; preds = %if.then96
  ...
  store i32 %21, ptr %rows_in_mem108, align 4, !tbaa !71
  br label %if.end123

if.else109:                                       ; preds = %if.then96
  %conv113 = mul i32 %22, %12
  ...
  %23 = load i32, ptr %blocksperrow118, align 4, !tbaa !57
  %conv119 = zext i32 %23 to i64
...
if.end123:                                        ; preds = %if.else109, %if.then106
  %24 = phi i32 [ %.pre239, %if.else109 ], [ %21, %if.then106 ]
  %blocksperrow124 = getelementptr inbounds %struct.jvirt_barray_control, ptr %bptr.1238, i64 0, i32 2
  %25 = load i32, ptr %blocksperrow124, align 4, !tbaa !57
  %call126 = tail call ptr @alloc_barray(ptr noundef %cinfo, i32 noundef 1, i32 noundef %25, i32 noundef %24)
  store ptr %call126, ptr %bptr.1238, align 8, !tbaa !54
  %26 = load i32, ptr %last_rowsperchunk128, align 8, !tbaa !36
  %rowsperchunk129 = getelementptr inbounds %struct.jvirt_barray_control, ptr %bptr.1238, i64 0, i32 5
  store i32 %26, ptr %rowsperchunk129, align 8, !tbaa !72
...
for.body.lr.ph.i:                                 ; preds = %if.then18
  ...
  %.pre100.i = load i32, ptr %rowsperchunk.i, align 8, !tbaa !66
  %conv5.i168 = zext i32 %.pre100.i to i64
  %14 = tail call i64 @llvm.smin.i64(i64 %conv391.i, i64 %conv5.i168) #7
  %15 = load i32, ptr %first_undef_row.i, align 8, !tbaa !68
  %conv17.i170 = zext i32 %15 to i64
  %sub18.i171 = sub nsw i64 %conv17.i170, %conv1.i
  %16 = tail call i64 @llvm.smin.i64(i64 %14, i64 %sub18.i171) #7
  %17 = load i32, ptr %rows_in_array, align 8, !tbaa !47
  %conv28.i172 = zext i32 %17 to i64
  %sub29.i173 = sub nsw i64 %conv28.i172, %conv1.i
  %18 = tail call i64 @llvm.smin.i64(i64 %16, i64 %sub29.i173) #7
  %cmp39.i174 = icmp slt i64 %18, 1
  br i1 %cmp39.i174, label %do_sarray_io.exit, label %if.end.i.preheader

if.end.i.preheader:                               ; preds = %for.body.lr.ph.i
  %mul2.i = mul nuw nsw i64 %conv1.i, %conv.i
  br label %if.end.i

if.end.i:                                         ; preds = %if.end.i.preheader, %if.end.for.body_crit_edge.i
  %19 = phi i64 [ %29, %if.end.for.body_crit_edge.i ], [ %18, %if.end.i.preheader ]
  %file_offset.093.i176 = phi i64 [ %add49.i, %if.end.for.body_crit_edge.i ], [ %mul2.i, %if.end.i.preheader ]
  %i.095.i175 = phi i64 [ %add52.i, %if.end.for.body_crit_edge.i ], [ 0, %if.end.i.preheader ]
  %mul41.i = mul nsw i64 %19, %conv.i
  %20 = load ptr, ptr %write_backing_store.i, align 8, !tbaa !77
  %21 = load ptr, ptr %ptr, align 8, !tbaa !44
  %arrayidx.i = getelementptr inbounds ptr, ptr %21, i64 %i.095.i175
  %22 = load ptr, ptr %arrayidx.i, align 8, !tbaa !35
  tail call void %20(ptr noundef %cinfo, ptr noundef nonnull %b_s_info.i, ptr noundef %22, i64 noundef %file_offset.093.i176, i64 noundef %mul41.i) #7
  %23 = load i32, ptr %rowsperchunk.i, align 8, !tbaa !66
  %conv51.i = zext i32 %23 to i64
  %add52.i = add nuw nsw i64 %i.095.i175, %conv51.i
  %24 = load i32, ptr %rows_in_mem.i, align 4, !tbaa !65
  %conv3.i = zext i32 %24 to i64
  %cmp.i = icmp ult i64 %add52.i, %conv3.i
  br i1 %cmp.i, label %if.end.for.body_crit_edge.i, label %do_sarray_io.exit, !llvm.loop !78

if.end.for.body_crit_edge.i:                      ; preds = %if.end.i
  %add49.i = add nsw i64 %mul41.i, %file_offset.093.i176
  %.pre99.i = load i32, ptr %cur_start_row, align 4, !tbaa !67
  %sub.i = sub nsw i64 %conv3.i, %add52.i
  %25 = tail call i64 @llvm.smin.i64(i64 %sub.i, i64 %conv51.i) #7
  %conv16.i = zext i32 %.pre99.i to i64
  %add.i = add nuw nsw i64 %add52.i, %conv16.i
  %26 = load i32, ptr %first_undef_row.i, align 8, !tbaa !68
  %conv17.i = zext i32 %26 to i64
  %sub18.i = sub nsw i64 %conv17.i, %add.i
  %27 = tail call i64 @llvm.smin.i64(i64 %25, i64 %sub18.i) #7
  %28 = load i32, ptr %rows_in_array, align 8, !tbaa !47
  %conv28.i = zext i32 %28 to i64
  %sub29.i = sub nsw i64 %conv28.i, %add.i
  %29 = tail call i64 @llvm.smin.i64(i64 %27, i64 %sub29.i) #7
  %cmp39.i = icmp slt i64 %29, 1
  br i1 %cmp39.i, label %do_sarray_io.exit, label %if.end.i

do_sarray_io.exit:                                ; preds = %if.end.i, %if.end.for.body_crit_edge.i, %for.body.lr.ph.i, %if.then18
  store i32 0, ptr %dirty, align 8, !tbaa !69
  br label %if.end20

if.end20:                                         ; preds = %do_sarray_io.exit, %if.end16
  %30 = load i32, ptr %cur_start_row, align 4, !tbaa !67
  %cmp22 = icmp ult i32 %30, %start_row
...
if.else:                                          ; preds = %if.end20
  ...
  %31 = load i32, ptr %rows_in_mem25, align 4, !tbaa !65
  %conv26 = zext i32 %31 to i64
  %sub = sub nsw i64 %conv, %conv26
  %32 = tail call i64 @llvm.smax.i64(i64 %sub, i64 0)
  %conv31 = trunc i64 %32 to i32
  br label %if.end33

if.end33:                                         ; preds = %if.end20.if.end33_crit_edge, %if.else
  %33 = phi i32 [ %31, %if.else ], [ %.pre, %if.end20.if.end33_crit_edge ]
  ...
  %34 = load i32, ptr %samplesperrow.i143, align 4, !tbaa !48
  %conv.i144 = zext i32 %34 to i64
...
for.body.lr.ph.i157:                              ; preds = %if.end33
  ...
  %.pre100.i156 = load i32, ptr %rowsperchunk.i146, align 8, !tbaa !66
  %conv5.us.i177 = zext i32 %.pre100.i156 to i64
  %35 = tail call i64 @llvm.smin.i64(i64 %conv391.i149, i64 %conv5.us.i177) #7
  %36 = load i32, ptr %first_undef_row.i152, align 8, !tbaa !68
  %conv17.us.i179 = zext i32 %36 to i64
  %sub18.us.i180 = sub nsw i64 %conv17.us.i179, %conv1.i150
  %37 = tail call i64 @llvm.smin.i64(i64 %35, i64 %sub18.us.i180) #7
  %38 = load i32, ptr %rows_in_array, align 8, !tbaa !47
  %conv28.us.i181 = zext i32 %38 to i64
  %sub29.us.i182 = sub nsw i64 %conv28.us.i181, %conv1.i150
  %39 = tail call i64 @llvm.smin.i64(i64 %37, i64 %sub29.us.i182) #7
  %cmp39.us.i183 = icmp slt i64 %39, 1
  br i1 %cmp39.us.i183, label %if.end34, label %if.end.us.i.preheader

if.end.us.i.preheader:                            ; preds = %for.body.lr.ph.i157
  %mul2.i151 = mul nuw nsw i64 %conv.i144, %conv1.i150
  br label %if.end.us.i

if.end.us.i:                                      ; preds = %if.end.us.i.preheader, %if.end.us.for.body.us_crit_edge.i
  %40 = phi i64 [ %50, %if.end.us.for.body.us_crit_edge.i ], [ %39, %if.end.us.i.preheader ]
  %file_offset.093.us.i185 = phi i64 [ %add49.us.i, %if.end.us.for.body.us_crit_edge.i ], [ %mul2.i151, %if.end.us.i.preheader ]
  %i.095.us.i184 = phi i64 [ %add52.us.i, %if.end.us.for.body.us_crit_edge.i ], [ 0, %if.end.us.i.preheader ]
  %mul41.us.i = mul nsw i64 %40, %conv.i144
  %41 = load ptr, ptr %b_s_info.i154, align 8, !tbaa !79
  %42 = load ptr, ptr %ptr, align 8, !tbaa !44
  %arrayidx47.us.i = getelementptr inbounds ptr, ptr %42, i64 %i.095.us.i184
  %43 = load ptr, ptr %arrayidx47.us.i, align 8, !tbaa !35
  tail call void %41(ptr noundef %cinfo, ptr noundef nonnull %b_s_info.i154, ptr noundef %43, i64 noundef %file_offset.093.us.i185, i64 noundef %mul41.us.i) #7
  %44 = load i32, ptr %rowsperchunk.i146, align 8, !tbaa !66
  %conv51.us.i = zext i32 %44 to i64
  %add52.us.i = add nuw nsw i64 %i.095.us.i184, %conv51.us.i
  %45 = load i32, ptr %rows_in_mem.i147, align 4, !tbaa !65
  %conv3.us.i = zext i32 %45 to i64
  %cmp.us.i = icmp ult i64 %add52.us.i, %conv3.us.i
  br i1 %cmp.us.i, label %if.end.us.for.body.us_crit_edge.i, label %if.end34, !llvm.loop !78

if.end.us.for.body.us_crit_edge.i:                ; preds = %if.end.us.i
  %add49.us.i = add nsw i64 %mul41.us.i, %file_offset.093.us.i185
  %.pre101.i = load i32, ptr %cur_start_row, align 4, !tbaa !67
  %sub.us.i = sub nsw i64 %conv3.us.i, %add52.us.i
  %46 = tail call i64 @llvm.smin.i64(i64 %sub.us.i, i64 %conv51.us.i) #7
  %conv16.us.i = zext i32 %.pre101.i to i64
  %add.us.i = add nuw nsw i64 %add52.us.i, %conv16.us.i
  %47 = load i32, ptr %first_undef_row.i152, align 8, !tbaa !68
  %conv17.us.i = zext i32 %47 to i64
  %sub18.us.i = sub nsw i64 %conv17.us.i, %add.us.i
  %48 = tail call i64 @llvm.smin.i64(i64 %46, i64 %sub18.us.i) #7
  %49 = load i32, ptr %rows_in_array, align 8, !tbaa !47
  %conv28.us.i = zext i32 %49 to i64
  %sub29.us.i = sub nsw i64 %conv28.us.i, %add.us.i
  %50 = tail call i64 @llvm.smin.i64(i64 %48, i64 %sub29.us.i) #7
  %cmp39.us.i = icmp slt i64 %50, 1
  br i1 %cmp39.us.i, label %if.end34, label %if.end.us.i

if.end34:                                         ; preds = %if.end.us.for.body.us_crit_edge.i, %if.end.us.i, %for.body.lr.ph.i157, %if.end33, %lor.lhs.false6
  %first_undef_row = getelementptr inbounds %struct.jvirt_sarray_control, ptr %ptr, i64 0, i32 7
  %51 = load i32, ptr %first_undef_row, align 8, !tbaa !68
  %cmp35 = icmp ult i32 %51, %add
  br i1 %cmp35, label %if.then37, label %if.end75

if.then37:                                        ; preds = %if.end34
  %cmp39 = icmp ult i32 %51, %start_row
  %tobool42.not = icmp eq i32 %writable, 0
  br i1 %cmp39, label %if.then41, label %if.end51

if.then41:                                        ; preds = %if.then37
  br i1 %tobool42.not, label %if.end55, label %if.end51.thread163

if.end51.thread163:                               ; preds = %if.then41
  %52 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_code45 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %52, i64 0, i32 5
  store i32 20, ptr %msg_code45, align 8, !tbaa !14
  %53 = load ptr, ptr %52, align 8, !tbaa !17
  tail call void %53(ptr noundef nonnull %cinfo) #7
  br label %if.end55.thread

if.end51:                                         ; preds = %if.then37
  br i1 %tobool42.not, label %if.end55, label %if.end55.thread

if.end55:                                         ; preds = %if.then41, %if.end51
  %undef_row.0161 = phi i32 [ %51, %if.end51 ], [ %start_row, %if.then41 ]
  %pre_zero = getelementptr inbounds %struct.jvirt_sarray_control, ptr %ptr, i64 0, i32 8
  %54 = load i32, ptr %pre_zero, align 4, !tbaa !50
  %tobool56.not = icmp eq i32 %54, 0
  br i1 %tobool56.not, label %if.end75.thread, label %if.then57

if.end55.thread:                                  ; preds = %if.end51, %if.end51.thread163
  %undef_row.0166 = phi i32 [ %start_row, %if.end51.thread163 ], [ %51, %if.end51 ]
  store i32 %add, ptr %first_undef_row, align 8, !tbaa !68
  %pre_zero191 = getelementptr inbounds %struct.jvirt_sarray_control, ptr %ptr, i64 0, i32 8
  %55 = load i32, ptr %pre_zero191, align 4, !tbaa !50
  %tobool56.not192 = icmp eq i32 %55, 0
  br i1 %tobool56.not192, label %if.then77, label %if.then57

if.then57:                                        ; preds = %if.end55.thread, %if.end55
  %undef_row.0161194 = phi i32 [ %undef_row.0166, %if.end55.thread ], [ %undef_row.0161, %if.end55 ]
  %samplesperrow = getelementptr inbounds %struct.jvirt_sarray_control, ptr %ptr, i64 0, i32 2
  %56 = load i32, ptr %samplesperrow, align 4, !tbaa !48
  %conv58 = zext i32 %56 to i64
  %57 = load i32, ptr %cur_start_row, align 4, !tbaa !67
  %sub60 = sub i32 %undef_row.0161194, %57
  %sub62 = sub i32 %add, %57
  %cmp63186 = icmp ult i32 %sub60, %sub62
  br i1 %cmp63186, label %while.body.preheader, label %if.end75

while.body.preheader:                             ; preds = %if.then57
  %58 = zext i32 %sub60 to i64
  br label %while.body

while.body:                                       ; preds = %while.body.preheader, %while.body
  %indvars.iv = phi i64 [ %58, %while.body.preheader ], [ %indvars.iv.next, %while.body ]
  %59 = load ptr, ptr %ptr, align 8, !tbaa !44
  %arrayidx = getelementptr inbounds ptr, ptr %59, i64 %indvars.iv
  %60 = load ptr, ptr %arrayidx, align 8, !tbaa !35
  tail call void @jzero_far(ptr noundef %60, i64 noundef %conv58) #7
...
if.end75.thread:                                  ; preds = %if.end55
  %61 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_code70 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %61, i64 0, i32 5
  store i32 20, ptr %msg_code70, align 8, !tbaa !14
  %62 = load ptr, ptr %61, align 8, !tbaa !17
  tail call void %62(ptr noundef nonnull %cinfo) #7
  br label %if.end79
...
if.then77:                                        ; preds = %if.end55.thread, %if.end75
...
if.end79:                                         ; preds = %if.end75.thread, %if.then77, %if.end75
  %63 = load ptr, ptr %ptr, align 8, !tbaa !44
  %64 = load i32, ptr %cur_start_row, align 4, !tbaa !67
  %sub82 = sub i32 %start_row, %64
  %idx.ext = zext i32 %sub82 to i64
  %add.ptr = getelementptr inbounds ptr, ptr %63, i64 %idx.ext
  ret ptr %add.ptr
}
...
for.body.lr.ph.i:                                 ; preds = %if.then18
  ...
  %.pre100.i = load i32, ptr %rowsperchunk.i, align 8, !tbaa !72
  %conv5.i169 = zext i32 %.pre100.i to i64
  %14 = tail call i64 @llvm.smin.i64(i64 %conv391.i, i64 %conv5.i169) #7
  %15 = load i32, ptr %first_undef_row.i, align 8, !tbaa !74
  %conv17.i171 = zext i32 %15 to i64
  %sub18.i172 = sub nsw i64 %conv17.i171, %conv1.i
  %16 = tail call i64 @llvm.smin.i64(i64 %14, i64 %sub18.i172) #7
  %17 = load i32, ptr %rows_in_array, align 8, !tbaa !56
  %conv28.i173 = zext i32 %17 to i64
  %sub29.i174 = sub nsw i64 %conv28.i173, %conv1.i
  %18 = tail call i64 @llvm.smin.i64(i64 %16, i64 %sub29.i174) #7
  %cmp39.i175 = icmp slt i64 %18, 1
  br i1 %cmp39.i175, label %do_barray_io.exit, label %if.end.i.preheader
...
if.end.i:                                         ; preds = %if.end.i.preheader, %if.end.for.body_crit_edge.i
  %19 = phi i64 [ %29, %if.end.for.body_crit_edge.i ], [ %18, %if.end.i.preheader ]
  %file_offset.093.i177 = phi i64 [ %add49.i, %if.end.for.body_crit_edge.i ], [ %mul2.i, %if.end.i.preheader ]
  %i.095.i176 = phi i64 [ %add52.i, %if.end.for.body_crit_edge.i ], [ 0, %if.end.i.preheader ]
  %mul41.i = mul nsw i64 %19, %mul.i
  %20 = load ptr, ptr %write_backing_store.i, align 8, !tbaa !81
  %21 = load ptr, ptr %ptr, align 8, !tbaa !54
  %arrayidx.i = getelementptr inbounds ptr, ptr %21, i64 %i.095.i176
  %22 = load ptr, ptr %arrayidx.i, align 8, !tbaa !35
  tail call void %20(ptr noundef %cinfo, ptr noundef nonnull %b_s_info.i, ptr noundef %22, i64 noundef %file_offset.093.i177, i64 noundef %mul41.i) #7
  %23 = load i32, ptr %rowsperchunk.i, align 8, !tbaa !72
  %conv51.i = zext i32 %23 to i64
  %add52.i = add nuw nsw i64 %i.095.i176, %conv51.i
  %24 = load i32, ptr %rows_in_mem.i, align 4, !tbaa !71
  %conv3.i = zext i32 %24 to i64
  %cmp.i = icmp ult i64 %add52.i, %conv3.i
  br i1 %cmp.i, label %if.end.for.body_crit_edge.i, label %do_barray_io.exit, !llvm.loop !82

if.end.for.body_crit_edge.i:                      ; preds = %if.end.i
  %add49.i = add nsw i64 %mul41.i, %file_offset.093.i177
  %.pre99.i = load i32, ptr %cur_start_row, align 4, !tbaa !73
  %sub.i = sub nsw i64 %conv3.i, %add52.i
  %25 = tail call i64 @llvm.smin.i64(i64 %sub.i, i64 %conv51.i) #7
  %conv16.i = zext i32 %.pre99.i to i64
  %add.i = add nuw nsw i64 %add52.i, %conv16.i
  %26 = load i32, ptr %first_undef_row.i, align 8, !tbaa !74
  %conv17.i = zext i32 %26 to i64
  %sub18.i = sub nsw i64 %conv17.i, %add.i
  %27 = tail call i64 @llvm.smin.i64(i64 %25, i64 %sub18.i) #7
  %28 = load i32, ptr %rows_in_array, align 8, !tbaa !56
  %conv28.i = zext i32 %28 to i64
  %sub29.i = sub nsw i64 %conv28.i, %add.i
  %29 = tail call i64 @llvm.smin.i64(i64 %27, i64 %sub29.i) #7
  %cmp39.i = icmp slt i64 %29, 1
...
do_barray_io.exit:                                ; preds = %if.end.i, %if.end.for.body_crit_edge.i, %for.body.lr.ph.i, %if.then18
  store i32 0, ptr %dirty, align 8, !tbaa !75
  br label %if.end20

if.end20:                                         ; preds = %do_barray_io.exit, %if.end16
  %30 = load i32, ptr %cur_start_row, align 4, !tbaa !73
  %cmp22 = icmp ult i32 %30, %start_row
  br i1 %cmp22, label %if.end20.if.end33_crit_edge, label %if.else
...
if.else:                                          ; preds = %if.end20
  ...
  %31 = load i32, ptr %rows_in_mem25, align 4, !tbaa !71
  %conv26 = zext i32 %31 to i64
  %sub = sub nsw i64 %conv, %conv26
  %32 = tail call i64 @llvm.smax.i64(i64 %sub, i64 0)
  %conv31 = trunc i64 %32 to i32
...
if.end33:                                         ; preds = %if.end20.if.end33_crit_edge, %if.else
  ...
  %34 = load i32, ptr %blocksperrow.i143, align 4, !tbaa !57
  %conv.i144 = zext i32 %34 to i64
...
for.body.lr.ph.i158:                              ; preds = %if.end33
  ...
  %.pre100.i157 = load i32, ptr %rowsperchunk.i147, align 8, !tbaa !72
  %conv5.us.i178 = zext i32 %.pre100.i157 to i64
  %35 = tail call i64 @llvm.smin.i64(i64 %conv391.i150, i64 %conv5.us.i178) #7
  %36 = load i32, ptr %first_undef_row.i153, align 8, !tbaa !74
  %conv17.us.i180 = zext i32 %36 to i64
  %sub18.us.i181 = sub nsw i64 %conv17.us.i180, %conv1.i151
  %37 = tail call i64 @llvm.smin.i64(i64 %35, i64 %sub18.us.i181) #7
  %38 = load i32, ptr %rows_in_array, align 8, !tbaa !56
  %conv28.us.i182 = zext i32 %38 to i64
  %sub29.us.i183 = sub nsw i64 %conv28.us.i182, %conv1.i151
  %39 = tail call i64 @llvm.smin.i64(i64 %37, i64 %sub29.us.i183) #7
  %cmp39.us.i184 = icmp slt i64 %39, 1
  br i1 %cmp39.us.i184, label %if.end34, label %if.end.us.i.preheader

if.end.us.i.preheader:                            ; preds = %for.body.lr.ph.i158
  %mul2.i152 = mul nsw i64 %mul.i145, %conv1.i151
  br label %if.end.us.i

if.end.us.i:                                      ; preds = %if.end.us.i.preheader, %if.end.us.for.body.us_crit_edge.i
  %40 = phi i64 [ %50, %if.end.us.for.body.us_crit_edge.i ], [ %39, %if.end.us.i.preheader ]
  %file_offset.093.us.i186 = phi i64 [ %add49.us.i, %if.end.us.for.body.us_crit_edge.i ], [ %mul2.i152, %if.end.us.i.preheader ]
  %i.095.us.i185 = phi i64 [ %add52.us.i, %if.end.us.for.body.us_crit_edge.i ], [ 0, %if.end.us.i.preheader ]
  %mul41.us.i = mul nsw i64 %40, %mul.i145
  %41 = load ptr, ptr %b_s_info.i155, align 8, !tbaa !83
  %42 = load ptr, ptr %ptr, align 8, !tbaa !54
  %arrayidx47.us.i = getelementptr inbounds ptr, ptr %42, i64 %i.095.us.i185
  %43 = load ptr, ptr %arrayidx47.us.i, align 8, !tbaa !35
  tail call void %41(ptr noundef %cinfo, ptr noundef nonnull %b_s_info.i155, ptr noundef %43, i64 noundef %file_offset.093.us.i186, i64 noundef %mul41.us.i) #7
  %44 = load i32, ptr %rowsperchunk.i147, align 8, !tbaa !72
  %conv51.us.i = zext i32 %44 to i64
  %add52.us.i = add nuw nsw i64 %i.095.us.i185, %conv51.us.i
  %45 = load i32, ptr %rows_in_mem.i148, align 4, !tbaa !71
  %conv3.us.i = zext i32 %45 to i64
  %cmp.us.i = icmp ult i64 %add52.us.i, %conv3.us.i
  br i1 %cmp.us.i, label %if.end.us.for.body.us_crit_edge.i, label %if.end34, !llvm.loop !82

if.end.us.for.body.us_crit_edge.i:                ; preds = %if.end.us.i
  %add49.us.i = add nsw i64 %mul41.us.i, %file_offset.093.us.i186
  %.pre101.i = load i32, ptr %cur_start_row, align 4, !tbaa !73
  %sub.us.i = sub nsw i64 %conv3.us.i, %add52.us.i
  %46 = tail call i64 @llvm.smin.i64(i64 %sub.us.i, i64 %conv51.us.i) #7
  %conv16.us.i = zext i32 %.pre101.i to i64
  %add.us.i = add nuw nsw i64 %add52.us.i, %conv16.us.i
  %47 = load i32, ptr %first_undef_row.i153, align 8, !tbaa !74
  %conv17.us.i = zext i32 %47 to i64
  %sub18.us.i = sub nsw i64 %conv17.us.i, %add.us.i
  %48 = tail call i64 @llvm.smin.i64(i64 %46, i64 %sub18.us.i) #7
  %49 = load i32, ptr %rows_in_array, align 8, !tbaa !56
  %conv28.us.i = zext i32 %49 to i64
  %sub29.us.i = sub nsw i64 %conv28.us.i, %add.us.i
  %50 = tail call i64 @llvm.smin.i64(i64 %48, i64 %sub29.us.i) #7
  %cmp39.us.i = icmp slt i64 %50, 1
...
if.end34:                                         ; preds = %if.end.us.for.body.us_crit_edge.i, %if.end.us.i, %for.body.lr.ph.i158, %if.end33, %lor.lhs.false6
  %first_undef_row = getelementptr inbounds %struct.jvirt_barray_control, ptr %ptr, i64 0, i32 7
  %51 = load i32, ptr %first_undef_row, align 8, !tbaa !74
  %cmp35 = icmp ult i32 %51, %add
  br i1 %cmp35, label %if.then37, label %if.end75
...
if.then41:                                        ; preds = %if.then37
  br i1 %tobool42.not, label %if.end55, label %if.end51.thread164
...
if.end55:                                         ; preds = %if.then41, %if.end51
  %undef_row.0162 = phi i32 [ %51, %if.end51 ], [ %start_row, %if.then41 ]
  %pre_zero = getelementptr inbounds %struct.jvirt_barray_control, ptr %ptr, i64 0, i32 8
  %54 = load i32, ptr %pre_zero, align 4, !tbaa !59
  %tobool56.not = icmp eq i32 %54, 0
  br i1 %tobool56.not, label %if.end75.thread, label %if.then57

if.end55.thread:                                  ; preds = %if.end51, %if.end51.thread164
  %undef_row.0167 = phi i32 [ %start_row, %if.end51.thread164 ], [ %51, %if.end51 ]
  store i32 %add, ptr %first_undef_row, align 8, !tbaa !74
  %pre_zero192 = getelementptr inbounds %struct.jvirt_barray_control, ptr %ptr, i64 0, i32 8
  %55 = load i32, ptr %pre_zero192, align 4, !tbaa !59
  %tobool56.not193 = icmp eq i32 %55, 0
  br i1 %tobool56.not193, label %if.then77, label %if.then57

if.then57:                                        ; preds = %if.end55.thread, %if.end55
  %undef_row.0162195 = phi i32 [ %undef_row.0167, %if.end55.thread ], [ %undef_row.0162, %if.end55 ]
  %blocksperrow = getelementptr inbounds %struct.jvirt_barray_control, ptr %ptr, i64 0, i32 2
  %56 = load i32, ptr %blocksperrow, align 4, !tbaa !57
  %conv58 = zext i32 %56 to i64
  %mul = shl nuw nsw i64 %conv58, 7
  %57 = load i32, ptr %cur_start_row, align 4, !tbaa !73
  %sub60 = sub i32 %undef_row.0162195, %57
  %sub62 = sub i32 %add, %57
  %cmp63187 = icmp ult i32 %sub60, %sub62
  br i1 %cmp63187, label %while.body.preheader, label %if.end75
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %indvars.iv = phi i64 [ %58, %while.body.preheader ], [ %indvars.iv.next, %while.body ]
  %59 = load ptr, ptr %ptr, align 8, !tbaa !54
  %arrayidx = getelementptr inbounds ptr, ptr %59, i64 %indvars.iv
  %60 = load ptr, ptr %arrayidx, align 8, !tbaa !35
  tail call void @jzero_far(ptr noundef %60, i64 noundef %mul) #7
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
  %exitcond.not = icmp eq i32 %sub62, %lftr.wideiv
...
if.end79:                                         ; preds = %if.end75.thread, %if.then77, %if.end75
  %63 = load ptr, ptr %ptr, align 8, !tbaa !54
  %64 = load i32, ptr %cur_start_row, align 4, !tbaa !73
  %sub82 = sub i32 %start_row, %64
  %idx.ext = zext i32 %sub82 to i64
  %add.ptr = getelementptr inbounds ptr, ptr %63, i64 %idx.ext
  ret ptr %add.ptr
...
entry:
  %mem1 = getelementptr inbounds %struct.jpeg_common_struct, ptr %cinfo, i64 0, i32 1
  %0 = load ptr, ptr %mem1, align 8, !tbaa !5
  %1 = icmp ugt i32 %pool_id, 1
  br i1 %1, label %if.end.thread, label %if.end
...
for.body:                                         ; preds = %if.then6, %for.inc
  ...
  %5 = load i32, ptr %b_s_open, align 4, !tbaa !51
...
if.then8:                                         ; preds = %for.body
  ...
  %6 = load ptr, ptr %close_backing_store, align 8, !tbaa !85
  tail call void %6(ptr noundef %cinfo, ptr noundef nonnull %b_s_info) #7
  br label %for.inc
...
for.end:                                          ; preds = %for.inc, %if.then6
  ...
  %virt_barray_list = getelementptr inbounds %struct.my_memory_mgr, ptr %0, i64 0, i32 4
  %bptr.0102 = load ptr, ptr %virt_barray_list, align 8, !tbaa !35
  %cmp14.not103 = icmp eq ptr %bptr.0102, null
  br i1 %cmp14.not103, label %for.end26, label %for.body15

for.body15:                                       ; preds = %for.end, %for.inc24
  %bptr.0104 = phi ptr [ %bptr.0, %for.inc24 ], [ %bptr.0102, %for.end ]
  %b_s_open16 = getelementptr inbounds %struct.jvirt_barray_control, ptr %bptr.0104, i64 0, i32 10
  %7 = load i32, ptr %b_s_open16, align 4, !tbaa !60
...
if.then18:                                        ; preds = %for.body15
  ...
  %b_s_info20 = getelementptr inbounds %struct.jvirt_barray_control, ptr %bptr.0104, i64 0, i32 12
  %close_backing_store21 = getelementptr inbounds %struct.jvirt_barray_control, ptr %bptr.0104, i64 0, i32 12, i32 2
  %8 = load ptr, ptr %close_backing_store21, align 8, !tbaa !87
  tail call void %8(ptr noundef %cinfo, ptr noundef nonnull %b_s_info20) #7
  br label %for.inc24

for.inc24:                                        ; preds = %for.body15, %if.then18
  %next25 = getelementptr inbounds %struct.jvirt_barray_control, ptr %bptr.0104, i64 0, i32 11
...
if.end28:                                         ; preds = %if.end.thread, %for.end26, %if.end
  ...
  %9 = load ptr, ptr %arrayidx29, align 8, !tbaa !35
  store ptr null, ptr %arrayidx29, align 8, !tbaa !35
  %cmp33.not106 = icmp eq ptr %9, null
  br i1 %cmp33.not106, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  %lhdr_ptr.0107 = phi ptr [ %9, %while.body.lr.ph ], [ %10, %while.body ]
  %10 = load ptr, ptr %lhdr_ptr.0107, align 8, !tbaa !16
  %bytes_used = getelementptr inbounds %struct.anon.0, ptr %lhdr_ptr.0107, i64 0, i32 1
  %11 = load i64, ptr %bytes_used, align 8, !tbaa !16
  %bytes_left = getelementptr inbounds %struct.anon.0, ptr %lhdr_ptr.0107, i64 0, i32 2
  %12 = load i64, ptr %bytes_left, align 8, !tbaa !16
  %add = add i64 %11, 24
  %add35 = add i64 %add, %12
  tail call void @jpeg_free_large(ptr noundef %cinfo, ptr noundef nonnull %lhdr_ptr.0107, i64 noundef %add35) #7
  %13 = load i64, ptr %total_space_allocated, align 8, !tbaa !32
  %sub = sub i64 %13, %add35
...
while.end:                                        ; preds = %while.body, %if.end28
  ...
  %14 = load ptr, ptr %arrayidx37, align 8, !tbaa !35
  store ptr null, ptr %arrayidx37, align 8, !tbaa !35
  %cmp42.not108 = icmp eq ptr %14, null
  br i1 %cmp42.not108, label %while.end51, label %while.body43.lr.ph
...
while.body43:                                     ; preds = %while.body43.lr.ph, %while.body43
  %shdr_ptr.0109 = phi ptr [ %14, %while.body43.lr.ph ], [ %15, %while.body43 ]
  %15 = load ptr, ptr %shdr_ptr.0109, align 8, !tbaa !16
  %bytes_used45 = getelementptr inbounds %struct.anon, ptr %shdr_ptr.0109, i64 0, i32 1
  %16 = load i64, ptr %bytes_used45, align 8, !tbaa !16
  %bytes_left46 = getelementptr inbounds %struct.anon, ptr %shdr_ptr.0109, i64 0, i32 2
  %17 = load i64, ptr %bytes_left46, align 8, !tbaa !16
  %add47 = add i64 %16, 24
  %add48 = add i64 %add47, %17
  tail call void @jpeg_free_small(ptr noundef %cinfo, ptr noundef nonnull %shdr_ptr.0109, i64 noundef %add48) #7
  %18 = load i64, ptr %total_space_allocated49, align 8, !tbaa !32
  %sub50 = sub i64 %18, %add48
  store i64 %sub50, ptr %total_space_allocated49, align 8, !tbaa !32
  %cmp42.not = icmp eq ptr %15, null
