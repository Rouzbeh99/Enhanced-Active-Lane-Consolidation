...
sw.bb47:                                          ; preds = %if.end23
  ...
  %msg_parm56 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %10, i64 0, i32 6
...
sw.bb73:                                          ; preds = %if.end23
  ...
  %msg_parm82 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %14, i64 0, i32 6
...
if.else119.sink.split:                            ; preds = %if.end23, %sw.bb32
  %.sink262 = phi i32 [ 3, %sw.bb32 ], [ 1, %if.end23 ]
  %.sink = phi i32 [ 2, %sw.bb32 ], [ 1, %if.end23 ]
  ...
  store i32 %.sink262, ptr %input_components33, align 8, !tbaa !28
  %in_color_space34 = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 9
  store i32 %.sink, ptr %in_color_space34, align 4, !tbaa !29
  ...
  %msg_parm28 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %23, i64 0, i32 6
  ...
  %25 = load ptr, ptr %emit_message, align 8, !tbaa !31
  tail call void %25(ptr noundef nonnull %cinfo, i32 noundef 1) #3
...
if.else119:                                       ; preds = %if.else119.sink.split, %if.end112
  ...
  %26 = load ptr, ptr %mem120, align 8, !tbaa !5
  %alloc_sarray = getelementptr inbounds %struct.jpeg_memory_mgr, ptr %26, i64 0, i32 2
  %27 = load ptr, ptr %alloc_sarray, align 8, !tbaa !35
  %input_components121 = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 8
  %28 = load i32, ptr %input_components121, align 8, !tbaa !28
  %mul122 = mul i32 %28, %call7
  %call123 = tail call ptr %27(ptr noundef nonnull %cinfo, i32 noundef 1, i32 noundef %mul122, i32 noundef 1) #3
...
if.then130:                                       ; preds = %if.else119, %if.end128
  ...
  %29 = load ptr, ptr %mem131, align 8, !tbaa !5
  %30 = load ptr, ptr %29, align 8, !tbaa !13
  %conv133 = zext i32 %call13 to i64
  %add = add nuw nsw i64 %conv133, 1
  %call135 = tail call ptr %30(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef %add) #3
  ...
  %div143263 = udiv i64 %conv136, %conv133
  %conv144264 = trunc i64 %div143263 to i8
  store i8 %conv144264, ptr %call135, align 1, !tbaa !30
  %exitcond.not265 = icmp eq i32 %call13, 0
  br i1 %exitcond.not265, label %if.end147, label %for.body.for.body_crit_edge.preheader, !llvm.loop !40

for.body.for.body_crit_edge.preheader:            ; preds = %if.then130
  %xtraiter = and i64 %conv133, 1
  %31 = icmp eq i32 %call13, 1
  br i1 %31, label %if.end147.loopexit.unr-lcssa, label %for.body.for.body_crit_edge.preheader.new

for.body.for.body_crit_edge.preheader.new:        ; preds = %for.body.for.body_crit_edge.preheader
  %unroll_iter = and i64 %conv133, 4294967294
...
for.body.for.body_crit_edge:                      ; preds = %for.body.for.body_crit_edge, %for.body.for.body_crit_edge.preheader.new
  %val.0259266 = phi i64 [ 0, %for.body.for.body_crit_edge.preheader.new ], [ %inc.1, %for.body.for.body_crit_edge ]
  %niter = phi i64 [ 0, %for.body.for.body_crit_edge.preheader.new ], [ %niter.next.1, %for.body.for.body_crit_edge ]
  %inc = or i64 %val.0259266, 1
  %.pre = load ptr, ptr %rescale, align 8, !tbaa !39
  %mul140 = mul nuw nsw i64 %inc, 255
  %add141 = add nuw nsw i64 %mul140, %conv136
  %div143 = udiv i64 %add141, %conv133
  %conv144 = trunc i64 %div143 to i8
  %arrayidx146 = getelementptr inbounds i8, ptr %.pre, i64 %inc
  store i8 %conv144, ptr %arrayidx146, align 1, !tbaa !30
  %inc.1 = add nuw nsw i64 %val.0259266, 2
  %.pre.1 = load ptr, ptr %rescale, align 8, !tbaa !39
  %mul140.1 = mul nuw nsw i64 %inc.1, 255
  %add141.1 = add nuw nsw i64 %mul140.1, %conv136
  %div143.1 = udiv i64 %add141.1, %conv133
  %conv144.1 = trunc i64 %div143.1 to i8
  %arrayidx146.1 = getelementptr inbounds i8, ptr %.pre.1, i64 %inc.1
  store i8 %conv144.1, ptr %arrayidx146.1, align 1, !tbaa !30
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %if.end147.loopexit.unr-lcssa.loopexit, label %for.body.for.body_crit_edge, !llvm.loop !40

if.end147.loopexit.unr-lcssa.loopexit:            ; preds = %for.body.for.body_crit_edge
  %phi.bo = add nuw i64 %val.0259266, 3
  br label %if.end147.loopexit.unr-lcssa

if.end147.loopexit.unr-lcssa:                     ; preds = %if.end147.loopexit.unr-lcssa.loopexit, %for.body.for.body_crit_edge.preheader
  %val.0259266.unr = phi i64 [ 1, %for.body.for.body_crit_edge.preheader ], [ %phi.bo, %if.end147.loopexit.unr-lcssa.loopexit ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %if.end147, label %for.body.for.body_crit_edge.epil

for.body.for.body_crit_edge.epil:                 ; preds = %if.end147.loopexit.unr-lcssa
  %.pre.epil = load ptr, ptr %rescale, align 8, !tbaa !39
  %mul140.epil = mul nuw nsw i64 %val.0259266.unr, 255
  ...
  %arrayidx146.epil = getelementptr inbounds i8, ptr %.pre.epil, i64 %val.0259266.unr
  store i8 %conv144.epil, ptr %arrayidx146.epil, align 1, !tbaa !30
  br label %if.end147

if.end147:                                        ; preds = %for.body.for.body_crit_edge.epil, %if.end147.loopexit.unr-lcssa, %if.then130, %if.else119, %if.end128
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone willreturn uwtable
define internal void @finish_input_ppm(ptr nocapture noundef %cinfo, ptr nocapture noundef %sinfo) #1 {
entry:
  ret void
}
...
do.end:                                           ; preds = %pbm_getc.exit
  %2 = add i32 %ch.0.i, -58
  %3 = icmp ult i32 %2, -10
  br i1 %3, label %if.then10, label %if.end15

if.then10:                                        ; preds = %do.end.thread, %do.end
  %4 = load ptr, ptr %cinfo, align 8, !tbaa !21
  %msg_code12 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %4, i64 0, i32 5
...
while.cond:                                       ; preds = %while.body, %if.end15
  ...
  %call.i41 = tail call i32 @getc(ptr noundef %infile) #3
  %cmp.i42 = icmp eq i32 %call.i41, 35
  br i1 %cmp.i42, label %do.body.i44, label %pbm_getc.exit46

do.body.i44:                                      ; preds = %while.cond, %do.body.i44
  %call1.i43 = tail call i32 @getc(ptr noundef %infile) #3
  switch i32 %call1.i43, label %do.body.i44 [
    i32 -1, label %pbm_getc.exit46
    i32 10, label %pbm_getc.exit46
  ]

pbm_getc.exit46:                                  ; preds = %do.body.i44, %do.body.i44, %while.cond
  %ch.0.i45 = phi i32 [ %call.i41, %while.cond ], [ %call1.i43, %do.body.i44 ], [ %call1.i43, %do.body.i44 ]
  %6 = add i32 %ch.0.i45, -48
  %7 = icmp ult i32 %6, 10
  br i1 %7, label %while.body, label %while.end

while.body:                                       ; preds = %pbm_getc.exit46
  %mul = mul i32 %val.0, 10
  %add = add i32 %6, %mul
  br label %while.cond, !llvm.loop !42

while.end:                                        ; preds = %pbm_getc.exit46
  ret i32 %val.0
}
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  %conv.prol = zext i8 %11 to i64
  %incdec.ptr7.prol = getelementptr inbounds i8, ptr %8, i64 2
  %12 = load i8, ptr %incdec.ptr.prol, align 1, !tbaa !30
  %conv8.prol = zext i8 %12 to i64
  %shl.prol = shl nuw nsw i64 %conv8.prol, 8
  %or.prol = or i64 %shl.prol, %conv.prol
  %arrayidx9.prol = getelementptr inbounds i8, ptr %0, i64 %or.prol
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  %ptr.026 = phi ptr [ %incdec.ptr10.1, %for.body ], [ %ptr.026.unr, %for.body.prol.loopexit ]
  %col.025 = phi i32 [ %dec.1, %for.body ], [ %col.025.unr, %for.body.prol.loopexit ]
  %bufferptr.024 = phi ptr [ %incdec.ptr7.1, %for.body ], [ %bufferptr.024.unr, %for.body.prol.loopexit ]
  %incdec.ptr = getelementptr inbounds i8, ptr %bufferptr.024, i64 1
  %15 = load i8, ptr %bufferptr.024, align 1, !tbaa !30
  ...
  %or = or i64 %shl, %conv
  %arrayidx9 = getelementptr inbounds i8, ptr %0, i64 %or
  ...
  %incdec.ptr.1 = getelementptr inbounds i8, ptr %bufferptr.024, i64 3
  %18 = load i8, ptr %incdec.ptr7, align 1, !tbaa !30
  %conv.1 = zext i8 %18 to i64
  %incdec.ptr7.1 = getelementptr inbounds i8, ptr %bufferptr.024, i64 4
  %19 = load i8, ptr %incdec.ptr.1, align 1, !tbaa !30
  %conv8.1 = zext i8 %19 to i64
  %shl.1 = shl nuw nsw i64 %conv8.1, 8
  %or.1 = or i64 %shl.1, %conv.1
  %arrayidx9.1 = getelementptr inbounds i8, ptr %0, i64 %or.1
  ...
  %dec.1 = add i32 %col.025, -2
  %cmp6.not.1 = icmp eq i32 %dec.1, 0
  br i1 %cmp6.not.1, label %for.end, label %for.body, !llvm.loop !46
...
for.body.prol:                                    ; preds = %for.body.preheader, %for.body.prol
  ...
  %12 = load i8, ptr %bufferptr.020.prol, align 1, !tbaa !30
  %13 = zext i8 %12 to i64
  %arrayidx7.prol = getelementptr inbounds i8, ptr %0, i64 %13
  %14 = load i8, ptr %arrayidx7.prol, align 1, !tbaa !30
  %incdec.ptr8.prol = getelementptr inbounds i8, ptr %ptr.021.prol, i64 1
  store i8 %14, ptr %ptr.021.prol, align 1, !tbaa !30
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %16 = load i8, ptr %bufferptr.020, align 1, !tbaa !30
  %17 = zext i8 %16 to i64
  %arrayidx7 = getelementptr inbounds i8, ptr %0, i64 %17
  %18 = load i8, ptr %arrayidx7, align 1, !tbaa !30
  %incdec.ptr8 = getelementptr inbounds i8, ptr %ptr.021, i64 1
  store i8 %18, ptr %ptr.021, align 1, !tbaa !30
  %incdec.ptr.1 = getelementptr inbounds i8, ptr %bufferptr.020, i64 2
  %19 = load i8, ptr %incdec.ptr, align 1, !tbaa !30
  %20 = zext i8 %19 to i64
  %arrayidx7.1 = getelementptr inbounds i8, ptr %0, i64 %20
  %21 = load i8, ptr %arrayidx7.1, align 1, !tbaa !30
  ...
  %22 = load i8, ptr %incdec.ptr.1, align 1, !tbaa !30
  %23 = zext i8 %22 to i64
  %arrayidx7.2 = getelementptr inbounds i8, ptr %0, i64 %23
  %24 = load i8, ptr %arrayidx7.2, align 1, !tbaa !30
  %incdec.ptr8.2 = getelementptr inbounds i8, ptr %ptr.021, i64 3
  store i8 %24, ptr %incdec.ptr8.1, align 1, !tbaa !30
  %incdec.ptr.3 = getelementptr inbounds i8, ptr %bufferptr.020, i64 4
  %25 = load i8, ptr %incdec.ptr.2, align 1, !tbaa !30
  %26 = zext i8 %25 to i64
  %arrayidx7.3 = getelementptr inbounds i8, ptr %0, i64 %26
  %27 = load i8, ptr %arrayidx7.3, align 1, !tbaa !30
  %incdec.ptr8.3 = getelementptr inbounds i8, ptr %ptr.021, i64 4
  store i8 %27, ptr %incdec.ptr8.2, align 1, !tbaa !30
  %dec.3 = add i32 %col.022, -4
  %cmp6.not.3 = icmp eq i32 %dec.3, 0
  br i1 %cmp6.not.3, label %for.end, label %for.body, !llvm.loop !49
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %ptr.056 = phi ptr [ %incdec.ptr28, %for.body ], [ %10, %for.body.preheader ]
  %col.055 = phi i32 [ %dec, %for.body ], [ %7, %for.body.preheader ]
  %bufferptr.054 = phi ptr [ %incdec.ptr22, %for.body ], [ %8, %for.body.preheader ]
  %incdec.ptr = getelementptr inbounds i8, ptr %bufferptr.054, i64 1
  %11 = load i8, ptr %bufferptr.054, align 1, !tbaa !30
  %conv = zext i8 %11 to i64
  %incdec.ptr7 = getelementptr inbounds i8, ptr %bufferptr.054, i64 2
  %12 = load i8, ptr %incdec.ptr, align 1, !tbaa !30
  %conv8 = zext i8 %12 to i64
  %shl = shl nuw nsw i64 %conv8, 8
  %or = or i64 %shl, %conv
  %arrayidx9 = getelementptr inbounds i8, ptr %0, i64 %or
  %13 = load i8, ptr %arrayidx9, align 1, !tbaa !30
  %incdec.ptr10 = getelementptr inbounds i8, ptr %ptr.056, i64 1
  store i8 %13, ptr %ptr.056, align 1, !tbaa !30
  %incdec.ptr11 = getelementptr inbounds i8, ptr %bufferptr.054, i64 3
  %14 = load i8, ptr %incdec.ptr7, align 1, !tbaa !30
  %conv12 = zext i8 %14 to i64
  %incdec.ptr13 = getelementptr inbounds i8, ptr %bufferptr.054, i64 4
  %15 = load i8, ptr %incdec.ptr11, align 1, !tbaa !30
  %conv14 = zext i8 %15 to i64
  %shl15 = shl nuw nsw i64 %conv14, 8
  %or16 = or i64 %shl15, %conv12
  %arrayidx18 = getelementptr inbounds i8, ptr %0, i64 %or16
  %16 = load i8, ptr %arrayidx18, align 1, !tbaa !30
  %incdec.ptr19 = getelementptr inbounds i8, ptr %ptr.056, i64 2
  store i8 %16, ptr %incdec.ptr10, align 1, !tbaa !30
  %incdec.ptr20 = getelementptr inbounds i8, ptr %bufferptr.054, i64 5
  %17 = load i8, ptr %incdec.ptr13, align 1, !tbaa !30
  %conv21 = zext i8 %17 to i64
  %incdec.ptr22 = getelementptr inbounds i8, ptr %bufferptr.054, i64 6
  %18 = load i8, ptr %incdec.ptr20, align 1, !tbaa !30
  %conv23 = zext i8 %18 to i64
  %shl24 = shl nuw nsw i64 %conv23, 8
  %or25 = or i64 %shl24, %conv21
  %arrayidx27 = getelementptr inbounds i8, ptr %0, i64 %or25
  %19 = load i8, ptr %arrayidx27, align 1, !tbaa !30
  %incdec.ptr28 = getelementptr inbounds i8, ptr %ptr.056, i64 3
  store i8 %19, ptr %incdec.ptr19, align 1, !tbaa !30
  %dec = add i32 %col.055, -1
  %cmp6.not = icmp eq i32 %dec, 0
  br i1 %cmp6.not, label %for.end, label %for.body, !llvm.loop !50
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  %arrayidx7.prol = getelementptr inbounds i8, ptr %0, i64 %12
  %13 = load i8, ptr %arrayidx7.prol, align 1, !tbaa !30
  %incdec.ptr8.prol = getelementptr inbounds i8, ptr %10, i64 1
  store i8 %13, ptr %10, align 1, !tbaa !30
  %incdec.ptr9.prol = getelementptr inbounds i8, ptr %8, i64 2
  %14 = load i8, ptr %incdec.ptr.prol, align 1, !tbaa !30
  %15 = zext i8 %14 to i64
  %arrayidx12.prol = getelementptr inbounds i8, ptr %0, i64 %15
  %16 = load i8, ptr %arrayidx12.prol, align 1, !tbaa !30
  %incdec.ptr13.prol = getelementptr inbounds i8, ptr %10, i64 2
  store i8 %16, ptr %incdec.ptr8.prol, align 1, !tbaa !30
  %incdec.ptr14.prol = getelementptr inbounds i8, ptr %8, i64 3
  %17 = load i8, ptr %incdec.ptr9.prol, align 1, !tbaa !30
  %18 = zext i8 %17 to i64
  %arrayidx17.prol = getelementptr inbounds i8, ptr %0, i64 %18
  %19 = load i8, ptr %arrayidx17.prol, align 1, !tbaa !30
  %incdec.ptr18.prol = getelementptr inbounds i8, ptr %10, i64 3
  store i8 %19, ptr %incdec.ptr13.prol, align 1, !tbaa !30
  %dec.prol = add i32 %7, -1
  br label %for.body.prol.loopexit
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %21 = load i8, ptr %bufferptr.036, align 1, !tbaa !30
  %22 = zext i8 %21 to i64
  %arrayidx7 = getelementptr inbounds i8, ptr %0, i64 %22
  %23 = load i8, ptr %arrayidx7, align 1, !tbaa !30
  %incdec.ptr8 = getelementptr inbounds i8, ptr %ptr.037, i64 1
  store i8 %23, ptr %ptr.037, align 1, !tbaa !30
  %incdec.ptr9 = getelementptr inbounds i8, ptr %bufferptr.036, i64 2
  %24 = load i8, ptr %incdec.ptr, align 1, !tbaa !30
  %25 = zext i8 %24 to i64
  %arrayidx12 = getelementptr inbounds i8, ptr %0, i64 %25
  %26 = load i8, ptr %arrayidx12, align 1, !tbaa !30
  %incdec.ptr13 = getelementptr inbounds i8, ptr %ptr.037, i64 2
  store i8 %26, ptr %incdec.ptr8, align 1, !tbaa !30
  %incdec.ptr14 = getelementptr inbounds i8, ptr %bufferptr.036, i64 3
  %27 = load i8, ptr %incdec.ptr9, align 1, !tbaa !30
  %28 = zext i8 %27 to i64
  %arrayidx17 = getelementptr inbounds i8, ptr %0, i64 %28
  %29 = load i8, ptr %arrayidx17, align 1, !tbaa !30
  %incdec.ptr18 = getelementptr inbounds i8, ptr %ptr.037, i64 3
  store i8 %29, ptr %incdec.ptr13, align 1, !tbaa !30
  %incdec.ptr.1 = getelementptr inbounds i8, ptr %bufferptr.036, i64 4
  %30 = load i8, ptr %incdec.ptr14, align 1, !tbaa !30
  %31 = zext i8 %30 to i64
  %arrayidx7.1 = getelementptr inbounds i8, ptr %0, i64 %31
  %32 = load i8, ptr %arrayidx7.1, align 1, !tbaa !30
  %incdec.ptr8.1 = getelementptr inbounds i8, ptr %ptr.037, i64 4
  store i8 %32, ptr %incdec.ptr18, align 1, !tbaa !30
  %incdec.ptr9.1 = getelementptr inbounds i8, ptr %bufferptr.036, i64 5
  %33 = load i8, ptr %incdec.ptr.1, align 1, !tbaa !30
  %34 = zext i8 %33 to i64
  %arrayidx12.1 = getelementptr inbounds i8, ptr %0, i64 %34
  %35 = load i8, ptr %arrayidx12.1, align 1, !tbaa !30
  %incdec.ptr13.1 = getelementptr inbounds i8, ptr %ptr.037, i64 5
  store i8 %35, ptr %incdec.ptr8.1, align 1, !tbaa !30
  %incdec.ptr14.1 = getelementptr inbounds i8, ptr %bufferptr.036, i64 6
  %36 = load i8, ptr %incdec.ptr9.1, align 1, !tbaa !30
  %37 = zext i8 %36 to i64
  %arrayidx17.1 = getelementptr inbounds i8, ptr %0, i64 %37
  %38 = load i8, ptr %arrayidx17.1, align 1, !tbaa !30
  %incdec.ptr18.1 = getelementptr inbounds i8, ptr %ptr.037, i64 6
  store i8 %38, ptr %incdec.ptr13.1, align 1, !tbaa !30
