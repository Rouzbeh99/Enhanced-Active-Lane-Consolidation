...
if.else:                                          ; preds = %entry
  ...
  %upmethod11 = getelementptr inbounds %struct.my_upsampler, ptr %call, i64 0, i32 1
  store ptr @h2v1_merged_upsample, ptr %upmethod11, align 8, !tbaa !26
  br label %if.end
...
; Function Attrs: nounwind uwtable
define internal void @merged_2v_upsample(ptr noundef %cinfo, ptr noundef %input_buf, ptr nocapture noundef %in_row_group_ctr, i32 noundef %in_row_groups_avail, ptr noundef %output_buf, ptr nocapture noundef %out_row_ctr, i32 noundef %out_rows_avail) #0 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  %6 = tail call i32 @llvm.umin.i32(i32 %4, i32 %sub)
  %7 = tail call i32 @llvm.umin.i32(i32 %6, i32 2)
  %idxprom = zext i32 %5 to i64
  %arrayidx = getelementptr inbounds ptr, ptr %output_buf, i64 %idxprom
  %8 = load ptr, ptr %arrayidx, align 8, !tbaa !39
  store ptr %8, ptr %work_ptrs, align 16, !tbaa !39
...
if.then10:                                        ; preds = %if.else
  ...
  %9 = load ptr, ptr %arrayidx12, align 8, !tbaa !39
  br label %if.end18

if.else14:                                        ; preds = %if.else
  %spare_row15 = getelementptr inbounds %struct.my_upsampler, ptr %0, i64 0, i32 6
  %10 = load ptr, ptr %spare_row15, align 8, !tbaa !40
  store i32 1, ptr %spare_full, align 8, !tbaa !36
  br label %if.end18

if.end18:                                         ; preds = %if.else14, %if.then10
  %.sink = phi ptr [ %9, %if.then10 ], [ %10, %if.else14 ]
  %11 = getelementptr inbounds [2 x ptr], ptr %work_ptrs, i64 0, i64 1
  store ptr %.sink, ptr %11, align 8
  %upmethod = getelementptr inbounds %struct.my_upsampler, ptr %0, i64 0, i32 1
  %12 = load ptr, ptr %upmethod, align 8, !tbaa !26
  %13 = load i32, ptr %in_row_group_ctr, align 4, !tbaa !32
  call void %12(ptr noundef nonnull %cinfo, ptr noundef %input_buf, i32 noundef %13, ptr noundef nonnull %work_ptrs) #6
  br label %if.end19

if.end19:                                         ; preds = %if.end18, %if.then
  %num_rows.2 = phi i32 [ 1, %if.then ], [ %7, %if.end18 ]
  %14 = load i32, ptr %out_row_ctr, align 4, !tbaa !32
  %add20 = add i32 %14, %num_rows.2
  store i32 %add20, ptr %out_row_ctr, align 4, !tbaa !32
  %rows_to_go21 = getelementptr inbounds %struct.my_upsampler, ptr %0, i64 0, i32 9
  %15 = load i32, ptr %rows_to_go21, align 8, !tbaa !38
  %sub22 = sub i32 %15, %num_rows.2
  store i32 %sub22, ptr %rows_to_go21, align 8, !tbaa !38
  %16 = load i32, ptr %spare_full, align 8, !tbaa !36
  %tobool24.not = icmp eq i32 %16, 0
  br i1 %tobool24.not, label %if.then25, label %if.end26

if.then25:                                        ; preds = %if.end19
  %17 = load i32, ptr %in_row_group_ctr, align 4, !tbaa !32
  %inc = add i32 %17, 1
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  %41 = phi i32 [ %15, %entry ], [ %.pre, %for.end.loopexit ]
...
if.then:                                          ; preds = %for.end
  %42 = load i8, ptr %inptr1.0.lcssa, align 1, !tbaa !42
  %43 = load i8, ptr %inptr2.0.lcssa, align 1, !tbaa !42
  %44 = zext i8 %43 to i64
  %arrayidx91 = getelementptr inbounds i32, ptr %2, i64 %44
  %45 = load i32, ptr %arrayidx91, align 4, !tbaa !32
  %46 = zext i8 %42 to i64
  %arrayidx93 = getelementptr inbounds i64, ptr %5, i64 %46
  %47 = load i64, ptr %arrayidx93, align 8, !tbaa !33
  %arrayidx95 = getelementptr inbounds i64, ptr %4, i64 %44
  %48 = load i64, ptr %arrayidx95, align 8, !tbaa !33
  %add96 = add nsw i64 %48, %47
  %49 = lshr i64 %add96, 16
  %conv98 = trunc i64 %49 to i32
  %arrayidx100 = getelementptr inbounds i32, ptr %3, i64 %46
  %50 = load i32, ptr %arrayidx100, align 4, !tbaa !32
  %51 = load i8, ptr %inptr00.0.lcssa, align 1, !tbaa !42
  %conv101 = zext i8 %51 to i32
  %add102 = add nsw i32 %45, %conv101
  %idxprom103 = sext i32 %add102 to i64
  %arrayidx104 = getelementptr inbounds i8, ptr %1, i64 %idxprom103
  %52 = load i8, ptr %arrayidx104, align 1, !tbaa !42
  store i8 %52, ptr %outptr0.0.lcssa, align 1, !tbaa !42
  %add106 = add nsw i32 %conv101, %conv98
  %idxprom107 = sext i32 %add106 to i64
  %arrayidx108 = getelementptr inbounds i8, ptr %1, i64 %idxprom107
  %53 = load i8, ptr %arrayidx108, align 1, !tbaa !42
  %arrayidx109 = getelementptr inbounds i8, ptr %outptr0.0.lcssa, i64 1
  store i8 %53, ptr %arrayidx109, align 1, !tbaa !42
  %add110 = add nsw i32 %50, %conv101
  %idxprom111 = sext i32 %add110 to i64
  %arrayidx112 = getelementptr inbounds i8, ptr %1, i64 %idxprom111
  %54 = load i8, ptr %arrayidx112, align 1, !tbaa !42
  %arrayidx113 = getelementptr inbounds i8, ptr %outptr0.0.lcssa, i64 2
  store i8 %54, ptr %arrayidx113, align 1, !tbaa !42
  %55 = load i8, ptr %inptr01.0.lcssa, align 1, !tbaa !42
  %conv114 = zext i8 %55 to i32
  %add115 = add nsw i32 %45, %conv114
  %idxprom116 = sext i32 %add115 to i64
  %arrayidx117 = getelementptr inbounds i8, ptr %1, i64 %idxprom116
  %56 = load i8, ptr %arrayidx117, align 1, !tbaa !42
  store i8 %56, ptr %outptr1.0.lcssa, align 1, !tbaa !42
  ...
  %57 = load i8, ptr %arrayidx121, align 1, !tbaa !42
  %arrayidx122 = getelementptr inbounds i8, ptr %outptr1.0.lcssa, i64 1
  store i8 %57, ptr %arrayidx122, align 1, !tbaa !42
  %add123 = add nsw i32 %50, %conv114
  %idxprom124 = sext i32 %add123 to i64
  %arrayidx125 = getelementptr inbounds i8, ptr %1, i64 %idxprom124
  %58 = load i8, ptr %arrayidx125, align 1, !tbaa !42
  %arrayidx126 = getelementptr inbounds i8, ptr %outptr1.0.lcssa, i64 2
  store i8 %58, ptr %arrayidx126, align 1, !tbaa !42
  br label %if.end
...
; Function Attrs: nounwind uwtable
define internal void @merged_1v_upsample(ptr noundef %cinfo, ptr noundef %input_buf, ptr nocapture noundef %in_row_group_ctr, i32 noundef %in_row_groups_avail, ptr noundef %output_buf, ptr nocapture noundef %out_row_ctr, i32 noundef %out_rows_avail) #0 {
entry:
  %upsample1 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 81
  %0 = load ptr, ptr %upsample1, align 8, !tbaa !16
  %upmethod = getelementptr inbounds %struct.my_upsampler, ptr %0, i64 0, i32 1
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx13 = getelementptr inbounds i32, ptr %2, i64 %16
  %17 = load i32, ptr %arrayidx13, align 4, !tbaa !32
  %18 = zext i8 %14 to i64
  %arrayidx15 = getelementptr inbounds i64, ptr %5, i64 %18
  %19 = load i64, ptr %arrayidx15, align 8, !tbaa !33
  %arrayidx17 = getelementptr inbounds i64, ptr %4, i64 %16
  %20 = load i64, ptr %arrayidx17, align 8, !tbaa !33
  %add = add nsw i64 %20, %19
  %21 = lshr i64 %add, 16
  %conv19 = trunc i64 %21 to i32
  %arrayidx21 = getelementptr inbounds i32, ptr %3, i64 %18
  %22 = load i32, ptr %arrayidx21, align 4, !tbaa !32
  %incdec.ptr22 = getelementptr inbounds i8, ptr %inptr0.0137, i64 1
  %23 = load i8, ptr %inptr0.0137, align 1, !tbaa !42
  %conv23 = zext i8 %23 to i32
  %add24 = add nsw i32 %17, %conv23
  %idxprom25 = sext i32 %add24 to i64
  %arrayidx26 = getelementptr inbounds i8, ptr %1, i64 %idxprom25
  %24 = load i8, ptr %arrayidx26, align 1, !tbaa !42
  store i8 %24, ptr %outptr.0136, align 1, !tbaa !42
  %add28 = add nsw i32 %conv23, %conv19
  %idxprom29 = sext i32 %add28 to i64
  %arrayidx30 = getelementptr inbounds i8, ptr %1, i64 %idxprom29
  %25 = load i8, ptr %arrayidx30, align 1, !tbaa !42
  %arrayidx31 = getelementptr inbounds i8, ptr %outptr.0136, i64 1
  store i8 %25, ptr %arrayidx31, align 1, !tbaa !42
  %add32 = add nsw i32 %22, %conv23
  %idxprom33 = sext i32 %add32 to i64
  %arrayidx34 = getelementptr inbounds i8, ptr %1, i64 %idxprom33
  %26 = load i8, ptr %arrayidx34, align 1, !tbaa !42
  %arrayidx35 = getelementptr inbounds i8, ptr %outptr.0136, i64 2
  store i8 %26, ptr %arrayidx35, align 1, !tbaa !42
  %add.ptr = getelementptr inbounds i8, ptr %outptr.0136, i64 3
  %incdec.ptr36 = getelementptr inbounds i8, ptr %inptr0.0137, i64 2
  %27 = load i8, ptr %incdec.ptr22, align 1, !tbaa !42
  %conv37 = zext i8 %27 to i32
  %add38 = add nsw i32 %17, %conv37
  %idxprom39 = sext i32 %add38 to i64
  %arrayidx40 = getelementptr inbounds i8, ptr %1, i64 %idxprom39
  %28 = load i8, ptr %arrayidx40, align 1, !tbaa !42
  ...
  %29 = load i8, ptr %arrayidx44, align 1, !tbaa !42
  %arrayidx45 = getelementptr inbounds i8, ptr %outptr.0136, i64 4
  store i8 %29, ptr %arrayidx45, align 1, !tbaa !42
  %add46 = add nsw i32 %22, %conv37
  %idxprom47 = sext i32 %add46 to i64
  %arrayidx48 = getelementptr inbounds i8, ptr %1, i64 %idxprom47
  %30 = load i8, ptr %arrayidx48, align 1, !tbaa !42
  %arrayidx49 = getelementptr inbounds i8, ptr %outptr.0136, i64 5
  store i8 %30, ptr %arrayidx49, align 1, !tbaa !42
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  %31 = phi i32 [ %13, %entry ], [ %.pre, %for.end.loopexit ]
...
if.then:                                          ; preds = %for.end
  %32 = load i8, ptr %inptr1.0.lcssa, align 1, !tbaa !42
  %33 = load i8, ptr %inptr2.0.lcssa, align 1, !tbaa !42
  %34 = zext i8 %33 to i64
  %arrayidx55 = getelementptr inbounds i32, ptr %2, i64 %34
  %35 = load i32, ptr %arrayidx55, align 4, !tbaa !32
  %36 = zext i8 %32 to i64
  %arrayidx57 = getelementptr inbounds i64, ptr %5, i64 %36
  %37 = load i64, ptr %arrayidx57, align 8, !tbaa !33
  %arrayidx59 = getelementptr inbounds i64, ptr %4, i64 %34
  %38 = load i64, ptr %arrayidx59, align 8, !tbaa !33
  %add60 = add nsw i64 %38, %37
  %39 = lshr i64 %add60, 16
  %conv62 = trunc i64 %39 to i32
  %arrayidx64 = getelementptr inbounds i32, ptr %3, i64 %36
  %40 = load i32, ptr %arrayidx64, align 4, !tbaa !32
  %41 = load i8, ptr %inptr0.0.lcssa, align 1, !tbaa !42
  %conv65 = zext i8 %41 to i32
  %add66 = add nsw i32 %35, %conv65
  %idxprom67 = sext i32 %add66 to i64
  %arrayidx68 = getelementptr inbounds i8, ptr %1, i64 %idxprom67
  %42 = load i8, ptr %arrayidx68, align 1, !tbaa !42
  store i8 %42, ptr %outptr.0.lcssa, align 1, !tbaa !42
  %add70 = add nsw i32 %conv65, %conv62
  %idxprom71 = sext i32 %add70 to i64
  %arrayidx72 = getelementptr inbounds i8, ptr %1, i64 %idxprom71
  %43 = load i8, ptr %arrayidx72, align 1, !tbaa !42
  %arrayidx73 = getelementptr inbounds i8, ptr %outptr.0.lcssa, i64 1
  store i8 %43, ptr %arrayidx73, align 1, !tbaa !42
  %add74 = add nsw i32 %40, %conv65
  %idxprom75 = sext i32 %add74 to i64
  %arrayidx76 = getelementptr inbounds i8, ptr %1, i64 %idxprom75
  %44 = load i8, ptr %arrayidx76, align 1, !tbaa !42
  %arrayidx77 = getelementptr inbounds i8, ptr %outptr.0.lcssa, i64 2
  store i8 %44, ptr %arrayidx77, align 1, !tbaa !42
  br label %if.end
