...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %whole_image, i8 0, i64 16, i1 false)
...
if.then3:                                         ; preds = %if.then
  ...
  %call10 = tail call ptr %5(ptr noundef nonnull %cinfo, i32 noundef 1, i32 noundef 0, i32 noundef %mul, i32 noundef %conv8, i32 noundef %9) #5
...
if.else:                                          ; preds = %if.then
  ...
  %11 = load i32, ptr %output_width13, align 8, !tbaa !24
  %out_color_components14 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 28
  %12 = load i32, ptr %out_color_components14, align 8, !tbaa !25
  %mul15 = mul i32 %12, %11
...
entry:
  ...
  %3 = tail call i32 @llvm.umin.i32(i32 %sub, i32 %2)
  store i32 0, ptr %num_rows, align 4, !tbaa !41
  %upsample = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 81
  %4 = load ptr, ptr %upsample, align 8, !tbaa !32
  %upsample3 = getelementptr inbounds %struct.jpeg_upsampler, ptr %4, i64 0, i32 1
  %5 = load ptr, ptr %upsample3, align 8, !tbaa !33
  %buffer = getelementptr inbounds %struct.my_post_controller, ptr %0, i64 0, i32 2
  %6 = load ptr, ptr %buffer, align 8, !tbaa !29
  call void %5(ptr noundef %cinfo, ptr noundef %input_buf, ptr noundef %in_row_group_ctr, i32 noundef %in_row_groups_avail, ptr noundef %6, ptr noundef nonnull %num_rows, i32 noundef %3) #5
  %cquantize = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 83
  %7 = load ptr, ptr %cquantize, align 8, !tbaa !42
  %color_quantize = getelementptr inbounds %struct.jpeg_color_quantizer, ptr %7, i64 0, i32 1
  %8 = load ptr, ptr %color_quantize, align 8, !tbaa !43
  %9 = load ptr, ptr %buffer, align 8, !tbaa !29
  ...
  call void %8(ptr noundef %cinfo, ptr noundef %9, ptr noundef %add.ptr, i32 noundef %11) #5
  %12 = load i32, ptr %num_rows, align 4, !tbaa !41
  %13 = load i32, ptr %out_row_ctr, align 4, !tbaa !41
  %add = add i32 %13, %12
...
; Function Attrs: nounwind uwtable
define internal void @post_process_prepass(ptr noundef %cinfo, ptr noundef %input_buf, ptr noundef %in_row_group_ctr, i32 noundef %in_row_groups_avail, ptr nocapture noundef readnone %output_buf, ptr nocapture noundef %out_row_ctr, i32 noundef %out_rows_avail) #0 {
entry:
  %post1 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 76
  %0 = load ptr, ptr %post1, align 8, !tbaa !16
  %next_row = getelementptr inbounds %struct.my_post_controller, ptr %0, i64 0, i32 5
...
; Function Attrs: nounwind uwtable
define internal void @post_process_2pass(ptr noundef %cinfo, ptr nocapture noundef readnone %input_buf, ptr nocapture noundef readnone %in_row_group_ctr, i32 noundef %in_row_groups_avail, ptr noundef %output_buf, ptr nocapture noundef %out_row_ctr, i32 noundef %out_rows_avail) #0 {
entry:
  %post1 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 76
  %0 = load ptr, ptr %post1, align 8, !tbaa !16
  %next_row = getelementptr inbounds %struct.my_post_controller, ptr %0, i64 0, i32 5
...
entry.if.end_crit_edge:                           ; preds = %entry
  ...
  %.pre58 = load ptr, ptr %buffer13.phi.trans.insert, align 8, !tbaa !29
  br label %if.end
...
if.end:                                           ; preds = %entry.if.end_crit_edge, %if.then
  %7 = phi ptr [ %call, %if.then ], [ %.pre58, %entry.if.end_crit_edge ]
  %8 = phi i32 [ %.pre, %if.then ], [ %1, %entry.if.end_crit_edge ]
  ...
  %output_height = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 27
  %12 = load i32, ptr %output_height, align 4, !tbaa !26
  %starting_row8 = getelementptr inbounds %struct.my_post_controller, ptr %0, i64 0, i32 4
  %13 = load i32, ptr %starting_row8, align 4, !tbaa !40
  %sub9 = sub i32 %12, %13
  %14 = tail call i32 @llvm.umin.i32(i32 %11, i32 %sub9)
  %cquantize = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 83
  %15 = load ptr, ptr %cquantize, align 8, !tbaa !42
  %color_quantize = getelementptr inbounds %struct.jpeg_color_quantizer, ptr %15, i64 0, i32 1
  %16 = load ptr, ptr %color_quantize, align 8, !tbaa !43
  %idx.ext = zext i32 %8 to i64
  ...
  tail call void %16(ptr noundef nonnull %cinfo, ptr noundef %add.ptr, ptr noundef %add.ptr16, i32 noundef %14) #5
  %17 = load i32, ptr %out_row_ctr, align 4, !tbaa !41
  %add = add i32 %17, %14
  store i32 %add, ptr %out_row_ctr, align 4, !tbaa !41
  %18 = load i32, ptr %next_row, align 8, !tbaa !39
  %add18 = add i32 %18, %14
  store i32 %add18, ptr %next_row, align 8, !tbaa !39
  %19 = load i32, ptr %strip_height2, align 8, !tbaa !22
  %cmp21.not = icmp ult i32 %add18, %19
  br i1 %cmp21.not, label %if.end27, label %if.then22

if.then22:                                        ; preds = %if.end
  %20 = load i32, ptr %starting_row8, align 4, !tbaa !40
  %add25 = add i32 %20, %19
