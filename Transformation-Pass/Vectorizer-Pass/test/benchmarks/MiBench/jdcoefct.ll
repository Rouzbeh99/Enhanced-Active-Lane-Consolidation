...
if.else:                                          ; preds = %entry
  ...
  %16 = insertelement <2 x ptr> poison, ptr %call20, i64 0
  ...
  store <2 x ptr> %18, ptr %arrayidx26.1, align 8, !tbaa !31
  ...
  store <2 x ptr> %19, ptr %arrayidx26.3, align 8, !tbaa !31
  ...
  store <2 x ptr> %20, ptr %arrayidx26.5, align 8, !tbaa !31
  ...
  store <2 x ptr> %21, ptr %arrayidx26.7, align 8, !tbaa !31
...
if.else.i:                                        ; preds = %entry
  ...
  %2 = load i32, ptr %total_iMCU_rows.i, align 8, !tbaa !40
...
if.else5.i:                                       ; preds = %if.else.i
  ...
  %5 = load i32, ptr %last_row_height.i, align 8, !tbaa !41
  br label %start_iMCU_row.exit
...
start_iMCU_row.exit:                              ; preds = %entry, %if.then3.i, %if.else5.i
  ...
  store i32 %.sink.i, ptr %MCU_rows_per_iMCU_row4.i, align 8, !tbaa !42
...
for.body61.preheader.i:                           ; preds = %if.end50.i
  ...
  %33 = insertelement <4 x i32> %32, i32 %26, i64 2
  %34 = insertelement <4 x i32> %33, i32 %25, i64 3
  %.fr = freeze <4 x i32> %34
  %35 = icmp ne <4 x i32> %.fr, zeroinitializer
  %36 = bitcast <4 x i1> %35 to i4
  %37 = icmp eq i4 %36, 0
  %38 = select i1 %37, i1 %cmp68.not.i, i1 false
  %spec.select.4.i = select i1 %38, i32 %smoothing_useful.0112.i, i32 1
  ...
  %39 = load i32, ptr %num_components9.i, align 8, !tbaa !22
  %40 = sext i32 %39 to i64
  %cmp10.i = icmp slt i64 %indvars.iv.next.i, %40
...
for.end:                                          ; preds = %for.body, %entry
  ...
  %12 = load i32, ptr %MCU_rows_per_iMCU_row, align 8, !tbaa !42
...
for.body9.lr.ph:                                  ; preds = %for.end
  ...
  %.pre154 = load i32, ptr %MCUs_per_row, align 8, !tbaa !55
  br label %for.body9

for.body9:                                        ; preds = %for.body9.lr.ph, %for.end50
  %14 = phi i32 [ %12, %for.body9.lr.ph ], [ %59, %for.end50 ]
  %15 = phi i32 [ %.pre154, %for.body9.lr.ph ], [ %60, %for.end50 ]
  %16 = phi i32 [ %.pre, %for.body9.lr.ph ], [ 0, %for.end50 ]
  %indvars.iv151 = phi i64 [ %13, %for.body9.lr.ph ], [ %indvars.iv.next152, %for.end50 ]
...
for.body16.preheader:                             ; preds = %for.cond13.preheader
  %wide.trip.count149 = zext i32 %17 to i64
  br label %for.body16

for.body16:                                       ; preds = %for.body16.preheader, %for.inc41
  %indvars.iv146 = phi i64 [ 0, %for.body16.preheader ], [ %indvars.iv.next147, %for.inc41 ]
  %blkn.0127 = phi i32 [ 0, %for.body16.preheader ], [ %blkn.1.lcssa, %for.inc41 ]
  %arrayidx19 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63, i64 %indvars.iv146
...
for.body23.lr.ph:                                 ; preds = %for.body16
  ...
  %arrayidx25 = getelementptr inbounds [4 x ptr], ptr %buffer, i64 0, i64 %indvars.iv146
...
for.body23.us.preheader:                          ; preds = %for.body23.lr.ph
  ...
  %29 = shl nuw nsw i64 %n.vec, 7
  %xtraiter = and i64 %28, 3
  %30 = icmp ult i64 %26, 12
  %unroll_iter = and i64 %28, 9223372036854775804
...
for.body23.us:                                    ; preds = %for.body23.us.preheader, %for.cond28.for.inc38_crit_edge.us
  %indvars.iv141 = phi i64 [ 0, %for.body23.us.preheader ], [ %indvars.iv.next142, %for.cond28.for.inc38_crit_edge.us ]
  %blkn.1123.us = phi i32 [ %blkn.0127, %for.body23.us.preheader ], [ %34, %for.cond28.for.inc38_crit_edge.us ]
  %31 = add nsw i64 %indvars.iv141, %indvars.iv151
  %arrayidx27.us = getelementptr inbounds ptr, ptr %21, i64 %31
  %32 = load ptr, ptr %arrayidx27.us, align 8, !tbaa !31
  %add.ptr.us = getelementptr inbounds [64 x i16], ptr %32, i64 %idx.ext
  %33 = sext i32 %blkn.1123.us to i64
  %34 = add i32 %19, %blkn.1123.us
...
vector.ph:                                        ; preds = %for.body23.us
  ...
  %ind.end163 = getelementptr i8, ptr %add.ptr.us, i64 %29
...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  %35 = getelementptr i8, ptr %pointer.phi, <2 x i64> <i64 0, i64 128>
  %36 = getelementptr i8, ptr %pointer.phi, <2 x i64> <i64 256, i64 384>
  %offset.idx = add i64 %index, %33
  %37 = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 4, i64 %offset.idx
  store <2 x ptr> %35, ptr %37, align 8, !tbaa !31
  %38 = getelementptr inbounds ptr, ptr %37, i64 2
  store <2 x ptr> %36, ptr %38, align 8, !tbaa !31
  %index.next = or i64 %index, 4
  %ptr.ind = getelementptr i8, ptr %pointer.phi, i64 512
  %39 = getelementptr i8, ptr %ptr.ind, <2 x i64> <i64 0, i64 128>
  %40 = getelementptr i8, ptr %ptr.ind, <2 x i64> <i64 256, i64 384>
  %offset.idx.1 = add i64 %index.next, %33
  %41 = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 4, i64 %offset.idx.1
  store <2 x ptr> %39, ptr %41, align 8, !tbaa !31
  %42 = getelementptr inbounds ptr, ptr %41, i64 2
  store <2 x ptr> %40, ptr %42, align 8, !tbaa !31
  %index.next.1 = or i64 %index, 8
  %ptr.ind.1 = getelementptr i8, ptr %pointer.phi, i64 1024
  %43 = getelementptr i8, ptr %ptr.ind.1, <2 x i64> <i64 0, i64 128>
  %44 = getelementptr i8, ptr %ptr.ind.1, <2 x i64> <i64 256, i64 384>
  %offset.idx.2 = add i64 %index.next.1, %33
  %45 = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 4, i64 %offset.idx.2
  store <2 x ptr> %43, ptr %45, align 8, !tbaa !31
  %46 = getelementptr inbounds ptr, ptr %45, i64 2
  store <2 x ptr> %44, ptr %46, align 8, !tbaa !31
  %index.next.2 = or i64 %index, 12
  %ptr.ind.2 = getelementptr i8, ptr %pointer.phi, i64 1536
  %47 = getelementptr i8, ptr %ptr.ind.2, <2 x i64> <i64 0, i64 128>
  %48 = getelementptr i8, ptr %ptr.ind.2, <2 x i64> <i64 256, i64 384>
  %offset.idx.3 = add i64 %index.next.2, %33
  %49 = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 4, i64 %offset.idx.3
  store <2 x ptr> %47, ptr %49, align 8, !tbaa !31
  %50 = getelementptr inbounds ptr, ptr %49, i64 2
  store <2 x ptr> %48, ptr %50, align 8, !tbaa !31
  ...
  br i1 %niter.ncmp.3, label %middle.block.unr-lcssa, label %vector.body, !llvm.loop !58
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa, %vector.body.epil
  ...
  %51 = getelementptr i8, ptr %pointer.phi.epil, <2 x i64> <i64 0, i64 128>
  %52 = getelementptr i8, ptr %pointer.phi.epil, <2 x i64> <i64 256, i64 384>
  %offset.idx.epil = add i64 %index.epil, %33
  %53 = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 4, i64 %offset.idx.epil
  store <2 x ptr> %51, ptr %53, align 8, !tbaa !31
  %54 = getelementptr inbounds ptr, ptr %53, i64 2
  store <2 x ptr> %52, ptr %54, align 8, !tbaa !31
  %index.next.epil = add nuw i64 %index.epil, 4
  %ptr.ind.epil = getelementptr i8, ptr %pointer.phi.epil, i64 512
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %middle.block, label %vector.body.epil, !llvm.loop !60
...
for.body31.us.preheader:                          ; preds = %for.body23.us, %middle.block
  %indvars.iv138.ph = phi i64 [ %33, %for.body23.us ], [ %ind.end, %middle.block ]
  %buffer_ptr.0121.us.ph = phi ptr [ %add.ptr.us, %for.body23.us ], [ %ind.end163, %middle.block ]
  br label %for.body31.us

for.body31.us:                                    ; preds = %for.body31.us.preheader, %for.body31.us
  %indvars.iv138 = phi i64 [ %indvars.iv.next139, %for.body31.us ], [ %indvars.iv138.ph, %for.body31.us.preheader ]
  ...
  %arrayidx34.us = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 4, i64 %indvars.iv138
  ...
  br i1 %exitcond.not, label %for.cond28.for.inc38_crit_edge.us, label %for.body31.us, !llvm.loop !62
...
for.cond28.for.inc38_crit_edge.us:                ; preds = %for.body31.us, %middle.block
  ...
  br i1 %exitcond145.not, label %for.inc41, label %for.body23.us, !llvm.loop !64

for.inc41:                                        ; preds = %for.cond28.for.inc38_crit_edge.us, %for.body23.lr.ph, %for.body16
  %blkn.1.lcssa = phi i32 [ %blkn.0127, %for.body16 ], [ %blkn.0127, %for.body23.lr.ph ], [ %34, %for.cond28.for.inc38_crit_edge.us ]
  %indvars.iv.next147 = add nuw nsw i64 %indvars.iv146, 1
  %exitcond150.not = icmp eq i64 %indvars.iv.next147, %wide.trip.count149
  br i1 %exitcond150.not, label %for.end43, label %for.body16, !llvm.loop !65

for.end43:                                        ; preds = %for.inc41, %for.cond13.preheader
  %55 = load ptr, ptr %entropy, align 8, !tbaa !66
  %decode_mcu = getelementptr inbounds %struct.jpeg_entropy_decoder, ptr %55, i64 0, i32 1
  %56 = load ptr, ptr %decode_mcu, align 8, !tbaa !67
  %call45 = tail call i32 %56(ptr noundef nonnull %cinfo, ptr noundef nonnull %MCU_buffer44) #5
  %tobool.not = icmp eq i32 %call45, 0
  br i1 %tobool.not, label %if.then, label %for.inc48

if.then:                                          ; preds = %for.end43
  %57 = trunc i64 %indvars.iv151 to i32
  store i32 %57, ptr %MCU_vert_offset, align 4, !tbaa !44
  store i32 %MCU_col_num.0130, ptr %MCU_ctr, align 8, !tbaa !43
  br label %cleanup

for.inc48:                                        ; preds = %for.end43
  %inc49 = add nuw i32 %MCU_col_num.0130, 1
  %58 = load i32, ptr %MCUs_per_row, align 8, !tbaa !55
  %cmp11 = icmp ult i32 %inc49, %58
  br i1 %cmp11, label %for.cond13.preheader, label %for.end50.loopexit, !llvm.loop !69

for.end50.loopexit:                               ; preds = %for.inc48
  %.pre155 = load i32, ptr %MCU_rows_per_iMCU_row, align 8, !tbaa !42
  br label %for.end50

for.end50:                                        ; preds = %for.end50.loopexit, %for.body9
  %59 = phi i32 [ %.pre155, %for.end50.loopexit ], [ %14, %for.body9 ]
  %60 = phi i32 [ %58, %for.end50.loopexit ], [ %15, %for.body9 ]
  store i32 0, ptr %MCU_ctr, align 8, !tbaa !43
  %indvars.iv.next152 = add nsw i64 %indvars.iv151, 1
  %61 = sext i32 %59 to i64
  %cmp8 = icmp slt i64 %indvars.iv.next152, %61
  br i1 %cmp8, label %for.body9, label %for.end54, !llvm.loop !70
...
for.end54:                                        ; preds = %for.end50, %for.end
  ...
  %62 = load i32, ptr %input_iMCU_row55, align 8, !tbaa !38
  %inc56 = add i32 %62, 1
  ...
  %63 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !40
  %cmp57 = icmp ult i32 %inc56, %63
  br i1 %cmp57, label %if.then58, label %if.end59

if.then58:                                        ; preds = %for.end54
  %64 = load ptr, ptr %coef1, align 8, !tbaa !16
  %65 = load i32, ptr %comps_in_scan, align 8, !tbaa !39
...
if.else.i:                                        ; preds = %if.then58
  ...
  %cur_comp_info.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63
  %66 = load ptr, ptr %cur_comp_info.i, align 8, !tbaa !31
  br i1 %cmp2.i, label %if.then3.i, label %if.else5.i

if.then3.i:                                       ; preds = %if.else.i
  %v_samp_factor.i = getelementptr inbounds %struct.jpeg_component_info, ptr %66, i64 0, i32 3
  %67 = load i32, ptr %v_samp_factor.i, align 4, !tbaa !24
  br label %start_iMCU_row.exit

if.else5.i:                                       ; preds = %if.else.i
  %last_row_height.i = getelementptr inbounds %struct.jpeg_component_info, ptr %66, i64 0, i32 18
  %68 = load i32, ptr %last_row_height.i, align 8, !tbaa !41
  br label %start_iMCU_row.exit

start_iMCU_row.exit:                              ; preds = %if.then58, %if.then3.i, %if.else5.i
  %.sink.i = phi i32 [ %67, %if.then3.i ], [ %68, %if.else5.i ], [ 1, %if.then58 ]
  %MCU_rows_per_iMCU_row4.i = getelementptr inbounds %struct.my_coef_controller, ptr %64, i64 0, i32 3
  store i32 %.sink.i, ptr %MCU_rows_per_iMCU_row4.i, align 8, !tbaa !42
  %MCU_ctr.i = getelementptr inbounds %struct.my_coef_controller, ptr %64, i64 0, i32 1
  store i32 0, ptr %MCU_ctr.i, align 8, !tbaa !43
  %MCU_vert_offset.i = getelementptr inbounds %struct.my_coef_controller, ptr %64, i64 0, i32 2
  store i32 0, ptr %MCU_vert_offset.i, align 4, !tbaa !44
  br label %cleanup

if.end59:                                         ; preds = %for.end54
  %inputctl = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 77
  %69 = load ptr, ptr %inputctl, align 8, !tbaa !71
  %finish_input_pass = getelementptr inbounds %struct.jpeg_input_controller, ptr %69, i64 0, i32 3
  %70 = load ptr, ptr %finish_input_pass, align 8, !tbaa !72
...
entry:
  ...
  %0 = load ptr, ptr %coef1, align 8, !tbaa !16
  %total_iMCU_rows = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 60
  %1 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !40
  %sub = add i32 %1, -1
...
while.cond:                                       ; preds = %while.body, %entry
  %2 = load i32, ptr %input_scan_number, align 4, !tbaa !74
  %3 = load i32, ptr %output_scan_number, align 4, !tbaa !75
...
while.body:                                       ; preds = %while.cond, %land.rhs
  %6 = load ptr, ptr %inputctl, align 8, !tbaa !71
  %7 = load ptr, ptr %6, align 8, !tbaa !76
  %call = tail call i32 %7(ptr noundef nonnull %cinfo) #5
  %cmp6 = icmp eq i32 %call, 0
  br i1 %cmp6, label %cleanup, label %while.cond, !llvm.loop !77
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc40
  %indvars.iv118 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next119, %for.inc40 ]
  %compptr.0113 = phi ptr [ %9, %for.body.lr.ph ], [ %incdec.ptr42, %for.inc40 ]
  %component_needed = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0113, i64 0, i32 12
  %10 = load i32, ptr %component_needed, align 8, !tbaa !78
...
if.end9:                                          ; preds = %for.body
  ...
  %arrayidx = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 5, i64 %indvars.iv118
  %13 = load ptr, ptr %arrayidx, align 8, !tbaa !31
  %14 = load i32, ptr %output_iMCU_row, align 8, !tbaa !51
  %v_samp_factor = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0113, i64 0, i32 3
...
if.else:                                          ; preds = %if.end9
  %height_in_blocks = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0113, i64 0, i32 8
...
if.end22:                                         ; preds = %if.else, %if.then15
  ...
  %20 = load ptr, ptr %idct, align 8, !tbaa !79
  %arrayidx25 = getelementptr inbounds %struct.jpeg_inverse_dct, ptr %20, i64 0, i32 1, i64 %indvars.iv118
  %21 = load ptr, ptr %arrayidx25, align 8, !tbaa !31
  %cmp29107 = icmp sgt i32 %block_rows.0, 0
  br i1 %cmp29107, label %for.body30.lr.ph, label %for.inc40

for.body30.lr.ph:                                 ; preds = %if.end22
  %width_in_blocks = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0113, i64 0, i32 7
  %DCT_scaled_size = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0113, i64 0, i32 9
...
for.body30.preheader:                             ; preds = %for.body30.lr.ph
  %arrayidx27 = getelementptr inbounds ptr, ptr %output_buf, i64 %indvars.iv118
...
for.body30.for.end_crit_edge:                     ; preds = %for.body30
  %.pre = load i32, ptr %DCT_scaled_size, align 4, !tbaa !80
  br label %for.end
...
for.body35:                                       ; preds = %for.body35.preheader, %for.body35
  ...
  tail call void %21(ptr noundef %cinfo, ptr noundef nonnull %compptr.0113, ptr noundef %buffer_ptr.0105, ptr noundef %output_ptr.0109, i32 noundef %output_col.0106) #5
  %incdec.ptr = getelementptr inbounds [64 x i16], ptr %buffer_ptr.0105, i64 1
  %26 = load i32, ptr %DCT_scaled_size, align 4, !tbaa !80
  ...
  br i1 %cmp34, label %for.body35, label %for.end, !llvm.loop !81
...
for.end:                                          ; preds = %for.body35, %for.body30.for.end_crit_edge
  ...
  br i1 %exitcond.not, label %for.inc40, label %for.body30, !llvm.loop !82

for.inc40:                                        ; preds = %for.end, %for.body30.lr.ph, %if.end22, %for.body
  %indvars.iv.next119 = add nuw nsw i64 %indvars.iv118, 1
  %incdec.ptr42 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0113, i64 1
  %30 = load i32, ptr %num_components, align 8, !tbaa !22
  %31 = sext i32 %30 to i64
  %cmp7 = icmp slt i64 %indvars.iv.next119, %31
  br i1 %cmp7, label %for.body, label %for.end43, !llvm.loop !84
...
for.end43:                                        ; preds = %for.inc40, %while.end
  ...
  %33 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !40
...
define internal i32 @dummy_consume_data(ptr nocapture noundef readnone %cinfo) #4 {
entry:
  ret i32 0
}
...
entry:
  ...
  %sub = add i32 %1, -1
  %total_iMCU_rows = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 60
  %2 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !40
  %sub2 = add i32 %2, -1
  %MCU_vert_offset = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 2
  %3 = load i32, ptr %MCU_vert_offset, align 4, !tbaa !44
  %MCU_rows_per_iMCU_row = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 3
  %4 = load i32, ptr %MCU_rows_per_iMCU_row, align 8, !tbaa !42
  %cmp170 = icmp slt i32 %3, %4
  br i1 %cmp170, label %for.body.lr.ph, label %for.end64
...
for.body:                                         ; preds = %for.body.lr.ph, %for.end60
  ...
  %yoffset.0171 = phi i32 [ %3, %for.body.lr.ph ], [ %inc63, %for.end60 ]
...
if.then:                                          ; preds = %for.body5
  store i32 %yoffset.0171, ptr %MCU_vert_offset, align 4, !tbaa !44
...
for.body12:                                       ; preds = %for.body12.lr.ph, %for.inc55
  ...
  %indvars.iv180 = phi i64 [ 0, %for.body12.lr.ph ], [ %indvars.iv.next181, %for.inc55 ]
  %blkn.0166 = phi i32 [ 0, %for.body12.lr.ph ], [ %blkn.2, %for.inc55 ]
  %arrayidx13 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63, i64 %indvars.iv180
  ...
  %14 = load i32, ptr %component_needed, align 8, !tbaa !78
...
if.then15:                                        ; preds = %for.body12
  ...
  %15 = load i32, ptr %MCU_blocks, align 4, !tbaa !86
  %add = add nsw i32 %15, %blkn.0166
  br label %for.inc55

if.end16:                                         ; preds = %for.body12
  %16 = load ptr, ptr %idct, align 8, !tbaa !79
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %19 = load i32, ptr %MCU_sample_width, align 8, !tbaa !87
...
for.body29.lr.ph:                                 ; preds = %cond.end
  %last_row_height = getelementptr inbounds %struct.jpeg_component_info, ptr %13, i64 0, i32 18
  %cmp37145 = icmp sgt i32 %cond, 0
  %MCU_width47 = getelementptr inbounds %struct.jpeg_component_info, ptr %13, i64 0, i32 13
  br i1 %cmp37145, label %for.body29.us.preheader, label %for.body29.lr.ph.split

for.body29.us.preheader:                          ; preds = %for.body29.lr.ph
  %arrayidx23 = getelementptr inbounds ptr, ptr %output_buf, i64 %indvars.iv180
  %21 = load ptr, ptr %arrayidx23, align 8, !tbaa !31
  %22 = load i32, ptr %DCT_scaled_size, align 4, !tbaa !80
  %mul24 = mul nsw i32 %22, %yoffset.0171
...
lor.lhs.false.us:                                 ; preds = %for.body29.us
  %add32.us = add nsw i32 %yindex.0149.us, %yoffset.0171
  %26 = load i32, ptr %last_row_height, align 8, !tbaa !41
...
if.end46.us.loopexit:                             ; preds = %for.body39.us
  %.pre183 = load i32, ptr %MCU_height, align 8, !tbaa !57
  br label %if.end46.us

if.end46.us:                                      ; preds = %if.end46.us.loopexit, %lor.lhs.false.us
  %28 = phi i32 [ %.pre183, %if.end46.us.loopexit ], [ %23, %lor.lhs.false.us ]
  %29 = phi i32 [ %33, %if.end46.us.loopexit ], [ %24, %lor.lhs.false.us ]
  %30 = load i32, ptr %MCU_width47, align 4, !tbaa !56
  ...
  br i1 %cmp27.us, label %for.body29.us, label %for.inc55.loopexit, !llvm.loop !88
...
for.body39.us:                                    ; preds = %if.then35.us, %for.body39.us
  ...
  %33 = load i32, ptr %DCT_scaled_size, align 4, !tbaa !80
  %add45.us = add i32 %33, %output_col.0147.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.end46.us.loopexit, label %for.body39.us, !llvm.loop !89

for.body29.lr.ph.split:                           ; preds = %for.body29.lr.ph
  %34 = load i32, ptr %MCU_width47, align 4, !tbaa !56
  %35 = mul i32 %34, %20
  %36 = add i32 %blkn.0166, %35
  br label %for.inc55

for.inc55.loopexit:                               ; preds = %if.end46.us
  %.pre184 = load i32, ptr %comps_in_scan, align 8, !tbaa !39
  br label %for.inc55

for.inc55:                                        ; preds = %for.body29.lr.ph.split, %for.inc55.loopexit, %cond.end, %if.then15
  %37 = phi i32 [ %12, %if.then15 ], [ %12, %cond.end ], [ %.pre184, %for.inc55.loopexit ], [ %12, %for.body29.lr.ph.split ]
  %blkn.2 = phi i32 [ %add, %if.then15 ], [ %blkn.0166, %cond.end ], [ %add48.us, %for.inc55.loopexit ], [ %36, %for.body29.lr.ph.split ]
  %indvars.iv.next181 = add nuw nsw i64 %indvars.iv180, 1
  %38 = sext i32 %37 to i64
  %cmp10 = icmp slt i64 %indvars.iv.next181, %38
  br i1 %cmp10, label %for.body12, label %for.inc58, !llvm.loop !90

for.inc58:                                        ; preds = %for.inc55, %for.cond9.preheader
  %inc59 = add i32 %MCU_col_num.0168, 1
  %cmp4.not = icmp ugt i32 %inc59, %sub
  br i1 %cmp4.not, label %for.end60.loopexit, label %for.body5, !llvm.loop !91

for.end60.loopexit:                               ; preds = %for.inc58
  %.pre185 = load i32, ptr %MCU_rows_per_iMCU_row, align 8, !tbaa !42
  br label %for.end60

for.end60:                                        ; preds = %for.end60.loopexit, %for.body
  %39 = phi i32 [ %.pre185, %for.end60.loopexit ], [ %5, %for.body ]
  store i32 0, ptr %MCU_ctr, align 8, !tbaa !43
  %inc63 = add nsw i32 %yoffset.0171, 1
  %cmp = icmp slt i32 %inc63, %39
  br i1 %cmp, label %for.body, label %for.end64.loopexit, !llvm.loop !92

for.end64.loopexit:                               ; preds = %for.end60
  %.pre186 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !40
  br label %for.end64

for.end64:                                        ; preds = %for.end64.loopexit, %entry
  %40 = phi i32 [ %.pre186, %for.end64.loopexit ], [ %2, %entry ]
  %output_iMCU_row = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 37
...
if.else5.i:                                       ; preds = %if.else.i
  ...
  %47 = load i32, ptr %last_row_height.i, align 8, !tbaa !41
  br label %start_iMCU_row.exit

start_iMCU_row.exit:                              ; preds = %if.then71, %if.then3.i, %if.else5.i
  %.sink.i = phi i32 [ %46, %if.then3.i ], [ %47, %if.else5.i ], [ 1, %if.then71 ]
...
if.end72:                                         ; preds = %for.end64
  %inputctl = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 77
  %48 = load ptr, ptr %inputctl, align 8, !tbaa !71
  %finish_input_pass = getelementptr inbounds %struct.jpeg_input_controller, ptr %48, i64 0, i32 3
  %49 = load ptr, ptr %finish_input_pass, align 8, !tbaa !72
...
land.rhs:                                         ; preds = %while.cond
  %4 = load ptr, ptr %inputctl, align 8, !tbaa !71
  %eoi_reached = getelementptr inbounds %struct.jpeg_input_controller, ptr %4, i64 0, i32 5
  %5 = load i32, ptr %eoi_reached, align 4, !tbaa !93
...
if.then:                                          ; preds = %while.body
  %6 = load i32, ptr %Ss, align 4, !tbaa !94
...
if.end8:                                          ; preds = %if.then, %while.body
  ...
  br i1 %cmp10, label %cleanup407, label %while.cond, !llvm.loop !95
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc396
  %indvars.iv669 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next670, %for.inc396 ]
  ...
  %12 = load i32, ptr %component_needed, align 8, !tbaa !78
...
if.then28:                                        ; preds = %if.end25
  ...
  %arrayidx = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 5, i64 %indvars.iv669
...
if.else37:                                        ; preds = %if.end25
  ...
  %arrayidx42 = getelementptr inbounds %struct.my_coef_controller, ptr %0, i64 0, i32 5, i64 %indvars.iv669
...
if.end44:                                         ; preds = %if.else37, %if.then28
  ...
  %25 = load ptr, ptr %idct, align 8, !tbaa !79
  %arrayidx66 = getelementptr inbounds %struct.jpeg_inverse_dct, ptr %25, i64 0, i32 1, i64 %indvars.iv669
...
for.body72.lr.ph:                                 ; preds = %if.end44
  %arrayidx68 = getelementptr inbounds ptr, ptr %output_buf, i64 %indvars.iv669
...
if.end83:                                         ; preds = %for.body72, %if.else79
  ...
  %or.cond633 = select i1 %cmp18.not, i1 %cmp87, i1 false
...
if.then137:                                       ; preds = %if.then130
  %add138 = add nsw i64 %mul134, %shl152
  %div = sdiv i64 %add138, %shl154
...
if.end166:                                        ; preds = %land.lhs.true159, %if.else151
  %pred.0 = phi i32 [ %conv156, %if.else151 ], [ %spec.select635, %land.lhs.true159 ]
  %sub167 = sub nsw i32 0, %pred.0
  br label %if.end168

if.end168:                                        ; preds = %land.lhs.true143, %if.then137, %if.end166
  %pred.1 = phi i32 [ %conv140, %if.then137 ], [ %sub167, %if.end166 ], [ %spec.select634, %land.lhs.true143 ]
...
if.then187:                                       ; preds = %if.then180
  %add189 = add nsw i64 %mul184, %shl204
  %div191 = sdiv i64 %add189, %shl206
...
if.end218:                                        ; preds = %land.lhs.true211, %if.else203
  %pred.2 = phi i32 [ %conv208, %if.else203 ], [ %spec.select637, %land.lhs.true211 ]
  %sub219 = sub nsw i32 0, %pred.2
  br label %if.end220

if.end220:                                        ; preds = %land.lhs.true195, %if.then187, %if.end218
  %pred.3 = phi i32 [ %conv192, %if.then187 ], [ %sub219, %if.end218 ], [ %spec.select636, %land.lhs.true195 ]
...
if.then232:                                       ; preds = %if.end223
  %mul235.neg = mul i32 %DC6.0653, -2
  %add234 = add i32 %mul235.neg, %DC3.0651
...
if.then241:                                       ; preds = %if.then232
  %add243 = add nsw i64 %mul238, %shl258
  %div245 = sdiv i64 %add243, %shl260
...
if.end272:                                        ; preds = %land.lhs.true265, %if.else257
  %pred.4 = phi i32 [ %conv262, %if.else257 ], [ %spec.select639, %land.lhs.true265 ]
  %sub273 = sub nsw i32 0, %pred.4
  br label %if.end274

if.end274:                                        ; preds = %land.lhs.true249, %if.then241, %if.end272
  %pred.5 = phi i32 [ %conv246, %if.then241 ], [ %sub273, %if.end272 ], [ %spec.select638, %land.lhs.true249 ]
  %conv275 = trunc i32 %pred.5 to i16
  store i16 %conv275, ptr %arrayidx228, align 16, !tbaa !48
  br label %if.end277

if.end277:                                        ; preds = %if.end274, %if.end223
  %55 = load i32, ptr %arrayidx278, align 4, !tbaa !49
  %cmp279 = icmp ne i32 %55, 0
  %56 = load i16, ptr %arrayidx282, align 2
  %cmp284 = icmp eq i16 %56, 0
...
if.then286:                                       ; preds = %if.end277
  %57 = add i32 %DC7.0654, %DC3.1
  %sub289 = sub i32 %DC1.0650, %57
...
if.end326:                                        ; preds = %land.lhs.true319, %if.else311
  %pred.6 = phi i32 [ %conv316, %if.else311 ], [ %spec.select641, %land.lhs.true319 ]
  %sub327 = sub nsw i32 0, %pred.6
  br label %if.end328

if.end328:                                        ; preds = %land.lhs.true303, %if.then295, %if.end326
  %pred.7 = phi i32 [ %conv300, %if.then295 ], [ %sub327, %if.end326 ], [ %spec.select640, %land.lhs.true303 ]
  %conv329 = trunc i32 %pred.7 to i16
  store i16 %conv329, ptr %arrayidx282, align 2, !tbaa !48
  br label %if.end331

if.end331:                                        ; preds = %if.end328, %if.end277
  %58 = load i32, ptr %arrayidx332, align 4, !tbaa !49
  %cmp333 = icmp ne i32 %58, 0
  %59 = load i16, ptr %arrayidx336, align 4
  %cmp338 = icmp eq i16 %59, 0
...
if.then340:                                       ; preds = %if.end331
  %mul343.neg = mul i32 %DC6.0653, -2
  %add342 = add i32 %mul343.neg, %DC4.0652
...
if.end380:                                        ; preds = %land.lhs.true373, %if.else365
  %pred.8 = phi i32 [ %conv370, %if.else365 ], [ %spec.select643, %land.lhs.true373 ]
  %sub381 = sub nsw i32 0, %pred.8
  br label %if.end382

if.end382:                                        ; preds = %land.lhs.true357, %if.then349, %if.end380
  %pred.9 = phi i32 [ %conv354, %if.then349 ], [ %sub381, %if.end380 ], [ %spec.select642, %land.lhs.true357 ]
...
if.end385:                                        ; preds = %if.end382, %if.end331
  ...
  %60 = load i32, ptr %DCT_scaled_size, align 4, !tbaa !80
  %add389 = add i32 %60, %output_col.0645
  %inc = add i32 %block_num.0649, 1
  %cmp106.not = icmp ugt i32 %inc, %sub104
  br i1 %cmp106.not, label %for.end, label %for.body108, !llvm.loop !96

for.end:                                          ; preds = %if.end385
  %idx.ext391 = sext i32 %60 to i64
  %add.ptr392 = getelementptr inbounds ptr, ptr %output_ptr.0657, i64 %idx.ext391
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.inc396, label %for.body72, !llvm.loop !97
...
for.inc396:                                       ; preds = %for.end, %if.end44, %for.body
  ...
  %61 = load i32, ptr %num_components, align 8, !tbaa !22
  %62 = sext i32 %61 to i64
  %cmp13 = icmp slt i64 %indvars.iv.next670, %62
  br i1 %cmp13, label %for.body, label %for.end399, !llvm.loop !98

for.end399:                                       ; preds = %for.inc396, %while.end
  %63 = load i32, ptr %output_iMCU_row, align 8, !tbaa !51
  %inc401 = add i32 %63, 1
  store i32 %inc401, ptr %output_iMCU_row, align 8, !tbaa !51
  %64 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !40
  %cmp403 = icmp ult i32 %inc401, %64
...
!62 = distinct !{!62, !33, !63, !59}
!63 = !{!"llvm.loop.unroll.runtime.disable"}
!64 = distinct !{!64, !33}
!65 = distinct !{!65, !33}
!66 = !{!6, !7, i64 576}
!67 = !{!68, !7, i64 8}
!68 = !{!"jpeg_entropy_decoder", !7, i64 0, !7, i64 8}
!69 = distinct !{!69, !33}
!70 = distinct !{!70, !33}
!71 = !{!6, !7, i64 560}
!72 = !{!73, !7, i64 24}
!73 = !{!"jpeg_input_controller", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !10, i64 32, !10, i64 36}
!74 = !{!6, !10, i64 164}
!75 = !{!6, !10, i64 172}
!76 = !{!73, !7, i64 0}
!77 = distinct !{!77, !33}
