...
if.then:                                          ; preds = %entry
  ...
  %call39 = tail call double @atan(double noundef 1.000000e+00) #3
  ...
  %call53 = tail call double @atan(double noundef 1.000000e+00) #3
...
if.else:                                          ; preds = %entry
  ...
  %9 = select i1 %cmp75, double %conv74, double %8
  %div80 = fdiv x86_fp80 %conv, 0xK4000C000000000000000
  %conv82 = fpext double %9 to x86_fp80
