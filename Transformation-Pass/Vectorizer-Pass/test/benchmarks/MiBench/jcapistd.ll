...
if.end21:                                         ; preds = %if.then19, %if.end18
  ...
  %sub = sub i32 %15, %16
  %17 = tail call i32 @llvm.umin.i32(i32 %sub, i32 %num_lines)
  store i32 0, ptr %row_ctr, align 4, !tbaa !37
  %main = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 52
  %18 = load ptr, ptr %main, align 8, !tbaa !38
  %process_data = getelementptr inbounds %struct.jpeg_c_main_controller, ptr %18, i64 0, i32 1
  %19 = load ptr, ptr %process_data, align 8, !tbaa !39
  call void %19(ptr noundef nonnull %cinfo, ptr noundef %scanlines, ptr noundef nonnull %row_ctr, i32 noundef %17) #4
  %20 = load i32, ptr %row_ctr, align 4, !tbaa !37
  %21 = load i32, ptr %next_scanline, align 8, !tbaa !26
  %add = add i32 %21, %20
