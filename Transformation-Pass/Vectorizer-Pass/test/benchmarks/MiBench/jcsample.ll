...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %smoothok.0144 = phi i32 [ 1, %for.body.lr.ph ], [ %smoothok.1, %for.inc ]
  %compptr.0141 = phi ptr [ %6, %for.body.lr.ph ], [ %incdec.ptr, %for.inc ]
  %h_samp_factor = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0141, i64 0, i32 2
...
land.lhs.true:                                    ; preds = %for.body
  %v_samp_factor = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0141, i64 0, i32 3
...
land.lhs.true21:                                  ; preds = %if.else17
  %v_samp_factor22 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0141, i64 0, i32 3
...
land.lhs.true57:                                  ; preds = %if.else53
  ...
  %v_samp_factor59 = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0141, i64 0, i32 3
...
for.inc:                                          ; preds = %if.else, %if.then10, %if.else48, %if.then42, %if.else66, %if.then62, %if.then25
  ...
  %smoothok.1 = phi i32 [ %smoothok.0144, %if.then10 ], [ %smoothok.0144, %if.else ], [ 0, %if.then25 ], [ %smoothok.0144, %if.then42 ], [ %smoothok.0144, %if.else48 ], [ 0, %if.then62 ], [ %smoothok.0144, %if.else66 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %incdec.ptr = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0141, i64 1
...
define internal void @start_pass_downsample(ptr nocapture noundef %cinfo) #1 {
entry:
  ret void
}
...
for.body.us.i:                                    ; preds = %for.body.us.i, %for.body.lr.ph.i.new
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i, i8 %10, i64 %6, i1 false) #5, !tbaa !42
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.1, i8 %12, i64 %6, i1 false) #5, !tbaa !42
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.2, i8 %14, i64 %6, i1 false) #5, !tbaa !42
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.3, i8 %16, i64 %6, i1 false) #5, !tbaa !42
...
for.body.us.i.epil:                               ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %for.body.us.i.epil
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.epil, i8 %18, i64 %6, i1 false) #5, !tbaa !42
...
expand_right_edge.exit:                           ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %for.body.us.i.epil, %entry
  ...
  %conv150 = zext i32 %19 to i64
  %mul1.neg = mul nsw i64 %conv150, -512
  %sub = add nsw i64 %mul1.neg, 65536
  %mul3 = shl nsw i32 %19, 6
  %conv4151 = zext i32 %mul3 to i64
  ...
  %cmp146 = icmp sgt i32 %20, 0
  br i1 %cmp146, label %for.body.lr.ph, label %for.end83
...
for.body:                                         ; preds = %for.body.lr.ph, %for.end
  ...
  %30 = load i8, ptr %incdec.ptr, align 1, !tbaa !42
  %conv23 = zext i8 %30 to i32
  %31 = load i8, ptr %incdec.ptr15, align 1, !tbaa !42
  %conv24 = zext i8 %31 to i32
  %add25 = add nuw nsw i32 %conv24, %conv23
  %32 = load i8, ptr %incdec.ptr20, align 1, !tbaa !42
  %conv26 = zext i8 %32 to i32
  %add27 = add nuw nsw i32 %add25, %conv26
  %33 = zext i32 %add27 to i64
  %34 = shl nuw nsw i32 %add19, 1
  %factor = zext i32 %34 to i64
  %add31 = sub nsw i64 %factor, %29
  %add33 = add nsw i64 %add31, %33
  %mul34 = mul nsw i64 %sub, %29
  %mul35 = mul i64 %add33, %conv4151
  %add36 = add nsw i64 %mul34, 32768
  %add37 = add i64 %add36, %mul35
  %35 = lshr i64 %add37, 16
  %conv38 = trunc i64 %35 to i8
  store i8 %conv38, ptr %21, align 1, !tbaa !42
  %outptr.0138 = getelementptr inbounds i8, ptr %21, i64 1
  br label %for.body44

for.body44:                                       ; preds = %for.body, %for.body44
  %outptr.0145 = phi ptr [ %outptr.0138, %for.body ], [ %outptr.0, %for.body44 ]
  %lastcolsum.0144 = phi i32 [ %add19, %for.body ], [ %colsum.0143, %for.body44 ]
  %colsum.0143 = phi i32 [ %add27, %for.body ], [ %add54, %for.body44 ]
  %colctr.0142 = phi i32 [ %sub40, %for.body ], [ %dec, %for.body44 ]
  %below_ptr.0141 = phi ptr [ %incdec.ptr15, %for.body ], [ %incdec.ptr49, %for.body44 ]
  %above_ptr.0140 = phi ptr [ %incdec.ptr, %for.body ], [ %incdec.ptr48, %for.body44 ]
  %inptr.0139 = phi ptr [ %incdec.ptr20, %for.body ], [ %incdec.ptr45, %for.body44 ]
  %incdec.ptr45 = getelementptr inbounds i8, ptr %inptr.0139, i64 1
  %36 = load i8, ptr %inptr.0139, align 1, !tbaa !42
  %37 = zext i8 %36 to i64
  %incdec.ptr48 = getelementptr inbounds i8, ptr %above_ptr.0140, i64 1
  %incdec.ptr49 = getelementptr inbounds i8, ptr %below_ptr.0141, i64 1
  %38 = load i8, ptr %incdec.ptr48, align 1, !tbaa !42
  %conv50 = zext i8 %38 to i32
  %39 = load i8, ptr %incdec.ptr49, align 1, !tbaa !42
  %conv51 = zext i8 %39 to i32
  %add52 = add nuw nsw i32 %conv51, %conv50
  %40 = load i8, ptr %incdec.ptr45, align 1, !tbaa !42
  %conv53 = zext i8 %40 to i32
  %add54 = add nuw nsw i32 %add52, %conv53
  %41 = zext i32 %lastcolsum.0144 to i64
  %42 = zext i32 %colsum.0143 to i64
  %43 = zext i32 %add54 to i64
  %sub57 = add nuw nsw i64 %41, %42
  %add58 = sub nsw i64 %sub57, %37
  %add60 = add nsw i64 %add58, %43
  %mul61 = mul nsw i64 %sub, %37
  %mul62 = mul i64 %add60, %conv4151
  %add63 = add nsw i64 %mul61, 32768
  %add64 = add i64 %add63, %mul62
  %44 = lshr i64 %add64, 16
  %conv66 = trunc i64 %44 to i8
  store i8 %conv66, ptr %outptr.0145, align 1, !tbaa !42
  %dec = add i32 %colctr.0142, -1
  %outptr.0 = getelementptr inbounds i8, ptr %outptr.0145, i64 1
  %cmp42.not = icmp eq i32 %dec, 0
  br i1 %cmp42.not, label %for.end, label %for.body44, !llvm.loop !46

for.end:                                          ; preds = %for.body44
  %45 = zext i32 %colsum.0143 to i64
  %46 = load i8, ptr %incdec.ptr45, align 1, !tbaa !42
  %47 = zext i8 %46 to i64
  %48 = shl nuw nsw i32 %add54, 1
  %factor137 = zext i32 %48 to i64
  %add73 = add nuw nsw i64 %factor137, %45
  %add75 = sub nsw i64 %add73, %47
  %mul76 = mul nsw i64 %sub, %47
  %mul77 = mul i64 %add75, %conv4151
  %add78 = add nsw i64 %mul76, 32768
  %add79 = add i64 %add78, %mul77
  %49 = lshr i64 %add79, 16
  %conv81 = trunc i64 %49 to i8
  store i8 %conv81, ptr %outptr.0, align 1, !tbaa !42
  %50 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
...
for.body.us.i:                                    ; preds = %for.body.us.i, %for.body.lr.ph.i.new
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i, i8 %12, i64 %8, i1 false) #5, !tbaa !42
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.1, i8 %14, i64 %8, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.1 = or i64 %indvars.iv.i, 2
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.2, i8 %16, i64 %8, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.2 = or i64 %indvars.iv.i, 3
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.3, i8 %18, i64 %8, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %expand_right_edge.exit.loopexit.unr-lcssa, label %for.body.us.i, !llvm.loop !43
...
for.body.us.i.epil:                               ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %for.body.us.i.epil
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.epil, i8 %20, i64 %8, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
expand_right_edge.exit:                           ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %for.body.us.i.epil, %entry
  %v_samp_factor = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr, i64 0, i32 3
  %19 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %cmp30 = icmp slt i32 %19, 1
  %cmp525.not = icmp eq i32 %mul, 0
  %or.cond = select i1 %cmp30, i1 true, i1 %cmp525.not
...
for.body.us:                                      ; preds = %expand_right_edge.exit, %for.cond4.for.inc11_crit_edge.us
  ...
  %20 = load ptr, ptr %arrayidx.us, align 8, !tbaa !35
  %arrayidx3.us = getelementptr inbounds ptr, ptr %input_data, i64 %indvars.iv
  %21 = load ptr, ptr %arrayidx3.us, align 8, !tbaa !35
  br label %for.body6.us

for.body6.us:                                     ; preds = %for.body6.us, %for.body.us
  %outptr.028.us = phi ptr [ %20, %for.body.us ], [ %incdec.ptr.us.1, %for.body6.us ]
  %inptr.027.us = phi ptr [ %21, %for.body.us ], [ %add.ptr.us.1, %for.body6.us ]
  %outcol.026.us = phi i32 [ 0, %for.body.us ], [ %inc.us.1, %for.body6.us ]
  %22 = load i8, ptr %inptr.027.us, align 1, !tbaa !42
  %conv.us = zext i8 %22 to i16
  %arrayidx7.us = getelementptr inbounds i8, ptr %inptr.027.us, i64 1
  %23 = load i8, ptr %arrayidx7.us, align 1, !tbaa !42
  %conv8.us = zext i8 %23 to i16
  %add9.us = add nuw nsw i16 %conv.us, %conv8.us
  %24 = lshr i16 %add9.us, 1
  %conv10.us = trunc i16 %24 to i8
  ...
  %25 = load i8, ptr %add.ptr.us, align 1, !tbaa !42
  %conv.us.1 = zext i8 %25 to i16
  %arrayidx7.us.1 = getelementptr inbounds i8, ptr %inptr.027.us, i64 3
  %26 = load i8, ptr %arrayidx7.us.1, align 1, !tbaa !42
  %conv8.us.1 = zext i8 %26 to i16
  %add.us.1 = add nuw nsw i16 %conv.us.1, 1
  %add9.us.1 = add nuw nsw i16 %add.us.1, %conv8.us.1
  %27 = lshr i16 %add9.us.1, 1
  %conv10.us.1 = trunc i16 %27 to i8
...
for.cond4.for.inc11_crit_edge.us:                 ; preds = %for.body6.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %28 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %29 = sext i32 %28 to i64
  %cmp.us = icmp slt i64 %indvars.iv.next, %29
...
for.body:                                         ; preds = %for.body.lr.ph, %for.end
  ...
  %32 = zext i32 %add26 to i64
  %33 = load i8, ptr %26, align 1, !tbaa !42
  %conv28 = zext i8 %33 to i32
  %arrayidx29 = getelementptr inbounds i8, ptr %26, i64 1
  %34 = load i8, ptr %arrayidx29, align 1, !tbaa !42
  ...
  %39 = zext i32 %add46 to i64
  %add48 = shl nuw nsw i64 %39, 1
  %arrayidx50 = getelementptr inbounds i8, ptr %26, i64 2
  %40 = load i8, ptr %arrayidx50, align 1, !tbaa !42
  %conv51 = zext i8 %40 to i32
  %arrayidx55 = getelementptr inbounds i8, ptr %27, i64 2
  %41 = load i8, ptr %arrayidx55, align 1, !tbaa !42
  ...
  %42 = zext i32 %add57 to i64
  %add59 = add nuw nsw i64 %add48, %42
  %mul60 = mul nuw nsw i64 %32, %conv293
  %mul61 = mul i64 %add59, %conv5294
  %add62 = add nuw nsw i64 %mul60, 32768
  %add63 = add i64 %add62, %mul61
  %43 = lshr i64 %add63, 16
  %conv64 = trunc i64 %43 to i8
...
for.body73:                                       ; preds = %for.body, %for.body73
  ...
  %61 = lshr i64 %add123, 16
  %conv125 = trunc i64 %61 to i8
...
for.end:                                          ; preds = %for.body73
  ...
  %73 = zext i32 %add161 to i64
  %add163 = shl nuw nsw i64 %73, 1
  %74 = load i8, ptr %arrayidx85.le, align 1, !tbaa !42
  %conv165 = zext i8 %74 to i32
  %75 = load i8, ptr %arrayidx90.le, align 1, !tbaa !42
  ...
  %76 = zext i32 %add174 to i64
  %add176 = add nuw nsw i64 %add163, %76
  %mul177 = mul nuw nsw i64 %66, %conv293
  %mul178 = mul i64 %add176, %conv5294
  %add179 = add nuw nsw i64 %mul177, 32768
  %add180 = add i64 %add179, %mul178
  %77 = lshr i64 %add180, 16
  %conv182 = trunc i64 %77 to i8
  store i8 %conv182, ptr %outptr.0, align 1, !tbaa !42
  %indvars.iv.next289 = add nuw nsw i64 %indvars.iv288, 1
  %78 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %79 = sext i32 %78 to i64
  %cmp = icmp slt i64 %indvars.iv.next289, %79
...
expand_right_edge.exit:                           ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %for.body.us.i.epil, %entry
  %v_samp_factor = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr, i64 0, i32 3
  %19 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %cmp45 = icmp slt i32 %19, 1
  %cmp739.not = icmp eq i32 %mul, 0
  %or.cond = select i1 %cmp45, i1 true, i1 %cmp739.not
...
for.body.us:                                      ; preds = %expand_right_edge.exit, %for.cond6.for.end_crit_edge.us
  ...
  %arrayidx5.us = getelementptr inbounds ptr, ptr %input_data, i64 %22
  %23 = load ptr, ptr %arrayidx5.us, align 8, !tbaa !35
  br label %for.body8.us

for.body8.us:                                     ; preds = %for.body8.us, %for.body.us
  %outptr.043.us = phi ptr [ %20, %for.body.us ], [ %incdec.ptr.us.1, %for.body8.us ]
  %inptr1.042.us = phi ptr [ %23, %for.body.us ], [ %add.ptr19.us.1, %for.body8.us ]
  %inptr0.041.us = phi ptr [ %21, %for.body.us ], [ %add.ptr.us.1, %for.body8.us ]
  %outcol.040.us = phi i32 [ 0, %for.body.us ], [ %inc.us.1, %for.body8.us ]
  %24 = load i8, ptr %inptr0.041.us, align 1, !tbaa !42
  %conv.us = zext i8 %24 to i16
  %arrayidx9.us = getelementptr inbounds i8, ptr %inptr0.041.us, i64 1
  %25 = load i8, ptr %arrayidx9.us, align 1, !tbaa !42
  %conv10.us = zext i8 %25 to i16
  %26 = load i8, ptr %inptr1.042.us, align 1, !tbaa !42
  %conv12.us = zext i8 %26 to i16
  %arrayidx14.us = getelementptr inbounds i8, ptr %inptr1.042.us, i64 1
  %27 = load i8, ptr %arrayidx14.us, align 1, !tbaa !42
  %conv15.us = zext i8 %27 to i16
  ...
  %28 = lshr i16 %add17.us, 2
  %conv18.us = trunc i16 %28 to i8
  ...
  %29 = load i8, ptr %add.ptr.us, align 1, !tbaa !42
  %conv.us.1 = zext i8 %29 to i16
  %arrayidx9.us.1 = getelementptr inbounds i8, ptr %inptr0.041.us, i64 3
  %30 = load i8, ptr %arrayidx9.us.1, align 1, !tbaa !42
  %conv10.us.1 = zext i8 %30 to i16
  %31 = load i8, ptr %add.ptr19.us, align 1, !tbaa !42
  %conv12.us.1 = zext i8 %31 to i16
  %arrayidx14.us.1 = getelementptr inbounds i8, ptr %inptr1.042.us, i64 3
  %32 = load i8, ptr %arrayidx14.us.1, align 1, !tbaa !42
  %conv15.us.1 = zext i8 %32 to i16
  ...
  %33 = lshr i16 %add17.us.1, 2
  %conv18.us.1 = trunc i16 %33 to i8
...
for.cond6.for.end_crit_edge.us:                   ; preds = %for.body8.us
  ...
  %34 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %35 = sext i32 %34 to i64
  %cmp.us = icmp slt i64 %indvars.iv.next51, %35
...
for.body.lr.ph.i:                                 ; preds = %entry
  ...
  br i1 %11, label %expand_right_edge.exit.loopexit.unr-lcssa, label %for.body.lr.ph.i.new
...
for.body.us.i:                                    ; preds = %for.body.us.i, %for.body.lr.ph.i.new
  ...
  %niter = phi i64 [ 0, %for.body.lr.ph.i.new ], [ %niter.next.3, %for.body.us.i ]
  %arrayidx.us.i = getelementptr inbounds ptr, ptr %input_data, i64 %indvars.iv.i
  %12 = load ptr, ptr %arrayidx.us.i, align 8, !tbaa !35
  %add.ptr.us.i = getelementptr inbounds i8, ptr %12, i64 %idx.ext.i
  %arrayidx2.us.i = getelementptr inbounds i8, ptr %add.ptr.us.i, i64 -1
  %13 = load i8, ptr %arrayidx2.us.i, align 1, !tbaa !42
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i, i8 %13, i64 %9, i1 false) #5, !tbaa !42
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.us.i.1 = getelementptr inbounds ptr, ptr %input_data, i64 %indvars.iv.next.i
  %14 = load ptr, ptr %arrayidx.us.i.1, align 8, !tbaa !35
  %add.ptr.us.i.1 = getelementptr inbounds i8, ptr %14, i64 %idx.ext.i
  %arrayidx2.us.i.1 = getelementptr inbounds i8, ptr %add.ptr.us.i.1, i64 -1
  %15 = load i8, ptr %arrayidx2.us.i.1, align 1, !tbaa !42
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.1, i8 %15, i64 %9, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.1 = or i64 %indvars.iv.i, 2
  %arrayidx.us.i.2 = getelementptr inbounds ptr, ptr %input_data, i64 %indvars.iv.next.i.1
  %16 = load ptr, ptr %arrayidx.us.i.2, align 8, !tbaa !35
  %add.ptr.us.i.2 = getelementptr inbounds i8, ptr %16, i64 %idx.ext.i
  %arrayidx2.us.i.2 = getelementptr inbounds i8, ptr %add.ptr.us.i.2, i64 -1
  %17 = load i8, ptr %arrayidx2.us.i.2, align 1, !tbaa !42
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.2, i8 %17, i64 %9, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.2 = or i64 %indvars.iv.i, 3
  %arrayidx.us.i.3 = getelementptr inbounds ptr, ptr %input_data, i64 %indvars.iv.next.i.2
  %18 = load ptr, ptr %arrayidx.us.i.3, align 8, !tbaa !35
  %add.ptr.us.i.3 = getelementptr inbounds i8, ptr %18, i64 %idx.ext.i
  %arrayidx2.us.i.3 = getelementptr inbounds i8, ptr %add.ptr.us.i.3, i64 -1
  %19 = load i8, ptr %arrayidx2.us.i.3, align 1, !tbaa !42
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.3, i8 %19, i64 %9, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %expand_right_edge.exit.loopexit.unr-lcssa, label %for.body.us.i, !llvm.loop !43
...
for.body.us.i.epil:                               ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %for.body.us.i.epil
  ...
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.us.i.epil ], [ 0, %expand_right_edge.exit.loopexit.unr-lcssa ]
  %arrayidx.us.i.epil = getelementptr inbounds ptr, ptr %input_data, i64 %indvars.iv.i.epil
  %20 = load ptr, ptr %arrayidx.us.i.epil, align 8, !tbaa !35
  %add.ptr.us.i.epil = getelementptr inbounds i8, ptr %20, i64 %idx.ext.i
  %arrayidx2.us.i.epil = getelementptr inbounds i8, ptr %add.ptr.us.i.epil, i64 -1
  %21 = load i8, ptr %arrayidx2.us.i.epil, align 1, !tbaa !42
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.us.i.epil, i8 %21, i64 %9, i1 false) #5, !tbaa !42
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
expand_right_edge.exit:                           ; preds = %expand_right_edge.exit.loopexit, %entry
  %22 = phi i32 [ %.pre, %expand_right_edge.exit.loopexit ], [ %4, %entry ]
...
for.body.us.us.us.preheader:                      ; preds = %for.body.lr.ph.split.us.split.us
  %23 = zext i32 %div1 to i64
  %wide.trip.count = zext i32 %div1 to i64
  %24 = add i32 %div, -1
  %xtraiter134 = and i32 %div, 7
  %25 = icmp ult i32 %24, 7
  %unroll_iter138 = and i32 %div, -8
...
for.body.us.us.us:                                ; preds = %for.body.us.us.us.preheader, %for.cond7.for.end32_crit_edge.split.us.split.us.us.us.us
  %indvars.iv123 = phi i64 [ 0, %for.body.us.us.us.preheader ], [ %indvars.iv.next124, %for.cond7.for.end32_crit_edge.split.us.split.us.us.us.us ]
  %indvars.iv121 = phi i64 [ 0, %for.body.us.us.us.preheader ], [ %indvars.iv.next122, %for.cond7.for.end32_crit_edge.split.us.split.us.us.us.us ]
  %arrayidx.us.us.us = getelementptr inbounds ptr, ptr %output_data, i64 %indvars.iv123
  %26 = load ptr, ptr %arrayidx.us.us.us, align 8, !tbaa !35
...
for.cond10.preheader.us.us.us.us.us:              ; preds = %for.cond10.for.end22_crit_edge.split.us.us.us.us.us.us, %for.body.us.us.us
  %outptr.071.us.us.us.us.us = phi ptr [ %26, %for.body.us.us.us ], [ %incdec.ptr28.us.us.us.us.us, %for.cond10.for.end22_crit_edge.split.us.us.us.us.us.us ]
...
for.body12.us.us.us.us.us.us:                     ; preds = %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us, %for.cond10.preheader.us.us.us.us.us
  %indvars.iv115 = phi i64 [ %indvars.iv.next116, %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us ], [ 0, %for.cond10.preheader.us.us.us.us.us ]
  ...
  %27 = add nuw nsw i64 %indvars.iv115, %indvars.iv121
  %arrayidx14.us.us.us.us.us.us = getelementptr inbounds ptr, ptr %input_data, i64 %27
  %28 = load ptr, ptr %arrayidx14.us.us.us.us.us.us, align 8, !tbaa !35
  %add.ptr.us.us.us.us.us.us = getelementptr inbounds i8, ptr %28, i64 %idx.ext.us.us.us.us.us
  br i1 %25, label %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us.unr-lcssa, label %for.body17.us.us.us.us.us.us
...
for.body17.us.us.us.us.us.us:                     ; preds = %for.body12.us.us.us.us.us.us, %for.body17.us.us.us.us.us.us
  ...
  %niter139 = phi i32 [ %niter139.next.7, %for.body17.us.us.us.us.us.us ], [ 0, %for.body12.us.us.us.us.us.us ]
  %incdec.ptr.us.us.us.us.us.us = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 1
  %29 = load i8, ptr %inptr.062.us.us.us.us.us.us, align 1, !tbaa !42
  %30 = zext i8 %29 to i64
  %add19.us.us.us.us.us.us = add nsw i64 %outvalue.163.us.us.us.us.us.us, %30
  %incdec.ptr.us.us.us.us.us.us.1 = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 2
  %31 = load i8, ptr %incdec.ptr.us.us.us.us.us.us, align 1, !tbaa !42
  %32 = zext i8 %31 to i64
  %add19.us.us.us.us.us.us.1 = add nsw i64 %add19.us.us.us.us.us.us, %32
  %incdec.ptr.us.us.us.us.us.us.2 = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 3
  %33 = load i8, ptr %incdec.ptr.us.us.us.us.us.us.1, align 1, !tbaa !42
  %34 = zext i8 %33 to i64
  %add19.us.us.us.us.us.us.2 = add nsw i64 %add19.us.us.us.us.us.us.1, %34
  %incdec.ptr.us.us.us.us.us.us.3 = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 4
  %35 = load i8, ptr %incdec.ptr.us.us.us.us.us.us.2, align 1, !tbaa !42
  %36 = zext i8 %35 to i64
  %add19.us.us.us.us.us.us.3 = add nsw i64 %add19.us.us.us.us.us.us.2, %36
  %incdec.ptr.us.us.us.us.us.us.4 = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 5
  %37 = load i8, ptr %incdec.ptr.us.us.us.us.us.us.3, align 1, !tbaa !42
  %38 = zext i8 %37 to i64
  %add19.us.us.us.us.us.us.4 = add nsw i64 %add19.us.us.us.us.us.us.3, %38
  %incdec.ptr.us.us.us.us.us.us.5 = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 6
  %39 = load i8, ptr %incdec.ptr.us.us.us.us.us.us.4, align 1, !tbaa !42
  %40 = zext i8 %39 to i64
  %add19.us.us.us.us.us.us.5 = add nsw i64 %add19.us.us.us.us.us.us.4, %40
  %incdec.ptr.us.us.us.us.us.us.6 = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 7
  %41 = load i8, ptr %incdec.ptr.us.us.us.us.us.us.5, align 1, !tbaa !42
  %42 = zext i8 %41 to i64
  %add19.us.us.us.us.us.us.6 = add nsw i64 %add19.us.us.us.us.us.us.5, %42
  %incdec.ptr.us.us.us.us.us.us.7 = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us, i64 8
  %43 = load i8, ptr %incdec.ptr.us.us.us.us.us.us.6, align 1, !tbaa !42
  %44 = zext i8 %43 to i64
  %add19.us.us.us.us.us.us.7 = add nsw i64 %add19.us.us.us.us.us.us.6, %44
  %niter139.next.7 = add i32 %niter139, 8
  %niter139.ncmp.7 = icmp eq i32 %niter139.next.7, %unroll_iter138
  br i1 %niter139.ncmp.7, label %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us.unr-lcssa, label %for.body17.us.us.us.us.us.us, !llvm.loop !59
...
for.cond15.for.inc20_crit_edge.us.us.us.us.us.us.unr-lcssa: ; preds = %for.body17.us.us.us.us.us.us, %for.body12.us.us.us.us.us.us
  ...
  br i1 %lcmp.mod136.not, label %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us, label %for.body17.us.us.us.us.us.us.epil
...
for.body17.us.us.us.us.us.us.epil:                ; preds = %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us.unr-lcssa, %for.body17.us.us.us.us.us.us.epil
  ...
  %epil.iter135 = phi i32 [ %epil.iter135.next, %for.body17.us.us.us.us.us.us.epil ], [ 0, %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us.unr-lcssa ]
  %incdec.ptr.us.us.us.us.us.us.epil = getelementptr inbounds i8, ptr %inptr.062.us.us.us.us.us.us.epil, i64 1
  %45 = load i8, ptr %inptr.062.us.us.us.us.us.us.epil, align 1, !tbaa !42
  %46 = zext i8 %45 to i64
  %add19.us.us.us.us.us.us.epil = add nsw i64 %outvalue.163.us.us.us.us.us.us.epil, %46
  %epil.iter135.next = add i32 %epil.iter135, 1
  %epil.iter135.cmp.not = icmp eq i32 %epil.iter135.next, %xtraiter134
  br i1 %epil.iter135.cmp.not, label %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us, label %for.body17.us.us.us.us.us.us.epil, !llvm.loop !60
...
for.cond15.for.inc20_crit_edge.us.us.us.us.us.us: ; preds = %for.body17.us.us.us.us.us.us.epil, %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us.unr-lcssa
  ...
  br i1 %exitcond119.not, label %for.cond10.for.end22_crit_edge.split.us.us.us.us.us.us, label %for.body12.us.us.us.us.us.us, !llvm.loop !61
...
for.cond10.for.end22_crit_edge.split.us.us.us.us.us.us: ; preds = %for.cond15.for.inc20_crit_edge.us.us.us.us.us.us
  ...
  %exitcond120.not = icmp eq i32 %inc30.us.us.us.us.us, %mul
  br i1 %exitcond120.not, label %for.cond7.for.end32_crit_edge.split.us.split.us.us.us.us, label %for.cond10.preheader.us.us.us.us.us, !llvm.loop !62

for.cond7.for.end32_crit_edge.split.us.split.us.us.us.us: ; preds = %for.cond10.for.end22_crit_edge.split.us.us.us.us.us.us
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, %23
  %indvars.iv.next124 = add nuw nsw i64 %indvars.iv123, 1
  %47 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %48 = sext i32 %47 to i64
  %cmp.us.us.us = icmp slt i64 %indvars.iv.next124, %48
...
for.body.lr.ph.split.us.split.us.split:           ; preds = %for.body.lr.ph.split.us.split.us
  %div26.us.us106.us = sdiv i64 %conv23, %conv25
  %conv27.us.us107.us = trunc i64 %div26.us.us106.us to i8
  %49 = zext i32 %mul to i64
  br label %for.body.us.us

for.body.us.us:                                   ; preds = %for.body.us.us, %for.body.lr.ph.split.us.split.us.split
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.body.us.us ], [ 0, %for.body.lr.ph.split.us.split.us.split ]
  %arrayidx.us.us = getelementptr inbounds ptr, ptr %output_data, i64 %indvars.iv112
  %50 = load ptr, ptr %arrayidx.us.us, align 8, !tbaa !35
  call void @llvm.memset.p0.i64(ptr align 1 %50, i8 %conv27.us.us107.us, i64 %49, i1 false), !tbaa !42
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %51 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %52 = sext i32 %51 to i64
  %cmp.us.us = icmp slt i64 %indvars.iv.next113, %52
...
for.body.lr.ph.split.us.split:                    ; preds = %for.body.lr.ph.split.us
  %div26.us94 = sdiv i64 %conv23, %conv25
  %conv27.us95 = trunc i64 %div26.us94 to i8
  %53 = zext i32 %mul to i64
...
for.body.us:                                      ; preds = %for.body.us, %for.body.lr.ph.split.us.split
  ...
  %arrayidx.us = getelementptr inbounds ptr, ptr %output_data, i64 %indvars.iv
  %54 = load ptr, ptr %arrayidx.us, align 8, !tbaa !35
  call void @llvm.memset.p0.i64(ptr align 1 %54, i8 %conv27.us95, i64 %53, i1 false), !tbaa !42
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %55 = load i32, ptr %v_samp_factor, align 4, !tbaa !32
  %56 = sext i32 %55 to i64
  %cmp.us = icmp slt i64 %indvars.iv.next, %56
