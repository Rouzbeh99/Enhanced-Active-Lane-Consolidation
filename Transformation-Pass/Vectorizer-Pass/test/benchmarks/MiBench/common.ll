; ModuleID = 'mpglib/common.c'
source_filename = "mpglib/common.c"
...
define dso_local i32 @decode_header(ptr noundef %fr, i64 noundef %newhead) local_unnamed_addr #0 {
entry:
  %and = and i64 %newhead, 1048576
  %tobool.not = icmp eq i64 %and, 0
  %.pre = trunc i64 %newhead to i32
...
if.end:                                           ; preds = %entry, %if.then
  ...
  %4 = phi i32 [ 0, %if.then ], [ 1, %entry ]
  %5 = getelementptr inbounds %struct.frame, ptr %fr, i64 0, i32 3
  store i32 %3, ptr %5, align 4
  %6 = getelementptr inbounds %struct.frame, ptr %fr, i64 0, i32 4
  store i32 %4, ptr %6, align 4
  %7 = lshr i32 %.pre, 17
  %8 = and i32 %7, 3
  %conv = sub nuw nsw i32 4, %8
...
if.then9:                                         ; preds = %if.end
  ...
  %10 = tail call i64 @fwrite(ptr nonnull @.str, i64 13, i64 1, ptr %9) #7
  tail call void @exit(i32 noundef 1) #8
  unreachable

if.end10:                                         ; preds = %if.end
  br i1 %tobool.not, label %if.then31, label %if.end25.thread

if.end25.thread:                                  ; preds = %if.end10
  %mul = mul nsw i32 %3, 3
  %11 = trunc i64 %and7 to i32
  br label %if.end35

if.then31:                                        ; preds = %if.end10
  %12 = trunc i64 %and7 to i32
  br label %if.end35

if.end35:                                         ; preds = %if.end25.thread, %if.then31
  %.sink = phi i32 [ %11, %if.end25.thread ], [ 6, %if.then31 ]
  %mul.sink = phi i32 [ %mul, %if.end25.thread ], [ %12, %if.then31 ]
  %conv23 = add nsw i32 %mul.sink, %.sink
  %.pre147 = lshr i32 %.pre, 12
  %.pre149 = and i32 %.pre147, 15
  %conv28.sink.in.in = lshr i32 %.pre, 16
  %conv28.sink.in = and i32 %conv28.sink.in.in, 1
  %conv28.sink = xor i32 %conv28.sink.in, 1
  %13 = getelementptr inbounds %struct.frame, ptr %fr, i64 0, i32 9
  store i32 %conv23, ptr %13, align 4
  %14 = getelementptr inbounds %struct.frame, ptr %fr, i64 0, i32 7
  store i32 %conv28.sink, ptr %14, align 4
  %bitrate_index39 = getelementptr inbounds %struct.frame, ptr %fr, i64 0, i32 8
  store i32 %.pre149, ptr %bitrate_index39, align 4, !tbaa !12
  %15 = lshr i32 %.pre, 9
  %conv42 = and i32 %15, 1
...
sw.bb:                                            ; preds = %if.end68
  ...
  %24 = tail call i64 @fwrite(ptr nonnull @.str.2, i64 23, i64 1, ptr %23) #7
  br label %return

sw.bb71:                                          ; preds = %if.end68
  %25 = load ptr, ptr @stderr, align 8, !tbaa !10
  %26 = tail call i64 @fwrite(ptr nonnull @.str.3, i64 23, i64 1, ptr %25) #7
  br label %return

sw.bb73:                                          ; preds = %if.end68
  %idxprom = sext i32 %3 to i64
  %idxprom77145 = zext i32 %.pre149 to i64
  %arrayidx78 = getelementptr inbounds [2 x [3 x [16 x i32]]], ptr @tabsel_123, i64 0, i64 %idxprom, i64 2, i64 %idxprom77145
  %27 = load i32, ptr %arrayidx78, align 4, !tbaa !21
  %mul80 = mul i32 %27, 144000
  %framesize = getelementptr inbounds %struct.frame, ptr %fr, i64 0, i32 17
  %idxprom83 = sext i32 %conv23 to i64
  %arrayidx84 = getelementptr inbounds [9 x i64], ptr @freqs, i64 0, i64 %idxprom83
  %28 = load i64, ptr %arrayidx84, align 8, !tbaa !22
  %sh_prom = zext i32 %3 to i64
  %shl = shl i64 %28, %sh_prom
...
sw.default:                                       ; preds = %if.end68
  ...
  %30 = tail call i64 @fwrite(ptr nonnull @.str.4, i64 27, i64 1, ptr %29) #7
  br label %return
