...
if.then12:                                        ; preds = %if.end9
  ...
  %call14 = call ptr @fopen(ptr noundef %4, ptr noundef nonnull @.str.2)
...
if.then26:                                        ; preds = %if.end23
  %call27 = call ptr @fopen(ptr noundef nonnull %8, ptr noundef nonnull @.str.4)
...
if.end.i:                                         ; preds = %if.end35
  %call1.i = call i32 @getc(ptr noundef %input_file.0) #7
...
if.end4.i:                                        ; preds = %if.then2.i, %if.end.i
  %call5.i = call i32 @ungetc(i32 noundef %call1.i, ptr noundef %input_file.0) #7
...
entry:
  ...
  br i1 %cmp153, label %for.body.lr.ph, label %for.end
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %scansarg.0182 = phi ptr [ null, %for.body.lr.ph ], [ %scansarg.1, %for.inc ]
  %samplearg.0178 = phi ptr [ null, %for.body.lr.ph ], [ %samplearg.1, %for.inc ]
  %qslotsarg.0174 = phi ptr [ null, %for.body.lr.ph ], [ %qslotsarg.1, %for.inc ]
  %qtablefile.0170 = phi ptr [ null, %for.body.lr.ph ], [ %qtablefile.1, %for.inc ]
  %simple_progressive.0166 = phi i32 [ 0, %for.body.lr.ph ], [ %simple_progressive.1, %for.inc ]
  %force_baseline.0162 = phi i32 [ 0, %for.body.lr.ph ], [ %force_baseline.1, %for.inc ]
  %q_scale_factor.0158 = phi i32 [ 100, %for.body.lr.ph ], [ %q_scale_factor.1, %for.inc ]
...
if.end78:                                         ; preds = %if.end71
  ...
  %13 = and i8 %12, -33
  %14 = icmp eq i8 %13, 77
  %15 = load i64, ptr %lval, align 8, !tbaa !37
  %mul = mul nsw i64 %15, 1000
  %spec.select = select i1 %14, i64 %mul, i64 %15
  %mul88 = mul nsw i64 %spec.select, 1000
...
if.end167:                                        ; preds = %if.end160
  %23 = load i64, ptr %lval154, align 8, !tbaa !37
  %24 = icmp ugt i64 %23, 65535
  br i1 %24, label %if.then173, label %if.end174
...
if.end174:                                        ; preds = %if.end167
  %25 = load i8, ptr %ch155, align 1, !tbaa !9
  %26 = and i8 %25, -33
  %27 = icmp eq i8 %26, 66
  %conv183 = trunc i64 %23 to i32
  br i1 %27, label %if.then182, label %if.end187
...
if.end196:                                        ; preds = %if.then191
  ...
  %28 = load ptr, ptr %arrayidx198, align 8, !tbaa !5
  br label %for.inc
...
if.end207:                                        ; preds = %if.then202
  ...
  %29 = load ptr, ptr %arrayidx209, align 8, !tbaa !5
  br label %for.inc
...
if.end218:                                        ; preds = %if.then213
  ...
  %30 = load ptr, ptr %arrayidx220, align 8, !tbaa !5
  %call221 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %30, ptr noundef nonnull @.str.68, ptr noundef nonnull %val) #7
...
if.end225:                                        ; preds = %if.end218
  %31 = load i32, ptr %val, align 4, !tbaa !34
  %32 = icmp ugt i32 %31, 100
  br i1 %32, label %if.then231, label %if.end232
...
if.end232:                                        ; preds = %if.end225
  store i32 %31, ptr %smoothing_factor, align 8, !tbaa !44
...
for.inc:                                          ; preds = %if.else107, %if.else, %if.then30, %if.then37, %if.then24, %if.then62, %if.then95, %if.end136, %if.end187, %if.end207, %if.then236, %if.end232, %if.end196, %if.end147, %if.end126, %if.end104, %if.end78, %if.end52, %if.then5
  %argn.1 = phi i32 [ %argn.0154, %if.then5 ], [ %inc, %if.then24 ], [ %inc, %if.then30 ], [ %inc, %if.then37 ], [ %argn.0154, %if.end52 ], [ %argn.0154, %if.then62 ], [ %inc67, %if.end78 ], [ %argn.0154, %if.then95 ], [ %inc100, %if.end104 ], [ %inc115, %if.end126 ], [ %inc132, %if.end136 ], [ %inc143, %if.end147 ], [ %inc156, %if.end187 ], [ %inc192, %if.end196 ], [ %inc203, %if.end207 ], [ %inc214, %if.end232 ], [ %argn.0154, %if.then236 ], [ %argn.0154, %if.else ], [ %argn.0154, %if.else107 ]
  %q_scale_factor.1 = phi i32 [ %q_scale_factor.0158, %if.then5 ], [ %q_scale_factor.0158, %if.then24 ], [ %q_scale_factor.0158, %if.then30 ], [ %q_scale_factor.0158, %if.then37 ], [ %q_scale_factor.0158, %if.end52 ], [ %q_scale_factor.0158, %if.then62 ], [ %q_scale_factor.0158, %if.end78 ], [ %q_scale_factor.0158, %if.then95 ], [ %q_scale_factor.0158, %if.end104 ], [ %call127, %if.end126 ], [ %q_scale_factor.0158, %if.end136 ], [ %q_scale_factor.0158, %if.end147 ], [ %q_scale_factor.0158, %if.end187 ], [ %q_scale_factor.0158, %if.end196 ], [ %q_scale_factor.0158, %if.end207 ], [ %q_scale_factor.0158, %if.end232 ], [ %q_scale_factor.0158, %if.then236 ], [ %q_scale_factor.0158, %if.else ], [ %q_scale_factor.0158, %if.else107 ]
  %force_baseline.1 = phi i32 [ %force_baseline.0162, %if.then5 ], [ %force_baseline.0162, %if.then24 ], [ %force_baseline.0162, %if.then30 ], [ %force_baseline.0162, %if.then37 ], [ %force_baseline.0162, %if.end52 ], [ %force_baseline.0162, %if.then62 ], [ %force_baseline.0162, %if.end78 ], [ %force_baseline.0162, %if.then95 ], [ %force_baseline.0162, %if.end104 ], [ %force_baseline.0162, %if.end126 ], [ %force_baseline.0162, %if.end136 ], [ %force_baseline.0162, %if.end147 ], [ %force_baseline.0162, %if.end187 ], [ %force_baseline.0162, %if.end196 ], [ %force_baseline.0162, %if.end207 ], [ %force_baseline.0162, %if.end232 ], [ %force_baseline.0162, %if.then236 ], [ 1, %if.else ], [ %force_baseline.0162, %if.else107 ]
  %simple_progressive.1 = phi i32 [ %simple_progressive.0166, %if.then5 ], [ %simple_progressive.0166, %if.then24 ], [ %simple_progressive.0166, %if.then30 ], [ %simple_progressive.0166, %if.then37 ], [ %simple_progressive.0166, %if.end52 ], [ %simple_progressive.0166, %if.then62 ], [ %simple_progressive.0166, %if.end78 ], [ %simple_progressive.0166, %if.then95 ], [ %simple_progressive.0166, %if.end104 ], [ %simple_progressive.0166, %if.end126 ], [ %simple_progressive.0166, %if.end136 ], [ %simple_progressive.0166, %if.end147 ], [ %simple_progressive.0166, %if.end187 ], [ %simple_progressive.0166, %if.end196 ], [ %simple_progressive.0166, %if.end207 ], [ %simple_progressive.0166, %if.end232 ], [ %simple_progressive.0166, %if.then236 ], [ %simple_progressive.0166, %if.else ], [ 1, %if.else107 ]
  %qtablefile.1 = phi ptr [ %qtablefile.0170, %if.then5 ], [ %qtablefile.0170, %if.then24 ], [ %qtablefile.0170, %if.then30 ], [ %qtablefile.0170, %if.then37 ], [ %qtablefile.0170, %if.end52 ], [ %qtablefile.0170, %if.then62 ], [ %qtablefile.0170, %if.end78 ], [ %qtablefile.0170, %if.then95 ], [ %qtablefile.0170, %if.end104 ], [ %qtablefile.0170, %if.end126 ], [ %qtablefile.0170, %if.end136 ], [ %21, %if.end147 ], [ %qtablefile.0170, %if.end187 ], [ %qtablefile.0170, %if.end196 ], [ %qtablefile.0170, %if.end207 ], [ %qtablefile.0170, %if.end232 ], [ %qtablefile.0170, %if.then236 ], [ %qtablefile.0170, %if.else ], [ %qtablefile.0170, %if.else107 ]
  %qslotsarg.1 = phi ptr [ %qslotsarg.0174, %if.then5 ], [ %qslotsarg.0174, %if.then24 ], [ %qslotsarg.0174, %if.then30 ], [ %qslotsarg.0174, %if.then37 ], [ %qslotsarg.0174, %if.end52 ], [ %qslotsarg.0174, %if.then62 ], [ %qslotsarg.0174, %if.end78 ], [ %qslotsarg.0174, %if.then95 ], [ %qslotsarg.0174, %if.end104 ], [ %qslotsarg.0174, %if.end126 ], [ %20, %if.end136 ], [ %qslotsarg.0174, %if.end147 ], [ %qslotsarg.0174, %if.end187 ], [ %qslotsarg.0174, %if.end196 ], [ %qslotsarg.0174, %if.end207 ], [ %qslotsarg.0174, %if.end232 ], [ %qslotsarg.0174, %if.then236 ], [ %qslotsarg.0174, %if.else ], [ %qslotsarg.0174, %if.else107 ]
  %samplearg.1 = phi ptr [ %samplearg.0178, %if.then5 ], [ %samplearg.0178, %if.then24 ], [ %samplearg.0178, %if.then30 ], [ %samplearg.0178, %if.then37 ], [ %samplearg.0178, %if.end52 ], [ %samplearg.0178, %if.then62 ], [ %samplearg.0178, %if.end78 ], [ %samplearg.0178, %if.then95 ], [ %samplearg.0178, %if.end104 ], [ %samplearg.0178, %if.end126 ], [ %samplearg.0178, %if.end136 ], [ %samplearg.0178, %if.end147 ], [ %samplearg.0178, %if.end187 ], [ %28, %if.end196 ], [ %samplearg.0178, %if.end207 ], [ %samplearg.0178, %if.end232 ], [ %samplearg.0178, %if.then236 ], [ %samplearg.0178, %if.else ], [ %samplearg.0178, %if.else107 ]
  %scansarg.1 = phi ptr [ %scansarg.0182, %if.then5 ], [ %scansarg.0182, %if.then24 ], [ %scansarg.0182, %if.then30 ], [ %scansarg.0182, %if.then37 ], [ %scansarg.0182, %if.end52 ], [ %scansarg.0182, %if.then62 ], [ %scansarg.0182, %if.end78 ], [ %scansarg.0182, %if.then95 ], [ %scansarg.0182, %if.end104 ], [ %scansarg.0182, %if.end126 ], [ %scansarg.0182, %if.end136 ], [ %scansarg.0182, %if.end147 ], [ %scansarg.0182, %if.end187 ], [ %scansarg.0182, %if.end196 ], [ %29, %if.end207 ], [ %scansarg.0182, %if.end232 ], [ %scansarg.0182, %if.then236 ], [ %scansarg.0182, %if.else ], [ %scansarg.0182, %if.else107 ]
...
for.end:                                          ; preds = %for.inc, %if.then, %entry
  %argn.0.lcssa = phi i32 [ 1, %entry ], [ %argn.0154, %if.then ], [ %inc255, %for.inc ]
  %q_scale_factor.0.lcssa = phi i32 [ 100, %entry ], [ %q_scale_factor.0158, %if.then ], [ %q_scale_factor.1, %for.inc ]
  %force_baseline.0.lcssa = phi i32 [ 0, %entry ], [ %force_baseline.0162, %if.then ], [ %force_baseline.1, %for.inc ]
  %simple_progressive.0.lcssa = phi i32 [ 0, %entry ], [ %simple_progressive.0166, %if.then ], [ %simple_progressive.1, %for.inc ]
  %qtablefile.0.lcssa = phi ptr [ null, %entry ], [ %qtablefile.0170, %if.then ], [ %qtablefile.1, %for.inc ]
  %qslotsarg.0.lcssa = phi ptr [ null, %entry ], [ %qslotsarg.0174, %if.then ], [ %qslotsarg.1, %for.inc ]
  %samplearg.0.lcssa = phi ptr [ null, %entry ], [ %samplearg.0178, %if.then ], [ %samplearg.1, %for.inc ]
  %scansarg.0.lcssa = phi ptr [ null, %entry ], [ %scansarg.0182, %if.then ], [ %scansarg.1, %for.inc ]
  %tobool256.not = icmp eq i32 %for_real, 0
  br i1 %tobool256.not, label %if.end293, label %if.then257

if.then257:                                       ; preds = %for.end
  %33 = load i32, ptr %quality, align 4, !tbaa !34
  call void @jpeg_set_quality(ptr noundef nonnull %cinfo, i32 noundef %33, i32 noundef %force_baseline.0.lcssa) #7
