...
for.body:                                         ; preds = %if.end7, %for.body
  ...
  %7 = tail call i64 @llvm.smax.i64(i64 %div, i64 1)
  %8 = tail call i64 @llvm.umin.i64(i64 %7, i64 32767)
  %cmp20 = icmp ugt i64 %8, 255
  %or.cond = select i1 %tobool, i1 %cmp20, i1 false
  %9 = trunc i64 %8 to i16
  %conv24 = select i1 %or.cond, i16 255, i16 %9
...
for.body.i:                                       ; preds = %for.body.i, %if.end7.i
  ...
  %7 = tail call i64 @llvm.smax.i64(i64 %div.i, i64 1) #6
  %8 = tail call i64 @llvm.umin.i64(i64 %7, i64 32767) #6
  %cmp20.i = icmp ugt i64 %8, 255
  %or.cond.i = select i1 %tobool.i, i1 %cmp20.i, i1 false
  %9 = trunc i64 %8 to i16
  %conv24.i = select i1 %or.cond.i, i16 255, i16 %9
...
jpeg_add_quant_table.exit:                        ; preds = %for.body.i
  ...
  %10 = load i32, ptr %global_state.i, align 4, !tbaa !5
  %cmp.not.i6 = icmp eq i32 %10, 100
...
if.then.i9:                                       ; preds = %jpeg_add_quant_table.exit
  ...
  %msg_code.i7 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %11, i64 0, i32 5
  store i32 18, ptr %msg_code.i7, align 8, !tbaa !14
  %msg_parm.i8 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %11, i64 0, i32 6
  store i32 %10, ptr %msg_parm.i8, align 4, !tbaa !17
...
if.end.i11:                                       ; preds = %if.then.i9, %jpeg_add_quant_table.exit
  %14 = load ptr, ptr %arrayidx.i4, align 8, !tbaa !19
  %cmp5.i10 = icmp eq ptr %14, null
...
if.end7.i16:                                      ; preds = %if.then6.i13, %if.end.i11
  %15 = phi ptr [ %call.i12, %if.then6.i13 ], [ %14, %if.end.i11 ]
  br label %for.body.i29

for.body.i29:                                     ; preds = %for.body.i29, %if.end7.i16
  %indvars.iv.i17 = phi i64 [ 0, %if.end7.i16 ], [ %indvars.iv.next.i27, %for.body.i29 ]
  %arrayidx10.i18 = getelementptr inbounds i32, ptr @jpeg_set_linear_quality.std_chrominance_quant_tbl, i64 %indvars.iv.i17
  %16 = load i32, ptr %arrayidx10.i18, align 4, !tbaa !20
  %conv.i19 = zext i32 %16 to i64
  %mul.i20 = mul nsw i64 %conv.i19, %conv11.i
  %add.i21 = add nsw i64 %mul.i20, 50
  %div.i22 = sdiv i64 %add.i21, 100
  %17 = tail call i64 @llvm.smax.i64(i64 %div.i22, i64 1) #6
  %18 = tail call i64 @llvm.umin.i64(i64 %17, i64 32767) #6
  %cmp20.i23 = icmp ugt i64 %18, 255
  %or.cond.i24 = select i1 %tobool.i, i1 %cmp20.i23, i1 false
  %19 = trunc i64 %18 to i16
  %conv24.i25 = select i1 %or.cond.i24, i16 255, i16 %19
  %arrayidx26.i26 = getelementptr inbounds [64 x i16], ptr %15, i64 0, i64 %indvars.iv.i17
  store i16 %conv24.i25, ptr %arrayidx26.i26, align 2, !tbaa !21
  %indvars.iv.next.i27 = add nuw nsw i64 %indvars.iv.i17, 1
  %exitcond.not.i28 = icmp eq i64 %indvars.iv.next.i27, 64
  br i1 %exitcond.not.i28, label %jpeg_add_quant_table.exit31, label %for.body.i29, !llvm.loop !22

jpeg_add_quant_table.exit31:                      ; preds = %for.body.i29
  %sent_table.i30 = getelementptr inbounds %struct.JQUANT_TBL, ptr %15, i64 0, i32 1
  store i32 0, ptr %sent_table.i30, align 4, !tbaa !24
  ret void
}
...
entry:
  %0 = tail call i32 @llvm.smax.i32(i32 %quality, i32 1)
  %1 = tail call i32 @llvm.umin.i32(i32 %0, i32 100)
  %cmp4 = icmp ult i32 %1, 50
...
entry:
  %0 = tail call i32 @llvm.smax.i32(i32 %quality, i32 1) #6
  %1 = tail call i32 @llvm.umin.i32(i32 %0, i32 100) #6
  %cmp4.i = icmp ult i32 %1, 50
  br i1 %cmp4.i, label %if.then5.i, label %if.else.i

if.then5.i:                                       ; preds = %entry
  %div.rhs.trunc.i = trunc i32 %1 to i16
  %div13.i = udiv i16 5000, %div.rhs.trunc.i
  %div.zext.i = zext i16 %div13.i to i32
  br label %jpeg_quality_scaling.exit

if.else.i:                                        ; preds = %entry
  %mul.neg.i = mul nsw i32 %1, -2
...
if.end7:                                          ; preds = %if.then5, %if.end
  ...
  tail call void @jpeg_set_linear_quality(ptr noundef nonnull %cinfo, i32 noundef 50, i32 noundef 1) #6
...
add_huff_table.exit.i:                            ; preds = %if.then.i.i, %if.end7
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(17) %8, ptr noundef nonnull align 16 dereferenceable(17) @std_huff_tables.bits_dc_luminance, i64 17, i1 false) #6
  %9 = load ptr, ptr %dc_huff_tbl_ptrs.i, align 8, !tbaa !19
  %huffval.i.i = getelementptr inbounds %struct.JHUFF_TBL, ptr %9, i64 0, i32 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %huffval.i.i, ptr noundef nonnull align 1 dereferenceable(256) @std_huff_tables.val_dc_chrominance, i64 256, i1 false) #6
...
add_huff_table.exit18.i:                          ; preds = %if.then.i15.i, %add_huff_table.exit.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(17) %12, ptr noundef nonnull align 16 dereferenceable(17) @std_huff_tables.bits_ac_luminance, i64 17, i1 false) #6
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %huffval.i16.i, ptr noundef nonnull align 16 dereferenceable(256) @std_huff_tables.val_ac_luminance, i64 256, i1 false) #6
...
add_huff_table.exit24.i:                          ; preds = %if.then.i21.i, %add_huff_table.exit18.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(17) %16, ptr noundef nonnull align 16 dereferenceable(17) @std_huff_tables.bits_dc_chrominance, i64 17, i1 false) #6
  %17 = load ptr, ptr %arrayidx3.i, align 8, !tbaa !19
  %huffval.i22.i = getelementptr inbounds %struct.JHUFF_TBL, ptr %17, i64 0, i32 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %huffval.i22.i, ptr noundef nonnull align 1 dereferenceable(256) @std_huff_tables.val_dc_chrominance, i64 256, i1 false) #6
...
std_huff_tables.exit:                             ; preds = %add_huff_table.exit24.i, %if.then.i27.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(17) %20, ptr noundef nonnull align 16 dereferenceable(17) @std_huff_tables.bits_ac_chrominance, i64 17, i1 false) #6
  %21 = load ptr, ptr %arrayidx5.i, align 8, !tbaa !19
  %huffval.i28.i = getelementptr inbounds %struct.JHUFF_TBL, ptr %21, i64 0, i32 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %huffval.i28.i, ptr noundef nonnull align 16 dereferenceable(256) @std_huff_tables.val_ac_chrominance, i64 256, i1 false) #6
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %uglygep, i8 0, i64 16, i1 false), !tbaa !17
  %uglygep55 = getelementptr i8, ptr %cinfo, i64 200
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %uglygep55, i8 1, i64 16, i1 false), !tbaa !17
  %uglygep56 = getelementptr i8, ptr %cinfo, i64 216
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %uglygep56, i8 5, i64 16, i1 false), !tbaa !17
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %scan_info, i8 0, i64 16, i1 false)
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %CCIR601_sampling, i8 0, i64 20, i1 false)
...
if.end.i:                                         ; preds = %if.then.i75, %sw.bb5
  ...
  br i1 %32, label %if.end148.i, label %for.body.lr.ph.i

if.end148.i:                                      ; preds = %if.end.i
  %33 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_code138.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %33, i64 0, i32 5
  store i32 24, ptr %msg_code138.i, align 8, !tbaa !14
  %msg_parm141.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %33, i64 0, i32 6
  store i32 %30, ptr %msg_parm141.i, align 4, !tbaa !17
  %34 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_parm144.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %34, i64 0, i32 6
  %arrayidx145.i = getelementptr inbounds [8 x i32], ptr %msg_parm144.i, i64 0, i64 1
  store i32 10, ptr %arrayidx145.i, align 4, !tbaa !17
  %35 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %36 = load ptr, ptr %35, align 8, !tbaa !18
  tail call void %36(ptr noundef nonnull %cinfo) #6
...
for.body.lr.ph.i:                                 ; preds = %if.end148.i, %if.end.i
  %37 = phi i32 [ %.pre.i, %if.end148.i ], [ %30, %if.end.i ]
  %comp_info151.i = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 14
  %38 = load ptr, ptr %comp_info151.i, align 8, !tbaa !26
  %wide.trip.count.i = zext i32 %37 to i64
  %xtraiter = and i64 %wide.trip.count.i, 1
  %39 = icmp eq i32 %37, 1
  br i1 %39, label %sw.epilog.loopexit.unr-lcssa, label %for.body.lr.ph.i.new
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  ...
  %arrayidx152.i = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.i
  %40 = trunc i64 %indvars.iv.i to i32
  store i32 %40, ptr %arrayidx152.i, align 8, !tbaa !42
  %h_samp_factor154.i = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.i, i32 2
  store <4 x i32> <i32 1, i32 1, i32 0, i32 0>, ptr %h_samp_factor154.i, align 8, !tbaa !20
  %ac_tbl_no158.i = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.i, i32 6
  store i32 0, ptr %ac_tbl_no158.i, align 8, !tbaa !44
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx152.i.1 = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.next.i
  %41 = trunc i64 %indvars.iv.next.i to i32
  store i32 %41, ptr %arrayidx152.i.1, align 8, !tbaa !42
  %h_samp_factor154.i.1 = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.next.i, i32 2
  store <4 x i32> <i32 1, i32 1, i32 0, i32 0>, ptr %h_samp_factor154.i.1, align 8, !tbaa !20
  %ac_tbl_no158.i.1 = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.next.i, i32 6
...
sw.default:                                       ; preds = %entry
  %42 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_code = getelementptr inbounds %struct.jpeg_error_mgr, ptr %42, i64 0, i32 5
  store i32 7, ptr %msg_code, align 8, !tbaa !14
  %43 = load ptr, ptr %42, align 8, !tbaa !18
  tail call void %43(ptr noundef nonnull %cinfo) #6
  br label %sw.epilog
...
for.body.i.epil:                                  ; preds = %sw.epilog.loopexit.unr-lcssa
  %arrayidx152.i.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.i.unr
  %44 = trunc i64 %indvars.iv.i.unr to i32
  store i32 %44, ptr %arrayidx152.i.epil, align 8, !tbaa !42
  %h_samp_factor154.i.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.i.unr, i32 2
  store <4 x i32> <i32 1, i32 1, i32 0, i32 0>, ptr %h_samp_factor154.i.epil, align 8, !tbaa !20
  %ac_tbl_no158.i.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %38, i64 %indvars.iv.i.unr, i32 6
...
sw.bb130:                                         ; preds = %if.end
  ...
  br i1 %11, label %if.end148, label %for.body.lr.ph

if.end148:                                        ; preds = %sw.bb130
  %12 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_code138 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %12, i64 0, i32 5
  store i32 24, ptr %msg_code138, align 8, !tbaa !14
  %msg_parm141 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %12, i64 0, i32 6
  store i32 %9, ptr %msg_parm141, align 4, !tbaa !17
  %13 = load ptr, ptr %cinfo, align 8, !tbaa !13
  %msg_parm144 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %13, i64 0, i32 6
...
for.body.lr.ph:                                   ; preds = %sw.bb130, %if.end148
  %16 = phi i32 [ %.pre, %if.end148 ], [ %9, %sw.bb130 ]
  %comp_info151 = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 14
  %17 = load ptr, ptr %comp_info151, align 8, !tbaa !26
  %wide.trip.count = zext i32 %16 to i64
  %xtraiter = and i64 %wide.trip.count, 1
  %18 = icmp eq i32 %16, 1
  br i1 %18, label %sw.epilog.loopexit.unr-lcssa, label %for.body.lr.ph.new
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %arrayidx152 = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv
  %19 = trunc i64 %indvars.iv to i32
  store i32 %19, ptr %arrayidx152, align 8, !tbaa !42
  %h_samp_factor154 = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv, i32 2
  store <4 x i32> <i32 1, i32 1, i32 0, i32 0>, ptr %h_samp_factor154, align 8, !tbaa !20
  %ac_tbl_no158 = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv, i32 6
  store i32 0, ptr %ac_tbl_no158, align 8, !tbaa !44
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx152.1 = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv.next
  %20 = trunc i64 %indvars.iv.next to i32
  store i32 %20, ptr %arrayidx152.1, align 8, !tbaa !42
  %h_samp_factor154.1 = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv.next, i32 2
  store <4 x i32> <i32 1, i32 1, i32 0, i32 0>, ptr %h_samp_factor154.1, align 8, !tbaa !20
  %ac_tbl_no158.1 = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv.next, i32 6
...
sw.default:                                       ; preds = %if.end
  ...
  %msg_code160 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %21, i64 0, i32 5
...
for.body.epil:                                    ; preds = %sw.epilog.loopexit.unr-lcssa
  %arrayidx152.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv.unr
  %23 = trunc i64 %indvars.iv.unr to i32
  store i32 %23, ptr %arrayidx152.epil, align 8, !tbaa !42
  %h_samp_factor154.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv.unr, i32 2
  store <4 x i32> <i32 1, i32 1, i32 0, i32 0>, ptr %h_samp_factor154.epil, align 8, !tbaa !20
  %ac_tbl_no158.epil = getelementptr inbounds %struct.jpeg_component_info, ptr %17, i64 %indvars.iv.unr, i32 6
...
if.then.i:                                        ; preds = %if.end12.split
  ...
  br i1 %cmp120.i, label %for.body.i, label %for.end.i

for.body.i:                                       ; preds = %if.then.i
  %arrayidx.i = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 0, i32 1, i64 0
  store i32 0, ptr %arrayidx.i, align 4, !tbaa !20
  %exitcond.not.i = icmp eq i32 %0, 1
  br i1 %exitcond.not.i, label %for.end.i, label %for.body.i.1, !llvm.loop !50

for.body.i.1:                                     ; preds = %for.body.i
  %arrayidx.i.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 0, i32 1, i64 1
  store i32 1, ptr %arrayidx.i.1, align 4, !tbaa !20
  %exitcond.not.i.1 = icmp eq i32 %0, 2
  br i1 %exitcond.not.i.1, label %for.end.i, label %for.body.i.2, !llvm.loop !50

for.body.i.2:                                     ; preds = %for.body.i.1
  %arrayidx.i.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 0, i32 1, i64 2
  store i32 2, ptr %arrayidx.i.2, align 4, !tbaa !20
  %exitcond.not.i.2 = icmp eq i32 %0, 3
  br i1 %exitcond.not.i.2, label %for.end.i, label %for.body.i.3, !llvm.loop !50

for.body.i.3:                                     ; preds = %for.body.i.2
  %arrayidx.i.3 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 0, i32 1, i64 3
  store i32 3, ptr %arrayidx.i.3, align 4, !tbaa !20
  br label %for.end.i

for.end.i:                                        ; preds = %for.body.i, %for.body.i.1, %for.body.i.2, %for.body.i.3, %if.then.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.i.i.preheader.new
  ...
  br i1 %niter.ncmp.3, label %fill_dc_scans.exit.loopexit.unr-lcssa, label %for.body.i.i, !llvm.loop !51
...
for.body.i.i.epil:                                ; preds = %fill_dc_scans.exit.loopexit.unr-lcssa, %for.body.i.i.epil
  ...
  br i1 %epil.iter.cmp.not, label %fill_dc_scans.exit, label %for.body.i.i.epil, !llvm.loop !52
...
for.body.i96.preheader:                           ; preds = %fill_dc_scans.exit
  %10 = add i32 %0, -1
  %xtraiter405 = and i32 %0, 3
  %11 = icmp ult i32 %10, 3
  br i1 %11, label %for.body.i109.preheader.unr-lcssa, label %for.body.i96.preheader.new

for.body.i96.preheader.new:                       ; preds = %for.body.i96.preheader
  %unroll_iter409 = and i32 %0, -4
...
for.body.i96:                                     ; preds = %for.body.i96, %for.body.i96.preheader.new
  ...
  %niter410 = phi i32 [ 0, %for.body.i96.preheader.new ], [ %niter410.next.3, %for.body.i96 ]
  ...
  %niter410.next.3 = add i32 %niter410, 4
  %niter410.ncmp.3 = icmp eq i32 %niter410.next.3, %unroll_iter409
  br i1 %niter410.ncmp.3, label %for.body.i109.preheader.unr-lcssa, label %for.body.i96, !llvm.loop !51
...
for.body.i109.preheader.unr-lcssa:                ; preds = %for.body.i96, %for.body.i96.preheader
  ...
  %lcmp.mod407.not = icmp eq i32 %xtraiter405, 0
  br i1 %lcmp.mod407.not, label %for.body.i109.preheader, label %for.body.i96.epil
...
for.body.i96.epil:                                ; preds = %for.body.i109.preheader.unr-lcssa, %for.body.i96.epil
  ...
  %epil.iter406 = phi i32 [ %epil.iter406.next, %for.body.i96.epil ], [ 0, %for.body.i109.preheader.unr-lcssa ]
  ...
  %epil.iter406.next = add i32 %epil.iter406, 1
  %epil.iter406.cmp.not = icmp eq i32 %epil.iter406.next, %xtraiter405
  br i1 %epil.iter406.cmp.not, label %for.body.i109.preheader, label %for.body.i96.epil, !llvm.loop !54
...
for.body.i109.preheader:                          ; preds = %for.body.i96.epil, %for.body.i109.preheader.unr-lcssa
  ...
  %xtraiter411 = and i32 %0, 3
  %12 = icmp ult i32 %10, 3
  br i1 %12, label %for.body.i124.preheader.unr-lcssa, label %for.body.i109.preheader.new

for.body.i109.preheader.new:                      ; preds = %for.body.i109.preheader
  %unroll_iter415 = and i32 %0, -4
...
for.body.i109:                                    ; preds = %for.body.i109, %for.body.i109.preheader.new
  ...
  %niter416 = phi i32 [ 0, %for.body.i109.preheader.new ], [ %niter416.next.3, %for.body.i109 ]
  ...
  %niter416.next.3 = add i32 %niter416, 4
  %niter416.ncmp.3 = icmp eq i32 %niter416.next.3, %unroll_iter415
  br i1 %niter416.ncmp.3, label %for.body.i124.preheader.unr-lcssa, label %for.body.i109, !llvm.loop !51
...
for.body.i124.preheader.unr-lcssa:                ; preds = %for.body.i109, %for.body.i109.preheader
  ...
  br i1 %lcmp.mod413.not, label %for.body.i124.preheader, label %for.body.i109.epil
...
for.body.i109.epil:                               ; preds = %for.body.i124.preheader.unr-lcssa, %for.body.i109.epil
  ...
  %epil.iter412 = phi i32 [ %epil.iter412.next, %for.body.i109.epil ], [ 0, %for.body.i124.preheader.unr-lcssa ]
  ...
  %epil.iter412.next = add i32 %epil.iter412, 1
  %epil.iter412.cmp.not = icmp eq i32 %epil.iter412.next, %xtraiter411
  br i1 %epil.iter412.cmp.not, label %for.body.i124.preheader, label %for.body.i109.epil, !llvm.loop !55
...
for.body.i124.preheader:                          ; preds = %for.body.i109.epil, %for.body.i124.preheader.unr-lcssa
  ...
  %xtraiter417 = and i32 %0, 3
  %13 = icmp ult i32 %10, 3
  br i1 %13, label %fill_scans.exit127.unr-lcssa, label %for.body.i124.preheader.new

for.body.i124.preheader.new:                      ; preds = %for.body.i124.preheader
  %unroll_iter422 = and i32 %0, -4
...
for.body.i124:                                    ; preds = %for.body.i124, %for.body.i124.preheader.new
  ...
  %niter423 = phi i32 [ 0, %for.body.i124.preheader.new ], [ %niter423.next.3, %for.body.i124 ]
  ...
  %niter423.next.3 = add i32 %niter423, 4
  %niter423.ncmp.3 = icmp eq i32 %niter423.next.3, %unroll_iter422
  br i1 %niter423.ncmp.3, label %fill_scans.exit127.unr-lcssa.loopexit, label %for.body.i124, !llvm.loop !51
...
fill_scans.exit127.unr-lcssa:                     ; preds = %fill_scans.exit127.unr-lcssa.loopexit, %for.body.i124.preheader
  ...
  br i1 %lcmp.mod419.not, label %fill_scans.exit127, label %for.body.i124.epil
...
for.body.i124.epil:                               ; preds = %fill_scans.exit127.unr-lcssa, %for.body.i124.epil
  ...
  %epil.iter418 = phi i32 [ %epil.iter418.next, %for.body.i124.epil ], [ 0, %fill_scans.exit127.unr-lcssa ]
  ...
  %epil.iter418.next = add i32 %epil.iter418, 1
  %epil.iter418.cmp.not = icmp eq i32 %epil.iter418.next, %xtraiter417
  br i1 %epil.iter418.cmp.not, label %fill_scans.exit127, label %for.body.i124.epil, !llvm.loop !56
...
fill_scans.exit127:                               ; preds = %for.body.i124.epil, %fill_scans.exit127.unr-lcssa
  ...
  br i1 %cmp.i, label %if.then.i130, label %for.body.i.i154.preheader

for.body.i.i154.preheader:                        ; preds = %fill_scans.exit127
  %xtraiter424 = and i32 %0, 3
  %14 = icmp ult i32 %10, 3
  br i1 %14, label %fill_dc_scans.exit156.loopexit.unr-lcssa, label %for.body.i.i154.preheader.new
...
if.then.i130:                                     ; preds = %fill_scans.exit127
  store i32 %0, ptr %incdec.ptr.i121.lcssa, align 4, !tbaa !48
  br i1 %cmp14.i, label %for.body.i137, label %for.end.i143

for.body.i137:                                    ; preds = %if.then.i130
  %arrayidx.i134 = getelementptr inbounds %struct.jpeg_scan_info, ptr %scanptr.addr.015.i115.lcssa, i64 1, i32 1, i64 0
  store i32 0, ptr %arrayidx.i134, align 4, !tbaa !20
  %exitcond.not.i136 = icmp eq i32 %0, 1
  br i1 %exitcond.not.i136, label %for.end.i143, label %for.body.i137.1, !llvm.loop !50

for.body.i137.1:                                  ; preds = %for.body.i137
  %arrayidx.i134.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %scanptr.addr.015.i115.lcssa, i64 1, i32 1, i64 1
  store i32 1, ptr %arrayidx.i134.1, align 4, !tbaa !20
  %exitcond.not.i136.1 = icmp eq i32 %0, 2
  br i1 %exitcond.not.i136.1, label %for.end.i143, label %for.body.i137.2, !llvm.loop !50

for.body.i137.2:                                  ; preds = %for.body.i137.1
  %arrayidx.i134.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %scanptr.addr.015.i115.lcssa, i64 1, i32 1, i64 2
  store i32 2, ptr %arrayidx.i134.2, align 4, !tbaa !20
  %exitcond.not.i136.2 = icmp eq i32 %0, 3
  br i1 %exitcond.not.i136.2, label %for.end.i143, label %for.body.i137.3, !llvm.loop !50

for.body.i137.3:                                  ; preds = %for.body.i137.2
  %arrayidx.i134.3 = getelementptr inbounds %struct.jpeg_scan_info, ptr %scanptr.addr.015.i115.lcssa, i64 1, i32 1, i64 3
  store i32 3, ptr %arrayidx.i134.3, align 4, !tbaa !20
  br label %for.end.i143

for.end.i143:                                     ; preds = %for.body.i137, %for.body.i137.1, %for.body.i137.2, %for.body.i137.3, %if.then.i130.thread, %if.then.i130
  %scanptr.addr.0.lcssa.i125342345 = phi ptr [ %scanptr.addr.0.i, %if.then.i130.thread ], [ %incdec.ptr.i121.lcssa, %if.then.i130 ], [ %incdec.ptr.i121.lcssa, %for.body.i137.3 ], [ %incdec.ptr.i121.lcssa, %for.body.i137.2 ], [ %incdec.ptr.i121.lcssa, %for.body.i137.1 ], [ %incdec.ptr.i121.lcssa, %for.body.i137 ]
  %Ss.i139 = getelementptr inbounds %struct.jpeg_scan_info, ptr %scanptr.addr.0.lcssa.i125342345, i64 0, i32 2
  store <4 x i32> <i32 0, i32 0, i32 1, i32 0>, ptr %Ss.i139, align 4, !tbaa !20
  %incdec.ptr.i142 = getelementptr inbounds %struct.jpeg_scan_info, ptr %scanptr.addr.0.lcssa.i125342345, i64 1
...
for.body.i.i154:                                  ; preds = %for.body.i.i154, %for.body.i.i154.preheader.new
  ...
  %niter429 = phi i32 [ 0, %for.body.i.i154.preheader.new ], [ %niter429.next.3, %for.body.i.i154 ]
  ...
  %niter429.next.3 = add nuw nsw i32 %niter429, 4
  %niter429.ncmp.3 = icmp eq i32 %niter429.next.3, %unroll_iter428
  br i1 %niter429.ncmp.3, label %fill_dc_scans.exit156.loopexit.unr-lcssa, label %for.body.i.i154, !llvm.loop !51
...
fill_dc_scans.exit156.loopexit.unr-lcssa:         ; preds = %for.body.i.i154, %for.body.i.i154.preheader
  ...
  %lcmp.mod426.not = icmp eq i32 %xtraiter424, 0
  br i1 %lcmp.mod426.not, label %fill_dc_scans.exit156, label %for.body.i.i154.epil
...
for.body.i.i154.epil:                             ; preds = %fill_dc_scans.exit156.loopexit.unr-lcssa, %for.body.i.i154.epil
  ...
  %epil.iter425 = phi i32 [ %epil.iter425.next, %for.body.i.i154.epil ], [ 0, %fill_dc_scans.exit156.loopexit.unr-lcssa ]
  ...
  %epil.iter425.next = add i32 %epil.iter425, 1
  %epil.iter425.cmp.not = icmp eq i32 %epil.iter425.next, %xtraiter424
  br i1 %epil.iter425.cmp.not, label %fill_dc_scans.exit156, label %for.body.i.i154.epil, !llvm.loop !57
...
for.body.i168.preheader:                          ; preds = %fill_dc_scans.exit156
  %15 = add i32 %0, -1
  %xtraiter430 = and i32 %0, 3
  %16 = icmp ult i32 %15, 3
  br i1 %16, label %if.end38.loopexit.unr-lcssa, label %for.body.i168.preheader.new

for.body.i168.preheader.new:                      ; preds = %for.body.i168.preheader
  %unroll_iter433 = and i32 %0, -4
...
for.body.i168:                                    ; preds = %for.body.i168, %for.body.i168.preheader.new
  ...
  %niter434 = phi i32 [ 0, %for.body.i168.preheader.new ], [ %niter434.next.3, %for.body.i168 ]
  ...
  %niter434.next.3 = add i32 %niter434, 4
  %niter434.ncmp.3 = icmp eq i32 %niter434.next.3, %unroll_iter433
  br i1 %niter434.ncmp.3, label %if.end38.loopexit.unr-lcssa, label %for.body.i168, !llvm.loop !51
...
land.lhs.true16:                                  ; preds = %if.end12
  ...
  %17 = load i32, ptr %jpeg_color_space17, align 8, !tbaa !38
  ...
  br i1 %cmp18, label %if.end38.sink.split, label %land.lhs.true16.split

land.lhs.true16.split:                            ; preds = %land.lhs.true16
  store i32 1, ptr %component_index.i279, align 4, !tbaa !20
  %Ss1.i190.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 2, i32 2
  store <4 x i32> <i32 1, i32 5, i32 0, i32 2>, ptr %Ss1.i190.1, align 4, !tbaa !20
...
if.end38.sink.split:                              ; preds = %land.lhs.true16, %land.lhs.true16.split
  %component_index.i203.2.sink = phi ptr [ %component_index.i203.2, %land.lhs.true16.split ], [ %component_index.i279, %land.lhs.true16 ]
  %.sink403 = phi i64 [ 6, %land.lhs.true16.split ], [ 2, %land.lhs.true16 ]
  %.sink402 = phi i32 [ 6, %land.lhs.true16.split ], [ 1, %land.lhs.true16 ]
  %.sink398 = phi i32 [ 2, %land.lhs.true16.split ], [ 1, %land.lhs.true16 ]
  %.sink397 = phi i64 [ 7, %land.lhs.true16.split ], [ 3, %land.lhs.true16 ]
  %.sink395 = phi i32 [ 0, %land.lhs.true16.split ], [ 1, %land.lhs.true16 ]
  %.sink391 = phi i32 [ 2, %land.lhs.true16.split ], [ 0, %land.lhs.true16 ]
  %.sink389 = phi i64 [ 8, %land.lhs.true16.split ], [ 4, %land.lhs.true16 ]
  %.sink387 = phi i32 [ 1, %land.lhs.true16.split ], [ 0, %land.lhs.true16 ]
  %.sink385 = phi i32 [ 1, %land.lhs.true16.split ], [ 6, %land.lhs.true16 ]
  %.sink380 = phi i32 [ 1, %land.lhs.true16.split ], [ 2, %land.lhs.true16 ]
  %.sink379 = phi i64 [ 9, %land.lhs.true16.split ], [ 5, %land.lhs.true16 ]
  %.sink372 = phi i64 [ 10, %land.lhs.true16.split ], [ 6, %land.lhs.true16 ]
  %.sink364 = phi i64 [ 11, %land.lhs.true16.split ], [ 7, %land.lhs.true16 ]
  %.sink362 = phi i32 [ 0, %land.lhs.true16.split ], [ 2, %land.lhs.true16 ]
  %.sink357 = phi i64 [ 12, %land.lhs.true16.split ], [ 8, %land.lhs.true16 ]
  %.sink351 = phi i64 [ 13, %land.lhs.true16.split ], [ 9, %land.lhs.true16 ]
  store i32 2, ptr %component_index.i203.2.sink, align 4, !tbaa !20
  %Ss1.i204.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink403, i32 2
  store i32 %.sink402, ptr %Ss1.i204.2, align 4, !tbaa !58
  %Se2.i205.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink403, i32 3
  store i32 63, ptr %Se2.i205.2, align 4, !tbaa !59
  %Ah3.i206.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink403, i32 4
  store i32 0, ptr %Ah3.i206.2, align 4, !tbaa !60
  %Al4.i207.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink403, i32 5
  store i32 %.sink398, ptr %Al4.i207.2, align 4, !tbaa !61
  %incdec.ptr.i208.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink397
  store i32 1, ptr %incdec.ptr.i208.2, align 4, !tbaa !48
  %component_index.i217 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink397, i32 1
  store i32 %.sink395, ptr %component_index.i217, align 4, !tbaa !20
  %Ss1.i218 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink397, i32 2
  store i32 1, ptr %Ss1.i218, align 4, !tbaa !58
  %Se2.i219 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink397, i32 3
  store i32 63, ptr %Se2.i219, align 4, !tbaa !59
  %Ah3.i220 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink397, i32 4
  store i32 %.sink391, ptr %Ah3.i220, align 4, !tbaa !60
  %Al4.i221 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink397, i32 5
  store i32 1, ptr %Al4.i221, align 4, !tbaa !61
  %incdec.ptr.i222 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink389
  store i32 1, ptr %incdec.ptr.i222, align 4, !tbaa !48
  %component_index.i217.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink389, i32 1
  store i32 %.sink387, ptr %component_index.i217.1, align 4, !tbaa !20
  %Ss1.i218.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink389, i32 2
  store i32 %.sink385, ptr %Ss1.i218.1, align 4, !tbaa !58
  %Se2.i219.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink389, i32 3
  store i32 63, ptr %Se2.i219.1, align 4, !tbaa !59
  %Ah3.i220.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink389, i32 4
  store i32 %.sink391, ptr %Ah3.i220.1, align 4, !tbaa !60
  %Al4.i221.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink389, i32 5
  store i32 %.sink380, ptr %Al4.i221.1, align 4, !tbaa !61
  %incdec.ptr.i222.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink379
  store i32 1, ptr %incdec.ptr.i222.1, align 4, !tbaa !48
  %component_index.i217.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink379, i32 1
  store i32 %.sink391, ptr %component_index.i217.2, align 4, !tbaa !20
  %Ss1.i218.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink379, i32 2
  store <4 x i32> <i32 1, i32 63, i32 2, i32 1>, ptr %Ss1.i218.2, align 4, !tbaa !20
  %incdec.ptr.i222.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink372
  store <4 x i32> <i32 3, i32 0, i32 1, i32 2>, ptr %incdec.ptr.i222.2, align 4, !tbaa !20
  %Ss.i237 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink372, i32 2
  store <4 x i32> <i32 0, i32 0, i32 1, i32 0>, ptr %Ss.i237, align 4, !tbaa !20
  %incdec.ptr.i240 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink364
  store i32 1, ptr %incdec.ptr.i240, align 4, !tbaa !48
  %component_index.i246 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink364, i32 1
  store i32 %.sink362, ptr %component_index.i246, align 4, !tbaa !20
  %Ss1.i247 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink364, i32 2
  store <4 x i32> <i32 1, i32 63, i32 1, i32 0>, ptr %Ss1.i247, align 4, !tbaa !20
  %incdec.ptr.i251 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink357
  store i32 1, ptr %incdec.ptr.i251, align 4, !tbaa !48
  %component_index.i246.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink357, i32 1
  store i32 1, ptr %component_index.i246.1, align 4, !tbaa !20
  %Ss1.i247.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink357, i32 2
  store <4 x i32> <i32 1, i32 63, i32 1, i32 0>, ptr %Ss1.i247.1, align 4, !tbaa !20
  %incdec.ptr.i251.1 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink351
  store i32 1, ptr %incdec.ptr.i251.1, align 4, !tbaa !48
  %component_index.i246.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink351, i32 1
  store i32 %.sink391, ptr %component_index.i246.2, align 4, !tbaa !20
  %Ss1.i247.2 = getelementptr inbounds %struct.jpeg_scan_info, ptr %call, i64 %.sink351, i32 2
...
if.end38.loopexit.unr-lcssa:                      ; preds = %for.body.i168, %for.body.i168.preheader
  ...
  br i1 %lcmp.mod432.not, label %if.end38, label %for.body.i168.epil
...
for.body.i168.epil:                               ; preds = %if.end38.loopexit.unr-lcssa, %for.body.i168.epil
  ...
  %epil.iter431 = phi i32 [ %epil.iter431.next, %for.body.i168.epil ], [ 0, %if.end38.loopexit.unr-lcssa ]
  ...
  %epil.iter431.next = add i32 %epil.iter431, 1
  %epil.iter431.cmp.not = icmp eq i32 %epil.iter431.next, %xtraiter430
  br i1 %epil.iter431.cmp.not, label %if.end38, label %for.body.i168.epil, !llvm.loop !62
...
attributes #2 = { mustprogress nofree nosync nounwind readnone willreturn uwtable "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
