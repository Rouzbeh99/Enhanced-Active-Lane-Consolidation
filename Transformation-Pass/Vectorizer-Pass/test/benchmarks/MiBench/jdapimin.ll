...
if.then:                                          ; preds = %entry
  ...
  %msg_parm3 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %1, i64 0, i32 6
...
if.then7:                                         ; preds = %if.end
  ...
  %msg_parm14 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %5, i64 0, i32 6
...
if.end18:                                         ; preds = %if.then7, %if.end
  ...
  %uglygep = getelementptr i8, ptr %cinfo, i64 192
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %uglygep, i8 0, i64 96, i1 false)
...
if.else:                                          ; preds = %entry
  ...
  %2 = icmp eq i32 %1, 224
  br i1 %2, label %if.then3, label %if.else5

if.then3:                                         ; preds = %if.else
  %marker4 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 78
  %3 = load ptr, ptr %marker4, align 8, !tbaa !23
  %sub = add nsw i32 %marker_code, -224
  %idxprom20 = zext i32 %sub to i64
  %arrayidx = getelementptr inbounds %struct.jpeg_marker_reader, ptr %3, i64 0, i32 4, i64 %idxprom20
...
do.body.i:                                        ; preds = %if.else30.i
  ...
  %arrayidx45.i = getelementptr inbounds i32, ptr %msg_parm43.i, i64 1
  store i32 %16, ptr %arrayidx45.i, align 4, !tbaa !41
  %arrayidx46.i = getelementptr inbounds i32, ptr %msg_parm43.i, i64 2
...
if.end:                                           ; preds = %entry, %if.then
  %inputctl = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 77
  %6 = load ptr, ptr %inputctl, align 8, !tbaa !27
  %eoi_reached = getelementptr inbounds %struct.jpeg_input_controller, ptr %6, i64 0, i32 5
  %7 = load i32, ptr %eoi_reached, align 4, !tbaa !48
  ret i32 %7
}
...
if.end:                                           ; preds = %entry, %if.then
  %inputctl = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 77
  %6 = load ptr, ptr %inputctl, align 8, !tbaa !27
  %has_multiple_scans = getelementptr inbounds %struct.jpeg_input_controller, ptr %6, i64 0, i32 4
  %7 = load i32, ptr %has_multiple_scans, align 8, !tbaa !49
  ret i32 %7
}
