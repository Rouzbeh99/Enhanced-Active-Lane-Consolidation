...
if.then21.i:                                      ; preds = %if.end18.i
  ...
  %msg_parm29.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %16, i64 0, i32 6
  %arrayidx30.i = getelementptr inbounds [8 x i32], ptr %msg_parm29.i, i64 0, i64 1
...
for.end.thread.i:                                 ; preds = %if.end33.i
  %min_DCT_scaled_size229.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 59
  store i32 8, ptr %min_DCT_scaled_size229.i, align 4, !tbaa !40
...
for.body.i:                                       ; preds = %if.end55.i, %for.body.preheader.i
  %21 = phi i32 [ %32, %if.end55.i ], [ %19, %for.body.preheader.i ]
  %22 = phi i32 [ %38, %if.end55.i ], [ 1, %for.body.preheader.i ]
  %23 = phi i32 [ %37, %if.end55.i ], [ 1, %for.body.preheader.i ]
  ...
  br i1 %26, label %if.then50.i, label %lor.lhs.false43.i
...
lor.lhs.false43.i:                                ; preds = %for.body.i
  ...
  %27 = load i32, ptr %v_samp_factor.i, align 4, !tbaa !44
  %28 = add i32 %27, -5
  %29 = icmp ult i32 %28, -4
  br i1 %29, label %if.then50.i, label %if.end55.i

if.then50.i:                                      ; preds = %lor.lhs.false43.i, %for.body.i
  %30 = load ptr, ptr %cinfo, align 8, !tbaa !31
  %msg_code52.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %30, i64 0, i32 5
  store i32 16, ptr %msg_code52.i, align 8, !tbaa !32
  %31 = load ptr, ptr %30, align 8, !tbaa !35
  tail call void %31(ptr noundef nonnull %cinfo) #5
  %.pre222.i = load i32, ptr %max_h_samp_factor.i, align 4, !tbaa !38
  %.pre223.i = load i32, ptr %h_samp_factor.i, align 8, !tbaa !42
  %.pre224.i = load i32, ptr %max_v_samp_factor.i, align 8, !tbaa !39
  %v_samp_factor64.phi.trans.insert.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0216.i, i64 0, i32 3
  %.pre225.i = load i32, ptr %v_samp_factor64.phi.trans.insert.i, align 4, !tbaa !44
  %.pre226.i = load i32, ptr %num_components.i, align 8, !tbaa !37
  br label %if.end55.i

if.end55.i:                                       ; preds = %if.then50.i, %lor.lhs.false43.i
  %32 = phi i32 [ %21, %lor.lhs.false43.i ], [ %.pre226.i, %if.then50.i ]
  %33 = phi i32 [ %27, %lor.lhs.false43.i ], [ %.pre225.i, %if.then50.i ]
  %34 = phi i32 [ %22, %lor.lhs.false43.i ], [ %.pre224.i, %if.then50.i ]
  %35 = phi i32 [ %24, %lor.lhs.false43.i ], [ %.pre223.i, %if.then50.i ]
  %36 = phi i32 [ %23, %lor.lhs.false43.i ], [ %.pre222.i, %if.then50.i ]
  %37 = tail call i32 @llvm.smax.i32(i32 %36, i32 %35) #5
  store i32 %37, ptr %max_h_samp_factor.i, align 4, !tbaa !38
  %38 = tail call i32 @llvm.smax.i32(i32 %34, i32 %33) #5
  store i32 %38, ptr %max_v_samp_factor.i, align 8, !tbaa !39
  %inc.i = add nuw nsw i32 %ci.0215.i, 1
  %incdec.ptr.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.0216.i, i64 1
  %cmp35.i = icmp slt i32 %inc.i, %32
...
for.end.i:                                        ; preds = %if.end55.i
  ...
  %cmp77219.i = icmp sgt i32 %32, 0
  br i1 %cmp77219.i, label %for.body79.lr.ph.i, label %for.end119.i

for.body79.lr.ph.i:                               ; preds = %for.end.i
  %39 = load ptr, ptr %comp_info.i, align 8, !tbaa !41
  %image_width80.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 6
  br label %for.body79.i

for.body79.i:                                     ; preds = %for.body79.for.body79_crit_edge.i, %for.body79.lr.ph.i
  %40 = phi i32 [ %37, %for.body79.lr.ph.i ], [ %.pre227.i, %for.body79.for.body79_crit_edge.i ]
  %compptr.1221.i = phi ptr [ %39, %for.body79.lr.ph.i ], [ %incdec.ptr118.i, %for.body79.for.body79_crit_edge.i ]
  %ci.1220.i = phi i32 [ 0, %for.body79.lr.ph.i ], [ %inc117.i, %for.body79.for.body79_crit_edge.i ]
  %DCT_scaled_size.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 9
  store i32 8, ptr %DCT_scaled_size.i, align 4, !tbaa !47
  %41 = load i32, ptr %image_width80.i, align 8, !tbaa !30
  %conv81.i = zext i32 %41 to i64
  %h_samp_factor82.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 2
  %42 = load i32, ptr %h_samp_factor82.i, align 8, !tbaa !42
  %conv83.i = sext i32 %42 to i64
  %mul.i = mul nsw i64 %conv83.i, %conv81.i
  %mul85.i = shl nsw i32 %40, 3
  ...
  %width_in_blocks.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 7
  store i32 %conv87.i, ptr %width_in_blocks.i, align 4, !tbaa !48
  %43 = load i32, ptr %image_height.i, align 4, !tbaa !29
  %conv89.i = zext i32 %43 to i64
  %v_samp_factor90.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 3
  %44 = load i32, ptr %v_samp_factor90.i, align 4, !tbaa !44
  %conv91.i = sext i32 %44 to i64
  %mul92.i = mul nsw i64 %conv91.i, %conv89.i
  %45 = load i32, ptr %max_v_samp_factor.i, align 8, !tbaa !39
  %mul94.i = shl nsw i32 %45, 3
  ...
  %height_in_blocks.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 8
  store i32 %conv97.i, ptr %height_in_blocks.i, align 8, !tbaa !49
  %46 = load i32, ptr %image_width80.i, align 8, !tbaa !30
  %conv99.i = zext i32 %46 to i64
  %47 = load i32, ptr %h_samp_factor82.i, align 8, !tbaa !42
  %conv101.i = sext i32 %47 to i64
  %mul102.i = mul nsw i64 %conv101.i, %conv99.i
  %48 = load i32, ptr %max_h_samp_factor.i, align 4, !tbaa !38
  %conv104.i = sext i32 %48 to i64
  %call105.i = tail call i64 @jdiv_round_up(i64 noundef %mul102.i, i64 noundef %conv104.i) #5
  %conv106.i = trunc i64 %call105.i to i32
  %downsampled_width.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 10
  store i32 %conv106.i, ptr %downsampled_width.i, align 8, !tbaa !50
  %49 = load i32, ptr %image_height.i, align 4, !tbaa !29
  %conv108.i = zext i32 %49 to i64
  %50 = load i32, ptr %v_samp_factor90.i, align 4, !tbaa !44
  %conv110.i = sext i32 %50 to i64
  %mul111.i = mul nsw i64 %conv110.i, %conv108.i
  %51 = load i32, ptr %max_v_samp_factor.i, align 8, !tbaa !39
  %conv113.i = sext i32 %51 to i64
  %call114.i = tail call i64 @jdiv_round_up(i64 noundef %mul111.i, i64 noundef %conv113.i) #5
  %conv115.i = trunc i64 %call114.i to i32
  %downsampled_height.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 11
  store i32 %conv115.i, ptr %downsampled_height.i, align 4, !tbaa !51
  %component_needed.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 12
  store i32 1, ptr %component_needed.i, align 8, !tbaa !52
  %quant_table.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 0, i32 19
  store ptr null, ptr %quant_table.i, align 8, !tbaa !53
  %inc117.i = add nuw nsw i32 %ci.1220.i, 1
  %52 = load i32, ptr %num_components.i, align 8, !tbaa !37
  %cmp77.i = icmp slt i32 %inc117.i, %52
  br i1 %cmp77.i, label %for.body79.for.body79_crit_edge.i, label %for.end119.loopexit.i, !llvm.loop !54

for.body79.for.body79_crit_edge.i:                ; preds = %for.body79.i
  %incdec.ptr118.i = getelementptr inbounds %struct.jpeg_component_info, ptr %compptr.1221.i, i64 1
  %.pre227.i = load i32, ptr %max_h_samp_factor.i, align 4, !tbaa !38
  br label %for.body79.i

for.end119.loopexit.i:                            ; preds = %for.body79.i
  %.pre228.i = load i32, ptr %max_v_samp_factor.i, align 8, !tbaa !39
  br label %for.end119.i

for.end119.i:                                     ; preds = %for.end119.loopexit.i, %for.end.i, %for.end.thread.i
  %53 = phi i32 [ %.pre228.i, %for.end119.loopexit.i ], [ %38, %for.end.i ], [ 1, %for.end.thread.i ]
  %54 = load i32, ptr %image_height.i, align 4, !tbaa !29
  %conv121.i = zext i32 %54 to i64
  %mul123.i = shl nsw i32 %53, 3
  ...
  %55 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !56
  %56 = load i32, ptr %num_components.i, align 8, !tbaa !37
  %cmp128.i = icmp slt i32 %55, %56
...
lor.lhs.false130.i:                               ; preds = %for.end119.i
  ...
  %57 = load i32, ptr %progressive_mode.i, align 8, !tbaa !57
  %tobool.not.i = icmp ne i32 %57, 0
...
initial_setup.exit:                               ; preds = %for.end119.i, %lor.lhs.false130.i
  ...
  %58 = load ptr, ptr %inputctl1, align 8, !tbaa !16
  %has_multiple_scans133.i = getelementptr inbounds %struct.jpeg_input_controller, ptr %58, i64 0, i32 4
...
if.else:                                          ; preds = %sw.bb
  ...
  %59 = load i32, ptr %has_multiple_scans, align 8, !tbaa !23
  %tobool6.not = icmp eq i32 %59, 0
  br i1 %tobool6.not, label %if.then7, label %if.end9

if.then7:                                         ; preds = %if.else
  %60 = load ptr, ptr %cinfo, align 8, !tbaa !31
  %msg_code = getelementptr inbounds %struct.jpeg_error_mgr, ptr %60, i64 0, i32 5
...
sw.bb11:                                          ; preds = %if.end
  ...
  %62 = load i32, ptr %inheaders14, align 8, !tbaa !25
  %tobool15.not = icmp eq i32 %62, 0
  br i1 %tobool15.not, label %if.else25, label %if.then16

if.then16:                                        ; preds = %sw.bb11
  %63 = load ptr, ptr %marker, align 8, !tbaa !26
  %saw_SOF = getelementptr inbounds %struct.jpeg_marker_reader, ptr %63, i64 0, i32 6
  %64 = load i32, ptr %saw_SOF, align 4, !tbaa !59
  %tobool18.not = icmp eq i32 %64, 0
  br i1 %tobool18.not, label %cleanup, label %if.then19

if.then19:                                        ; preds = %if.then16
  %65 = load ptr, ptr %cinfo, align 8, !tbaa !31
  %msg_code21 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %65, i64 0, i32 5
...
if.else.i:                                        ; preds = %entry
  %6 = add i32 %0, -5
  %7 = icmp ult i32 %6, -4
  br i1 %7, label %if.then10.i, label %if.end18.i
...
if.then10.i:                                      ; preds = %if.else.i
  ...
  %msg_parm.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %8, i64 0, i32 6
  store i32 %0, ptr %msg_parm.i, align 4, !tbaa !34
  %9 = load ptr, ptr %cinfo, align 8, !tbaa !31
  %msg_parm15.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %9, i64 0, i32 6
  %arrayidx16.i = getelementptr inbounds [8 x i32], ptr %msg_parm15.i, i64 0, i64 1
...
if.end18.i:                                       ; preds = %if.then10.i, %if.else.i
  %image_width.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 6
  %12 = load i32, ptr %image_width.i, align 8, !tbaa !30
  %conv.i = zext i32 %12 to i64
  %max_h_samp_factor.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 57
  %13 = load i32, ptr %max_h_samp_factor.i, align 4, !tbaa !38
  ...
  %image_height.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 7
  %14 = load i32, ptr %image_height.i, align 4, !tbaa !29
  %conv22.i = zext i32 %14 to i64
  %max_v_samp_factor.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 58
  %15 = load i32, ptr %max_v_samp_factor.i, align 8, !tbaa !39
  %mul23.i = shl nsw i32 %15, 3
  ...
  %16 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !56
  %cmp30152.i = icmp sgt i32 %16, 0
  br i1 %cmp30152.i, label %for.body.i, label %latch_quant_tables.exit

for.body.i:                                       ; preds = %if.end18.i, %for.inc.for.body_crit_edge.i
  %17 = phi i32 [ %.pre.i, %for.inc.for.body_crit_edge.i ], [ 0, %if.end18.i ]
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.inc.for.body_crit_edge.i ], [ 0, %if.end18.i ]
  %arrayidx33.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 63, i64 %indvars.iv.i
  %18 = load ptr, ptr %arrayidx33.i, align 8, !tbaa !65
  %h_samp_factor.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 2
  %19 = load i32, ptr %h_samp_factor.i, align 8, !tbaa !42
  %MCU_width34.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 13
  store i32 %19, ptr %MCU_width34.i, align 4, !tbaa !68
  %v_samp_factor35.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 3
  %20 = load i32, ptr %v_samp_factor35.i, align 4, !tbaa !44
  %MCU_height36.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 14
  store i32 %20, ptr %MCU_height36.i, align 8, !tbaa !69
  %mul39.i = mul i32 %20, %19
  %MCU_blocks40.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 15
  store i32 %mul39.i, ptr %MCU_blocks40.i, align 4, !tbaa !70
  %DCT_scaled_size42.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 9
  %21 = load i32, ptr %DCT_scaled_size42.i, align 4, !tbaa !47
  %mul43.i = mul nsw i32 %21, %19
  %MCU_sample_width44.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 16
  store i32 %mul43.i, ptr %MCU_sample_width44.i, align 8, !tbaa !71
  %width_in_blocks45.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 7
  %22 = load i32, ptr %width_in_blocks45.i, align 4, !tbaa !48
  %rem47.i = urem i32 %22, %19
  %cmp48.i = icmp eq i32 %rem47.i, 0
  %spec.select148.i = select i1 %cmp48.i, i32 %19, i32 %rem47.i
  %last_col_width53.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 17
  store i32 %spec.select148.i, ptr %last_col_width53.i, align 4, !tbaa !72
  %height_in_blocks54.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 8
  %23 = load i32, ptr %height_in_blocks54.i, align 8, !tbaa !49
  %rem56.i = urem i32 %23, %20
  %cmp57.i = icmp eq i32 %rem56.i, 0
  %spec.select149.i = select i1 %cmp57.i, i32 %20, i32 %rem56.i
  %last_row_height62.i = getelementptr inbounds %struct.jpeg_component_info, ptr %18, i64 0, i32 18
  store i32 %spec.select149.i, ptr %last_row_height62.i, align 8, !tbaa !73
  %add.i = add nsw i32 %mul39.i, %17
...
if.then67.i:                                      ; preds = %for.body.i
  ...
  %msg_code69.i = getelementptr inbounds %struct.jpeg_error_mgr, ptr %24, i64 0, i32 5
...
if.end72.i:                                       ; preds = %if.then67.i, %for.body.i
  %cmp73150.i = icmp sgt i32 %mul39.i, 0
  br i1 %cmp73150.i, label %while.body.preheader.i, label %for.inc.i

while.body.preheader.i:                           ; preds = %if.end72.i
  %26 = trunc i64 %indvars.iv.i to i32
  %27 = add i32 %mul39.i, -1
...
while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.preheader.i
  %mcublks.0151.i.unr = phi i32 [ %mul39.i, %while.body.preheader.i ], [ %dec.i.prol, %while.body.i.prol ]
  %29 = icmp ult i32 %27, 3
  br i1 %29, label %for.inc.i, label %while.body.i

while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  %mcublks.0151.i = phi i32 [ %dec.i.3, %while.body.i ], [ %mcublks.0151.i.unr, %while.body.i.prol.loopexit ]
...
for.inc.i:                                        ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end72.i
  ...
  %35 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !56
  %36 = sext i32 %35 to i64
  %cmp30.i = icmp slt i64 %indvars.iv.next.i, %36
  br i1 %cmp30.i, label %for.inc.for.body_crit_edge.i, label %per_scan_setup.exit, !llvm.loop !79

for.inc.for.body_crit_edge.i:                     ; preds = %for.inc.i
  %.pre.i = load i32, ptr %blocks_in_MCU28.i, align 8, !tbaa !74
  br label %for.body.i

per_scan_setup.exit:                              ; preds = %for.inc.i
  %cmp36.i = icmp sgt i32 %35, 0
  br i1 %cmp36.i, label %for.body.lr.ph.i, label %latch_quant_tables.exit

for.body.lr.ph.i:                                 ; preds = %per_scan_setup.exit.thread, %per_scan_setup.exit
  %37 = phi i32 [ 1, %per_scan_setup.exit.thread ], [ %35, %per_scan_setup.exit ]
...
for.body.i11:                                     ; preds = %for.inc.i18, %for.body.lr.ph.i
  %38 = phi i32 [ %37, %for.body.lr.ph.i ], [ %50, %for.inc.i18 ]
  ...
  %39 = load ptr, ptr %arrayidx.i, align 8, !tbaa !65
  %quant_table.i = getelementptr inbounds %struct.jpeg_component_info, ptr %39, i64 0, i32 19
  %40 = load ptr, ptr %quant_table.i, align 8, !tbaa !53
  %cmp1.not.i = icmp eq ptr %40, null
  br i1 %cmp1.not.i, label %if.end.i, label %for.inc.i18

if.end.i:                                         ; preds = %for.body.i11
  %quant_tbl_no.i = getelementptr inbounds %struct.jpeg_component_info, ptr %39, i64 0, i32 4
  %41 = load i32, ptr %quant_tbl_no.i, align 8, !tbaa !80
  %42 = icmp ugt i32 %41, 3
  br i1 %42, label %if.then8.i, label %lor.lhs.false4.i

lor.lhs.false4.i:                                 ; preds = %if.end.i
  %idxprom535.i = zext i32 %41 to i64
  %arrayidx6.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 39, i64 %idxprom535.i
  %43 = load ptr, ptr %arrayidx6.i, align 8, !tbaa !65
  %cmp7.i = icmp eq ptr %43, null
...
if.then8.i:                                       ; preds = %lor.lhs.false4.i, %if.end.i
  ...
  %msg_code.i12 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %44, i64 0, i32 5
  store i32 51, ptr %msg_code.i12, align 8, !tbaa !32
  %msg_parm.i13 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %44, i64 0, i32 6
  store i32 %41, ptr %msg_parm.i13, align 4, !tbaa !34
  %45 = load ptr, ptr %cinfo, align 8, !tbaa !31
  %46 = load ptr, ptr %45, align 8, !tbaa !35
  tail call void %46(ptr noundef nonnull %cinfo) #5
  br label %if.end12.i

if.end12.i:                                       ; preds = %if.then8.i, %lor.lhs.false4.i
  %47 = load ptr, ptr %mem.i, align 8, !tbaa !5
  %48 = load ptr, ptr %47, align 8, !tbaa !13
  %call.i14 = tail call ptr %48(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef 132) #5
  %idxprom14.i = sext i32 %41 to i64
  %arrayidx15.i = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 39, i64 %idxprom14.i
  %49 = load ptr, ptr %arrayidx15.i, align 8, !tbaa !65
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(132) %call.i14, ptr noundef nonnull align 1 dereferenceable(132) %49, i64 132, i1 false) #5
  store ptr %call.i14, ptr %quant_table.i, align 8, !tbaa !53
  %.pre.i15 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !56
  br label %for.inc.i18

for.inc.i18:                                      ; preds = %if.end12.i, %for.body.i11
  %50 = phi i32 [ %38, %for.body.i11 ], [ %.pre.i15, %if.end12.i ]
  %indvars.iv.next.i16 = add nuw nsw i64 %indvars.iv.i10, 1
  %51 = sext i32 %50 to i64
  %cmp.i17 = icmp slt i64 %indvars.iv.next.i16, %51
...
latch_quant_tables.exit:                          ; preds = %for.inc.i18, %if.end18.i, %per_scan_setup.exit
  ...
  %52 = load ptr, ptr %entropy, align 8, !tbaa !82
  %53 = load ptr, ptr %52, align 8, !tbaa !83
  tail call void %53(ptr noundef %cinfo) #5
  %coef = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 75
  %54 = load ptr, ptr %coef, align 8, !tbaa !85
  %55 = load ptr, ptr %54, align 8, !tbaa !86
  tail call void %55(ptr noundef %cinfo) #5
  %56 = load ptr, ptr %coef, align 8, !tbaa !85
  %consume_data = getelementptr inbounds %struct.jpeg_d_coef_controller, ptr %56, i64 0, i32 1
  %57 = load ptr, ptr %consume_data, align 8, !tbaa !88
  %inputctl = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 77
  %58 = load ptr, ptr %inputctl, align 8, !tbaa !16
  store ptr %57, ptr %58, align 8, !tbaa !89
  ret void
}
