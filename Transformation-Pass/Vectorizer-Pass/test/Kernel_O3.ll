...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 49) #14, !dbg !128
...
if.then75:                                        ; preds = %for.cond.cleanup
  ...
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %135, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 69) #14, !dbg !167
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 332) #14, !dbg !246
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 335) #14, !dbg !253
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  %rem = urem i32 %9, 100, !dbg !279
  %cmp24 = icmp ult i32 %rem, 3, !dbg !280
...
for.cond.cleanup32:                               ; preds = %for.body33
  ...
  %15 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !301, !tbaa !298
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %15), !dbg !302
  %16 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !303, !tbaa !298
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %16), !dbg !304
  %17 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !305, !tbaa !298
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, i64 noundef %17), !dbg !306
  %18 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 4), align 8, !dbg !307, !tbaa !298
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.10, i64 noundef %18), !dbg !308
  %19 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 5), align 8, !dbg !309, !tbaa !298
  %call46 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.11, i64 noundef %19), !dbg !310
  %20 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 6), align 8, !dbg !311, !tbaa !298
  %call47 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.12, i64 noundef %20), !dbg !312
  %21 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @CounterValues, i64 0, i64 7), align 8, !dbg !313, !tbaa !298
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.13, i64 noundef %21), !dbg !314
  %22 = load double, ptr @ExecutionTime, align 8, !dbg !315, !tbaa !172
  %call49 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.14, double noundef %22), !dbg !316
  %23 = load i32, ptr @EventSet, align 4, !dbg !317, !tbaa !119
  %call50 = tail call i32 @PAPI_remove_events(i32 noundef %23, ptr noundef nonnull @EventCodes, i32 noundef 8) #13, !dbg !319
  call void @llvm.dbg.value(metadata i32 %call50, metadata !220, metadata !DIExpression()), !dbg !243
  %cmp51.not = icmp eq i32 %call50, 0, !dbg !320
  br i1 %cmp51.not, label %if.end55, label %if.then53, !dbg !321
...
for.body33:                                       ; preds = %for.body33, %for.cond.cleanup
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv82, metadata !229, metadata !DIExpression()), !dbg !269
  call void @llvm.dbg.value(metadata i32 %sum.079, metadata !228, metadata !DIExpression()), !dbg !243
  %arrayidx35 = getelementptr inbounds i32, ptr %8, i64 %indvars.iv82, !dbg !322
  %24 = load i32, ptr %arrayidx35, align 4, !dbg !322, !tbaa !119
  %add = add nsw i32 %24, %sum.079, !dbg !325
  call void @llvm.dbg.value(metadata i32 %add, metadata !228, metadata !DIExpression()), !dbg !243
  %indvars.iv.next83 = add nuw nsw i64 %indvars.iv82, 1, !dbg !326
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next83, metadata !229, metadata !DIExpression()), !dbg !269
  %exitcond85.not = icmp eq i64 %indvars.iv.next83, 5000000, !dbg !327
  br i1 %exitcond85.not, label %for.cond.cleanup32, label %for.body33, !dbg !270, !llvm.loop !328

if.then53:                                        ; preds = %for.cond.cleanup32
  %25 = load ptr, ptr @stderr, align 8, !dbg !330, !tbaa !130
  %call54 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %25, ptr noundef nonnull @.str, i32 noundef %call50, ptr noundef nonnull @.str.1, i32 noundef 386) #14, !dbg !330
  tail call void @exit(i32 noundef %call50) #15, !dbg !330
  unreachable, !dbg !330

if.end55:                                         ; preds = %for.cond.cleanup32
  %call56 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #13, !dbg !332
  call void @llvm.dbg.value(metadata i32 %call56, metadata !220, metadata !DIExpression()), !dbg !243
  %cmp57.not = icmp eq i32 %call56, 0, !dbg !334
  br i1 %cmp57.not, label %if.end61, label %if.then59, !dbg !335

if.then59:                                        ; preds = %if.end55
  %26 = load ptr, ptr @stderr, align 8, !dbg !336, !tbaa !130
  %call60 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %26, ptr noundef nonnull @.str, i32 noundef %call56, ptr noundef nonnull @.str.1, i32 noundef 389) #14, !dbg !336
  tail call void @exit(i32 noundef %call56) #15, !dbg !336
  unreachable, !dbg !336
...
!164 = !DILocation(line: 66, column: 5, scope: !114)
!165 = !{!"llvm.loop.mustprogress"}
!166 = !{!"llvm.loop.unroll.disable"}
!167 = !DILocation(line: 69, column: 67, scope: !168)
!168 = distinct !DILexicalBlock(scope: !133, file: !3, line: 69, column: 67)
!169 = !DILocation(line: 71, column: 21, scope: !100)
!170 = !DILocation(line: 71, column: 42, scope: !100)
!171 = !DILocation(line: 71, column: 19, scope: !100)
!172 = !{!173, !173, i64 0}
!173 = !{!"double", !81, i64 0}
!174 = !DILocation(line: 72, column: 1, scope: !100)
...
!183 = distinct !DISubprogram(name: "checked_malloc_int_array", scope: !3, file: !3, line: 304, type: !184, scopeLine: 304, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !186)
!184 = !DISubroutineType(types: !185)
!185 = !{!5, !6}
!186 = !{!187, !188}
!187 = !DILocalVariable(name: "n", arg: 1, scope: !183, file: !3, line: 304, type: !6)
!188 = !DILocalVariable(name: "ptr", scope: !183, file: !3, line: 305, type: !5)
!189 = !DILocation(line: 0, scope: !183)
!190 = !DILocation(line: 305, column: 45, scope: !183)
!191 = !DILocation(line: 305, column: 43, scope: !183)
!192 = !DILocation(line: 305, column: 24, scope: !183)
!193 = !DILocation(line: 306, column: 13, scope: !194)
!194 = distinct !DILexicalBlock(scope: !183, file: !3, line: 306, column: 9)
!195 = !DILocation(line: 306, column: 9, scope: !183)
!196 = !DILocation(line: 307, column: 9, scope: !197)
!197 = distinct !DILexicalBlock(scope: !194, file: !3, line: 306, column: 22)
!198 = !DILocation(line: 308, column: 9, scope: !197)
!199 = !DILocation(line: 310, column: 5, scope: !183)
!200 = distinct !DISubprogram(name: "checked_malloc_bool_array", scope: !3, file: !3, line: 313, type: !201, scopeLine: 313, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !203)
!201 = !DISubroutineType(types: !202)
!202 = !{!8, !6}
!203 = !{!204, !205}
!204 = !DILocalVariable(name: "n", arg: 1, scope: !200, file: !3, line: 313, type: !6)
!205 = !DILocalVariable(name: "ptr", scope: !200, file: !3, line: 314, type: !8)
!206 = !DILocation(line: 0, scope: !200)
!207 = !DILocation(line: 314, column: 48, scope: !200)
!208 = !DILocation(line: 314, column: 26, scope: !200)
!209 = !DILocation(line: 315, column: 13, scope: !210)
!210 = distinct !DILexicalBlock(scope: !200, file: !3, line: 315, column: 9)
!211 = !DILocation(line: 315, column: 9, scope: !200)
!212 = !DILocation(line: 316, column: 9, scope: !213)
!213 = distinct !DILexicalBlock(scope: !210, file: !3, line: 315, column: 22)
!214 = !DILocation(line: 317, column: 9, scope: !213)
!215 = !DILocation(line: 319, column: 5, scope: !200)
!216 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 322, type: !217, scopeLine: 322, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !219)
!217 = !DISubroutineType(types: !218)
!218 = !{!6}
!219 = !{!220, !221, !226, !228, !229}
!220 = !DILocalVariable(name: "status", scope: !216, file: !3, line: 323, type: !6)
!221 = !DILocalVariable(name: "errstring", scope: !216, file: !3, line: 324, type: !222)
...
!226 = !DILocalVariable(name: "i", scope: !227, file: !3, line: 348, type: !6)
!227 = distinct !DILexicalBlock(scope: !216, file: !3, line: 348, column: 5)
!228 = !DILocalVariable(name: "sum", scope: !216, file: !3, line: 361, type: !6)
!229 = !DILocalVariable(name: "i", scope: !230, file: !3, line: 363, type: !6)
!230 = distinct !DILexicalBlock(scope: !216, file: !3, line: 363, column: 5)
!231 = !DILocation(line: 324, column: 5, scope: !216)
!232 = !DILocation(line: 324, column: 10, scope: !216)
!233 = !DILocation(line: 326, column: 9, scope: !234)
!234 = distinct !DILexicalBlock(scope: !216, file: !3, line: 326, column: 9)
!235 = !DILocation(line: 326, column: 45, scope: !234)
!236 = !DILocation(line: 326, column: 9, scope: !216)
!237 = !DILocation(line: 327, column: 17, scope: !238)
!238 = distinct !DILexicalBlock(scope: !234, file: !3, line: 326, column: 66)
!239 = !DILocation(line: 327, column: 9, scope: !238)
!240 = !DILocation(line: 328, column: 9, scope: !238)
!241 = !DILocation(line: 332, column: 19, scope: !242)
!242 = distinct !DILexicalBlock(scope: !216, file: !3, line: 332, column: 9)
!243 = !DILocation(line: 0, scope: !216)
!244 = !DILocation(line: 332, column: 52, scope: !242)
!245 = !DILocation(line: 332, column: 9, scope: !216)
!246 = !DILocation(line: 332, column: 64, scope: !247)
!247 = distinct !DILexicalBlock(scope: !242, file: !3, line: 332, column: 64)
!248 = !DILocation(line: 335, column: 35, scope: !249)
!249 = distinct !DILexicalBlock(scope: !216, file: !3, line: 335, column: 9)
!250 = !DILocation(line: 335, column: 19, scope: !249)
!251 = !DILocation(line: 335, column: 69, scope: !249)
!252 = !DILocation(line: 335, column: 9, scope: !216)
!253 = !DILocation(line: 335, column: 81, scope: !254)
!254 = distinct !DILexicalBlock(scope: !249, file: !3, line: 335, column: 81)
!255 = !DILocation(line: 338, column: 9, scope: !216)
!256 = !DILocation(line: 338, column: 7, scope: !216)
!257 = !DILocation(line: 339, column: 9, scope: !216)
!258 = !DILocation(line: 339, column: 7, scope: !216)
!259 = !DILocation(line: 340, column: 9, scope: !216)
!260 = !DILocation(line: 340, column: 7, scope: !216)
!261 = !DILocation(line: 341, column: 12, scope: !216)
!262 = !DILocation(line: 341, column: 10, scope: !216)
!263 = !DILocation(line: 343, column: 13, scope: !216)
!264 = !DILocation(line: 345, column: 11, scope: !216)
!265 = !DILocation(line: 345, column: 5, scope: !216)
!266 = !DILocation(line: 0, scope: !227)
!267 = !DILocation(line: 348, column: 5, scope: !227)
!268 = !DILocation(line: 357, column: 5, scope: !216)
!269 = !DILocation(line: 0, scope: !230)
!270 = !DILocation(line: 363, column: 5, scope: !230)
!271 = !DILocation(line: 349, column: 9, scope: !272)
!272 = distinct !DILexicalBlock(scope: !273, file: !3, line: 348, column: 33)
!273 = distinct !DILexicalBlock(scope: !227, file: !3, line: 348, column: 5)
!274 = !DILocation(line: 349, column: 14, scope: !272)
!275 = !DILocation(line: 350, column: 9, scope: !272)
!276 = !DILocation(line: 350, column: 14, scope: !272)
!277 = !DILocation(line: 351, column: 9, scope: !272)
!278 = !DILocation(line: 351, column: 14, scope: !272)
!279 = !DILocation(line: 353, column: 22, scope: !272)
!280 = !DILocation(line: 353, column: 29, scope: !272)
!281 = !DILocation(line: 353, column: 9, scope: !272)
!282 = !DILocation(line: 353, column: 17, scope: !272)
!283 = !DILocation(line: 348, column: 28, scope: !273)
!284 = !DILocation(line: 348, column: 23, scope: !273)
!285 = distinct !{!285, !267, !286, !165, !166}
!286 = !DILocation(line: 354, column: 5, scope: !227)
!287 = !DILocation(line: 368, column: 5, scope: !216)
!288 = !DILocation(line: 369, column: 5, scope: !216)
!289 = !DILocation(line: 371, column: 10, scope: !216)
!290 = !DILocation(line: 371, column: 5, scope: !216)
!291 = !DILocation(line: 372, column: 10, scope: !216)
!292 = !DILocation(line: 372, column: 5, scope: !216)
!293 = !DILocation(line: 373, column: 10, scope: !216)
!294 = !DILocation(line: 373, column: 5, scope: !216)
!295 = !DILocation(line: 374, column: 10, scope: !216)
!296 = !DILocation(line: 374, column: 5, scope: !216)
!297 = !DILocation(line: 376, column: 53, scope: !216)
!298 = !{!299, !299, i64 0}
!299 = !{!"long long", !81, i64 0}
!300 = !DILocation(line: 376, column: 5, scope: !216)
!301 = !DILocation(line: 377, column: 44, scope: !216)
!302 = !DILocation(line: 377, column: 5, scope: !216)
!303 = !DILocation(line: 378, column: 50, scope: !216)
!304 = !DILocation(line: 378, column: 5, scope: !216)
!305 = !DILocation(line: 379, column: 49, scope: !216)
!306 = !DILocation(line: 379, column: 5, scope: !216)
!307 = !DILocation(line: 380, column: 57, scope: !216)
!308 = !DILocation(line: 380, column: 5, scope: !216)
!309 = !DILocation(line: 381, column: 59, scope: !216)
!310 = !DILocation(line: 381, column: 5, scope: !216)
!311 = !DILocation(line: 382, column: 45, scope: !216)
!312 = !DILocation(line: 382, column: 5, scope: !216)
!313 = !DILocation(line: 383, column: 66, scope: !216)
!314 = !DILocation(line: 383, column: 5, scope: !216)
!315 = !DILocation(line: 384, column: 40, scope: !216)
!316 = !DILocation(line: 384, column: 5, scope: !216)
!317 = !DILocation(line: 386, column: 38, scope: !318)
!318 = distinct !DILexicalBlock(scope: !216, file: !3, line: 386, column: 9)
!319 = !DILocation(line: 386, column: 19, scope: !318)
!320 = !DILocation(line: 386, column: 72, scope: !318)
!321 = !DILocation(line: 386, column: 9, scope: !216)
!322 = !DILocation(line: 364, column: 16, scope: !323)
!323 = distinct !DILexicalBlock(scope: !324, file: !3, line: 363, column: 33)
!324 = distinct !DILexicalBlock(scope: !230, file: !3, line: 363, column: 5)
!325 = !DILocation(line: 364, column: 13, scope: !323)
!326 = !DILocation(line: 363, column: 28, scope: !324)
!327 = !DILocation(line: 363, column: 23, scope: !324)
!328 = distinct !{!328, !270, !329, !165, !166}
!329 = !DILocation(line: 365, column: 5, scope: !230)
!330 = !DILocation(line: 386, column: 84, scope: !331)
!331 = distinct !DILexicalBlock(scope: !318, file: !3, line: 386, column: 84)
!332 = !DILocation(line: 389, column: 19, scope: !333)
!333 = distinct !DILexicalBlock(scope: !216, file: !3, line: 389, column: 9)
!334 = !DILocation(line: 389, column: 53, scope: !333)
!335 = !DILocation(line: 389, column: 9, scope: !216)
!336 = !DILocation(line: 389, column: 65, scope: !337)
!337 = distinct !DILexicalBlock(scope: !333, file: !3, line: 389, column: 65)
!338 = !DILocation(line: 392, column: 5, scope: !216)
!339 = !DILocation(line: 395, column: 1, scope: !216)
!340 = !DILocation(line: 394, column: 5, scope: !216)
!341 = !DISubprogram(name: "PAPI_library_init", scope: !176, file: !176, line: 1172, type: !177, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
!342 = !DISubprogram(name: "PAPI_create_eventset", scope: !176, file: !176, line: 1147, type: !343, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
!343 = !DISubroutineType(types: !344)
!344 = !{!6, !5}
!345 = !DISubprogram(name: "PAPI_add_events", scope: !176, file: !176, line: 1143, type: !346, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
!346 = !DISubroutineType(types: !347)
!347 = !{!6, !6, !5, !6}
!348 = !DISubprogram(name: "srand", scope: !349, file: !349, line: 455, type: !350, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
...
!353 = !DISubprogram(name: "time", scope: !92, file: !92, line: 75, type: !354, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
!354 = !DISubroutineType(types: !355)
!355 = !{!356, !358}
!356 = !DIDerivedType(tag: DW_TAG_typedef, name: "time_t", file: !357, line: 7, baseType: !69)
...
!359 = !DISubprogram(name: "PAPI_remove_events", scope: !176, file: !176, line: 1192, type: !346, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
!360 = !DISubprogram(name: "PAPI_destroy_eventset", scope: !176, file: !176, line: 1149, type: !343, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
!361 = !DISubprogram(name: "PAPI_shutdown", scope: !176, file: !176, line: 1202, type: !362, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !99)
