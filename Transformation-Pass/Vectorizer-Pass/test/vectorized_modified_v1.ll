...
Preheader.for.remaining.iterations:               ; preds = %middel.block, %for.cond2.preheader
  %7 = phi i64 [ 0, %for.cond2.preheader ], [ %51, %middel.block ]
  br label %for.body5

pre.alc:                                          ; preds = %for.cond2.preheader
  %8 = call i64 @llvm.vscale.i64()
  %9 = mul i64 %8, 2
  %uniform.vector = call <vscale x 2 x i64> @llvm.experimental.stepvector.nxv4i64()
  %10 = urem i64 8192, %9
  ...
  %remaining.vector = add <vscale x 2 x i64> %uniform.vector, %stepVector.update.values
  %12 = getelementptr inbounds [8192 x i32], ptr @a, i64 0, i64 0, !dbg !110
  %13 = getelementptr inbounds [8192 x i32], ptr @b, i64 0, i64 0, !dbg !118
  %14 = call i64 @llvm.vscale.i64(), !dbg !110
  %15 = mul i64 %14, 2, !dbg !110
  %16 = getelementptr inbounds [8192 x i32], ptr @a, i64 0, i64 %15, !dbg !110
  %17 = getelementptr inbounds [8192 x i32], ptr @b, i64 0, i64 %15, !dbg !118
  %18 = load <vscale x 2 x i32>, ptr %12, align 8
  %19 = load <vscale x 2 x i32>, ptr %13, align 8
  %20 = icmp sgt <vscale x 2 x i32> %18, %19
  %21 = load <vscale x 2 x i32>, ptr %16, align 8
  %22 = load <vscale x 2 x i32>, ptr %17, align 8
  %23 = icmp sgt <vscale x 2 x i32> %21, %22
  %start.index = mul i64 %15, 2
  br label %alc.header

alc.header:                                       ; preds = %new.latch, %pre.alc
  %24 = phi i64 [ %15, %pre.alc ], [ %51, %new.latch ]
  %25 = phi <vscale x 2 x i64> [ %uniform.vector, %pre.alc ], [ %next.uniform.vec, %new.latch ]
  %26 = phi <vscale x 2 x i64> [ %remaining.vector, %pre.alc ], [ %next.remaining.vec, %new.latch ]
  %predicate.vector.1= phi <vscale x 2 x i1> [ %20, %pre.alc ], [ %next.uniform.predicates, %new.latch ]
  %predicate.vector.2= phi <vscale x 2 x i1> [ %23, %pre.alc ], [ %next.remaining.predicates, %new.latch ]
   br label %lane.gather

lane.gather:                                      ; preds = %alc.header
  %27 = call <vscale x 2 x i1> @llvm.aarch64.sve.ptrue.nxv4i1(i32 31)
  %28 = call <vscale x 2 x i64> @llvm.aarch64.sve.compact.nxv4i64(<vscale x 2 x i1> %20, <vscale x 2 x i64> %uniform.vector)
  %29 = call <vscale x 2 x i64> @llvm.aarch64.sve.compact.nxv4i64(<vscale x 2 x i1> %20, <vscale x 2 x i64> %remaining.vector)
  %30 = xor <vscale x 2 x i1> %20, shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer)
  %31 = xor <vscale x 2 x i1> %20, shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer)
  %32 = call <vscale x 2 x i64> @llvm.aarch64.sve.compact.nxv4i64(<vscale x 2 x i1> %30, <vscale x 2 x i64> %uniform.vector)
  %33 = call <vscale x 2 x i64> @llvm.aarch64.sve.compact.nxv4i64(<vscale x 2 x i1> %31, <vscale x 2 x i64> %remaining.vector)
  %34 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 2 x i1> %27, <vscale x 2 x i1> %20)
  %35 = call <vscale x 2 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %34)
  %36 = call <vscale x 2 x i64> @llvm.aarch64.sve.splice.nxv4i64(<vscale x 2 x i1> %35, <vscale x 2 x i64> %28, <vscale x 2 x i64> %29)   ;uniform vector
  %37 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 2 x i1> %27, <vscale x 2 x i1> %20)
  %38 = call <vscale x 2 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %37)
  %39 = call <vscale x 2 x i64> @llvm.aarch64.sve.splice.nxv4i64(<vscale x 2 x i1> %38, <vscale x 2 x i64> %29, <vscale x 2 x i64> %33)
  %40 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 2 x i1> %27, <vscale x 2 x i1> %30)
  %41 = call <vscale x 2 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %40)
  %42 = call <vscale x 2 x i64> @llvm.aarch64.sve.sel.nxv4i64(<vscale x 2 x i1> %41, <vscale x 2 x i64> %32, <vscale x 2 x i64> %39)		; merge vector
  %43 = xor <vscale x 2 x i1> %41, shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer)
  %44 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 2 x i1> %27, <vscale x 2 x i1> %41)
  %45 = sub i64 %37, %40
  %46 = add i64 %45, %44
  %47 = call <vscale x 2 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %46)
  %48 = xor <vscale x 2 x i1> %47, shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer)
  %49 = and <vscale x 2 x i1> %43, %47
  %50 = and <vscale x 2 x i1> %47, %48
  %permuted.rem.predicates = or <vscale x 2 x i1> %49, %50
  %all.true = call <vscale x 2 x i1> @llvm.aarch64.sve.ptrue.nxv4i1(i32 31)
  %first.vec.active.lanes = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 2 x i1> %all.true, <vscale x 2 x i1> %predicate.vector.1)
  %second.vec.active.lanes = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 2 x i1> %all.true, <vscale x 2 x i1> %predicate.vector.2)
  %num.active.lanes = add i64 %first.vec.active.lanes, %second.vec.active.lanes
  %condition = icmp uge  i64 %num.active.lanes, %15
  br i1 %condition, label %alc.applied, label %linearized
  ;br label %alc.applied                                       ;--------------------------------> yields to half executing intructions!!

alc.applied:  					 ; preds = %lane.gather
  %all.true.p = call <vscale x 2 x i1> @llvm.aarch64.sve.ptrue.nxv4i1(i32 31)
  %ptr.vec.a = getelementptr inbounds [8192 x i32], ptr @a, i64 0, <vscale x 2 x i64> %36, !dbg !110
  %ptr.vec.b = getelementptr inbounds [8192 x i32], ptr @b, i64 0, <vscale x 2 x i64> %36, !dbg !110
  %loaded.a = call <vscale x 2 x i32> @llvm.masked.gather.v4i32.v4p0(<vscale x 2 x ptr> %ptr.vec.a , i32 16, <vscale x 2 x i1> %all.true.p, <vscale x 2 x i32> poison)
  %loaded.b = call <vscale x 2 x i32> @llvm.masked.gather.v4i32.v4p0(<vscale x 2 x ptr> %ptr.vec.b , i32 16, <vscale x 2 x i1> %all.true.p, <vscale x 2 x i32> poison)
  %ptr.vec.d = getelementptr inbounds [8192 x i32], ptr @d, i64 0, <vscale x 2 x i64> %36, !dbg !110
  %loaded.d = call <vscale x 2 x i32> @llvm.masked.gather.v4i32.v4p0(<vscale x 2 x ptr> %ptr.vec.d , i32 16, <vscale x 2 x i1> %all.true.p, <vscale x 2 x i32> poison)
  %mul.vec = mul <vscale x 2 x i32> %loaded.b, %loaded.d
  %sub.vec = sub <vscale x 2 x i32>  %loaded.a, %mul.vec
  %ptr.vec.c = getelementptr inbounds [8192 x i32], ptr @c, i64 0, <vscale x 2 x i64> %36, !dbg !110
  %loaded.c = call <vscale x 2 x i32> @llvm.masked.gather.v4i32.v4p0(<vscale x 2 x ptr> %ptr.vec.c , i32 16, <vscale x 2 x i1> %all.true.p, <vscale x 2 x i32> poison)
  %add.vec = add <vscale x 2 x i32> %loaded.c, %sub.vec
  call void @llvm.masked.scatter.v4i32.v4p0(<vscale x 2 x i32> %add.vec, <vscale x 2 x ptr> %ptr.vec.c, i32 16, <vscale x 2 x i1> %all.true.p)
  call void @llvm.masked.scatter.v4i32.v4p0(<vscale x 2 x i32> %sub.vec, <vscale x 2 x ptr> %ptr.vec.a, i32 16, <vscale x 2 x i1> %all.true.p)
  ;forming predicates for the next iteration
  %new.index = add i64 %24, %9
  %new.ptr.a = getelementptr inbounds [8192 x i32], ptr @a, i64 0, i64 %new.index, !dbg !110
  %new.ptr.b = getelementptr inbounds [8192 x i32], ptr @b, i64 0, i64 %new.index, !dbg !118
  %new.loaded.a = load <vscale x 2 x i32>, ptr %12, align 8
  %new.loaded.b = load <vscale x 2 x i32>, ptr %13, align 8
  %new.predicates = icmp sgt <vscale x 2 x i32> %18, %19
  %new.index.vec = call <vscale x 2 x i64> @llvm.aarch64.sve.index.nxv4i64(i64 %24, i64 1)
  br label %new.latch

linearized:   				 ; preds = %alc.header
  %new.index.linearized = add i64 %24, %9
  %new.ptr.a.linearized = getelementptr inbounds [8192 x i32], ptr @a, i64 0, i64 %new.index.linearized, !dbg !110
  %new.ptr.b.linearized = getelementptr inbounds [8192 x i32], ptr @b, i64 0, i64 %new.index.linearized, !dbg !118
  %new.loaded.a.linearized = load <vscale x 2 x i32>, ptr %12, align 8
  %new.loaded.b.linearized = load <vscale x 2 x i32>, ptr %13, align 8
  %new.predicates.linearized = icmp sgt <vscale x 2 x i32> %18, %19
  %new.index.vec.linearized = call <vscale x 2 x i64> @llvm.aarch64.sve.index.nxv4i64(i64 %24, i64 1)                                   
  br label %new.latch

new.latch:                                        ; preds = %linearized, %alc.applied
  %next.uniform.vec = phi <vscale x 2 x i64> [ %new.index.vec, %alc.applied ], [ %36, %linearized ]
  %next.remaining.vec = phi <vscale x 2 x i64> [ %42, %alc.applied ], [ %new.index.vec.linearized, %linearized ]
  %next.uniform.predicates = phi <vscale x 2 x i1> [ %new.predicates, %alc.applied ], [ %predicate.vector.1, %linearized ]
  %next.remaining.predicates = phi <vscale x 2 x i1> [ %permuted.rem.predicates, %alc.applied ], [ %new.predicates.linearized, %linearized ]
  %51 = add i64 %9, %24
  %loop.exit.cond = icmp ugt i64 %51, %total.iterations.to.be.vectorized
...
; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare <vscale x 2 x i64> @llvm.experimental.stepvector.nxv4i64() #7

; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare <vscale x 2 x i1> @llvm.aarch64.sve.ptrue.nxv4i1(i32 immarg) #7

; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare <vscale x 2 x i64> @llvm.aarch64.sve.compact.nxv4i64(<vscale x 2 x i1>, <vscale x 2 x i64>) #7	   

; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 2 x i1>, <vscale x 2 x i1>) #7

; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare <vscale x 2 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64, i64) #7

; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare <vscale x 2 x i64> @llvm.aarch64.sve.splice.nxv4i64(<vscale x 2 x i1>, <vscale x 2 x i64>, <vscale x 2 x i64>) #7

; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare <vscale x 2 x i64> @llvm.aarch64.sve.sel.nxv4i64(<vscale x 2 x i1>, <vscale x 2 x i64>, <vscale x 2 x i64>) #7


declare <vscale x 2 x i32> @llvm.masked.gather.v4i32.v4p0(<vscale x 2 x ptr>, i32, <vscale x 2 x i1>, <vscale x 2 x i32>)

declare void @llvm.masked.scatter.v4i32.v4p0(<vscale x 2 x i32>, <vscale x 2 x ptr>, i32, <vscale x 2 x i1>)

declare <vscale x 2 x i64> @llvm.aarch64.sve.index.nxv4i64(i64, i64)
