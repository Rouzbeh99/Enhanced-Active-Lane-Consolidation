...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %for.cond.preheader
  ...
  %call12 = tail call i32 @PAPI_stop(i32 noundef %6, ptr noundef nonnull @CounterValues) #13, !dbg !117
...
if.else:                                          ; preds = %for.body
  ...
  %9 = load i32, ptr %arrayidx10, align 4, !dbg !135, !tbaa !102
  %sub = add nsw i32 %9, -4, !dbg !135
...
Preheader.for.remaining.iterations:               ; preds = %middel.block, %for.body.preheader
  %10 = phi i64 [ 0, %for.body.preheader ], [ %93, %middel.block ]
  br label %for.body
...
pre.alc:                                          ; preds = %for.body.preheader
  ...
  %16 = getelementptr inbounds i8, ptr %cond, i32 0, !dbg !120
  %17 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 0, i32 1)
  %18 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg = shufflevector <vscale x 4 x i32> %18, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %19 = load <vscale x 4 x i8>, ptr %16, align 4
  %20 = icmp eq <vscale x 4 x i8> %19, zeroinitializer
  br label %alc.header

alc.header:                                       ; preds = %new.latch, %pre.alc
  %vector.loop.index = phi i32 [ %2, %pre.alc ], [ %67, %new.latch ]
  %uniform.vector = phi <vscale x 4 x i32> [ %12, %pre.alc ], [ %65, %new.latch ]
  %uniform.vector.predicates = phi <vscale x 4 x i1> [ %20, %pre.alc ], [ %66, %new.latch ]
  %21 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %vector.loop.index, i32 1)
  %22 = getelementptr inbounds i8, ptr %cond, i32 %vector.loop.index, !dbg !120
  ...
  %vector.arg1 = shufflevector <vscale x 4 x i32> %24, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
...
lane.gather:                                      ; preds = %alc.header
  %27 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %uniform.vector.predicates, <vscale x 4 x i1> %uniform.vector.predicates)
  %28 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %26, <vscale x 4 x i1> %26)
  ...
  %33 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %26, <vscale x 4 x i32> %21)
  ...
  %36 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %34, <vscale x 4 x i32> %uniform.vector)
  %37 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %35, <vscale x 4 x i32> %21)
  %38 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %29)
  %39 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %38, <vscale x 4 x i32> %32, <vscale x 4 x i32> %33)
  %40 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %31)
  %41 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %26, <vscale x 4 x i1> %26)
  %42 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %41)
  %43 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %42, <vscale x 4 x i32> %33, <vscale x 4 x i32> %37)
  %44 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %34, <vscale x 4 x i1> %34)
  %45 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %44)
  %46 = call <vscale x 4 x i32> @llvm.aarch64.sve.sel.nxv4i32(<vscale x 4 x i1> %45, <vscale x 4 x i32> %36, <vscale x 4 x i32> %43)
  %47 = xor <vscale x 4 x i1> %45, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %48 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %35, <vscale x 4 x i1> %35)
  %49 = sext i32 %2 to i64
  %50 = sub i64 %49, %48
  %51 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %50)
  %52 = and <vscale x 4 x i1> %47, %51
  %53 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %40, <vscale x 4 x i1> %40)
  %54 = trunc i64 %53 to i32
  %55 = icmp ugt i32 %31, %2
  br i1 %55, label %uniform.then, label %uniform.else

uniform.then:                                     ; preds = %lane.gather
  %56 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !133
  %57 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg2 = shufflevector <vscale x 4 x i32> %57, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %58 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %11, ptr %56, <vscale x 4 x i32> %39)
  ...
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %59, <vscale x 4 x i1> %11, ptr %56, <vscale x 4 x i32> %39)
  br label %new.latch

uniform.else:                                     ; preds = %lane.gather
  %60 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !127
  %61 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !130
  %62 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg3 = shufflevector <vscale x 4 x i32> %62, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %63 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %11, ptr %60, <vscale x 4 x i32> %46)
  %64 = add <vscale x 4 x i32> %63, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 56, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %64, <vscale x 4 x i1> %11, ptr %61, <vscale x 4 x i32> %46)
  br label %new.latch

new.latch:                                        ; preds = %uniform.else, %uniform.then
  %65 = phi <vscale x 4 x i32> [ %46, %uniform.then ], [ %39, %uniform.else ]
  %66 = phi <vscale x 4 x i1> [ %52, %uniform.then ], [ %40, %uniform.else ]
  %67 = add i32 %vector.loop.index, %2
  %68 = icmp uge i32 %67, %total.iterations.to.be.vectorized
  br i1 %68, label %joinBlock, label %alc.header

linearized.then:                                  ; preds = %joinBlock
  %69 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !133
  %70 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg4 = shufflevector <vscale x 4 x i32> %70, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %71 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %40, ptr %69, <vscale x 4 x i32> %39)
  %72 = add <vscale x 4 x i32> %71, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %72, <vscale x 4 x i1> %40, ptr %69, <vscale x 4 x i32> %39)
  %73 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !127
  %74 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !130
  %75 = xor <vscale x 4 x i1> %40, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %76 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg5 = shufflevector <vscale x 4 x i32> %76, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %77 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %75, ptr %73, <vscale x 4 x i32> %39)
  %78 = add <vscale x 4 x i32> %77, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 56, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %78, <vscale x 4 x i1> %75, ptr %74, <vscale x 4 x i32> %39)
  br label %middel.block

linearized.else:                                  ; preds = %joinBlock
  %79 = xor <vscale x 4 x i1> %52, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %80 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !127
  %81 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !130
  %82 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg6 = shufflevector <vscale x 4 x i32> %82, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %83 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %79, ptr %80, <vscale x 4 x i32> %46)
  %84 = add <vscale x 4 x i32> %83, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 56, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %84, <vscale x 4 x i1> %79, ptr %81, <vscale x 4 x i32> %46)
  %85 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !133
  %86 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg7 = shufflevector <vscale x 4 x i32> %86, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %87 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %52, ptr %85, <vscale x 4 x i32> %46)
  %88 = add <vscale x 4 x i32> %87, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %88, <vscale x 4 x i1> %52, ptr %85, <vscale x 4 x i32> %46)
  br label %middel.block

joinBlock:                                        ; preds = %new.latch
  %89 = icmp eq <vscale x 4 x i32> %65, %39
  %90 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %89, <vscale x 4 x i1> %89)
  %91 = trunc i64 %90 to i32
  %92 = icmp eq i32 %91, %2
  br i1 %92, label %linearized.then, label %linearized.else
...
if.then14:                                        ; preds = %for.cond.cleanup
  %94 = load ptr, ptr @stderr, align 8, !dbg !141, !tbaa !113
  %call15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %94, ptr noundef nonnull @.str, i32 noundef %call12, ptr noundef nonnull @.str.1, i32 noundef 78) #14, !dbg !141
  tail call void @exit(i32 noundef %call12) #15, !dbg !141
  unreachable, !dbg !141
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %errstring) #13, !dbg !206
  call void @llvm.dbg.declare(metadata ptr %errstring, metadata !195, metadata !DIExpression()), !dbg !207
  %call = tail call i32 @PAPI_library_init(i32 noundef 117440512) #13, !dbg !208
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3, ptr noundef nonnull %errstring) #14, !dbg !214
  call void @exit(i32 noundef 1) #15, !dbg !215
  unreachable, !dbg !215

if.end:                                           ; preds = %entry
  %call2 = tail call i32 @PAPI_create_eventset(ptr noundef nonnull @EventSet) #13, !dbg !216
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 293) #14, !dbg !221
  tail call void @exit(i32 noundef %call2) #15, !dbg !221
  unreachable, !dbg !221

if.end6:                                          ; preds = %if.end
  %2 = load i32, ptr @EventSet, align 4, !dbg !223, !tbaa !102
  %call7 = tail call i32 @PAPI_add_events(i32 noundef %2, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !225
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 296) #14, !dbg !228
  tail call void @exit(i32 noundef %call7) #15, !dbg !228
  unreachable, !dbg !228
...
if.end11:                                         ; preds = %if.end6
  ...
  %call16 = tail call i64 @time(ptr noundef null) #13, !dbg !239
  %conv = trunc i64 %call16 to i32, !dbg !239
  tail call void @srand(i32 noundef %conv) #13, !dbg !240
...
for.cond.cleanup32:                               ; preds = %for.body33
  %add.lcssa = phi i32 [ %add, %for.body33 ], !dbg !262
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add.lcssa), !dbg !265
  %9 = load ptr, ptr @a, align 8, !dbg !266, !tbaa !113
  tail call void @free(ptr noundef %9) #13, !dbg !267
  %10 = load ptr, ptr @b, align 8, !dbg !268, !tbaa !113
  tail call void @free(ptr noundef %10) #13, !dbg !269
  %11 = load ptr, ptr @c, align 8, !dbg !270, !tbaa !113
  tail call void @free(ptr noundef %11) #13, !dbg !271
  %12 = load ptr, ptr @cond, align 8, !dbg !272, !tbaa !113
  tail call void @free(ptr noundef %12) #13, !dbg !273
  %13 = load i64, ptr @CounterValues, align 8, !dbg !274, !tbaa !275
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i64 noundef %13), !dbg !277
  %14 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !278, !tbaa !275
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %14), !dbg !279
  %15 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !280, !tbaa !275
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %15), !dbg !281
  %16 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !282, !tbaa !275
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %16), !dbg !283
  %17 = load double, ptr @ExecutionTime, align 8, !dbg !284, !tbaa !146
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, double noundef %17), !dbg !285
  %18 = load i32, ptr @EventSet, align 4, !dbg !286, !tbaa !102
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %18, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !288
  call void @llvm.dbg.value(metadata i32 %call45, metadata !194, metadata !DIExpression()), !dbg !218
  %cmp46.not = icmp eq i32 %call45, 0, !dbg !289
  br i1 %cmp46.not, label %if.end50, label %if.then48, !dbg !290
...
for.body33:                                       ; preds = %for.body33, %for.cond.cleanup
  ...
  %arrayidx35 = getelementptr inbounds i32, ptr %8, i64 %indvars.iv85, !dbg !291
  %19 = load i32, ptr %arrayidx35, align 4, !dbg !291, !tbaa !102
  %add = add nsw i32 %19, %sum.082, !dbg !262
...
if.then48:                                        ; preds = %for.cond.cleanup32
  ...
  %call49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str, i32 noundef %call45, ptr noundef nonnull @.str.1, i32 noundef 340) #14, !dbg !296
  tail call void @exit(i32 noundef %call45) #15, !dbg !296
  unreachable, !dbg !296

if.end50:                                         ; preds = %for.cond.cleanup32
  %call51 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #13, !dbg !298
...
if.then54:                                        ; preds = %if.end50
  ...
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %21, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 343) #14, !dbg !302
  tail call void @exit(i32 noundef %call51) #15, !dbg !302
  unreachable, !dbg !302
...
!262 = !DILocation(line: 324, column: 13, scope: !263)
!263 = distinct !DILexicalBlock(scope: !264, file: !3, line: 323, column: 33)
!264 = distinct !DILexicalBlock(scope: !205, file: !3, line: 323, column: 5)
!265 = !DILocation(line: 327, column: 5, scope: !190)
!266 = !DILocation(line: 329, column: 10, scope: !190)
!267 = !DILocation(line: 329, column: 5, scope: !190)
!268 = !DILocation(line: 330, column: 10, scope: !190)
!269 = !DILocation(line: 330, column: 5, scope: !190)
!270 = !DILocation(line: 331, column: 10, scope: !190)
!271 = !DILocation(line: 331, column: 5, scope: !190)
!272 = !DILocation(line: 332, column: 10, scope: !190)
!273 = !DILocation(line: 332, column: 5, scope: !190)
!274 = !DILocation(line: 334, column: 53, scope: !190)
!275 = !{!276, !276, i64 0}
!276 = !{!"long long", !64, i64 0}
!277 = !DILocation(line: 334, column: 5, scope: !190)
!278 = !DILocation(line: 335, column: 36, scope: !190)
!279 = !DILocation(line: 335, column: 5, scope: !190)
!280 = !DILocation(line: 336, column: 50, scope: !190)
!281 = !DILocation(line: 336, column: 5, scope: !190)
!282 = !DILocation(line: 337, column: 49, scope: !190)
!283 = !DILocation(line: 337, column: 5, scope: !190)
!284 = !DILocation(line: 338, column: 40, scope: !190)
!285 = !DILocation(line: 338, column: 5, scope: !190)
!286 = !DILocation(line: 340, column: 38, scope: !287)
!287 = distinct !DILexicalBlock(scope: !190, file: !3, line: 340, column: 9)
!288 = !DILocation(line: 340, column: 19, scope: !287)
!289 = !DILocation(line: 340, column: 72, scope: !287)
!290 = !DILocation(line: 340, column: 9, scope: !190)
!291 = !DILocation(line: 324, column: 16, scope: !263)
!292 = !DILocation(line: 323, column: 28, scope: !264)
!293 = !DILocation(line: 323, column: 23, scope: !264)
!294 = distinct !{!294, !245, !295, !139, !140}
!295 = !DILocation(line: 325, column: 5, scope: !205)
!296 = !DILocation(line: 340, column: 84, scope: !297)
!297 = distinct !DILexicalBlock(scope: !287, file: !3, line: 340, column: 84)
