...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %for.cond.preheader
  ...
  %call109 = tail call i32 @PAPI_stop(i32 noundef %6, ptr noundef nonnull @CounterValues) #13, !dbg !117
...
if.then4:                                         ; preds = %for.body
  ...
  %mul21186 = add i32 %9, 2, !dbg !131
  %10 = trunc i64 %indvars.iv to i32, !dbg !131
  %add22 = mul i32 %mul21186, %10, !dbg !131
  %.neg = mul i32 %8, -2
  %add = add i32 %add22, %9, !dbg !132
  %add25 = add i32 %add, %.neg, !dbg !133
  store i32 %add25, ptr %arrayidx69, align 4, !dbg !133, !tbaa !102
  %mul43187.neg = sub i32 -3, %8, !dbg !134
  %add44.neg194 = mul i32 %mul43187.neg, %10, !dbg !134
  %11 = add i32 %8, %9
  %reass.add189 = sub i32 %add25, %11
...
if.else:                                          ; preds = %for.body
  %14 = load i32, ptr %arrayidx69, align 4, !dbg !145, !tbaa !102
  %mul70 = shl nsw i32 %14, 1, !dbg !145
  %arrayidx74 = getelementptr inbounds i32, ptr %c, i64 %indvars.iv, !dbg !147
  %sub80 = shl i32 %14, 2, !dbg !148
  %arrayidx82 = getelementptr inbounds i32, ptr %b, i64 %indvars.iv, !dbg !149
  %mul85.neg = mul i32 %14, -4, !dbg !150
...
Preheader.for.remaining.iterations:               ; preds = %middel.block, %for.body.preheader
  %15 = phi i64 [ 0, %for.body.preheader ], [ %202, %middel.block ]
  br label %for.body

pre.alc:                                          ; preds = %for.body.preheader
  %16 = call <vscale x 4 x i1> @llvm.aarch64.sve.ptrue.nxv4i1(i32 31)
  %17 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 0, i32 1)
  %18 = urem i32 %n, %2
  %19 = mul i32 %2, 2
  %20 = add i32 %19, %18
  %total.iterations.to.be.vectorized = sub i32 %n, %20
  %21 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  %22 = getelementptr inbounds i8, ptr %cond, i32 0, !dbg !120
  %23 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  ...
  %26 = load <vscale x 4 x i8>, ptr %22, align 4
  %27 = icmp eq <vscale x 4 x i8> %26, zeroinitializer
  br label %alc.header

alc.header:                                       ; preds = %new.latch, %pre.alc
  %vector.loop.index = phi i32 [ %2, %pre.alc ], [ %110, %new.latch ]
  %uniform.vector = phi <vscale x 4 x i32> [ %17, %pre.alc ], [ %108, %new.latch ]
  %uniform.vector.predicates = phi <vscale x 4 x i1> [ %27, %pre.alc ], [ %109, %new.latch ]
  %28 = call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %vector.loop.index, i32 1)
  %29 = getelementptr inbounds i32, ptr %a, i32 %vector.loop.index, !dbg !126
  %30 = getelementptr inbounds i8, ptr %cond, i32 %vector.loop.index, !dbg !120
  %31 = getelementptr inbounds i32, ptr %a, i32 %vector.loop.index, !dbg !126
  ...
  %34 = load <vscale x 4 x i8>, ptr %30, align 4
  %35 = icmp eq <vscale x 4 x i8> %34, zeroinitializer
  br label %lane.gather

lane.gather:                                      ; preds = %alc.header
  %36 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %uniform.vector.predicates, <vscale x 4 x i1> %uniform.vector.predicates)
  %37 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %35, <vscale x 4 x i1> %35)
  ...
  %42 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %35, <vscale x 4 x i32> %28)
  %43 = xor <vscale x 4 x i1> %uniform.vector.predicates, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %44 = xor <vscale x 4 x i1> %35, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %45 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %43, <vscale x 4 x i32> %uniform.vector)
  %46 = call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %44, <vscale x 4 x i32> %28)
  %47 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %38)
  %48 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %47, <vscale x 4 x i32> %41, <vscale x 4 x i32> %42)
  %49 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %40)
  %50 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %35, <vscale x 4 x i1> %35)
  %51 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %50)
  %52 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %51, <vscale x 4 x i32> %42, <vscale x 4 x i32> %46)
  %53 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %43, <vscale x 4 x i1> %43)
  %54 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %53)
  %55 = call <vscale x 4 x i32> @llvm.aarch64.sve.sel.nxv4i32(<vscale x 4 x i1> %54, <vscale x 4 x i32> %45, <vscale x 4 x i32> %52)
  %56 = call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %49, <vscale x 4 x i32> %48, <vscale x 4 x i32> %46)
  %57 = xor <vscale x 4 x i1> %54, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %58 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %44, <vscale x 4 x i1> %44)
  %59 = sext i32 %2 to i64
  %60 = sub i64 %59, %58
  %61 = call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %60)
  %62 = and <vscale x 4 x i1> %57, %61
  %63 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %49, <vscale x 4 x i1> %49)
  %64 = trunc i64 %63 to i32
  %65 = icmp ugt i32 %40, %2
  br i1 %65, label %uniform.then, label %uniform.else

uniform.then:                                     ; preds = %lane.gather
  %66 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  %67 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !147
  %68 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !149
  %69 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg2 = shufflevector <vscale x 4 x i32> %69, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %70 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %66, <vscale x 4 x i32> %56)
  %71 = shl <vscale x 4 x i32> %70, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %72 = shl <vscale x 4 x i32> %70, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %73 = mul <vscale x 4 x i32> %70, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %74 = add <vscale x 4 x i32> %73, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %75 = add <vscale x 4 x i32> %74, %72
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %75, <vscale x 4 x i1> %16, ptr %68, <vscale x 4 x i32> %56)
  %76 = mul <vscale x 4 x i32> %75, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %77 = add <vscale x 4 x i32> %71, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %78 = add <vscale x 4 x i32> %77, %76
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %78, <vscale x 4 x i1> %16, ptr %66, <vscale x 4 x i32> %56)
  %79 = mul <vscale x 4 x i32> %78, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %80 = add <vscale x 4 x i32> %71, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %81 = add <vscale x 4 x i32> %80, %79
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %81, <vscale x 4 x i1> %16, ptr %67, <vscale x 4 x i32> %56)
  br label %new.latch

uniform.else:                                     ; preds = %lane.gather
  %82 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  %83 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !128
  %84 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !130
  %85 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg3 = shufflevector <vscale x 4 x i32> %85, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %86 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %83, <vscale x 4 x i32> %55)
  %87 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %84, <vscale x 4 x i32> %55)
  %88 = add <vscale x 4 x i32> %87, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %89 = mul <vscale x 4 x i32> %88, %55
  %90 = mul <vscale x 4 x i32> %86, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %91 = add <vscale x 4 x i32> %89, %87
  %92 = add <vscale x 4 x i32> %91, %90
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %92, <vscale x 4 x i1> %16, ptr %82, <vscale x 4 x i32> %55)
  %93 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %86
  %94 = mul <vscale x 4 x i32> %93, %55
  %95 = add <vscale x 4 x i32> %86, %87
  %96 = sub <vscale x 4 x i32> %92, %95
  ...
  %98 = add <vscale x 4 x i32> %94, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %99 = add <vscale x 4 x i32> %98, %97
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %99, <vscale x 4 x i1> %16, ptr %84, <vscale x 4 x i32> %55)
  %100 = add <vscale x 4 x i32> %99, %92
  ...
  %102 = sub <vscale x 4 x i32> %86, %99
  ...
  %104 = mul <vscale x 4 x i32> %55, %55
  %105 = add <vscale x 4 x i32> %103, %104
  %106 = mul <vscale x 4 x i32> %105, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %107 = add <vscale x 4 x i32> %106, %101
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %107, <vscale x 4 x i1> %16, ptr %83, <vscale x 4 x i32> %55)
  br label %new.latch

new.latch:                                        ; preds = %uniform.else, %uniform.then
  %108 = phi <vscale x 4 x i32> [ %55, %uniform.then ], [ %56, %uniform.else ]
  %109 = phi <vscale x 4 x i1> [ %62, %uniform.then ], [ %49, %uniform.else ]
  %110 = add i32 %vector.loop.index, %2
  %111 = icmp uge i32 %110, %total.iterations.to.be.vectorized
  br i1 %111, label %joinBlock, label %alc.header

linearized.then:                                  ; preds = %joinBlock
  %112 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  %113 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !147
  %114 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !149
  %115 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg4 = shufflevector <vscale x 4 x i32> %115, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %116 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %49, ptr %112, <vscale x 4 x i32> %56)
  ...
  %118 = shl <vscale x 4 x i32> %116, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %119 = mul <vscale x 4 x i32> %116, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %120 = add <vscale x 4 x i32> %119, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %121 = add <vscale x 4 x i32> %120, %118
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %121, <vscale x 4 x i1> %49, ptr %114, <vscale x 4 x i32> %56)
  %122 = mul <vscale x 4 x i32> %121, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %123 = add <vscale x 4 x i32> %117, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %124 = add <vscale x 4 x i32> %123, %122
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %124, <vscale x 4 x i1> %49, ptr %112, <vscale x 4 x i32> %56)
  %125 = mul <vscale x 4 x i32> %124, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %126 = add <vscale x 4 x i32> %117, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %127 = add <vscale x 4 x i32> %126, %125
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %127, <vscale x 4 x i1> %49, ptr %113, <vscale x 4 x i32> %56)
  %128 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  %129 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !128
  %130 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !130
  %131 = xor <vscale x 4 x i1> %49, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %132 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg5 = shufflevector <vscale x 4 x i32> %132, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %133 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %131, ptr %129, <vscale x 4 x i32> %56)
  %134 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %131, ptr %130, <vscale x 4 x i32> %56)
  %135 = add <vscale x 4 x i32> %134, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %136 = mul <vscale x 4 x i32> %135, %56
  %137 = mul <vscale x 4 x i32> %133, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %138 = add <vscale x 4 x i32> %136, %134
  %139 = add <vscale x 4 x i32> %138, %137
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %139, <vscale x 4 x i1> %131, ptr %128, <vscale x 4 x i32> %56)
  %140 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %133
  %141 = mul <vscale x 4 x i32> %140, %56
  %142 = add <vscale x 4 x i32> %133, %134
  %143 = sub <vscale x 4 x i32> %139, %142
  ...
  %145 = add <vscale x 4 x i32> %141, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %146 = add <vscale x 4 x i32> %145, %144
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %146, <vscale x 4 x i1> %131, ptr %130, <vscale x 4 x i32> %56)
  %147 = add <vscale x 4 x i32> %146, %139
  ...
  %149 = sub <vscale x 4 x i32> %133, %146
  %150 = shl <vscale x 4 x i32> %149, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %151 = mul <vscale x 4 x i32> %56, %56
  %152 = add <vscale x 4 x i32> %150, %151
  %153 = mul <vscale x 4 x i32> %152, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %154 = add <vscale x 4 x i32> %153, %148
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %154, <vscale x 4 x i1> %131, ptr %129, <vscale x 4 x i32> %56)
  br label %middel.block

linearized.else:                                  ; preds = %joinBlock
  %155 = xor <vscale x 4 x i1> %62, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %156 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  %157 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !128
  %158 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !130
  %159 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg6 = shufflevector <vscale x 4 x i32> %159, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %160 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %155, ptr %157, <vscale x 4 x i32> %55)
  %161 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %155, ptr %158, <vscale x 4 x i32> %55)
  %162 = add <vscale x 4 x i32> %161, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %163 = mul <vscale x 4 x i32> %162, %55
  %164 = mul <vscale x 4 x i32> %160, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %165 = add <vscale x 4 x i32> %163, %161
  %166 = add <vscale x 4 x i32> %165, %164
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %166, <vscale x 4 x i1> %155, ptr %156, <vscale x 4 x i32> %55)
  %167 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %160
  %168 = mul <vscale x 4 x i32> %167, %55
  %169 = add <vscale x 4 x i32> %160, %161
  %170 = sub <vscale x 4 x i32> %166, %169
  %171 = shl <vscale x 4 x i32> %170, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %172 = add <vscale x 4 x i32> %168, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %173 = add <vscale x 4 x i32> %172, %171
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %173, <vscale x 4 x i1> %155, ptr %158, <vscale x 4 x i32> %55)
  %174 = add <vscale x 4 x i32> %173, %166
  %175 = shl <vscale x 4 x i32> %174, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %176 = sub <vscale x 4 x i32> %160, %173
  ...
  %178 = mul <vscale x 4 x i32> %55, %55
  %179 = add <vscale x 4 x i32> %177, %178
  ...
  %181 = add <vscale x 4 x i32> %180, %175
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %181, <vscale x 4 x i1> %155, ptr %157, <vscale x 4 x i32> %55)
  %182 = getelementptr inbounds i32, ptr %a, i32 0, !dbg !126
  %183 = getelementptr inbounds i32, ptr %c, i32 0, !dbg !147
  %184 = getelementptr inbounds i32, ptr %b, i32 0, !dbg !149
  %185 = insertelement <vscale x 4 x i32> undef, i32 %n, i64 0
  %vector.arg7 = shufflevector <vscale x 4 x i32> %185, <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer
  %186 = call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %62, ptr %182, <vscale x 4 x i32> %55)
  %187 = shl <vscale x 4 x i32> %186, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %188 = shl <vscale x 4 x i32> %186, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %189 = mul <vscale x 4 x i32> %186, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %190 = add <vscale x 4 x i32> %189, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %191 = add <vscale x 4 x i32> %190, %188
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %191, <vscale x 4 x i1> %62, ptr %184, <vscale x 4 x i32> %55)
  ...
  %193 = add <vscale x 4 x i32> %187, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %194 = add <vscale x 4 x i32> %193, %192
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %194, <vscale x 4 x i1> %62, ptr %182, <vscale x 4 x i32> %55)
  %195 = mul <vscale x 4 x i32> %194, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %196 = add <vscale x 4 x i32> %187, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %197 = add <vscale x 4 x i32> %196, %195
  call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %197, <vscale x 4 x i1> %62, ptr %183, <vscale x 4 x i32> %55)
  br label %middel.block

joinBlock:                                        ; preds = %new.latch
  %198 = icmp eq <vscale x 4 x i32> %108, %56
  %199 = call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %198, <vscale x 4 x i1> %198)
  %200 = trunc i64 %199 to i32
  %201 = icmp eq i32 %200, %2
  br i1 %201, label %linearized.then, label %linearized.else

middel.block:                                     ; preds = %linearized.else, %linearized.then
  %202 = zext i32 %110 to i64
...
for.inc:                                          ; preds = %if.else, %if.then4
  ...
  br i1 %exitcond.not, label %for.cond.cleanup.loopexit, label %for.body, !dbg !110, !llvm.loop !160

if.then111:                                       ; preds = %for.cond.cleanup
  %203 = load ptr, ptr @stderr, align 8, !dbg !164, !tbaa !113
  %call112 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %203, ptr noundef nonnull @.str, i32 noundef %call109, ptr noundef nonnull @.str.1, i32 noundef 88) #14, !dbg !164
...
for.cond.cleanup32:                               ; preds = %for.body33
  %add.lcssa = phi i32 [ %add, %for.body33 ], !dbg !285
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add.lcssa), !dbg !288
  %putchar = tail call i32 @putchar(i32 10), !dbg !289
  %10 = load ptr, ptr @a, align 8, !dbg !290, !tbaa !113
  tail call void @free(ptr noundef %10) #13, !dbg !291
  %11 = load ptr, ptr @b, align 8, !dbg !292, !tbaa !113
  tail call void @free(ptr noundef %11) #13, !dbg !293
  %12 = load ptr, ptr @c, align 8, !dbg !294, !tbaa !113
  tail call void @free(ptr noundef %12) #13, !dbg !295
  %13 = load ptr, ptr @cond, align 8, !dbg !296, !tbaa !113
  tail call void @free(ptr noundef %13) #13, !dbg !297
  ...
  %15 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !302, !tbaa !299
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %15), !dbg !303
  %16 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !304, !tbaa !299
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %16), !dbg !305
  %17 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !306, !tbaa !299
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, i64 noundef %17), !dbg !307
  %18 = load double, ptr @ExecutionTime, align 8, !dbg !308, !tbaa !169
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.10, double noundef %18), !dbg !309
  %19 = load i32, ptr @EventSet, align 4, !dbg !310, !tbaa !102
  %call46 = tail call i32 @PAPI_remove_events(i32 noundef %19, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !312
  call void @llvm.dbg.value(metadata i32 %call46, metadata !217, metadata !DIExpression()), !dbg !241
  %cmp47.not = icmp eq i32 %call46, 0, !dbg !313
  br i1 %cmp47.not, label %if.end51, label %if.then49, !dbg !314
...
for.body33:                                       ; preds = %for.body33, %for.cond.cleanup
  ...
  %arrayidx35 = getelementptr inbounds i32, ptr %8, i64 %indvars.iv84, !dbg !315
  %20 = load i32, ptr %arrayidx35, align 4, !dbg !315, !tbaa !102
  %add = add nsw i32 %20, %sum.081, !dbg !285
...
!285 = !DILocation(line: 334, column: 13, scope: !286)
!286 = distinct !DILexicalBlock(scope: !287, file: !3, line: 333, column: 33)
!287 = distinct !DILexicalBlock(scope: !228, file: !3, line: 333, column: 5)
!288 = !DILocation(line: 337, column: 5, scope: !213)
!289 = !DILocation(line: 338, column: 5, scope: !213)
!290 = !DILocation(line: 340, column: 10, scope: !213)
!291 = !DILocation(line: 340, column: 5, scope: !213)
!292 = !DILocation(line: 341, column: 10, scope: !213)
!293 = !DILocation(line: 341, column: 5, scope: !213)
!294 = !DILocation(line: 342, column: 10, scope: !213)
!295 = !DILocation(line: 342, column: 5, scope: !213)
!296 = !DILocation(line: 343, column: 10, scope: !213)
!297 = !DILocation(line: 343, column: 5, scope: !213)
!298 = !DILocation(line: 345, column: 53, scope: !213)
!299 = !{!300, !300, i64 0}
!300 = !{!"long long", !64, i64 0}
!301 = !DILocation(line: 345, column: 5, scope: !213)
!302 = !DILocation(line: 346, column: 36, scope: !213)
!303 = !DILocation(line: 346, column: 5, scope: !213)
!304 = !DILocation(line: 347, column: 50, scope: !213)
!305 = !DILocation(line: 347, column: 5, scope: !213)
!306 = !DILocation(line: 348, column: 49, scope: !213)
!307 = !DILocation(line: 348, column: 5, scope: !213)
!308 = !DILocation(line: 349, column: 40, scope: !213)
!309 = !DILocation(line: 349, column: 5, scope: !213)
!310 = !DILocation(line: 351, column: 38, scope: !311)
!311 = distinct !DILexicalBlock(scope: !213, file: !3, line: 351, column: 9)
!312 = !DILocation(line: 351, column: 19, scope: !311)
!313 = !DILocation(line: 351, column: 72, scope: !311)
!314 = !DILocation(line: 351, column: 9, scope: !213)
!315 = !DILocation(line: 334, column: 16, scope: !286)
!316 = !DILocation(line: 333, column: 28, scope: !287)
!317 = !DILocation(line: 333, column: 23, scope: !287)
!318 = distinct !{!318, !268, !319, !162, !163}
!319 = !DILocation(line: 335, column: 5, scope: !228)
!320 = !DILocation(line: 351, column: 84, scope: !321)
!321 = distinct !DILexicalBlock(scope: !311, file: !3, line: 351, column: 84)
