...
Preheader.for.remaining.iterations:               ; preds = %middel.block, %for.body.preheader
  %6 = phi i64 [ 0, %for.body.preheader ], [ %22, %middel.block ]
  br label %for.body
...
alc.header:                                       ; preds = %new.latch, %pre.alc
  %11 = phi i64 [ 0, %pre.alc ], [ %22, %new.latch ]
...
alc.applied:                                      ; preds = %lane.gather
  %call = tail call i64 (ptr, ...) @printf(ptr noundef nonnull @.str, i64 noundef %add.lcssa)
  %ptr.a.3 = getelementptr inbounds i32, ptr %a, <vscale x 2 x i64> %21 
  %ptr.b.3 = getelementptr inbounds i32, ptr %c, <vscale x 2 x i64> %21 
  %ptr.c.3 = getelementptr inbounds i32, ptr %b, <vscale x 2 x i64> %21 
  %loaded.a.3 = call <vscale x 2 x i32> @llvm.masked.gather.v2i32.v2p0(<vscale x 2 x ptr> %ptr.a.3 , i32 8, <vscale x 2 x i1> %uniform.vec.predicate, <vscale x 2 x i32> poison)
  ...
  %loaded.b.3 = call <vscale x 2 x i32> @llvm.masked.gather.v2i32.v2p0(<vscale x 2 x ptr> %ptr.b.3 , i32 8, <vscale x 2 x i1> %uniform.vec.predicate, <vscale x 2 x i32> poison)
  ...
  %loaded.c.3 = call <vscale x 2 x i32> @llvm.masked.gather.v2i32.v2p0(<vscale x 2 x ptr> %ptr.c.3 , i32 8, <vscale x 2 x i1> %uniform.vec.predicate, <vscale x 2 x i32> poison)
  ...
  call void @llvm.masked.scatter.v2i32.v2p0(<vscale x 2 x i32> %div.3, <vscale x 2 x ptr>%ptr.a.3, i32 8, <vscale x 2 x i1> %uniform.vec.predicate)
  ...
  call void @llvm.masked.scatter.v2i32.v2p0(<vscale x 2 x i32> %mul.3.4, <vscale x 2 x ptr>%ptr.c.3, i32 8, <vscale x 2 x i1> %uniform.vec.predicate)
  ...
  call void @llvm.masked.scatter.v2i32.v2p0(<vscale x 2 x i32> %add.3.3, <vscale x 2 x ptr>%ptr.b.3, i32 8, <vscale x 2 x i1> %uniform.vec.predicate)
  br label %new.latch

linearized:                                       ; preds = %alc.header
  %ptr.a.1 = getelementptr inbounds i32, ptr %a, i64 %11
  %ptr.b.1 = getelementptr inbounds i32, ptr %c, i64 %11
  %ptr.c.1 = getelementptr inbounds i32, ptr %b, i64 %11
  %loaded.a.1 = call <vscale x 2 x i32> @llvm.masked.load.nxv2i32.p0(ptr %ptr.a.1, i32 8, <vscale x 2 x i1> %predicate.vector.1, <vscale x 2 x i32> undef)
  ...
  %loaded.b.1 = call <vscale x 2 x i32> @llvm.masked.load.nxv2i32.p0(ptr %ptr.b.1, i32 8, <vscale x 2 x i1> %predicate.vector.1, <vscale x 2 x i32> undef)
  ...
  %loaded.c.1 = call <vscale x 2 x i32> @llvm.masked.load.nxv2i32.p0(ptr %ptr.c.1, i32 8, <vscale x 2 x i1> %predicate.vector.1, <vscale x 2 x i32> undef)
  ...
  call void @llvm.masked.store.nxv2i32.p0(<vscale x 2 x i32> %div.1, ptr %ptr.a.1, i32 8, <vscale x 2 x i1> %predicate.vector.1)
  ...
  call void @llvm.masked.store.nxv2i32.p0(<vscale x 2 x i32> %mul.1.4, ptr %ptr.c.1, i32 8, <vscale x 2 x i1> %predicate.vector.1)
  ...
  call void @llvm.masked.store.nxv2i32.p0(<vscale x 2 x i32> %add.1.3, ptr %ptr.b.1, i32 8, <vscale x 2 x i1> %predicate.vector.1)
  ...
  %loaded.a.2 = call <vscale x 2 x i32> @llvm.masked.load.nxv2i32.p0(ptr %ptr.a.2, i32 8, <vscale x 2 x i1> %predicate.vector.2, <vscale x 2 x i32> undef)
  ...
  %loaded.b.2 = call <vscale x 2 x i32> @llvm.masked.load.nxv2i32.p0(ptr %ptr.b.2, i32 8, <vscale x 2 x i1> %predicate.vector.2, <vscale x 2 x i32> undef)
  ...
  %loaded.c.2 = call <vscale x 2 x i32> @llvm.masked.load.nxv2i32.p0(ptr %ptr.c.2, i32 8, <vscale x 2 x i1> %predicate.vector.2, <vscale x 2 x i32> undef)
  ...
  call void @llvm.masked.store.nxv2i32.p0(<vscale x 2 x i32> %div.2, ptr %ptr.a.2, i32 8, <vscale x 2 x i1> %predicate.vector.2)
  ...
  call void @llvm.masked.store.nxv2i32.p0(<vscale x 2 x i32> %mul.2.4, ptr %ptr.c.2, i32 8, <vscale x 2 x i1> %predicate.vector.2)
  ...
  call void @llvm.masked.store.nxv2i32.p0(<vscale x 2 x i32> %add.2.3, ptr %ptr.b.2, i32 8, <vscale x 2 x i1> %predicate.vector.2)
  
  br label %new.latch

new.latch:                                        ; preds = %linearized, %alc.applied
  %22 = add i64 %second.itr.index, %8
  %loop.exit.cond = icmp eq i64 %22, %total.iterations.to.be.vectorized
