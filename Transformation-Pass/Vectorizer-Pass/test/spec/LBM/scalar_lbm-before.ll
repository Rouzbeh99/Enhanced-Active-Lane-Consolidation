...
; Function Attrs: argmemonly nofree norecurse nosync nounwind uwtable
define dso_local void @LBM_performStreamCollideTRT(ptr noundef readonly noalias %srcGrid, ptr noundef writeonly noalias %dstGrid) local_unnamed_addr #10 {
entry:
  br label %for.body
...
for.inc:                                          ; preds = %if.end, %if.then
  ;%.sink1488 = phi i64 [ -200002, %if.end ], [ 200035, %if.then ]
  ;%sub962.sink = phi double [ %sub962, %if.end ], [ %55, %if.then ]
  ;%149 = add nsw i64 %indvars.iv, %.sink1488
  ;%arrayidx965 = getelementptr inbounds [26000000 x double], ptr %dstGrid, i64 0, i64 %149
  ;store double %sub962.sink, ptr %arrayidx965, align 8, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 20
  %cmp = icmp ult i64 %indvars.iv, 25999980
...
for.body:                                         ; preds = %entry, %for.body
  ...
  br i1 %cmp, label %for.body, label %for.body393, !llvm.loop !27
...
for.body393:                                      ; preds = %for.body, %for.body393
  ...
  br i1 %cmp391, label %for.body393, label %for.end1020, !llvm.loop !28
...
for.body6:                                        ; preds = %for.cond4.preheader, %for.inc
  ...
  store float %div, ptr %ux, align 4, !tbaa !30
  %div491 = fdiv fast float %conv390, %conv
  store float %div491, ptr %uy, align 4, !tbaa !30
  %div492 = fdiv fast float %conv490, %conv
  store float %div492, ptr %uz, align 4, !tbaa !30
...
for.inc:                                          ; preds = %if.then, %if.else
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 100
  br i1 %exitcond.not, label %for.inc498, label %for.body6, !llvm.loop !32
...
for.inc498:                                       ; preds = %for.inc
  ...
  br i1 %exitcond761.not, label %for.inc501, label %for.cond4.preheader, !llvm.loop !33
...
for.inc501:                                       ; preds = %for.inc498
  ...
  br i1 %exitcond766.not, label %for.end503, label %for.cond1.preheader, !llvm.loop !34
...
for.cond1.preheader:                              ; preds = %entry, %for.inc512
...
for.cond4.preheader:                              ; preds = %for.cond1.preheader, %for.inc509
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 100
  br i1 %exitcond.not, label %for.inc509, label %for.body6, !llvm.loop !35

for.inc509:                                       ; preds = %if.end
  %indvars.iv.next782 = add nuw nsw i64 %indvars.iv781, 1
  %exitcond786.not = icmp eq i64 %indvars.iv.next782, 100
  br i1 %exitcond786.not, label %for.inc512, label %for.cond4.preheader, !llvm.loop !36

for.inc512:                                       ; preds = %for.inc509
  %indvars.iv.next788 = add nuw nsw i64 %indvars.iv787, 1
  %exitcond791.not = icmp eq i64 %indvars.iv.next788, 130
  br i1 %exitcond791.not, label %for.end514, label %for.cond1.preheader, !llvm.loop !37
