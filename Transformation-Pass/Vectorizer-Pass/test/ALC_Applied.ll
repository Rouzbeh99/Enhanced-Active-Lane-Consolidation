...
for.body.preheader:                               ; preds = %entry
  ...
  br i1 %2, label %for.body, label %remaining.iterations, !dbg !33

for.cond.cleanup.loopexit:                        ; preds = %remaining.iterations, %for.inc
...
remaining.iterations:                             ; preds = %for.body.preheader
...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  call void @llvm.dbg.value(metadata i32 2048, metadata !24, metadata !DIExpression()) #6, !dbg !103
