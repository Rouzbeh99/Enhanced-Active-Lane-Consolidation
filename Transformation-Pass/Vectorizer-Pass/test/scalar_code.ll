...
for.cond.cleanup33:                               ; preds = %for.body34
  ...
  %17 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !306, !tbaa !303
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %17), !dbg !307
  %18 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !308, !tbaa !303
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %18), !dbg !309
  %19 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !310, !tbaa !303
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, i64 noundef %19), !dbg !311
  %20 = load double, ptr @ExecutionTime, align 8, !dbg !312, !tbaa !173
  %call46 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.10, double noundef %20), !dbg !313
  %21 = load i32, ptr @EventSet, align 4, !dbg !314, !tbaa !119
  %call47 = tail call i32 @PAPI_remove_events(i32 noundef %21, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !316
  call void @llvm.dbg.value(metadata i32 %call47, metadata !221, metadata !DIExpression()), !dbg !244
  %cmp48.not = icmp eq i32 %call47, 0, !dbg !317
  br i1 %cmp48.not, label %if.end52, label %if.then50, !dbg !318
...
for.body34:                                       ; preds = %for.cond.cleanup, %for.body34
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv78, metadata !230, metadata !DIExpression()), !dbg !273
  call void @llvm.dbg.value(metadata i32 %sum.075, metadata !229, metadata !DIExpression()), !dbg !244
  %arrayidx36 = getelementptr inbounds i32, ptr %7, i64 %indvars.iv78, !dbg !319
  %22 = load i32, ptr %arrayidx36, align 4, !dbg !319, !tbaa !119
  %add = add nsw i32 %22, %sum.075, !dbg !322
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next79, metadata !230, metadata !DIExpression()), !dbg !273
  %exitcond81.not = icmp eq i64 %indvars.iv.next79, 5000000, !dbg !324
  br i1 %exitcond81.not, label %for.cond.cleanup33, label %for.body34, !dbg !274, !llvm.loop !325

if.then50:                                        ; preds = %for.cond.cleanup33
  %23 = load ptr, ptr @stderr, align 8, !dbg !327, !tbaa !130
  %call51 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %23, ptr noundef nonnull @.str, i32 noundef %call47, ptr noundef nonnull @.str.1, i32 noundef 370) #12, !dbg !327
  tail call void @exit(i32 noundef %call47) #13, !dbg !327
  unreachable, !dbg !327

if.end52:                                         ; preds = %for.cond.cleanup33
  %call53 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #11, !dbg !329
...
if.then56:                                        ; preds = %if.end52
  ...
  %call57 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %24, ptr noundef nonnull @.str, i32 noundef %call53, ptr noundef nonnull @.str.1, i32 noundef 373) #12, !dbg !333
  tail call void @exit(i32 noundef %call53) #13, !dbg !333
  unreachable, !dbg !333

if.end58:                                         ; preds = %if.end52
  tail call void @PAPI_shutdown() #11, !dbg !335
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #11, !dbg !336
  ret i32 0, !dbg !337
}
...
!3 = !DIFile(filename: "test.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation-Pass/Vectorizer-Pass/test", checksumkind: CSK_MD5, checksum: "48cdfb99a97ac918cdc70ac23e39660c")
!4 = !{!5, !7, !8}
...
!306 = !DILocation(line: 365, column: 36, scope: !217)
...
!312 = !DILocation(line: 368, column: 40, scope: !217)
!313 = !DILocation(line: 368, column: 5, scope: !217)
!314 = !DILocation(line: 370, column: 38, scope: !315)
!315 = distinct !DILexicalBlock(scope: !217, file: !3, line: 370, column: 9)
!316 = !DILocation(line: 370, column: 19, scope: !315)
!317 = !DILocation(line: 370, column: 72, scope: !315)
!318 = !DILocation(line: 370, column: 9, scope: !217)
!319 = !DILocation(line: 352, column: 16, scope: !320)
!320 = distinct !DILexicalBlock(scope: !321, file: !3, line: 351, column: 33)
!321 = distinct !DILexicalBlock(scope: !231, file: !3, line: 351, column: 5)
!322 = !DILocation(line: 352, column: 13, scope: !320)
!323 = !DILocation(line: 351, column: 28, scope: !321)
!324 = !DILocation(line: 351, column: 23, scope: !321)
!325 = distinct !{!325, !274, !326, !166, !167}
!326 = !DILocation(line: 353, column: 5, scope: !231)
!327 = !DILocation(line: 370, column: 84, scope: !328)
!328 = distinct !DILexicalBlock(scope: !315, file: !3, line: 370, column: 84)
