...
if.end6:                                          ; preds = %if.end
  ...
  %call7 = tail call i32 @PAPI_add_events(i32 noundef %2, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !251
...
for.cond.cleanup32:                               ; preds = %for.body33
  ...
  %18 = load double, ptr @ExecutionTime, align 8, !dbg !308, !tbaa !173
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.10, double noundef %18), !dbg !309
  %19 = load i32, ptr @EventSet, align 4, !dbg !310, !tbaa !119
  %call46 = tail call i32 @PAPI_remove_events(i32 noundef %19, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !312
...
for.body33:                                       ; preds = %for.cond.cleanup, %for.body33
  ...
  %arrayidx35 = getelementptr inbounds i32, ptr %8, i64 %indvars.iv78, !dbg !315
  %20 = load i32, ptr %arrayidx35, align 4, !dbg !315, !tbaa !119
  %add = add nsw i32 %20, %sum.075, !dbg !318
...
if.then49:                                        ; preds = %for.cond.cleanup32
  ...
  %call50 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %21, ptr noundef nonnull @.str, i32 noundef %call46, ptr noundef nonnull @.str.1, i32 noundef 370) #12, !dbg !323
  tail call void @exit(i32 noundef %call46) #13, !dbg !323
  unreachable, !dbg !323

if.end51:                                         ; preds = %for.cond.cleanup32
  %call52 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #11, !dbg !325
...
if.then55:                                        ; preds = %if.end51
  ...
  %call56 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %22, ptr noundef nonnull @.str, i32 noundef %call52, ptr noundef nonnull @.str.1, i32 noundef 373) #12, !dbg !329
  tail call void @exit(i32 noundef %call52) #13, !dbg !329
  unreachable, !dbg !329

if.end57:                                         ; preds = %if.end51
  tail call void @PAPI_shutdown() #11, !dbg !331
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #11, !dbg !332
  ret i32 0, !dbg !333
}
...
!288 = !DILocation(line: 356, column: 5, scope: !217)
!289 = !DILocation(line: 357, column: 5, scope: !217)
!290 = !DILocation(line: 359, column: 10, scope: !217)
!291 = !DILocation(line: 359, column: 5, scope: !217)
!292 = !DILocation(line: 360, column: 10, scope: !217)
!293 = !DILocation(line: 360, column: 5, scope: !217)
!294 = !DILocation(line: 361, column: 10, scope: !217)
!295 = !DILocation(line: 361, column: 5, scope: !217)
!296 = !DILocation(line: 362, column: 10, scope: !217)
!297 = !DILocation(line: 362, column: 5, scope: !217)
!298 = !DILocation(line: 364, column: 53, scope: !217)
!299 = !{!300, !300, i64 0}
!300 = !{!"long long", !81, i64 0}
!301 = !DILocation(line: 364, column: 5, scope: !217)
!302 = !DILocation(line: 365, column: 36, scope: !217)
!303 = !DILocation(line: 365, column: 5, scope: !217)
!304 = !DILocation(line: 366, column: 50, scope: !217)
!305 = !DILocation(line: 366, column: 5, scope: !217)
!306 = !DILocation(line: 367, column: 49, scope: !217)
!307 = !DILocation(line: 367, column: 5, scope: !217)
!308 = !DILocation(line: 368, column: 40, scope: !217)
!309 = !DILocation(line: 368, column: 5, scope: !217)
!310 = !DILocation(line: 370, column: 38, scope: !311)
!311 = distinct !DILexicalBlock(scope: !217, file: !3, line: 370, column: 9)
!312 = !DILocation(line: 370, column: 19, scope: !311)
!313 = !DILocation(line: 370, column: 72, scope: !311)
!314 = !DILocation(line: 370, column: 9, scope: !217)
!315 = !DILocation(line: 352, column: 16, scope: !316)
!316 = distinct !DILexicalBlock(scope: !317, file: !3, line: 351, column: 33)
!317 = distinct !DILexicalBlock(scope: !231, file: !3, line: 351, column: 5)
!318 = !DILocation(line: 352, column: 13, scope: !316)
!319 = !DILocation(line: 351, column: 28, scope: !317)
!320 = !DILocation(line: 351, column: 23, scope: !317)
!321 = distinct !{!321, !271, !322, !166, !167}
!322 = !DILocation(line: 353, column: 5, scope: !231)
!323 = !DILocation(line: 370, column: 84, scope: !324)
!324 = distinct !DILexicalBlock(scope: !311, file: !3, line: 370, column: 84)
