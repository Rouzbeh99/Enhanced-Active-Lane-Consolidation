...
if.then128:                                       ; preds = %for.cond.cleanup
  ...
  %call129 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str, i32 noundef %call126, ptr noundef nonnull @.str.1, i32 noundef 91) #12, !dbg !171
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 306) #12, !dbg !251
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 309) #12, !dbg !258
...
for.cond.cleanup33:                               ; preds = %for.body34
  ...
  tail call void @free(ptr noundef %13) #11, !dbg !298
  %14 = load ptr, ptr @b, align 8, !dbg !299, !tbaa !113
  tail call void @free(ptr noundef %14) #11, !dbg !300
  %15 = load ptr, ptr @c, align 8, !dbg !301, !tbaa !113
  tail call void @free(ptr noundef %15) #11, !dbg !302
  %16 = load ptr, ptr @cond, align 8, !dbg !303, !tbaa !113
  tail call void @free(ptr noundef %16) #11, !dbg !304
  ...
  %call47 = tail call i32 @PAPI_remove_events(i32 noundef %22, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !319
...
if.then50:                                        ; preds = %for.cond.cleanup33
  ...
  %call51 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %24, ptr noundef nonnull @.str, i32 noundef %call47, ptr noundef nonnull @.str.1, i32 noundef 355) #12, !dbg !330
  tail call void @exit(i32 noundef %call47) #13, !dbg !330
  unreachable, !dbg !330

if.end52:                                         ; preds = %for.cond.cleanup33
  %call53 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #11, !dbg !332
...
if.then56:                                        ; preds = %if.end52
  ...
  %call57 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %25, ptr noundef nonnull @.str, i32 noundef %call53, ptr noundef nonnull @.str.1, i32 noundef 358) #12, !dbg !336
  tail call void @exit(i32 noundef %call53) #13, !dbg !336
  unreachable, !dbg !336

if.end58:                                         ; preds = %if.end52
  tail call void @PAPI_shutdown() #11, !dbg !338
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #11, !dbg !339
  ret i32 0, !dbg !340
}
