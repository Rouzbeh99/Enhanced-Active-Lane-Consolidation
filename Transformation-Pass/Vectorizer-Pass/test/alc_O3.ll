...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 37) #14, !dbg !111
...
lane.gather:                                      ; preds = %alc.header
  ...
  br i1 %36, label %new.latch, label %uniform.block
...
if.then75:                                        ; preds = %for.cond.cleanup
  %126 = load ptr, ptr @stderr, align 8, !dbg !150, !tbaa !113
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %126, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 53) #14, !dbg !150
  tail call void @exit(i32 noundef %call73) #15, !dbg !150
  unreachable, !dbg !150
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul) #16, !dbg !175
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #15, !dbg !181
  unreachable, !dbg !181
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %conv) #16, !dbg !191
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #15, !dbg !197
  unreachable, !dbg !197
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %errstring) #13, !dbg !215
  call void @llvm.dbg.declare(metadata ptr %errstring, metadata !204, metadata !DIExpression()), !dbg !216
  %call = tail call i32 @PAPI_library_init(i32 noundef 117440512) #13, !dbg !217
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3, ptr noundef nonnull %errstring) #14, !dbg !223
  call void @exit(i32 noundef 1) #15, !dbg !224
  unreachable, !dbg !224

if.end:                                           ; preds = %entry
  %call2 = tail call i32 @PAPI_create_eventset(ptr noundef nonnull @EventSet) #13, !dbg !225
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 233) #14, !dbg !230
  tail call void @exit(i32 noundef %call2) #15, !dbg !230
  unreachable, !dbg !230

if.end6:                                          ; preds = %if.end
  %2 = load i32, ptr @EventSet, align 4, !dbg !232, !tbaa !102
  %call7 = tail call i32 @PAPI_add_events(i32 noundef %2, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !234
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 236) #14, !dbg !237
  tail call void @exit(i32 noundef %call7) #15, !dbg !237
  unreachable, !dbg !237
...
if.end11:                                         ; preds = %if.end6
  ...
  %call16 = tail call i64 @time(ptr noundef null) #13, !dbg !248
  %conv = trunc i64 %call16 to i32, !dbg !248
  tail call void @srand(i32 noundef %conv) #13, !dbg !249
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  %arrayidx19 = getelementptr inbounds i32, ptr %4, i64 %indvars.iv, !dbg !252
  %8 = trunc i64 %indvars.iv to i32, !dbg !255
  store i32 %8, ptr %arrayidx19, align 4, !dbg !255, !tbaa !102
  %arrayidx21 = getelementptr inbounds i32, ptr %5, i64 %indvars.iv, !dbg !256
  store i32 2, ptr %arrayidx21, align 4, !dbg !257, !tbaa !102
  %arrayidx23 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv, !dbg !258
  store i32 0, ptr %arrayidx23, align 4, !dbg !259, !tbaa !102
  %rem = urem i32 %8, 100, !dbg !260
  %cmp24 = icmp ult i32 %rem, 40, !dbg !261
  %arrayidx27 = getelementptr inbounds i8, ptr %7, i64 %indvars.iv, !dbg !262
  %frombool = zext i1 %cmp24 to i8, !dbg !263
  store i8 %frombool, ptr %arrayidx27, align 1, !dbg !263, !tbaa !123
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 5000000, !dbg !265
  br i1 %exitcond.not, label %for.body33, label %for.body, !dbg !251, !llvm.loop !266

for.cond.cleanup32:                               ; preds = %for.body33
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add), !dbg !268
  %9 = load ptr, ptr @a, align 8, !dbg !269, !tbaa !113
  tail call void @free(ptr noundef %9) #13, !dbg !270
  %10 = load ptr, ptr @b, align 8, !dbg !271, !tbaa !113
  tail call void @free(ptr noundef %10) #13, !dbg !272
  %11 = load ptr, ptr @c, align 8, !dbg !273, !tbaa !113
  tail call void @free(ptr noundef %11) #13, !dbg !274
  %12 = load ptr, ptr @cond, align 8, !dbg !275, !tbaa !113
  tail call void @free(ptr noundef %12) #13, !dbg !276
  %13 = load i64, ptr @CounterValues, align 8, !dbg !277, !tbaa !278
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i64 noundef %13), !dbg !280
  %14 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !281, !tbaa !278
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %14), !dbg !282
  %15 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !283, !tbaa !278
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %15), !dbg !284
  %16 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !285, !tbaa !278
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %16), !dbg !286
  %17 = load double, ptr @ExecutionTime, align 8, !dbg !287, !tbaa !155
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, double noundef %17), !dbg !288
  %18 = load i32, ptr @EventSet, align 4, !dbg !289, !tbaa !102
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %18, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !291
  call void @llvm.dbg.value(metadata i32 %call45, metadata !203, metadata !DIExpression()), !dbg !227
  %cmp46.not = icmp eq i32 %call45, 0, !dbg !292
  br i1 %cmp46.not, label %if.end50, label %if.then48, !dbg !293

for.body33:                                       ; preds = %for.body, %for.body33
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.body33 ], [ 0, %for.body ]
  %sum.080 = phi i32 [ %add, %for.body33 ], [ 0, %for.body ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv83, metadata !213, metadata !DIExpression()), !dbg !294
  call void @llvm.dbg.value(metadata i32 %sum.080, metadata !212, metadata !DIExpression()), !dbg !227
  %arrayidx35 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv83, !dbg !295
  %19 = load i32, ptr %arrayidx35, align 4, !dbg !295, !tbaa !102
  %add = add nsw i32 %19, %sum.080, !dbg !298
  call void @llvm.dbg.value(metadata i32 %add, metadata !212, metadata !DIExpression()), !dbg !227
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1, !dbg !299
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next84, metadata !213, metadata !DIExpression()), !dbg !294
  %exitcond86.not = icmp eq i64 %indvars.iv.next84, 5000000, !dbg !300
  br i1 %exitcond86.not, label %for.cond.cleanup32, label %for.body33, !dbg !301, !llvm.loop !302

if.then48:                                        ; preds = %for.cond.cleanup32
  %20 = load ptr, ptr @stderr, align 8, !dbg !304, !tbaa !113
  %call49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str, i32 noundef %call45, ptr noundef nonnull @.str.1, i32 noundef 279) #14, !dbg !304
  tail call void @exit(i32 noundef %call45) #15, !dbg !304
  unreachable, !dbg !304

if.end50:                                         ; preds = %for.cond.cleanup32
  %call51 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #13, !dbg !306
  call void @llvm.dbg.value(metadata i32 %call51, metadata !203, metadata !DIExpression()), !dbg !227
  %cmp52.not = icmp eq i32 %call51, 0, !dbg !308
  br i1 %cmp52.not, label %if.end56, label %if.then54, !dbg !309

if.then54:                                        ; preds = %if.end50
  %21 = load ptr, ptr @stderr, align 8, !dbg !310, !tbaa !113
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %21, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 282) #14, !dbg !310
  tail call void @exit(i32 noundef %call51) #15, !dbg !310
  unreachable, !dbg !310

if.end56:                                         ; preds = %if.end50
  tail call void @PAPI_shutdown() #13, !dbg !312
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #13, !dbg !313
  ret i32 0, !dbg !314
}

declare !dbg !315 i32 @PAPI_library_init(i32 noundef) local_unnamed_addr #4

declare !dbg !316 i32 @PAPI_create_eventset(ptr noundef) local_unnamed_addr #4

declare !dbg !319 i32 @PAPI_add_events(i32 noundef, ptr noundef, i32 noundef) local_unnamed_addr #4

; Function Attrs: nounwind
declare !dbg !322 void @srand(i32 noundef) local_unnamed_addr #3

; Function Attrs: nounwind
declare !dbg !327 i64 @time(ptr noundef) local_unnamed_addr #3

; Function Attrs: inaccessiblemem_or_argmemonly mustprogress nounwind willreturn
declare void @free(ptr nocapture noundef) local_unnamed_addr #8

declare !dbg !333 i32 @PAPI_remove_events(i32 noundef, ptr noundef, i32 noundef) local_unnamed_addr #4

declare !dbg !334 i32 @PAPI_destroy_eventset(ptr noundef) local_unnamed_addr #4

declare !dbg !335 void @PAPI_shutdown() local_unnamed_addr #4
...
!166 = distinct !DISubprogram(name: "checked_malloc_int_array", scope: !3, file: !3, line: 205, type: !167, scopeLine: 205, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !169)
!167 = !DISubroutineType(types: !168)
!168 = !{!5, !6}
!169 = !{!170, !171}
!170 = !DILocalVariable(name: "n", arg: 1, scope: !166, file: !3, line: 205, type: !6)
!171 = !DILocalVariable(name: "ptr", scope: !166, file: !3, line: 206, type: !5)
!172 = !DILocation(line: 0, scope: !166)
!173 = !DILocation(line: 206, column: 45, scope: !166)
!174 = !DILocation(line: 206, column: 43, scope: !166)
!175 = !DILocation(line: 206, column: 24, scope: !166)
!176 = !DILocation(line: 207, column: 13, scope: !177)
!177 = distinct !DILexicalBlock(scope: !166, file: !3, line: 207, column: 9)
!178 = !DILocation(line: 207, column: 9, scope: !166)
!179 = !DILocation(line: 208, column: 9, scope: !180)
!180 = distinct !DILexicalBlock(scope: !177, file: !3, line: 207, column: 22)
!181 = !DILocation(line: 209, column: 9, scope: !180)
!182 = !DILocation(line: 211, column: 5, scope: !166)
!183 = distinct !DISubprogram(name: "checked_malloc_bool_array", scope: !3, file: !3, line: 214, type: !184, scopeLine: 214, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !186)
!184 = !DISubroutineType(types: !185)
!185 = !{!8, !6}
!186 = !{!187, !188}
!187 = !DILocalVariable(name: "n", arg: 1, scope: !183, file: !3, line: 214, type: !6)
!188 = !DILocalVariable(name: "ptr", scope: !183, file: !3, line: 215, type: !8)
!189 = !DILocation(line: 0, scope: !183)
!190 = !DILocation(line: 215, column: 48, scope: !183)
!191 = !DILocation(line: 215, column: 26, scope: !183)
!192 = !DILocation(line: 216, column: 13, scope: !193)
!193 = distinct !DILexicalBlock(scope: !183, file: !3, line: 216, column: 9)
!194 = !DILocation(line: 216, column: 9, scope: !183)
!195 = !DILocation(line: 217, column: 9, scope: !196)
!196 = distinct !DILexicalBlock(scope: !193, file: !3, line: 216, column: 22)
!197 = !DILocation(line: 218, column: 9, scope: !196)
!198 = !DILocation(line: 220, column: 5, scope: !183)
!199 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 223, type: !200, scopeLine: 223, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !202)
!200 = !DISubroutineType(types: !201)
!201 = !{!6}
!202 = !{!203, !204, !209, !210, !212, !213}
!203 = !DILocalVariable(name: "status", scope: !199, file: !3, line: 224, type: !6)
!204 = !DILocalVariable(name: "errstring", scope: !199, file: !3, line: 225, type: !205)
...
!209 = !DILocalVariable(name: "n", scope: !199, file: !3, line: 238, type: !6)
!210 = !DILocalVariable(name: "i", scope: !211, file: !3, line: 249, type: !6)
!211 = distinct !DILexicalBlock(scope: !199, file: !3, line: 249, column: 5)
!212 = !DILocalVariable(name: "sum", scope: !199, file: !3, line: 260, type: !6)
!213 = !DILocalVariable(name: "i", scope: !214, file: !3, line: 262, type: !6)
!214 = distinct !DILexicalBlock(scope: !199, file: !3, line: 262, column: 5)
!215 = !DILocation(line: 225, column: 5, scope: !199)
!216 = !DILocation(line: 225, column: 10, scope: !199)
!217 = !DILocation(line: 227, column: 9, scope: !218)
!218 = distinct !DILexicalBlock(scope: !199, file: !3, line: 227, column: 9)
!219 = !DILocation(line: 227, column: 45, scope: !218)
!220 = !DILocation(line: 227, column: 9, scope: !199)
!221 = !DILocation(line: 228, column: 17, scope: !222)
!222 = distinct !DILexicalBlock(scope: !218, file: !3, line: 227, column: 66)
!223 = !DILocation(line: 228, column: 9, scope: !222)
!224 = !DILocation(line: 229, column: 9, scope: !222)
!225 = !DILocation(line: 233, column: 19, scope: !226)
!226 = distinct !DILexicalBlock(scope: !199, file: !3, line: 233, column: 9)
!227 = !DILocation(line: 0, scope: !199)
!228 = !DILocation(line: 233, column: 52, scope: !226)
!229 = !DILocation(line: 233, column: 9, scope: !199)
!230 = !DILocation(line: 233, column: 64, scope: !231)
!231 = distinct !DILexicalBlock(scope: !226, file: !3, line: 233, column: 64)
!232 = !DILocation(line: 236, column: 35, scope: !233)
!233 = distinct !DILexicalBlock(scope: !199, file: !3, line: 236, column: 9)
!234 = !DILocation(line: 236, column: 19, scope: !233)
!235 = !DILocation(line: 236, column: 69, scope: !233)
!236 = !DILocation(line: 236, column: 9, scope: !199)
!237 = !DILocation(line: 236, column: 81, scope: !238)
!238 = distinct !DILexicalBlock(scope: !233, file: !3, line: 236, column: 81)
!239 = !DILocation(line: 240, column: 9, scope: !199)
!240 = !DILocation(line: 240, column: 7, scope: !199)
!241 = !DILocation(line: 241, column: 9, scope: !199)
!242 = !DILocation(line: 241, column: 7, scope: !199)
!243 = !DILocation(line: 242, column: 9, scope: !199)
!244 = !DILocation(line: 242, column: 7, scope: !199)
!245 = !DILocation(line: 243, column: 12, scope: !199)
!246 = !DILocation(line: 243, column: 10, scope: !199)
!247 = !DILocation(line: 245, column: 13, scope: !199)
!248 = !DILocation(line: 247, column: 11, scope: !199)
!249 = !DILocation(line: 247, column: 5, scope: !199)
!250 = !DILocation(line: 0, scope: !211)
!251 = !DILocation(line: 249, column: 5, scope: !211)
!252 = !DILocation(line: 250, column: 9, scope: !253)
!253 = distinct !DILexicalBlock(scope: !254, file: !3, line: 249, column: 33)
!254 = distinct !DILexicalBlock(scope: !211, file: !3, line: 249, column: 5)
!255 = !DILocation(line: 250, column: 14, scope: !253)
!256 = !DILocation(line: 251, column: 9, scope: !253)
!257 = !DILocation(line: 251, column: 14, scope: !253)
!258 = !DILocation(line: 252, column: 9, scope: !253)
!259 = !DILocation(line: 252, column: 14, scope: !253)
!260 = !DILocation(line: 253, column: 22, scope: !253)
!261 = !DILocation(line: 253, column: 28, scope: !253)
!262 = !DILocation(line: 253, column: 9, scope: !253)
!263 = !DILocation(line: 253, column: 17, scope: !253)
!264 = !DILocation(line: 249, column: 28, scope: !254)
!265 = !DILocation(line: 249, column: 23, scope: !254)
!266 = distinct !{!266, !251, !267, !148, !149}
!267 = !DILocation(line: 254, column: 5, scope: !211)
!268 = !DILocation(line: 266, column: 5, scope: !199)
!269 = !DILocation(line: 268, column: 10, scope: !199)
!270 = !DILocation(line: 268, column: 5, scope: !199)
!271 = !DILocation(line: 269, column: 10, scope: !199)
!272 = !DILocation(line: 269, column: 5, scope: !199)
!273 = !DILocation(line: 270, column: 10, scope: !199)
!274 = !DILocation(line: 270, column: 5, scope: !199)
!275 = !DILocation(line: 271, column: 10, scope: !199)
!276 = !DILocation(line: 271, column: 5, scope: !199)
!277 = !DILocation(line: 273, column: 53, scope: !199)
!278 = !{!279, !279, i64 0}
!279 = !{!"long long", !64, i64 0}
!280 = !DILocation(line: 273, column: 5, scope: !199)
!281 = !DILocation(line: 274, column: 36, scope: !199)
!282 = !DILocation(line: 274, column: 5, scope: !199)
!283 = !DILocation(line: 275, column: 50, scope: !199)
!284 = !DILocation(line: 275, column: 5, scope: !199)
!285 = !DILocation(line: 276, column: 49, scope: !199)
!286 = !DILocation(line: 276, column: 5, scope: !199)
!287 = !DILocation(line: 277, column: 40, scope: !199)
!288 = !DILocation(line: 277, column: 5, scope: !199)
!289 = !DILocation(line: 279, column: 38, scope: !290)
!290 = distinct !DILexicalBlock(scope: !199, file: !3, line: 279, column: 9)
!291 = !DILocation(line: 279, column: 19, scope: !290)
!292 = !DILocation(line: 279, column: 72, scope: !290)
!293 = !DILocation(line: 279, column: 9, scope: !199)
!294 = !DILocation(line: 0, scope: !214)
!295 = !DILocation(line: 263, column: 16, scope: !296)
!296 = distinct !DILexicalBlock(scope: !297, file: !3, line: 262, column: 33)
!297 = distinct !DILexicalBlock(scope: !214, file: !3, line: 262, column: 5)
!298 = !DILocation(line: 263, column: 13, scope: !296)
!299 = !DILocation(line: 262, column: 28, scope: !297)
!300 = !DILocation(line: 262, column: 23, scope: !297)
!301 = !DILocation(line: 262, column: 5, scope: !214)
!302 = distinct !{!302, !301, !303, !148, !149}
!303 = !DILocation(line: 264, column: 5, scope: !214)
!304 = !DILocation(line: 279, column: 84, scope: !305)
!305 = distinct !DILexicalBlock(scope: !290, file: !3, line: 279, column: 84)
!306 = !DILocation(line: 282, column: 19, scope: !307)
!307 = distinct !DILexicalBlock(scope: !199, file: !3, line: 282, column: 9)
!308 = !DILocation(line: 282, column: 53, scope: !307)
!309 = !DILocation(line: 282, column: 9, scope: !199)
!310 = !DILocation(line: 282, column: 65, scope: !311)
!311 = distinct !DILexicalBlock(scope: !307, file: !3, line: 282, column: 65)
!312 = !DILocation(line: 285, column: 5, scope: !199)
!313 = !DILocation(line: 288, column: 1, scope: !199)
!314 = !DILocation(line: 287, column: 5, scope: !199)
!315 = !DISubprogram(name: "PAPI_library_init", scope: !159, file: !159, line: 1172, type: !160, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!316 = !DISubprogram(name: "PAPI_create_eventset", scope: !159, file: !159, line: 1147, type: !317, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!317 = !DISubroutineType(types: !318)
!318 = !{!6, !5}
!319 = !DISubprogram(name: "PAPI_add_events", scope: !159, file: !159, line: 1143, type: !320, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!320 = !DISubroutineType(types: !321)
!321 = !{!6, !6, !5, !6}
!322 = !DISubprogram(name: "srand", scope: !323, file: !323, line: 455, type: !324, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!323 = !DIFile(filename: "/usr/include/stdlib.h", directory: "", checksumkind: CSK_MD5, checksum: "f0db66726d35051e5af2525f5b33bd81")
!324 = !DISubroutineType(types: !325)
!325 = !{null, !326}
!326 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!327 = !DISubprogram(name: "time", scope: !75, file: !75, line: 75, type: !328, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!328 = !DISubroutineType(types: !329)
!329 = !{!330, !332}
!330 = !DIDerivedType(tag: DW_TAG_typedef, name: "time_t", file: !331, line: 7, baseType: !52)
!331 = !DIFile(filename: "/usr/include/bits/types/time_t.h", directory: "", checksumkind: CSK_MD5, checksum: "49b4e16ef1215de5afdbb283400ab90c")
!332 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !330, size: 64)
!333 = !DISubprogram(name: "PAPI_remove_events", scope: !159, file: !159, line: 1192, type: !320, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!334 = !DISubprogram(name: "PAPI_destroy_eventset", scope: !159, file: !159, line: 1149, type: !317, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
!335 = !DISubprogram(name: "PAPI_shutdown", scope: !159, file: !159, line: 1202, type: !336, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
