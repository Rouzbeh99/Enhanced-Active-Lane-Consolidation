...
if.else:                                          ; preds = %for.body
  ...
  %8 = load i32, ptr %arrayidx10, align 4, !dbg !135, !tbaa !102
  %sub = add nsw i32 %8, -4, !dbg !135
...
alc.header:                                       ; preds = %new.latch, %pre.alc
  ...
  %uniform.vector = phi <vscale x 4 x i32> [ %10, %pre.alc ], [ %50, %new.latch ]
  %uniform.vector.predicates = phi <vscale x 4 x i1> [ %14, %pre.alc ], [ %51, %new.latch ]
  ...
  %35 = tail call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %22)
...
uniform.else:                                     ; preds = %alc.header
  ...
  %49 = add <vscale x 4 x i32> %48, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 56, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %49, <vscale x 4 x i1> %9, ptr %c, <vscale x 4 x i32> %39)
  br label %new.latch

new.latch:                                        ; preds = %uniform.else, %uniform.then
  %50 = phi <vscale x 4 x i32> [ %39, %uniform.then ], [ %33, %uniform.else ]
  %51 = phi <vscale x 4 x i1> [ %44, %uniform.then ], [ %34, %uniform.else ]
...
linearized.then:                                  ; preds = %joinBlock
  %53 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %34, ptr %c, <vscale x 4 x i32> %33)
  %54 = add <vscale x 4 x i32> %53, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %54, <vscale x 4 x i1> %34, ptr %c, <vscale x 4 x i32> %33)
  %55 = xor <vscale x 4 x i1> %34, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %56 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %55, ptr %a, <vscale x 4 x i32> %33)
  %57 = add <vscale x 4 x i32> %56, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 56, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %57, <vscale x 4 x i1> %55, ptr %c, <vscale x 4 x i32> %33)
  br label %middel.block

linearized.else:                                  ; preds = %joinBlock
  %58 = xor <vscale x 4 x i1> %44, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %59 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %58, ptr %a, <vscale x 4 x i32> %39)
  %60 = add <vscale x 4 x i32> %59, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 56, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %60, <vscale x 4 x i1> %58, ptr %c, <vscale x 4 x i32> %39)
  %61 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %44, ptr %c, <vscale x 4 x i32> %39)
  %62 = add <vscale x 4 x i32> %61, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %62, <vscale x 4 x i1> %44, ptr %c, <vscale x 4 x i32> %39)
  br label %middel.block

joinBlock:                                        ; preds = %new.latch
  %63 = icmp eq <vscale x 4 x i32> %50, %33
  %64 = tail call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %63, <vscale x 4 x i1> %63)
  %65 = trunc i64 %64 to i32
  %66 = icmp eq i32 %2, %65
  br i1 %66, label %linearized.then, label %linearized.else
...
if.then14:                                        ; preds = %for.cond.cleanup
  %68 = load ptr, ptr @stderr, align 8, !dbg !141, !tbaa !113
  %call15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %68, ptr noundef nonnull @.str, i32 noundef %call12, ptr noundef nonnull @.str.1, i32 noundef 78) #14, !dbg !141
...
for.cond.cleanup32:                               ; preds = %for.body33
  ...
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %18, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !285
