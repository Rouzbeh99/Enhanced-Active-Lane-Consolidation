...
$LLVM_BUILD_DIR/bin/clang -target aarch64-none-linux-gnu  --gcc-toolchain=$GCC_TOOLCHAIN --sysroot=$GCC_TOOLCHAIN/aarch64-none-linux-gnu/libc  -mcpu=cortex-a710 -march=armv9.2-a+sve -static alc_applied_O3.o -o $2.x -L $M5_LIB_PATH/ -lm5
