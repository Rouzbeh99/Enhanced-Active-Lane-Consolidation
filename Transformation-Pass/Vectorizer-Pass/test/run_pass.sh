...
#
# $LLVM_BUILD_DIR/bin/clang -g -O3 -target aarch64-unknown-linux-gnu -fno-inline -fno-vectorize -fno-slp-vectorize -fno-unroll-loops -S -emit-llvm -fpass-plugin=$PASS_DIR/build/ALC_Vectorizer.so  -S -emit-llvm $1 -o tmp.ll
