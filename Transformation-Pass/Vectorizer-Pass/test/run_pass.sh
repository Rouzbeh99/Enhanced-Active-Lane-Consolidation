...
#/home/rouzbeh/Graduate/LLVM/llvm-project/build/bin/llc -O3  -mtriple=aarch64-linux-gnu -mattr=sve,sve2 -mcpu=cortex-a710 -filetype=obj vectorized_modified_v1.ll -o vectorized_modified_v1.o