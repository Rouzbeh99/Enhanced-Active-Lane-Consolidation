...
#$LLVM_BUILD_DIR/bin/clang -g -O0 -target aarch64-unknown-linux-gnu -DSVE_INTRINSICS -fpass-plugin=$PASS_DIR/build/ALC_Vectorizer.so -S -emit-llvm -I $GEM5_PATH/include -I ${PAPI_DIR}/include -L ${PAPI_DIR}/lib  $1.ll -o $2.ll
