; ModuleID = 'alc_data_permute_2%.ll'
...
if.then75:                                        ; preds = %for.cond.cleanup
  ...
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %135, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 64) #14, !dbg !167
