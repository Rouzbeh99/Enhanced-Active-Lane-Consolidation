; ModuleID = 'alc_itr_laneGather_1_header_0.ll'
...
lane.gather:                                      ; preds = %alc.header
  ...
  br i1 %36, label %new.latch, label %uniform.block, !prof !145
...
if.then75:                                        ; preds = %for.cond.cleanup
  %126 = load ptr, ptr @stderr, align 8, !dbg !151, !tbaa !113
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %126, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 52) #14, !dbg !151
...
for.cond.cleanup32:                               ; preds = %for.body33
  ...
  tail call void @free(ptr noundef %10) #13, !dbg !274
  %11 = load ptr, ptr @b, align 8, !dbg !275, !tbaa !113
  tail call void @free(ptr noundef %11) #13, !dbg !276
  %12 = load ptr, ptr @c, align 8, !dbg !277, !tbaa !113
  tail call void @free(ptr noundef %12) #13, !dbg !278
  %13 = load ptr, ptr @cond, align 8, !dbg !279, !tbaa !113
  tail call void @free(ptr noundef %13) #13, !dbg !280
  ...
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %19, ptr noundef nonnull @EventCodes, i32 noundef 4) #13, !dbg !295
