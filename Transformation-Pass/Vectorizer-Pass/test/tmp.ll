; ModuleID = 'benchmarks/MiBench/jfdctfst.ll'
...
vector.body:                                      ; preds = %for.body
  ...
  %69 = getelementptr inbounds i32, ptr %next.gep.1, i64 56
  ...
  %72 = getelementptr inbounds i32, ptr %next.gep.1, i64 8
  %wide.load274.1 = load <4 x i32>, ptr %72, align 4, !tbaa !5
  %73 = getelementptr inbounds i32, ptr %next.gep.1, i64 48
  ...
  %76 = getelementptr inbounds i32, ptr %next.gep.1, i64 16
  %wide.load276.1 = load <4 x i32>, ptr %76, align 4, !tbaa !5
  %77 = getelementptr inbounds i32, ptr %next.gep.1, i64 40
  ...
  %80 = getelementptr inbounds i32, ptr %next.gep.1, i64 24
  %wide.load278.1 = load <4 x i32>, ptr %80, align 4, !tbaa !5
  %81 = getelementptr inbounds i32, ptr %next.gep.1, i64 32
