...
cleanup:                                          ; preds = %while.end25, %entry
  ret void, !dbg !760
}
...
cond.end7:                                        ; preds = %cond.false5, %if.then
...
while.body.preheader:                             ; preds = %if.then2
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %add.ptr3, i8 0, i64 %7, i1 false), !dbg !847
...
if.end44:                                         ; preds = %if.else33, %if.then25, %resize
...
while.body53.preheader:                           ; preds = %land.lhs.true46
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %uglygep, i8 0, i64 %17, i1 false), !dbg !894
  call void @llvm.dbg.value(metadata i32 undef, metadata !815, metadata !DIExpression()), !dbg !834
  call void @llvm.dbg.value(metadata i32 undef, metadata !815, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !834
...
emptyness:                                        ; preds = %if.then66, %lor.lhs.false41, %if.end36
...
return:                                           ; preds = %lor.lhs.false58, %if.end51, %cond.true45, %emptyness, %cond.end, %if.end15, %if.then5
...
if.then147:                                       ; preds = %cond.false137, %land.lhs.true123, %lor.lhs.false116, %land.lhs.true88, %lor.lhs.false81, %cond.true69, %cond.false41, %cond.true36, %land.lhs.true22, %land.lhs.true19, %if.then15, %land.lhs.true, %land.end, %entry
...
if.end163:                                        ; preds = %cond.end156, %cond.false137, %land.lhs.true123, %land.lhs.true109, %land.lhs.true88, %land.lhs.true75, %cond.true36
  br label %cleanup, !dbg !1022

cleanup:                                          ; preds = %if.end163, %cond.end156
...
if.then8:                                         ; preds = %if.end6, %if.then3.if.then8_crit_edge
...
if.end53:                                         ; preds = %Perl_av_reify.exit, %if.end44
  %26 = phi i32 [ %or.i, %Perl_av_reify.exit ], [ %10, %if.end44 ]
  call void @llvm.dbg.value(metadata i64 %6, metadata !1038, metadata !DIExpression()), !dbg !1048
  %27 = load ptr, ptr %av, align 8, !dbg !1124
  %xav_max = getelementptr inbounds %struct.xpvav, ptr %27, i64 0, i32 3, !dbg !1124
  %28 = load i64, ptr %xav_max, align 8, !dbg !1124
  %cmp55 = icmp sgt i64 %6, %28, !dbg !1126
...
if.then57:                                        ; preds = %if.end53
  ...
  %.pre14 = load i32, ptr %sv_flags, align 4, !dbg !1131
  br label %if.end58, !dbg !1128

if.end58:                                         ; preds = %if.then57, %if.end53
  %29 = phi i32 [ %.pre14, %if.then57 ], [ %26, %if.end53 ], !dbg !1131
  %30 = phi ptr [ %.pre197, %if.then57 ], [ %27, %if.end53 ], !dbg !1129
  %sv_u = getelementptr inbounds %struct.av, ptr %av, i64 0, i32 3, !dbg !1132
  %31 = load ptr, ptr %sv_u, align 8, !dbg !1132
  call void @llvm.dbg.value(metadata ptr %31, metadata !1040, metadata !DIExpression()), !dbg !1048
  %xav_fill60 = getelementptr inbounds %struct.xpvav, ptr %30, i64 0, i32 2, !dbg !1129
  %32 = load i64, ptr %xav_fill60, align 8, !dbg !1129
  call void @llvm.dbg.value(metadata i64 %6, metadata !1038, metadata !DIExpression()), !dbg !1048
  %cmp61 = icmp slt i64 %32, %6, !dbg !1133
  %and65 = and i32 %29, 1073741824, !dbg !1131
  %tobool66.not = icmp eq i32 %and65, 0, !dbg !1131
...
if.then67:                                        ; preds = %if.then63
  %33 = load ptr, ptr @PL_curstack, align 8, !dbg !1137
  %cmp68 = icmp eq ptr %33, %av, !dbg !1141
  br i1 %cmp68, label %land.lhs.true70, label %do.body.preheader, !dbg !1142

land.lhs.true70:                                  ; preds = %if.then67
  %34 = load ptr, ptr @PL_stack_sp, align 8, !dbg !1143
  %35 = load ptr, ptr @PL_stack_base, align 8, !dbg !1144
  %sub.ptr.lhs.cast = ptrtoint ptr %34 to i64, !dbg !1145
  %sub.ptr.rhs.cast = ptrtoint ptr %35 to i64, !dbg !1145
...
if.then73:                                        ; preds = %land.lhs.true70
  %add.ptr = getelementptr inbounds ptr, ptr %35, i64 %6, !dbg !1148
...
do.body.preheader:                                ; preds = %if.then73, %land.lhs.true70, %if.then67
  %.ph = phi i64 [ %.pre199.pre, %if.then73 ], [ %32, %land.lhs.true70 ], [ %32, %if.then67 ]
...
do.body:                                          ; preds = %do.body.preheader, %do.body
  ...
  %inc = add nsw i64 %36, 1, !dbg !1152
  store i64 %inc, ptr %xav_fill76, align 8, !dbg !1152
  %arrayidx = getelementptr inbounds ptr, ptr %31, i64 %inc, !dbg !1155
  store ptr null, ptr %arrayidx, align 8, !dbg !1156
  %38 = load ptr, ptr %av, align 8, !dbg !1157
  %xav_fill78 = getelementptr inbounds %struct.xpvav, ptr %38, i64 0, i32 2, !dbg !1157
...
if.then87:                                        ; preds = %if.else
  %arrayidx88 = getelementptr inbounds ptr, ptr %31, i64 %6, !dbg !1166
  %41 = load ptr, ptr %arrayidx88, align 8, !dbg !1166
  call void @llvm.dbg.value(metadata ptr %41, metadata !1168, metadata !DIExpression()) #6, !dbg !1177
  %cmp.not.i = icmp eq ptr %41, null, !dbg !1179
  br i1 %cmp.not.i, label %if.end90, label %if.then.i, !dbg !1180

if.then.i:                                        ; preds = %if.then87
  %sv_refcnt.i187 = getelementptr inbounds %struct.sv, ptr %41, i64 0, i32 1, !dbg !1181
  %42 = load i32, ptr %sv_refcnt.i187, align 8, !dbg !1181
  call void @llvm.dbg.value(metadata i32 %42, metadata !1174, metadata !DIExpression()) #6, !dbg !1182
  %cmp1.i = icmp ugt i32 %42, 1, !dbg !1183
  br i1 %cmp1.i, label %if.then4.i, label %if.else.i, !dbg !1185

if.then4.i:                                       ; preds = %if.then.i
  %sub.i = add i32 %42, -1, !dbg !1186
  store i32 %sub.i, ptr %sv_refcnt.i187, align 8, !dbg !1187
  br label %if.end90, !dbg !1188

if.else.i:                                        ; preds = %if.then.i
  tail call void @Perl_sv_free2(ptr noundef nonnull %41, i32 noundef %42) #6, !dbg !1189
  br label %if.end90

if.end90:                                         ; preds = %if.else.i, %if.then4.i, %if.then87, %if.else, %if.end81
  call void @llvm.dbg.value(metadata i64 %6, metadata !1038, metadata !DIExpression()), !dbg !1048
  %arrayidx91 = getelementptr inbounds ptr, ptr %31, i64 %6, !dbg !1190
  store ptr %val, ptr %arrayidx91, align 8, !dbg !1191
  %43 = load i32, ptr %sv_flags, align 4, !dbg !1192
  %and93 = and i32 %43, 4194304, !dbg !1192
  %tobool94.not = icmp eq i32 %and93, 0, !dbg !1192
  br i1 %tobool94.not, label %cleanup142, label %if.then95, !dbg !1193

if.then95:                                        ; preds = %if.end90
  %44 = load ptr, ptr %av, align 8, !dbg !1194
  %xmg_u = getelementptr inbounds %struct.xpvmg, ptr %44, i64 0, i32 1, !dbg !1194
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.inc.us
  ...
  %idxprom.us = zext i8 %45 to i64, !dbg !1201
  %arrayidx98.us = getelementptr inbounds [0 x i32], ptr @PL_charclass, i64 0, i64 %idxprom.us, !dbg !1201
  %46 = load i32, ptr %arrayidx98.us, align 4, !dbg !1201
  %and99.us = and i32 %46, 16400, !dbg !1201
...
if.end103.us:                                     ; preds = %for.body.us
  %47 = load i16, ptr @PL_delaymagic, align 2, !dbg !1204
  %tobool126.not.us = icmp ne i16 %47, 0, !dbg !1204
  %cmp130.us = icmp eq i8 %45, 73
...
if.then132.us:                                    ; preds = %if.end103.us
  %48 = or i16 %47, 4, !dbg !1207
  store i16 %48, ptr @PL_delaymagic, align 2, !dbg !1207
...
if.end103:                                        ; preds = %for.body
  ...
  %51 = load i16, ptr @PL_delaymagic, align 2, !dbg !1204
  %tobool126.not = icmp eq i16 %51, 0, !dbg !1204
  br i1 %tobool126.not, label %for.inc, label %land.lhs.true127, !dbg !1206

land.lhs.true127:                                 ; preds = %if.end103
  %52 = load i8, ptr %mg_type, align 2, !dbg !1215
  %cmp130 = icmp eq i8 %52, 73, !dbg !1216
  br i1 %cmp130, label %if.then132, label %for.inc, !dbg !1217

if.then132:                                       ; preds = %land.lhs.true127
  %53 = or i16 %51, 4, !dbg !1207
  store i16 %53, ptr @PL_delaymagic, align 2, !dbg !1207
  call void @llvm.dbg.value(metadata i8 0, metadata !1047, metadata !DIExpression()), !dbg !1195
  br label %for.inc, !dbg !1209

for.inc:                                          ; preds = %if.then132, %land.lhs.true127, %if.end103, %for.body
...
if.then137:                                       ; preds = %for.end, %if.then95
  %call138 = tail call i32 @Perl_mg_set(ptr noundef nonnull %av) #6, !dbg !1221
  br label %cleanup142, !dbg !1221

cleanup142:                                       ; preds = %if.then137, %for.end, %if.end90, %cond.end, %if.then8, %if.end6, %if.then3
...
if.end14:                                         ; preds = %if.else, %if.then10, %if.end
...
cleanup:                                          ; preds = %if.then43, %if.end39, %if.end14
  ret void, !dbg !1381
}
...
while.body:                                       ; preds = %S_SvREFCNT_dec.exit, %while.body.lr.ph
...
cond.end8:                                        ; preds = %cond.false6, %if.then2
...
while.body23.preheader:                           ; preds = %while.cond21.preheader
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %uglygep, i8 0, i64 %11, i1 false), !dbg !1472
...
cond.end10:                                       ; preds = %cond.false8, %if.then5
...
cond.end:                                         ; preds = %if.end
  ...
  br i1 %tobool5.not, label %cond.end.if.end18_crit_edge, label %if.then6, !dbg !1554

cond.end.if.end18_crit_edge:                      ; preds = %cond.end
  %.pre1 = load i32, ptr %sv_flags2, align 4, !dbg !1555
  br label %if.end18, !dbg !1554

if.then6:                                         ; preds = %cond.end
  %2 = load ptr, ptr getelementptr inbounds ([35 x ptr], ptr @PL_sv_consts, i64 0, i64 10), align 16, !dbg !1557
  %tobool7.not = icmp eq ptr %2, null, !dbg !1557
  br i1 %tobool7.not, label %cond.false9, label %cond.end11, !dbg !1557

cond.false9:                                      ; preds = %if.then6
  %call10 = tail call ptr @Perl_newSVpv_share(ptr noundef nonnull @.str.2, i32 noundef 0) #6, !dbg !1557
  store ptr %call10, ptr getelementptr inbounds ([35 x ptr], ptr @PL_sv_consts, i64 0, i64 10), align 16, !dbg !1557
  br label %cond.end11, !dbg !1557

cond.end11:                                       ; preds = %cond.false9, %if.then6
  %cond12 = phi ptr [ %call10, %cond.false9 ], [ %2, %if.then6 ], !dbg !1557
  %call13 = tail call ptr (ptr, ptr, ptr, i32, i32, ...) @Perl_magic_methcall(ptr noundef nonnull %av, ptr noundef nonnull %call, ptr noundef %cond12, i32 noundef 0, i32 noundef 0) #6, !dbg !1559
  call void @llvm.dbg.value(metadata ptr %call13, metadata !1544, metadata !DIExpression()), !dbg !1546
  %tobool14.not = icmp eq ptr %call13, null, !dbg !1560
  br i1 %tobool14.not, label %cleanup, label %if.then15, !dbg !1562

if.then15:                                        ; preds = %cond.end11
  %call16 = tail call ptr @Perl_newSVsv(ptr noundef nonnull %call13) #6, !dbg !1563
  call void @llvm.dbg.value(metadata ptr %call16, metadata !1544, metadata !DIExpression()), !dbg !1546
  br label %cleanup, !dbg !1564

if.end18:                                         ; preds = %cond.end.if.end18_crit_edge, %if.end
  %3 = phi i32 [ %.pre1, %cond.end.if.end18_crit_edge ], [ %1, %if.end ], !dbg !1555
  %and20 = and i32 %3, 8388608, !dbg !1555
  %tobool21.not = icmp eq i32 %and20, 0, !dbg !1555
  br i1 %tobool21.not, label %cond.false24, label %cond.true22, !dbg !1555

cond.true22:                                      ; preds = %if.end18
  %call23 = tail call i32 @Perl_mg_size(ptr noundef nonnull %av) #6, !dbg !1555
  %conv = sext i32 %call23 to i64, !dbg !1555
  br label %cond.end25, !dbg !1555

cond.false24:                                     ; preds = %if.end18
  %4 = load ptr, ptr %av, align 8, !dbg !1555
  %xav_fill = getelementptr inbounds %struct.xpvav, ptr %4, i64 0, i32 2, !dbg !1555
  %5 = load i64, ptr %xav_fill, align 8, !dbg !1555
  br label %cond.end25, !dbg !1555

cond.end25:                                       ; preds = %cond.false24, %cond.true22
  %cond26 = phi i64 [ %conv, %cond.true22 ], [ %5, %cond.false24 ], !dbg !1555
...
cleanup:                                          ; preds = %if.end41, %cond.end25, %if.then15, %cond.end11
...
if.then38:                                        ; preds = %if.end36
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %32, i8 0, i64 %33, i1 false), !dbg !1692
...
cleanup:                                          ; preds = %if.then38, %if.end36, %if.end13, %cond.end10
  ret void, !dbg !1702
}
...
cond.end:                                         ; preds = %if.end
  ...
  br i1 %tobool5.not, label %cond.end.if.end18_crit_edge, label %if.then6, !dbg !1716

cond.end.if.end18_crit_edge:                      ; preds = %cond.end
  %.pre1 = load i32, ptr %sv_flags2, align 4, !dbg !1717
  br label %if.end18, !dbg !1716

if.then6:                                         ; preds = %cond.end
  %2 = load ptr, ptr getelementptr inbounds ([35 x ptr], ptr @PL_sv_consts, i64 0, i64 11), align 8, !dbg !1719
  %tobool7.not = icmp eq ptr %2, null, !dbg !1719
  br i1 %tobool7.not, label %cond.false9, label %cond.end11, !dbg !1719

cond.false9:                                      ; preds = %if.then6
  %call10 = tail call ptr @Perl_newSVpv_share(ptr noundef nonnull @.str.4, i32 noundef 0) #6, !dbg !1719
  store ptr %call10, ptr getelementptr inbounds ([35 x ptr], ptr @PL_sv_consts, i64 0, i64 11), align 8, !dbg !1719
  br label %cond.end11, !dbg !1719

cond.end11:                                       ; preds = %cond.false9, %if.then6
  %cond12 = phi ptr [ %call10, %cond.false9 ], [ %2, %if.then6 ], !dbg !1719
  %call13 = tail call ptr (ptr, ptr, ptr, i32, i32, ...) @Perl_magic_methcall(ptr noundef nonnull %av, ptr noundef nonnull %call, ptr noundef %cond12, i32 noundef 0, i32 noundef 0) #6, !dbg !1721
  call void @llvm.dbg.value(metadata ptr %call13, metadata !1706, metadata !DIExpression()), !dbg !1708
  %tobool14.not = icmp eq ptr %call13, null, !dbg !1722
  br i1 %tobool14.not, label %cleanup, label %if.then15, !dbg !1724

if.then15:                                        ; preds = %cond.end11
  %call16 = tail call ptr @Perl_newSVsv(ptr noundef nonnull %call13) #6, !dbg !1725
  call void @llvm.dbg.value(metadata ptr %call16, metadata !1706, metadata !DIExpression()), !dbg !1708
  br label %cleanup, !dbg !1726

if.end18:                                         ; preds = %cond.end.if.end18_crit_edge, %if.end
  %3 = phi i32 [ %.pre1, %cond.end.if.end18_crit_edge ], [ %1, %if.end ], !dbg !1717
  %and20 = and i32 %3, 8388608, !dbg !1717
  %tobool21.not = icmp eq i32 %and20, 0, !dbg !1717
  br i1 %tobool21.not, label %cond.false24, label %cond.true22, !dbg !1717

cond.true22:                                      ; preds = %if.end18
  %call23 = tail call i32 @Perl_mg_size(ptr noundef nonnull %av) #6, !dbg !1717
  %conv = sext i32 %call23 to i64, !dbg !1717
  br label %cond.end25, !dbg !1717

cond.false24:                                     ; preds = %if.end18
  %4 = load ptr, ptr %av, align 8, !dbg !1717
  %xav_fill = getelementptr inbounds %struct.xpvav, ptr %4, i64 0, i32 2, !dbg !1717
  %5 = load i64, ptr %xav_fill, align 8, !dbg !1717
  br label %cond.end25, !dbg !1717

cond.end25:                                       ; preds = %cond.false24, %cond.true22
  %cond26 = phi i64 [ %conv, %cond.true22 ], [ %5, %cond.false24 ], !dbg !1717
...
cleanup:                                          ; preds = %if.end47, %cond.end25, %if.then15, %cond.end11
...
S_av_top_index.exit:                              ; preds = %cond.false.i, %cond.true.i
...
if.end28:                                         ; preds = %if.end13, %lor.lhs.false, %if.end
...
do.body.preheader:                                ; preds = %if.end53
  %dec142 = add nsw i64 %key.addr.promoted, -1, !dbg !1871
...
land.rhs.do.body_crit_edge:                       ; preds = %land.rhs
  ...
  %.pre140 = load i64, ptr %xav_fill62.phi.trans.insert, align 8, !dbg !1871
  %dec = add nsw i64 %.pre140, -1, !dbg !1871
...
if.end69:                                         ; preds = %if.end69.loopexit, %if.end53
  %30 = load i32, ptr %sv_flags, align 4, !dbg !1884
  %and71 = and i32 %30, 4194304, !dbg !1884
...
if.then82:                                        ; preds = %if.then79
  ...
  %31 = load i32, ptr %sv_refcnt.i125, align 8, !dbg !1902
  call void @llvm.dbg.value(metadata i32 %31, metadata !1898, metadata !DIExpression()) #6, !dbg !1899
  %cmp.i126 = icmp ugt i32 %31, 1, !dbg !1903
  br i1 %cmp.i126, label %if.then.i, label %if.else.i, !dbg !1905

if.then.i:                                        ; preds = %if.then82
  %sub.i = add i32 %31, -1, !dbg !1906
  store i32 %sub.i, ptr %sv_refcnt.i125, align 8, !dbg !1907
  br label %cleanup92, !dbg !1908

if.else.i:                                        ; preds = %if.then82
  tail call void @Perl_sv_free2(ptr noundef nonnull %25, i32 noundef %31) #6, !dbg !1909
  br label %cleanup92

if.else83:                                        ; preds = %if.then79
  %32 = load i32, ptr %sv_flags, align 4, !dbg !1910
  %and85 = and i32 %32, 1073741824, !dbg !1910
...
cleanup92:                                        ; preds = %if.then87, %if.else83, %if.else.i, %if.then.i, %if.end76, %if.end40, %cond.end, %if.then20, %if.then16, %if.then9
...
if.end108:                                        ; preds = %if.end19, %if.then, %entry
...
return:                                           ; preds = %if.else137, %land.lhs.true133, %cond.end121, %cond.false87, %lor.rhs78, %land.rhs75, %lor.rhs71, %land.lhs.true67, %land.rhs54, %lor.rhs, %land.rhs, %cond.true45, %if.then25, %cond.end, %if.then5
...
S_get_aux_mg.exit:                                ; preds = %if.then.i, %entry
...
!1132 = !DILocation(line: 349, column: 11, scope: !1033)
!1133 = !DILocation(line: 350, column: 21, scope: !1130)
...
!1555 = !DILocation(line: 622, column: 9, scope: !1556)
!1556 = distinct !DILexicalBlock(scope: !1539, file: !712, line: 622, column: 9)
!1557 = !DILocation(line: 617, column: 57, scope: !1558)
!1558 = distinct !DILexicalBlock(scope: !1552, file: !712, line: 616, column: 60)
!1559 = !DILocation(line: 617, column: 11, scope: !1558)
!1560 = !DILocation(line: 618, column: 6, scope: !1561)
!1561 = distinct !DILexicalBlock(scope: !1558, file: !712, line: 618, column: 6)
!1562 = !DILocation(line: 618, column: 6, scope: !1558)
!1563 = !DILocation(line: 619, column: 15, scope: !1561)
!1564 = !DILocation(line: 619, column: 6, scope: !1561)
!1565 = !DILocation(line: 622, column: 20, scope: !1556)
...
!1717 = !DILocation(line: 746, column: 9, scope: !1718)
!1718 = distinct !DILexicalBlock(scope: !1703, file: !712, line: 746, column: 9)
!1719 = !DILocation(line: 741, column: 57, scope: !1720)
!1720 = distinct !DILexicalBlock(scope: !1714, file: !712, line: 740, column: 60)
!1721 = !DILocation(line: 741, column: 11, scope: !1720)
!1722 = !DILocation(line: 742, column: 6, scope: !1723)
!1723 = distinct !DILexicalBlock(scope: !1720, file: !712, line: 742, column: 6)
!1724 = !DILocation(line: 742, column: 6, scope: !1720)
!1725 = !DILocation(line: 743, column: 15, scope: !1723)
!1726 = !DILocation(line: 743, column: 6, scope: !1723)
!1727 = !DILocation(line: 746, column: 20, scope: !1718)
...
!1871 = !DILocation(line: 900, column: 14, scope: !1872)
!1872 = distinct !DILexicalBlock(scope: !1873, file: !712, line: 899, column: 9)
...
!1883 = !DILocation(line: 900, column: 3, scope: !1872)
