...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 36) #12, !dbg !111
...
if.then75:                                        ; preds = %for.cond.cleanup
  ...
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %12, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 52) #12, !dbg !151
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 90) #12, !dbg !231
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 93) #12, !dbg !238
...
for.cond.cleanup32:                               ; preds = %for.body33
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add), !dbg !272
  %10 = load ptr, ptr @a, align 8, !dbg !273, !tbaa !113
  tail call void @free(ptr noundef %10) #11, !dbg !274
  %11 = load ptr, ptr @b, align 8, !dbg !275, !tbaa !113
  tail call void @free(ptr noundef %11) #11, !dbg !276
  %12 = load ptr, ptr @c, align 8, !dbg !277, !tbaa !113
  tail call void @free(ptr noundef %12) #11, !dbg !278
  %13 = load ptr, ptr @cond, align 8, !dbg !279, !tbaa !113
  tail call void @free(ptr noundef %13) #11, !dbg !280
  %14 = load i64, ptr @CounterValues, align 8, !dbg !281, !tbaa !282
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i64 noundef %14), !dbg !284
  %15 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !285, !tbaa !282
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %15), !dbg !286
  %16 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !287, !tbaa !282
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %16), !dbg !288
  %17 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !289, !tbaa !282
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %17), !dbg !290
  %18 = load double, ptr @ExecutionTime, align 8, !dbg !291, !tbaa !156
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, double noundef %18), !dbg !292
  %19 = load i32, ptr @EventSet, align 4, !dbg !293, !tbaa !102
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %19, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !295
  call void @llvm.dbg.value(metadata i32 %call45, metadata !204, metadata !DIExpression()), !dbg !228
  %cmp46.not = icmp eq i32 %call45, 0, !dbg !296
  br i1 %cmp46.not, label %if.end50, label %if.then48, !dbg !297
...
for.body33:                                       ; preds = %for.cond.cleanup, %for.body33
  ...
  %arrayidx35 = getelementptr inbounds i32, ptr %8, i64 %indvars.iv84, !dbg !298
  %20 = load i32, ptr %arrayidx35, align 4, !dbg !298, !tbaa !102
  %add = add nsw i32 %20, %sum.081, !dbg !301
...
if.then48:                                        ; preds = %for.cond.cleanup32
  ...
  %call49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %21, ptr noundef nonnull @.str, i32 noundef %call45, ptr noundef nonnull @.str.1, i32 noundef 134) #12, !dbg !306
  tail call void @exit(i32 noundef %call45) #13, !dbg !306
  unreachable, !dbg !306

if.end50:                                         ; preds = %for.cond.cleanup32
  %call51 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #11, !dbg !308
...
if.then54:                                        ; preds = %if.end50
  ...
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %22, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 137) #12, !dbg !312
  tail call void @exit(i32 noundef %call51) #13, !dbg !312
  unreachable, !dbg !312

if.end56:                                         ; preds = %if.end50
  tail call void @PAPI_shutdown() #11, !dbg !314
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #11, !dbg !315
  ret i32 0, !dbg !316
}
...
!272 = !DILocation(line: 121, column: 5, scope: !200)
!273 = !DILocation(line: 123, column: 10, scope: !200)
!274 = !DILocation(line: 123, column: 5, scope: !200)
!275 = !DILocation(line: 124, column: 10, scope: !200)
!276 = !DILocation(line: 124, column: 5, scope: !200)
!277 = !DILocation(line: 125, column: 10, scope: !200)
!278 = !DILocation(line: 125, column: 5, scope: !200)
!279 = !DILocation(line: 126, column: 10, scope: !200)
!280 = !DILocation(line: 126, column: 5, scope: !200)
!281 = !DILocation(line: 128, column: 53, scope: !200)
!282 = !{!283, !283, i64 0}
!283 = !{!"long long", !64, i64 0}
!284 = !DILocation(line: 128, column: 5, scope: !200)
!285 = !DILocation(line: 129, column: 36, scope: !200)
!286 = !DILocation(line: 129, column: 5, scope: !200)
!287 = !DILocation(line: 130, column: 50, scope: !200)
!288 = !DILocation(line: 130, column: 5, scope: !200)
!289 = !DILocation(line: 131, column: 49, scope: !200)
!290 = !DILocation(line: 131, column: 5, scope: !200)
!291 = !DILocation(line: 132, column: 40, scope: !200)
!292 = !DILocation(line: 132, column: 5, scope: !200)
!293 = !DILocation(line: 134, column: 38, scope: !294)
!294 = distinct !DILexicalBlock(scope: !200, file: !3, line: 134, column: 9)
!295 = !DILocation(line: 134, column: 19, scope: !294)
!296 = !DILocation(line: 134, column: 72, scope: !294)
!297 = !DILocation(line: 134, column: 9, scope: !200)
!298 = !DILocation(line: 118, column: 16, scope: !299)
!299 = distinct !DILexicalBlock(scope: !300, file: !3, line: 117, column: 33)
!300 = distinct !DILexicalBlock(scope: !215, file: !3, line: 117, column: 5)
!301 = !DILocation(line: 118, column: 13, scope: !299)
!302 = !DILocation(line: 117, column: 28, scope: !300)
!303 = !DILocation(line: 117, column: 23, scope: !300)
!304 = distinct !{!304, !255, !305, !149, !150}
!305 = !DILocation(line: 119, column: 5, scope: !215)
!306 = !DILocation(line: 134, column: 84, scope: !307)
!307 = distinct !DILexicalBlock(scope: !294, file: !3, line: 134, column: 84)
