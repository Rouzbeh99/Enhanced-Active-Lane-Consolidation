...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup4
  ...
  %call23 = tail call i32 @gettimeofday(ptr noundef nonnull %t2, ptr noundef null) #6, !dbg !94
  %call24 = tail call i32 @calc_checksum(ptr noundef nonnull @__func__.s253) #6, !dbg !95
  ret i32 %call24, !dbg !96

for.cond.cleanup4:                                ; preds = %for.inc
  %call19 = tail call i32 @dummy(ptr noundef nonnull @a, ptr noundef nonnull @b, ptr noundef nonnull @c, ptr noundef nonnull @d, ptr noundef nonnull @e, ptr noundef nonnull @aa, ptr noundef nonnull @bb, ptr noundef nonnull @cc, i32 noundef 0) #6, !dbg !97
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.inc
  ...
  %0 = load i32, ptr %arrayidx, align 4, !dbg !104, !tbaa !108
  %arrayidx7 = getelementptr inbounds [32000 x i32], ptr @b, i64 0, i64 %indvars.iv, !dbg !112
  %1 = load i32, ptr %arrayidx7, align 4, !dbg !112, !tbaa !108
  %cmp8 = icmp sgt i32 %0, %1, !dbg !113
...
if.then:                                          ; preds = %for.body5
  ...
  %2 = load i32, ptr %arrayidx14, align 4, !dbg !115, !tbaa !108
  %mul = mul nsw i32 %2, %1, !dbg !117
  %sub = sub nsw i32 %0, %mul, !dbg !118
  ...
  %3 = load i32, ptr %arrayidx16, align 4, !dbg !120, !tbaa !108
  %add = add nsw i32 %sub, %3, !dbg !120
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %ip) #6, !dbg !161
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %s1) #6, !dbg !162
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %s2) #6, !dbg !162
  ...
  call void @init(ptr noundef nonnull %ip, ptr noundef nonnull %s1, ptr noundef nonnull %s2) #6, !dbg !163
  %puts = call i32 @puts(ptr nonnull @str), !dbg !164
  %call1 = call i32 @time_function(ptr noundef nonnull @s253, ptr noundef null) #6, !dbg !165
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %s2) #6, !dbg !166
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %s1) #6, !dbg !166
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ip) #6, !dbg !166
  ret i32 0, !dbg !166
}
