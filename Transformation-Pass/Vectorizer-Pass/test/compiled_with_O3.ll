...
if.then.us:                                       ; preds = %for.body4.us
  ...
  %1 = load i32, ptr %arrayidx6.us, align 4, !dbg !61, !tbaa !63
  %mul.neg.us = mul i32 %1, -2, !dbg !65
  %arrayidx8.us = getelementptr inbounds i32, ptr %c, i64 %indvars.iv, !dbg !66
  %2 = load i32, ptr %arrayidx8.us, align 4, !dbg !66, !tbaa !63
  %3 = sub nsw i32 %1, %2, !dbg !67
  %sub.us = shl nsw i32 %3, 1, !dbg !67
  %arrayidx11.us = getelementptr inbounds i32, ptr %b, i64 %indvars.iv, !dbg !68
  %4 = load i32, ptr %arrayidx11.us, align 4, !dbg !68, !tbaa !63
  %sub15.us = add i32 %4, %mul.neg.us, !dbg !69
  %add.us = add nsw i32 %sub15.us, %sub.us, !dbg !70
  store i32 %add.us, ptr %arrayidx6.us, align 4, !dbg !71, !tbaa !63
  %add20.us = add nsw i32 %4, 2, !dbg !72
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul) #7, !dbg !98
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #8, !dbg !104
  unreachable, !dbg !104
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %conv) #7, !dbg !114
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #8, !dbg !120
  unreachable, !dbg !120
