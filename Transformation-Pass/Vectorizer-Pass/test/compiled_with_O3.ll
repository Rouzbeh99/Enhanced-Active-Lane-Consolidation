...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 37) #12, !dbg !111
...
for.cond.cleanup:                                 ; preds = %for.inc, %for.cond.preheader
  ...
  %call73 = tail call i32 @PAPI_stop(i32 noundef %2, ptr noundef nonnull @CounterValues) #11, !dbg !117
...
for.inc:                                          ; preds = %for.body, %if.then4
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !110, !llvm.loop !147

if.then75:                                        ; preds = %for.cond.cleanup
  %12 = load ptr, ptr @stderr, align 8, !dbg !151, !tbaa !113
  %call76 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %12, ptr noundef nonnull @.str, i32 noundef %call73, ptr noundef nonnull @.str.1, i32 noundef 53) #12, !dbg !151
  tail call void @exit(i32 noundef %call73) #13, !dbg !151
  unreachable, !dbg !151
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul) #14, !dbg !176
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #13, !dbg !182
  unreachable, !dbg !182
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %conv) #14, !dbg !192
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #13, !dbg !198
  unreachable, !dbg !198
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %errstring) #11, !dbg !216
  call void @llvm.dbg.declare(metadata ptr %errstring, metadata !205, metadata !DIExpression()), !dbg !217
  %call = tail call i32 @PAPI_library_init(i32 noundef 117440512) #11, !dbg !218
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3, ptr noundef nonnull %errstring) #12, !dbg !224
  call void @exit(i32 noundef 1) #13, !dbg !225
  unreachable, !dbg !225

if.end:                                           ; preds = %entry
  %call2 = tail call i32 @PAPI_create_eventset(ptr noundef nonnull @EventSet) #11, !dbg !226
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 233) #12, !dbg !231
  tail call void @exit(i32 noundef %call2) #13, !dbg !231
  unreachable, !dbg !231

if.end6:                                          ; preds = %if.end
  %2 = load i32, ptr @EventSet, align 4, !dbg !233, !tbaa !102
  %call7 = tail call i32 @PAPI_add_events(i32 noundef %2, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !235
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 236) #12, !dbg !238
  tail call void @exit(i32 noundef %call7) #13, !dbg !238
  unreachable, !dbg !238
...
if.end11:                                         ; preds = %if.end6
  ...
  %call16 = tail call i64 @time(ptr noundef null) #11, !dbg !249
  %conv = trunc i64 %call16 to i32, !dbg !249
  tail call void @srand(i32 noundef %conv) #11, !dbg !250
...
for.body:                                         ; preds = %if.end11, %for.body
  ...
  br i1 %exitcond.not, label %for.body33, label %for.body, !dbg !252, !llvm.loop !267

for.cond.cleanup32:                               ; preds = %for.body33
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %add), !dbg !269
  %9 = load ptr, ptr @a, align 8, !dbg !270, !tbaa !113
  tail call void @free(ptr noundef %9) #11, !dbg !271
  %10 = load ptr, ptr @b, align 8, !dbg !272, !tbaa !113
  tail call void @free(ptr noundef %10) #11, !dbg !273
  %11 = load ptr, ptr @c, align 8, !dbg !274, !tbaa !113
  tail call void @free(ptr noundef %11) #11, !dbg !275
  %12 = load ptr, ptr @cond, align 8, !dbg !276, !tbaa !113
  tail call void @free(ptr noundef %12) #11, !dbg !277
  %13 = load i64, ptr @CounterValues, align 8, !dbg !278, !tbaa !279
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i64 noundef %13), !dbg !281
  %14 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 1), align 8, !dbg !282, !tbaa !279
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.6, i64 noundef %14), !dbg !283
  %15 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 2), align 8, !dbg !284, !tbaa !279
  %call42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.7, i64 noundef %15), !dbg !285
  %16 = load i64, ptr getelementptr inbounds ([4 x i64], ptr @CounterValues, i64 0, i64 3), align 8, !dbg !286, !tbaa !279
  %call43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i64 noundef %16), !dbg !287
  %17 = load double, ptr @ExecutionTime, align 8, !dbg !288, !tbaa !156
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.9, double noundef %17), !dbg !289
  %18 = load i32, ptr @EventSet, align 4, !dbg !290, !tbaa !102
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %18, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !292
  call void @llvm.dbg.value(metadata i32 %call45, metadata !204, metadata !DIExpression()), !dbg !228
  %cmp46.not = icmp eq i32 %call45, 0, !dbg !293
  br i1 %cmp46.not, label %if.end50, label %if.then48, !dbg !294
...
for.body33:                                       ; preds = %for.body, %for.body33
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv83, metadata !214, metadata !DIExpression()), !dbg !295
  call void @llvm.dbg.value(metadata i32 %sum.080, metadata !213, metadata !DIExpression()), !dbg !228
  %arrayidx35 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv83, !dbg !296
  %19 = load i32, ptr %arrayidx35, align 4, !dbg !296, !tbaa !102
  %add = add nsw i32 %19, %sum.080, !dbg !299
  call void @llvm.dbg.value(metadata i32 %add, metadata !213, metadata !DIExpression()), !dbg !228
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1, !dbg !300
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next84, metadata !214, metadata !DIExpression()), !dbg !295
  %exitcond86.not = icmp eq i64 %indvars.iv.next84, 5000000, !dbg !301
  br i1 %exitcond86.not, label %for.cond.cleanup32, label %for.body33, !dbg !302, !llvm.loop !303

if.then48:                                        ; preds = %for.cond.cleanup32
  %20 = load ptr, ptr @stderr, align 8, !dbg !305, !tbaa !113
  %call49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str, i32 noundef %call45, ptr noundef nonnull @.str.1, i32 noundef 279) #12, !dbg !305
  tail call void @exit(i32 noundef %call45) #13, !dbg !305
  unreachable, !dbg !305

if.end50:                                         ; preds = %for.cond.cleanup32
  %call51 = tail call i32 @PAPI_destroy_eventset(ptr noundef nonnull @EventSet) #11, !dbg !307
...
if.then54:                                        ; preds = %if.end50
  ...
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %21, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 282) #12, !dbg !311
  tail call void @exit(i32 noundef %call51) #13, !dbg !311
  unreachable, !dbg !311

if.end56:                                         ; preds = %if.end50
  tail call void @PAPI_shutdown() #11, !dbg !313
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %errstring) #11, !dbg !314
  ret i32 0, !dbg !315
}
...
!269 = !DILocation(line: 266, column: 5, scope: !200)
!270 = !DILocation(line: 268, column: 10, scope: !200)
!271 = !DILocation(line: 268, column: 5, scope: !200)
!272 = !DILocation(line: 269, column: 10, scope: !200)
!273 = !DILocation(line: 269, column: 5, scope: !200)
!274 = !DILocation(line: 270, column: 10, scope: !200)
!275 = !DILocation(line: 270, column: 5, scope: !200)
!276 = !DILocation(line: 271, column: 10, scope: !200)
!277 = !DILocation(line: 271, column: 5, scope: !200)
!278 = !DILocation(line: 273, column: 53, scope: !200)
!279 = !{!280, !280, i64 0}
!280 = !{!"long long", !64, i64 0}
!281 = !DILocation(line: 273, column: 5, scope: !200)
!282 = !DILocation(line: 274, column: 36, scope: !200)
!283 = !DILocation(line: 274, column: 5, scope: !200)
!284 = !DILocation(line: 275, column: 50, scope: !200)
!285 = !DILocation(line: 275, column: 5, scope: !200)
!286 = !DILocation(line: 276, column: 49, scope: !200)
!287 = !DILocation(line: 276, column: 5, scope: !200)
!288 = !DILocation(line: 277, column: 40, scope: !200)
!289 = !DILocation(line: 277, column: 5, scope: !200)
!290 = !DILocation(line: 279, column: 38, scope: !291)
!291 = distinct !DILexicalBlock(scope: !200, file: !3, line: 279, column: 9)
!292 = !DILocation(line: 279, column: 19, scope: !291)
!293 = !DILocation(line: 279, column: 72, scope: !291)
!294 = !DILocation(line: 279, column: 9, scope: !200)
!295 = !DILocation(line: 0, scope: !215)
!296 = !DILocation(line: 263, column: 16, scope: !297)
!297 = distinct !DILexicalBlock(scope: !298, file: !3, line: 262, column: 33)
!298 = distinct !DILexicalBlock(scope: !215, file: !3, line: 262, column: 5)
!299 = !DILocation(line: 263, column: 13, scope: !297)
!300 = !DILocation(line: 262, column: 28, scope: !298)
!301 = !DILocation(line: 262, column: 23, scope: !298)
!302 = !DILocation(line: 262, column: 5, scope: !215)
!303 = distinct !{!303, !302, !304, !149, !150}
!304 = !DILocation(line: 264, column: 5, scope: !215)
!305 = !DILocation(line: 279, column: 84, scope: !306)
!306 = distinct !DILexicalBlock(scope: !291, file: !3, line: 279, column: 84)
