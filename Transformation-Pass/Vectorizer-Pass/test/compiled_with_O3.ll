...
for.cond.cleanup:                                 ; preds = %for.inc, %for.cond.preheader
  ...
  %call15 = tail call i32 @PAPI_stop(i32 noundef %2, ptr noundef nonnull @CounterValues) #11, !dbg !117
...
if.then4:                                         ; preds = %for.body
  ...
  %5 = load i32, ptr %arrayidx8, align 4, !dbg !129, !tbaa !102
  %add = add nsw i32 %5, %4, !dbg !130
  %arrayidx10 = getelementptr inbounds i32, ptr %c, i64 %indvars.iv, !dbg !131
  %6 = load i32, ptr %arrayidx10, align 4, !dbg !131, !tbaa !102
  %add11 = add nsw i32 %add, %6, !dbg !132
...
if.then17:                                        ; preds = %for.cond.cleanup
  %7 = load ptr, ptr @stderr, align 8, !dbg !140, !tbaa !113
  %call18 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str, i32 noundef %call15, ptr noundef nonnull @.str.1, i32 noundef 54) #12, !dbg !140
  tail call void @exit(i32 noundef %call15) #13, !dbg !140
  unreachable, !dbg !140
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul) #14, !dbg !165
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #13, !dbg !171
  unreachable, !dbg !171
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %conv) #14, !dbg !181
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 1) #13, !dbg !187
  unreachable, !dbg !187
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %errstring) #11, !dbg !205
  call void @llvm.dbg.declare(metadata ptr %errstring, metadata !194, metadata !DIExpression()), !dbg !206
  %call = tail call i32 @PAPI_library_init(i32 noundef 117440512) #11, !dbg !207
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3, ptr noundef nonnull %errstring) #12, !dbg !213
  call void @exit(i32 noundef 1) #13, !dbg !214
  unreachable, !dbg !214

if.end:                                           ; preds = %entry
  %call2 = tail call i32 @PAPI_create_eventset(ptr noundef nonnull @EventSet) #11, !dbg !215
...
if.then4:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i32 noundef %call2, ptr noundef nonnull @.str.1, i32 noundef 292) #12, !dbg !220
  tail call void @exit(i32 noundef %call2) #13, !dbg !220
  unreachable, !dbg !220

if.end6:                                          ; preds = %if.end
  %2 = load i32, ptr @EventSet, align 4, !dbg !222, !tbaa !102
  %call7 = tail call i32 @PAPI_add_events(i32 noundef %2, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !224
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, i32 noundef %call7, ptr noundef nonnull @.str.1, i32 noundef 295) #12, !dbg !227
  tail call void @exit(i32 noundef %call7) #13, !dbg !227
  unreachable, !dbg !227
...
if.end11:                                         ; preds = %if.end6
  ...
  tail call void @srand(i32 noundef %conv) #11, !dbg !239
...
for.cond.cleanup32:                               ; preds = %for.body33
  ...
  tail call void @free(ptr noundef %10) #11, !dbg !263
  %11 = load ptr, ptr @b, align 8, !dbg !264, !tbaa !113
  tail call void @free(ptr noundef %11) #11, !dbg !265
  %12 = load ptr, ptr @c, align 8, !dbg !266, !tbaa !113
  tail call void @free(ptr noundef %12) #11, !dbg !267
  %13 = load ptr, ptr @cond, align 8, !dbg !268, !tbaa !113
  tail call void @free(ptr noundef %13) #11, !dbg !269
  ...
  %call45 = tail call i32 @PAPI_remove_events(i32 noundef %19, ptr noundef nonnull @EventCodes, i32 noundef 4) #11, !dbg !284
...
if.then48:                                        ; preds = %for.cond.cleanup32
  ...
  %call49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %21, ptr noundef nonnull @.str, i32 noundef %call45, ptr noundef nonnull @.str.1, i32 noundef 338) #12, !dbg !295
...
if.then54:                                        ; preds = %if.end50
  ...
  %call55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %22, ptr noundef nonnull @.str, i32 noundef %call51, ptr noundef nonnull @.str.1, i32 noundef 341) #12, !dbg !301
