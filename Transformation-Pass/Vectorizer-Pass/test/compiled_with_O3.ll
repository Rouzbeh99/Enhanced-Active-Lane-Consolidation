...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %for.body11, label %for.body.i, !dbg !102, !llvm.loop !116

for.body:                                         ; preds = %entry, %for.body
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv, metadata !74, metadata !DIExpression()), !dbg !86
  %arrayidx = getelementptr inbounds i32, ptr %vla30, i64 %indvars.iv, !dbg !118
  %2 = trunc i64 %indvars.iv to i32, !dbg !119
  store i32 %2, ptr %arrayidx, align 4, !dbg !119, !tbaa !39
  %arrayidx4 = getelementptr inbounds i32, ptr %vla131, i64 %indvars.iv, !dbg !120
  store i32 2, ptr %arrayidx4, align 4, !dbg !121, !tbaa !39
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 2048, !dbg !123
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !90, !llvm.loop !124

for.cond.cleanup10:                               ; preds = %for.body11
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str, i32 noundef %add), !dbg !126
  ret i32 0, !dbg !127

for.body11:                                       ; preds = %for.inc.i, %for.body11
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body11 ], [ 0, %for.inc.i ]
  %sum.034 = phi i32 [ %add, %for.body11 ], [ 0, %for.inc.i ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv37, metadata !77, metadata !DIExpression()), !dbg !128
  call void @llvm.dbg.value(metadata i32 %sum.034, metadata !76, metadata !DIExpression()), !dbg !79
  %arrayidx13 = getelementptr inbounds i32, ptr %vla232, i64 %indvars.iv37, !dbg !129
  %3 = load i32, ptr %arrayidx13, align 4, !dbg !129, !tbaa !39
  %add = add nsw i32 %3, %sum.034, !dbg !132
  call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !79
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1, !dbg !133
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next38, metadata !77, metadata !DIExpression()), !dbg !128
  %exitcond40.not = icmp eq i64 %indvars.iv.next38, 2048, !dbg !134
  br i1 %exitcond40.not, label %for.cond.cleanup10, label %for.body11, !dbg !135, !llvm.loop !136
}
...
!118 = !DILocation(line: 28, column: 9, scope: !88)
!119 = !DILocation(line: 28, column: 14, scope: !88)
!120 = !DILocation(line: 29, column: 9, scope: !88)
!121 = !DILocation(line: 29, column: 14, scope: !88)
!122 = !DILocation(line: 27, column: 28, scope: !89)
!123 = !DILocation(line: 27, column: 23, scope: !89)
!124 = distinct !{!124, !90, !125, !51, !52}
!125 = !DILocation(line: 31, column: 5, scope: !75)
!126 = !DILocation(line: 41, column: 5, scope: !53)
!127 = !DILocation(line: 45, column: 1, scope: !53)
!128 = !DILocation(line: 0, scope: !78)
!129 = !DILocation(line: 39, column: 16, scope: !130)
!130 = distinct !DILexicalBlock(scope: !131, file: !1, line: 38, column: 33)
!131 = distinct !DILexicalBlock(scope: !78, file: !1, line: 38, column: 5)
!132 = !DILocation(line: 39, column: 13, scope: !130)
!133 = !DILocation(line: 38, column: 28, scope: !131)
!134 = !DILocation(line: 38, column: 23, scope: !131)
!135 = !DILocation(line: 38, column: 5, scope: !78)
!136 = distinct !{!136, !135, !137, !51, !52}
