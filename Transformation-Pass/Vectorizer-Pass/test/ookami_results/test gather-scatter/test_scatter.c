...
void data_permutation_scatter_store(int *a, int *b, int n) {
    int vscale = svcntw();
    svbool_t allActive = svptrue_b32();
...
void data_permutation_scalar_store(int *a, int *b, int n) {
    int vscale = svcntw();
    svbool_t allActive = svptrue_b32();
...
int main() {
    ...
    //ACLE(a, b, indices, n);
    data_permutation_scatter_store(a, b, n);
    data_permutation_scalar_store(a, b, n);
