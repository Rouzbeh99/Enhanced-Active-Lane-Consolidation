; ModuleID = '/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Benchmarks/SPEC/benchspec/CPU/544.nab_r/src/rand2.c'
source_filename = "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Benchmarks/SPEC/benchspec/CPU/544.nab_r/src/rand2.c"
...
3:                                                ; preds = %3, %2
  ...
  %5 = fmul double %4, 2.000000e+00, !dbg !151
  %6 = fadd double %5, -1.000000e+00, !dbg !152
  call void @llvm.dbg.value(metadata double %6, metadata !144, metadata !DIExpression()) #7, !dbg !146
  %7 = tail call fastcc double @rand2a() #7, !dbg !153
  %8 = fmul double %7, 2.000000e+00, !dbg !154
  %9 = fadd double %8, -1.000000e+00, !dbg !155
  call void @llvm.dbg.value(metadata double %9, metadata !145, metadata !DIExpression()) #7, !dbg !146
  %10 = fmul double %6, %6, !dbg !156
  %11 = fmul double %9, %9, !dbg !157
  %12 = fadd double %10, %11, !dbg !158
  call void @llvm.dbg.value(metadata double %12, metadata !143, metadata !DIExpression()) #7, !dbg !146
  %13 = fcmp oge double %12, 1.000000e+00, !dbg !159
  %14 = fcmp oeq double %12, 0.000000e+00, !dbg !160
  %15 = or i1 %13, %14, !dbg !160
  br i1 %15, label %3, label %16, !dbg !161, !llvm.loop !162

16:                                               ; preds = %3
  %17 = tail call double @log(double %12) #7, !dbg !164
  %18 = fmul double %17, -2.000000e+00, !dbg !165
  %19 = fdiv double %18, %12, !dbg !166
  %20 = tail call double @sqrt(double %19) #7, !dbg !167
  call void @llvm.dbg.value(metadata double %20, metadata !141, metadata !DIExpression()) #7, !dbg !146
  %21 = fmul double %6, %20, !dbg !168
  call void @llvm.dbg.value(metadata double %21, metadata !142, metadata !DIExpression()) #7, !dbg !146
  %22 = load double, double* %1, align 8, !dbg !169, !tbaa !170
  %23 = fmul double %22, %21, !dbg !172
  %24 = load double, double* %0, align 8, !dbg !173, !tbaa !170
  %25 = fadd double %23, %24, !dbg !174
  ret double %25, !dbg !175
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @setseed(i32* nocapture readonly %0) local_unnamed_addr #1 !dbg !176 {
  call void @llvm.dbg.value(metadata i32* %0, metadata !180, metadata !DIExpression()), !dbg !181
  %2 = load i32, i32* %0, align 4, !dbg !182, !tbaa !55
  %3 = icmp sgt i32 %2, -1, !dbg !184
  br i1 %3, label %4, label %7, !dbg !185

4:                                                ; preds = %1
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !186, !tbaa !188
  %6 = tail call i64 @fwrite(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0), i64 38, i64 1, %struct._IO_FILE* %5) #8, !dbg !190
  br label %8, !dbg !191

7:                                                ; preds = %1
  store i32 %2, i32* @seed3, align 4, !dbg !192, !tbaa !55
  br label %8, !dbg !194

8:                                                ; preds = %7, %4
  %9 = phi i32 [ 1, %4 ], [ 0, %7 ], !dbg !195
  ret i32 %9, !dbg !196
}

; Function Attrs: nounwind uwtable
define dso_local i32 @rseed() local_unnamed_addr #3 !dbg !197 {
  %1 = alloca %struct.timeval, align 8
  %2 = bitcast %struct.timeval* %1 to i8*, !dbg !202
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2) #7, !dbg !202
  call void @llvm.dbg.declare(metadata %struct.timeval* %1, metadata !201, metadata !DIExpression()), !dbg !203
  %3 = call i32 @gettimeofday(%struct.timeval* nonnull %1, i8* null) #7, !dbg !204
  %4 = getelementptr inbounds %struct.timeval, %struct.timeval* %1, i64 0, i32 0, !dbg !205
  %5 = load i64, i64* %4, align 8, !dbg !205, !tbaa !206
  %6 = getelementptr inbounds %struct.timeval, %struct.timeval* %1, i64 0, i32 1, !dbg !209
  %7 = load i64, i64* %6, align 8, !dbg !209, !tbaa !210
  %8 = xor i64 %7, %5, !dbg !211
  %9 = trunc i64 %8 to i32, !dbg !212
  %10 = sub nsw i32 0, %9, !dbg !213
  store i32 %10, i32* @seed3, align 4, !dbg !214, !tbaa !55
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2) #7, !dbg !215
  ret i32 %10, !dbg !216
}
...
!3 = !DIFile(filename: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Benchmarks/SPEC/benchspec/CPU/544.nab_r/src/rand2.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation-Pass/Vectorizer-Pass/test/spec codes")
!4 = !{}
!5 = !{!6, !7, !11}
...
!25 = !DIFile(filename: "Benchmarks/SPEC/benchspec/CPU/544.nab_r/src/rand2.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation")
...
!151 = !DILocation(line: 152, column: 11, scope: !150, inlinedAt: !147)
!152 = !DILocation(line: 152, column: 25, scope: !150, inlinedAt: !147)
!153 = !DILocation(line: 153, column: 12, scope: !150, inlinedAt: !147)
!154 = !DILocation(line: 153, column: 11, scope: !150, inlinedAt: !147)
!155 = !DILocation(line: 153, column: 25, scope: !150, inlinedAt: !147)
!156 = !DILocation(line: 154, column: 12, scope: !150, inlinedAt: !147)
!157 = !DILocation(line: 154, column: 20, scope: !150, inlinedAt: !147)
!158 = !DILocation(line: 154, column: 16, scope: !150, inlinedAt: !147)
!159 = !DILocation(line: 155, column: 17, scope: !135, inlinedAt: !147)
!160 = !DILocation(line: 155, column: 23, scope: !135, inlinedAt: !147)
!161 = !DILocation(line: 155, column: 3, scope: !150, inlinedAt: !147)
!162 = distinct !{!162, !148, !163}
!163 = !DILocation(line: 155, column: 37, scope: !135, inlinedAt: !147)
!164 = !DILocation(line: 156, column: 18, scope: !135, inlinedAt: !147)
!165 = !DILocation(line: 156, column: 17, scope: !135, inlinedAt: !147)
!166 = !DILocation(line: 156, column: 26, scope: !135, inlinedAt: !147)
!167 = !DILocation(line: 156, column: 9, scope: !135, inlinedAt: !147)
!168 = !DILocation(line: 157, column: 13, scope: !135, inlinedAt: !147)
!169 = !DILocation(line: 159, column: 11, scope: !135, inlinedAt: !147)
!170 = !{!171, !171, i64 0}
!171 = !{!"double", !57, i64 0}
!172 = !DILocation(line: 159, column: 14, scope: !135, inlinedAt: !147)
!173 = !DILocation(line: 159, column: 23, scope: !135, inlinedAt: !147)
!174 = !DILocation(line: 159, column: 21, scope: !135, inlinedAt: !147)
!175 = !DILocation(line: 177, column: 2, scope: !126)
!176 = distinct !DISubprogram(name: "setseed", scope: !25, file: !25, line: 184, type: !177, scopeLine: 185, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !179)
!177 = !DISubroutineType(types: !178)
!178 = !{!11, !46}
!179 = !{!180}
!180 = !DILocalVariable(name: "seed4", arg: 1, scope: !176, file: !25, line: 184, type: !46)
!181 = !DILocation(line: 0, scope: !176)
!182 = !DILocation(line: 186, column: 6, scope: !183)
!183 = distinct !DILexicalBlock(scope: !176, file: !25, line: 186, column: 6)
!184 = !DILocation(line: 186, column: 13, scope: !183)
!185 = !DILocation(line: 186, column: 6, scope: !176)
!186 = !DILocation(line: 187, column: 12, scope: !187)
!187 = distinct !DILexicalBlock(scope: !183, file: !25, line: 186, column: 19)
!188 = !{!189, !189, i64 0}
!189 = !{!"any pointer", !57, i64 0}
!190 = !DILocation(line: 187, column: 3, scope: !187)
!191 = !DILocation(line: 188, column: 3, scope: !187)
!192 = !DILocation(line: 190, column: 9, scope: !193)
!193 = distinct !DILexicalBlock(scope: !183, file: !25, line: 189, column: 9)
!194 = !DILocation(line: 191, column: 3, scope: !193)
!195 = !DILocation(line: 0, scope: !183)
!196 = !DILocation(line: 193, column: 1, scope: !176)
!197 = distinct !DISubprogram(name: "rseed", scope: !25, file: !25, line: 200, type: !198, scopeLine: 201, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !200)
!198 = !DISubroutineType(types: !199)
!199 = !{!11}
!200 = !{!201}
!201 = !DILocalVariable(name: "tv", scope: !197, file: !25, line: 202, type: !13)
!202 = !DILocation(line: 202, column: 2, scope: !197)
!203 = !DILocation(line: 202, column: 17, scope: !197)
!204 = !DILocation(line: 203, column: 2, scope: !197)
!205 = !DILocation(line: 204, column: 21, scope: !197)
!206 = !{!207, !208, i64 0}
!207 = !{!"timeval", !208, i64 0, !208, i64 8}
!208 = !{!"long", !57, i64 0}
!209 = !DILocation(line: 204, column: 33, scope: !197)
!210 = !{!207, !208, i64 8}
!211 = !DILocation(line: 204, column: 28, scope: !197)
!212 = !DILocation(line: 204, column: 12, scope: !197)
!213 = !DILocation(line: 204, column: 10, scope: !197)
!214 = !DILocation(line: 204, column: 8, scope: !197)
!215 = !DILocation(line: 206, column: 1, scope: !197)
!216 = !DILocation(line: 205, column: 2, scope: !197)
