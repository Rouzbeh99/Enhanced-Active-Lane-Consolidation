...
for.body.preheader2:                              ; preds = %middle.block, %for.body.preheader
  %indvars.iv.ph = phi i64 [ %28, %middle.block ], [ 0, %for.body.preheader ]
...
middle.block:                                     ; preds = %vectorizing.block
  %condition = icmp eq i64 %6, 0
  br i1 %condition, label %for.cond.cleanup, label %for.body.preheader2

Pre.Vectorization:                                ; preds = %for.body.preheader
  %6 = urem i64 %wide.trip.count, %1
  %total.iterations.to.be.vectorized = sub nsw i64 %wide.trip.count, %6
  br label %vectorizing.block

vectorizing.block:                                ; preds = %vectorizing.block, %Pre.Vectorization
  %7 = phi i64 [ 0, %Pre.Vectorization ], [ %28, %vectorizing.block ]
  %8 = getelementptr inbounds i8, ptr %cond, i64 %7, !dbg !39
  %9 = load <vscale x 4 x i8>, ptr %8, align 4
  %10 = icmp ne <vscale x 4 x i8> %9, zeroinitializer
  %11 = getelementptr inbounds i32, ptr %a, i64 %7, !dbg !48
  %12 = getelementptr inbounds i32, ptr %c, i64 %7, !dbg !53
  %13 = getelementptr inbounds i32, ptr %b, i64 %7, !dbg !56
  %14 = tail call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %11, i32 16, <vscale x 4 x i1> %10, <vscale x 4 x i32> undef)
  %15 = mul <vscale x 4 x i32> %14, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> poison, i32 18, i64 0), <vscale x 4 x i32> poison, <vscale x 4 x i32> zeroinitializer)
  %16 = tail call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %12, i32 16, <vscale x 4 x i1> %10, <vscale x 4 x i32> undef)
  %17 = shl <vscale x 4 x i32> %16, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> poison, i32 1, i64 0), <vscale x 4 x i32> poison, <vscale x 4 x i32> zeroinitializer)
  %18 = add <vscale x 4 x i32> %17, %15
  %19 = tail call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %13, i32 16, <vscale x 4 x i1> %10, <vscale x 4 x i32> undef)
  %20 = mul <vscale x 4 x i32> %14, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> poison, i32 -4, i64 0), <vscale x 4 x i32> poison, <vscale x 4 x i32> zeroinitializer)
  %21 = add <vscale x 4 x i32> %19, %20
  %22 = sdiv <vscale x 4 x i32> %18, %21
  tail call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %22, ptr %11, i32 16, <vscale x 4 x i1> %10)
  %23 = mul <vscale x 4 x i32> %19, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> poison, i32 5, i64 0), <vscale x 4 x i32> poison, <vscale x 4 x i32> zeroinitializer)
  %24 = mul <vscale x 4 x i32> %23, %22
  tail call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %24, ptr %13, i32 16, <vscale x 4 x i1> %10)
  %25 = shl <vscale x 4 x i32> %24, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> poison, i32 1, i64 0), <vscale x 4 x i32> poison, <vscale x 4 x i32> zeroinitializer)
  %26 = mul <vscale x 4 x i32> %22, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> poison, i32 -3, i64 0), <vscale x 4 x i32> poison, <vscale x 4 x i32> zeroinitializer)
  %27 = add <vscale x 4 x i32> %25, %26
  tail call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %27, ptr %12, i32 16, <vscale x 4 x i1> %10)
  %28 = add i64 %7, %1
  %terminate.condition.not = icmp ult i64 %28, %total.iterations.to.be.vectorized
  br i1 %terminate.condition.not, label %vectorizing.block, label %middle.block
...
declare <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr, i32 immarg, <vscale x 4 x i1>, <vscale x 4 x i32>) #6

; Function Attrs: argmemonly mustprogress nocallback nofree nosync nounwind willreturn writeonly
declare void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32>, ptr, i32 immarg, <vscale x 4 x i1>) #7
...
!1 = !DIFile(filename: "test.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation-Pass/Vectorizer-Pass/test", checksumkind: CSK_MD5, checksum: "4a0b27213e8d0751c4505b53170cdf60")
