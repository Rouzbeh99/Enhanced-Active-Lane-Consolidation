...
foo:                                    // @foo
.Lfunc_begin0:
	.file	0 "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation-Pass/Vectorizer-Pass/test" "test.c" md5 0x934b071bdca8250cfb34ac9e786213bd
...
// %bb.1:                               // %for.body.preheader
	...
	//DEBUG_VALUE: foo:b <- $x1
	//DEBUG_VALUE: foo:a <- $x0
	.loc	0 7 23 is_stmt 0                // test.c:7:23
	mov	w8, w3
.Ltmp2:
	.loc	0 7 5                           // test.c:7:5
	cntw	x10
...
.LBB0_3:                                // %vectorizing.block
	...
	mov	z4.d, z0.d
.Ltmp5:
	.loc	0 9 27 is_stmt 1                // test.c:9:27
	add	x15, x0, x11
	.loc	0 9 13 is_stmt 0                // test.c:9:13
	add	x16, x1, x11
	and	z3.d, z3.d, #0x1
	and	z4.d, z4.d, #0x1
	cmpeq	p1.d, p0/z, z4.d, #0
	cmpeq	p2.d, p0/z, z3.d, #0
	uzp1	p1.s, p1.s, p2.s
	add	x9, x9, x10
	ld1w	{ z3.s }, p1/z, [x15]
	ld1w	{ z4.s }, p1/z, [x16]
...
.Ldebug_info_start0:
	...
	.byte	2                               // DW_AT_low_pc
	.word	.Ltmp21-.Ltmp14                 // DW_AT_high_pc
	...
	.word	93                              // DW_AT_abstract_origin
	.byte	3                               // DW_AT_low_pc
	.word	.Ltmp29-.Ltmp22                 // DW_AT_high_pc
	...
	.byte	4                               // DW_AT_low_pc
	.word	.Ltmp27-.Ltmp23                 // DW_AT_high_pc
	...
	.byte	5                               // DW_AT_low_pc
	.word	.Ltmp34-.Ltmp29                 // DW_AT_high_pc
