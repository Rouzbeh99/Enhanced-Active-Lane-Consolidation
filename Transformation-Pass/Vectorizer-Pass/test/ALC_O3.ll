...
for.body.preheader:                               ; preds = %for.cond.preheader
  ...
  br i1 %.not, label %for.body.preheader41, label %pre.alc, !dbg !127

if.then:                                          ; preds = %entry
  %4 = load ptr, ptr @stderr, align 8, !dbg !128, !tbaa !130
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str, i32 noundef %call1, ptr noundef nonnull @.str.1, i32 noundef 77) #14, !dbg !128
...
for.cond.cleanup:                                 ; preds = %for.inc, %for.cond.preheader
  ...
  %call127 = tail call i32 @PAPI_stop(i32 noundef %5, ptr noundef nonnull @CounterValues) #13, !dbg !134
...
if.then4:                                         ; preds = %for.body
  ...
  %mul21214 = add i32 %8, 2, !dbg !148
  %9 = trunc i64 %indvars.iv to i32, !dbg !148
  %add22 = mul i32 %mul21214, %9, !dbg !148
  %.neg = mul i32 %7, -2
  %add = add i32 %.neg, %8, !dbg !149
  %add25 = add i32 %add, %add22, !dbg !150
  store i32 %add25, ptr %arrayidx6, align 4, !dbg !150, !tbaa !119
  %mul43215.neg = sub i32 -3, %7, !dbg !151
  %add44.neg224 = mul i32 %mul43215.neg, %9, !dbg !151
  %10 = add i32 %8, %7
  ...
  %11 = add nsw i32 %sub47, %add25, !dbg !154
  %add54 = shl nsw i32 %11, 1, !dbg !154
  %12 = sub nsw i32 %7, %sub47, !dbg !155
  %sub61 = shl nsw i32 %12, 1, !dbg !155
  %mul62 = mul nsw i32 %9, %9, !dbg !156
  %add63 = add nsw i32 %sub61, %mul62, !dbg !157
  %mul64.neg = mul i32 %add63, -3, !dbg !158
  %sub65 = add i32 %add54, %7, !dbg !159
...
if.else:                                          ; preds = %for.body
  ...
  %13 = load i32, ptr %arrayidx70, align 4, !dbg !162, !tbaa !119
  %add71 = add nsw i32 %13, 2, !dbg !164
  %arrayidx73 = getelementptr inbounds i32, ptr %c, i64 %indvars.iv, !dbg !165
  %14 = load i32, ptr %arrayidx73, align 4, !dbg !165, !tbaa !119
  %mul74.neg = mul i32 %14, -3, !dbg !166
  %sub75 = add i32 %add71, %mul74.neg, !dbg !167
  %arrayidx77 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv, !dbg !168
  %15 = load i32, ptr %arrayidx77, align 4, !dbg !169, !tbaa !119
  %mul78 = mul nsw i32 %sub75, %15, !dbg !169
  %mul83 = mul nsw i32 %mul78, %13, !dbg !170
  %sub84 = add i32 %14, -1, !dbg !171
...
alc.header:                                       ; preds = %new.latch, %pre.alc
  ...
  %uniform.vector = phi <vscale x 4 x i32> [ %17, %pre.alc ], [ %99, %new.latch ]
  %uniform.vector.predicates = phi <vscale x 4 x i1> [ %21, %pre.alc ], [ %100, %new.latch ]
  %23 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.index.nxv4i32(i32 %vector.loop.index, i32 1)
  %24 = sext i32 %vector.loop.index to i64, !dbg !137
  %25 = getelementptr inbounds i8, ptr %cond, i64 %24, !dbg !137
  %26 = load <vscale x 4 x i8>, ptr %25, align 4
  %27 = icmp eq <vscale x 4 x i8> %26, zeroinitializer
  %28 = tail call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %uniform.vector.predicates, <vscale x 4 x i1> %uniform.vector.predicates)
  %29 = tail call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %27, <vscale x 4 x i1> %27)
  %30 = trunc i64 %28 to i32
  %31 = trunc i64 %29 to i32
  %32 = add i32 %31, %30
  %33 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %uniform.vector.predicates, <vscale x 4 x i32> %uniform.vector)
  %34 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %27, <vscale x 4 x i32> %23)
  %35 = xor <vscale x 4 x i1> %uniform.vector.predicates, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %36 = xor <vscale x 4 x i1> %27, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %37 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %35, <vscale x 4 x i32> %uniform.vector)
  %38 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.compact.nxv4i32(<vscale x 4 x i1> %36, <vscale x 4 x i32> %23)
  %39 = tail call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %30)
  %40 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %39, <vscale x 4 x i32> %33, <vscale x 4 x i32> %34)
  %41 = tail call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i32(i32 0, i32 %32)
  %42 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %41, <vscale x 4 x i32> %40, <vscale x 4 x i32> %38)
  %43 = tail call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %29)
  %44 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.splice.nxv4i32(<vscale x 4 x i1> %43, <vscale x 4 x i32> %34, <vscale x 4 x i32> %38)
  %45 = tail call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %35, <vscale x 4 x i1> %35)
  %46 = tail call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %45)
  %47 = select <vscale x 4 x i1> %46, <vscale x 4 x i32> %37, <vscale x 4 x i32> %44
  %48 = xor <vscale x 4 x i1> %46, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %49 = tail call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %36, <vscale x 4 x i1> %36)
  %50 = sub i64 %22, %49
  %51 = tail call <vscale x 4 x i1> @llvm.aarch64.sve.whilelt.nxv4i1.i64(i64 0, i64 %50)
  %52 = and <vscale x 4 x i1> %51, %48
  %53 = icmp ugt i32 %32, %2
  br i1 %53, label %uniform.then, label %uniform.else

uniform.then:                                     ; preds = %alc.header
  %54 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %b, <vscale x 4 x i32> %42)
  %55 = add <vscale x 4 x i32> %54, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %56 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %c, <vscale x 4 x i32> %42)
  ...
  %58 = add <vscale x 4 x i32> %55, %57
  %59 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %a, <vscale x 4 x i32> %42)
  %60 = mul <vscale x 4 x i32> %58, %59
  %61 = mul <vscale x 4 x i32> %60, %54
  %62 = add <vscale x 4 x i32> %56, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %63 = add <vscale x 4 x i32> %62, %61
  %64 = mul <vscale x 4 x i32> %60, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  ...
  %66 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %60
  %67 = add <vscale x 4 x i32> %66, %64
  %68 = add <vscale x 4 x i32> %67, %65
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %68, <vscale x 4 x i1> %16, ptr %b, <vscale x 4 x i32> %42)
  ...
  %70 = add <vscale x 4 x i32> %60, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %71 = add <vscale x 4 x i32> %70, %69
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %71, <vscale x 4 x i1> %16, ptr %a, <vscale x 4 x i32> %42)
  ...
  %74 = add <vscale x 4 x i32> %73, %63
  %75 = add <vscale x 4 x i32> %74, %72
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %75, <vscale x 4 x i1> %16, ptr %c, <vscale x 4 x i32> %42)
  br label %new.latch

uniform.else:                                     ; preds = %alc.header
  %76 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %c, <vscale x 4 x i32> %47)
  %77 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %16, ptr %b, <vscale x 4 x i32> %47)
  %78 = add <vscale x 4 x i32> %77, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %79 = mul <vscale x 4 x i32> %78, %47
  %80 = mul <vscale x 4 x i32> %76, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %81 = add <vscale x 4 x i32> %80, %77
  %82 = add <vscale x 4 x i32> %81, %79
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %82, <vscale x 4 x i1> %16, ptr %a, <vscale x 4 x i32> %47)
  %83 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %76
  %84 = mul <vscale x 4 x i32> %83, %47
  %85 = add <vscale x 4 x i32> %77, %76
  ...
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %89, <vscale x 4 x i1> %16, ptr %b, <vscale x 4 x i32> %47)
  ...
  %94 = mul <vscale x 4 x i32> %47, %47
  %95 = add <vscale x 4 x i32> %93, %94
  %96 = mul <vscale x 4 x i32> %95, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %97 = add <vscale x 4 x i32> %91, %76
  %98 = add <vscale x 4 x i32> %97, %96
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %98, <vscale x 4 x i1> %16, ptr %c, <vscale x 4 x i32> %47)
  br label %new.latch

new.latch:                                        ; preds = %uniform.else, %uniform.then
  %99 = phi <vscale x 4 x i32> [ %47, %uniform.then ], [ %42, %uniform.else ]
  %100 = phi <vscale x 4 x i1> [ %52, %uniform.then ], [ %41, %uniform.else ]
  %101 = add i32 %vector.loop.index, %2
  %.not2 = icmp ult i32 %101, %total.iterations.to.be.vectorized
  br i1 %.not2, label %alc.header, label %joinBlock

linearized.then:                                  ; preds = %joinBlock
  %102 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %41, ptr %b, <vscale x 4 x i32> %42)
  %103 = add <vscale x 4 x i32> %102, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %104 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %41, ptr %c, <vscale x 4 x i32> %42)
  %105 = mul <vscale x 4 x i32> %104, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %106 = add <vscale x 4 x i32> %103, %105
  %107 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %41, ptr %a, <vscale x 4 x i32> %42)
  %108 = mul <vscale x 4 x i32> %106, %107
  %109 = mul <vscale x 4 x i32> %108, %102
  %110 = add <vscale x 4 x i32> %104, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %111 = add <vscale x 4 x i32> %110, %109
  %112 = mul <vscale x 4 x i32> %108, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %113 = mul <vscale x 4 x i32> %111, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %114 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %108
  %115 = add <vscale x 4 x i32> %114, %112
  %116 = add <vscale x 4 x i32> %115, %113
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %116, <vscale x 4 x i1> %41, ptr %b, <vscale x 4 x i32> %42)
  %117 = mul <vscale x 4 x i32> %116, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %118 = add <vscale x 4 x i32> %108, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %119 = add <vscale x 4 x i32> %118, %117
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %119, <vscale x 4 x i1> %41, ptr %a, <vscale x 4 x i32> %42)
  %120 = mul <vscale x 4 x i32> %119, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 5, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %121 = shl <vscale x 4 x i32> %116, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %122 = add <vscale x 4 x i32> %121, %111
  %123 = add <vscale x 4 x i32> %122, %120
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %123, <vscale x 4 x i1> %41, ptr %c, <vscale x 4 x i32> %42)
  %124 = xor <vscale x 4 x i1> %41, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %125 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %124, ptr %c, <vscale x 4 x i32> %42)
  %126 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %124, ptr %b, <vscale x 4 x i32> %42)
  ...
  %128 = mul <vscale x 4 x i32> %127, %42
  ...
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %131, <vscale x 4 x i1> %124, ptr %a, <vscale x 4 x i32> %42)
  ...
  %133 = mul <vscale x 4 x i32> %132, %42
  ...
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %138, <vscale x 4 x i1> %124, ptr %b, <vscale x 4 x i32> %42)
  ...
  %143 = mul <vscale x 4 x i32> %42, %42
  ...
  %146 = add <vscale x 4 x i32> %140, %125
  %147 = add <vscale x 4 x i32> %146, %145
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %147, <vscale x 4 x i1> %124, ptr %c, <vscale x 4 x i32> %42)
  br label %middel.block

linearized.else:                                  ; preds = %joinBlock
  %148 = xor <vscale x 4 x i1> %52, shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
  %149 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %148, ptr %c, <vscale x 4 x i32> %47)
  %150 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %148, ptr %b, <vscale x 4 x i32> %47)
  ...
  %152 = mul <vscale x 4 x i32> %151, %47
  ...
  %154 = add <vscale x 4 x i32> %153, %150
  %155 = add <vscale x 4 x i32> %154, %152
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %155, <vscale x 4 x i1> %148, ptr %a, <vscale x 4 x i32> %47)
  ...
  %157 = mul <vscale x 4 x i32> %156, %47
  %158 = add <vscale x 4 x i32> %150, %149
  ...
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %162, <vscale x 4 x i1> %148, ptr %b, <vscale x 4 x i32> %47)
  ...
  %167 = mul <vscale x 4 x i32> %47, %47
  ...
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %171, <vscale x 4 x i1> %148, ptr %c, <vscale x 4 x i32> %47)
  %172 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %52, ptr %b, <vscale x 4 x i32> %47)
  ...
  %174 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %52, ptr %c, <vscale x 4 x i32> %47)
  %175 = mul <vscale x 4 x i32> %174, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %176 = add <vscale x 4 x i32> %173, %175
  %177 = tail call <vscale x 4 x i32> @llvm.aarch64.sve.ld1.gather.sxtw.index.nxv4i32(<vscale x 4 x i1> %52, ptr %a, <vscale x 4 x i32> %47)
  %178 = mul <vscale x 4 x i32> %176, %177
  %179 = mul <vscale x 4 x i32> %178, %172
  %180 = add <vscale x 4 x i32> %174, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %181 = add <vscale x 4 x i32> %180, %179
  %182 = mul <vscale x 4 x i32> %178, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 3, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %183 = mul <vscale x 4 x i32> %181, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %184 = sub <vscale x 4 x i32> shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -7, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer), %178
  %185 = add <vscale x 4 x i32> %184, %182
  %186 = add <vscale x 4 x i32> %185, %183
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %186, <vscale x 4 x i1> %52, ptr %b, <vscale x 4 x i32> %47)
  %187 = mul <vscale x 4 x i32> %186, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -2, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %188 = add <vscale x 4 x i32> %178, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 -4, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %189 = add <vscale x 4 x i32> %188, %187
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %189, <vscale x 4 x i1> %52, ptr %a, <vscale x 4 x i32> %47)
  %190 = mul <vscale x 4 x i32> %189, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 5, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %191 = shl <vscale x 4 x i32> %186, shufflevector (<vscale x 4 x i32> insertelement (<vscale x 4 x i32> undef, i32 1, i64 0), <vscale x 4 x i32> undef, <vscale x 4 x i32> zeroinitializer)
  %192 = add <vscale x 4 x i32> %191, %181
  %193 = add <vscale x 4 x i32> %192, %190
  tail call void @llvm.aarch64.sve.st1.scatter.sxtw.index.nxv4i32(<vscale x 4 x i32> %193, <vscale x 4 x i1> %52, ptr %c, <vscale x 4 x i32> %47)
  br label %middel.block

joinBlock:                                        ; preds = %new.latch
  %194 = icmp eq <vscale x 4 x i32> %99, %42
  %195 = tail call i64 @llvm.aarch64.sve.cntp.nxv4i1(<vscale x 4 x i1> %194, <vscale x 4 x i1> %194)
  %196 = trunc i64 %195 to i32
  %197 = icmp eq i32 %2, %196
  br i1 %197, label %linearized.then, label %linearized.else

middel.block:                                     ; preds = %linearized.else, %linearized.then
  %198 = zext i32 %101 to i64
  br label %for.body.preheader41

for.body.preheader41:                             ; preds = %middel.block, %for.body.preheader
  %indvars.iv.ph = phi i64 [ %198, %middel.block ], [ 0, %for.body.preheader ]
...
if.then129:                                       ; preds = %for.cond.cleanup
  %199 = load ptr, ptr @stderr, align 8, !dbg !189, !tbaa !130
  %call130 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %199, ptr noundef nonnull @.str, i32 noundef %call127, ptr noundef nonnull @.str.1, i32 noundef 103) #14, !dbg !189
...
for.body:                                         ; preds = %for.body, %if.end11
  ...
  %call24 = tail call i32 @rand() #13, !dbg !304
...
for.cond.cleanup33:                               ; preds = %for.body34
  ...
  tail call void @free(ptr noundef %12) #13, !dbg !316
  %13 = load ptr, ptr @b, align 8, !dbg !317, !tbaa !130
  tail call void @free(ptr noundef %13) #13, !dbg !318
  %14 = load ptr, ptr @c, align 8, !dbg !319, !tbaa !130
  tail call void @free(ptr noundef %14) #13, !dbg !320
  %15 = load ptr, ptr @cond, align 8, !dbg !321, !tbaa !130
  tail call void @free(ptr noundef %15) #13, !dbg !322
  ...
  %call51 = tail call i32 @PAPI_remove_events(i32 noundef %25, ptr noundef nonnull @EventCodes, i32 noundef 8) #13, !dbg !345
