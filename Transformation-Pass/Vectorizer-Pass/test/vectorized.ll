...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  ...
  %1 = mul i64 %0, 4, !dbg !98
  %2 = icmp uge i64 8192, %1, !dbg !98
  br i1 %2, label %Pre.Vectorization, label %Preheader.for.remaining.iterations, !dbg !98

for.cond.cleanup:                                 ; preds = %for.cond.cleanup4
  %t2 = getelementptr inbounds %struct.args_t, ptr %func_args, i64 0, i32 1, !dbg !99
  %call23 = tail call i32 @gettimeofday(ptr noundef nonnull %t2, ptr noundef null) #10, !dbg !100
  %call24 = tail call i32 @calc_checksum(ptr noundef nonnull @__func__.s253) #10, !dbg !101
  ret i32 %call24, !dbg !102

for.cond.cleanup4:                                ; preds = %middle.block, %for.inc
  %call19 = tail call i32 @dummy(ptr noundef nonnull @a, ptr noundef nonnull @b, ptr noundef nonnull @c, ptr noundef nonnull @d, ptr noundef nonnull @e, ptr noundef nonnull @aa, ptr noundef nonnull @bb, ptr noundef nonnull @cc, i32 noundef 0) #10, !dbg !103
...
Pre.Vectorization:                                ; preds = %for.cond2.preheader
  ...
  %8 = mul i64 %7, 4
  %9 = call <vscale x 4 x i64> @llvm.experimental.stepvector.nxv4i64()
  %10 = urem i64 8192, %8
  %total.iterations.to.be.vectorized = sub i64 8192, %10
  %11 = insertelement <vscale x 4 x i64> poison, i64 %8, i64 0
  %stepVector.update.values = shufflevector <vscale x 4 x i64> %11, <vscale x 4 x i64> poison, <vscale x 4 x i32> zeroinitializer
  br label %vectorizing.block

vectorizing.block:                                ; preds = %vectorizing.block, %Pre.Vectorization
  %12 = phi i64 [ 0, %Pre.Vectorization ], [ %26, %vectorizing.block ]
  %13 = phi <vscale x 4 x i64> [ %9, %Pre.Vectorization ], [ %27, %vectorizing.block ]
  %14 = getelementptr inbounds [8192 x i32], ptr @a, i64 0, i64 %12, !dbg !110
  %15 = getelementptr inbounds [8192 x i32], ptr @b, i64 0, i64 %12, !dbg !118
  %16 = load <vscale x 4 x i32>, ptr %14, align 16
  %17 = load <vscale x 4 x i32>, ptr %15, align 16
  %18 = icmp sgt <vscale x 4 x i32> %16, %17
  %19 = getelementptr inbounds [8192 x i32], ptr @d, i64 0, i64 %12, !dbg !121
  %20 = getelementptr inbounds [8192 x i32], ptr @c, i64 0, i64 %12, !dbg !125
  %21 = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %19, i32 16, <vscale x 4 x i1> %18, <vscale x 4 x i32> undef)
  %22 = mul <vscale x 4 x i32> %21, %17
  %23 = sub <vscale x 4 x i32> %16, %22
  %24 = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr %20, i32 16, <vscale x 4 x i1> %18, <vscale x 4 x i32> undef)
  %25 = add <vscale x 4 x i32> %23, %24
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %25, ptr %20, i32 16, <vscale x 4 x i1> %18)
  call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> %23, ptr %14, i32 16, <vscale x 4 x i1> %18)
  %26 = add i64 %8, %12
  %27 = add <vscale x 4 x i64> %13, %stepVector.update.values
  %terminate.condition = icmp uge i64 %26, %total.iterations.to.be.vectorized
...
Preheader.for.remaining.iterations:               ; preds = %middle.block, %for.cond2.preheader
  %28 = phi i64 [ 0, %for.cond2.preheader ], [ %26, %middle.block ]
  br label %for.body5
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %func_args) #10, !dbg !168
  ...
  %call = call i32 %vector_func(ptr noundef nonnull %func_args) #10, !dbg !176
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %func_args) #10, !dbg !196
  ret void, !dbg !196
}
...
; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare <vscale x 4 x i64> @llvm.experimental.stepvector.nxv4i64() #7
