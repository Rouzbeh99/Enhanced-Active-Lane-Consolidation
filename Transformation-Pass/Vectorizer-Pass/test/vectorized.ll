...
for.cond.cleanup10:                               ; preds = %for.body11
  %add.lcssa = phi i32 [ %add, %for.body11 ], !dbg !102
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str, i32 noundef %add.lcssa), !dbg !105
  ret i32 0, !dbg !106
...
for.body11:                                       ; preds = %for.body11, %for.cond.cleanup
  ...
  %arrayidx13 = getelementptr inbounds i32, ptr %vla232, i64 %indvars.iv37, !dbg !107
  %1 = load i32, ptr %arrayidx13, align 4, !dbg !107, !tbaa !39
  %add = add nsw i32 %1, %sum.034, !dbg !102
...
!103 = distinct !DILexicalBlock(scope: !104, file: !1, line: 35, column: 33)
!104 = distinct !DILexicalBlock(scope: !78, file: !1, line: 35, column: 5)
!105 = !DILocation(line: 38, column: 5, scope: !53)
!106 = !DILocation(line: 42, column: 1, scope: !53)
!107 = !DILocation(line: 36, column: 16, scope: !103)
!108 = !DILocation(line: 35, column: 28, scope: !104)
!109 = !DILocation(line: 35, column: 23, scope: !104)
